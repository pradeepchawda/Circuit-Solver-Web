 ...
 *
 ***********************************************************************/
var TimeStepWindow = /** @class */ (function () {
    function TimeStepWindow() {
    ...
    TimeStepWindow.prototype.mouse_down = function () {
    ...
    TimeStepWindow.prototype.mouse_move = function () {
        if (global.FLAG_SELECT_TIMESTEP) {
    ...
    TimeStepWindow.prototype.mouse_up = function () {
        if (global.FLAG_SELECT_TIMESTEP) {
    ...
    TimeStepWindow.prototype.insert_cursor = function (is_mouse_up, is_mouse_move) {
    ...
    TimeStepWindow.prototype.key_down = function (key_event) {
        if (global.FLAG_SELECT_TIMESTEP) {
            this.handle_keyboard(key_event);
        }
    };
    TimeStepWindow.prototype.key_up = function (key_event) {
        if (global.FLAG_SELECT_TIMESTEP) {
        }
    };
    /* Handle the user's input! */
    TimeStepWindow.prototype.handle_keyboard = function (key_event) {
    ...
    TimeStepWindow.prototype.handle_partial_select = function () {
        if (this.SELECT_START != this.SELECT_END) {
    ...
    TimeStepWindow.prototype.reset_cursor = function () {
        this.CURSOR_POSITION = this.input_button.text.length;
        this.SELECT_ALL = false;
        this.SELECT_START = -1;
        this.SELECT_END = -1;
    };
    TimeStepWindow.prototype.double_click = function (mouse_event) {
    ...
    TimeStepWindow.prototype.resize_window = function () {
        if (global.MOBILE_MODE) {
            this.width = view_port.view_width * 0.2625;
            this.height = view_port.view_height * 0.15;
        }
    ...
    TimeStepWindow.prototype.draw_window = function (canvas) {
        if (global.FLAG_SELECT_TIMESTEP) {
