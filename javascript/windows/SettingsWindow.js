...
var SettingsWindow = /** @class */ (function () {
    ...
    SettingsWindow.prototype.draw_window = function (canvas) {
        if (global.FLAG_SELECT_SETTINGS) {
            this.title_bounds.text =
                language_manager.SYSTEM_SETTINGS[global.LANGUAGES[global.LANGUAGE_INDEX]];
            this.okay_button.text =
            ...
            for (var i = 0; i < this.ATTRIBUTE_SHOW_SIZE; i++) {
                if (global.not_null(global.SYSTEM_OPTIONS)) {
                    if (i < global.SYSTEM_OPTIONS['options'].length &&
                        ...
                        if (i === global.SYSTEM_OPTION_LANGUAGE) {
                            canvas.draw_text(language_manager.LANGUAGE[global.LANGUAGES[global.LANGUAGE_INDEX]] + ':=', this.attributes[i].left +
                            ...
                            canvas.draw_text(language_manager.AUTOMATIC_TIMESTEP[global.LANGUAGES[global.LANGUAGE_INDEX]] + ':=', this.attributes[i].left +
                                this.PADDING * this.bounds.get_width() +
                                this.OFFSET_X, this.attributes[i].get_center_y() + this.OFFSET_Y, this.text_paint);
                        }
                        else if (i === global.SYSTEM_OPTION_SHORTCUT_HINTS) {
                            canvas.draw_text(language_manager.SHORTCUT_HINTS[global.LANGUAGES[global.LANGUAGE_INDEX]] + ':=', this.attributes[i].left +
                                this.PADDING * this.bounds.get_width() +
                                this.OFFSET_X, this.attributes[i].get_center_y() + this.OFFSET_Y, this.text_paint);
                        }
                        else if (i === global.SYSTEM_OPTION_STRETCH_WINDOW) {
                            canvas.draw_text(language_manager.STRETCH_WINDOW[global.LANGUAGES[global.LANGUAGE_INDEX]] + ':=', this.attributes[i].left +
                                this.PADDING * this.bounds.get_width() +
                                this.OFFSET_X, this.attributes[i].get_center_y() + this.OFFSET_Y, this.text_paint);
                        }
                        else {
                            canvas.draw_text(global.SYSTEM_OPTIONS['options'][i] + ':=', this.attributes[i].left +
                                this.PADDING * this.bounds.get_width(), this.attributes[i].get_center_y() + this.OFFSET_Y, this.text_paint);
                        }
                        ...
                        if (global.SYSTEM_OPTIONS['values'][i] === global.ON ||
                            ...
                            canvas.draw_text(global.SYSTEM_OPTIONS['values'][i], this.attributes[i].right -
                                this.PADDING * this.bounds.get_width() +
