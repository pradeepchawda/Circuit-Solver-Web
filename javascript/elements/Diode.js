 ...
 *
 * Purpose           : A class to handle the Diode element. It will automatically generate
...
var Diode = /** @class */ (function () {
    function Diode(type, id, n1, n2) {
      ...
      or overlapped)*/
        ...
        this.bounds = new RectF(0, 0, 0, 0);
        /* Inititalize the element2 class that will hold the basic data about our component */
        this.elm = new Element2(id, type, global.copy(global.PROPERTY_DIODE));
    ...
    Diode.prototype.refresh_bounds = function () {
        if (this.elm.consistent()) {
            this.p1 = new PointF(0, 0);
            this.p2 = new PointF(0, 0);
            /* Create some points to hold the node locations, this will be used for drawing components */
    ...
    Diode.prototype.push_reference = function (ref) {
        this.wire_reference.push(ref);
    };
    Diode.prototype.stamp = function () {
        if (this.elm.consistent()) {
    ...
    Diode.prototype.calculate_vcrit = function () {
    ...
    Diode.prototype.is_converged = function () {
    ...
    Diode.prototype.reset_diode = function () {
    ...
    Diode.prototype.gmin_step = function (step, error) {
    ...
    Diode.prototype.get_vertices = function () {
        var vertices = [];
        var p1 = [];
        var p2 = [];
    ...
    Diode.prototype.release_wires = function () {
    ...
    Diode.prototype.release_nodes = function () {
        if (this.elm.consistent()) {
    ...
    Diode.prototype.capture_nodes = function () {
        var vertices = this.get_vertices();
        this.elm.map_node2(vertices[0], vertices[1], vertices[2], vertices[3]);
    ...
    Diode.prototype.mouse_down = function () {
        if (global.FLAG_IDLE &&
    ...
    Diode.prototype.handle_wire_builder = function (n, anchor) {
    ...
    Diode.prototype.move_element = function (dx, dy) {
    ...
    Diode.prototype.mouse_move = function () {
    ...
    Diode.prototype.mouse_up = function () {
        if (global.FLAG_IDLE) {
            if (global.focused &&
                global.focused_id === this.elm.id &&
                global.focused_type === this.elm.type) {
    ...
    Diode.prototype.select = function () {
        if (global.WIRE_BUILDER['step'] != 0) {
            wire_manager.reset_wire_builder();
        }
    ...
    Diode.prototype.remove_focus = function () {
        if (global.focused &&
            global.focused_id === this.elm.id &&
            global.focused_type === this.elm.type) {
            global.focused_id = global.NULL;
    ...
    Diode.prototype.remove_selection = function () {
        if (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type) {
            global.selected_id = global.NULL;
            global.selected_type = -1;
    ...
    Diode.prototype.wire_reference_maintenance = function () {
    ...
    Diode.prototype.unanchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    Diode.prototype.anchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    Diode.prototype.set_flip = function (flip) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    Diode.prototype.set_rotation = function (rotation) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    Diode.prototype.push_history = function () {
        if (this.INITIALIZED) {
            global.HISTORY_MANAGER['packet'].push(engine_functions.history_snapshot());
        }
    };
    /* Generate the SVG for the component. */
    Diode.prototype.build_element = function () {
        if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
            var cache_0 = this.x_space >> 1;
            var cache_1 = this.y_space >> 1;
            this.dio_0.x =
                this.c_x +
            ...
            this.connect2_y = this.c_y + cache_1 * global.sine(this.theta);
            this.BUILD_ELEMENT = false;
        }
    };
    /* General function to help with resizing, i.e., canvas dimension change, zooming*/
    Diode.prototype.resize = function () {
        if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
    ...
    Diode.prototype.refactor = function () {
    ...
    Diode.prototype.increment_rotation = function () {
        this.elm.rotation++;
    ...
    Diode.prototype.increment_flip = function () { };
    Diode.prototype.map_rotation = function () {
        if (this.elm.rotation === global.ROTATION_0 ||
    ...
    Diode.prototype.recolor = function () {
        if (global.selected) {
            if (global.selected_id === this.elm.id &&
                global.selected_type === this.elm.type) {
    ...
    Diode.prototype.is_selected_element = function () {
        return (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type);
    };
    /* Draws the component */
    Diode.prototype.draw_component = function (canvas) {
    ...
    Diode.prototype.patch = function () {
    ...
    Diode.prototype.time_data = function () {
