...
class Wire {
    ...
    wire_collision() {
        if (this.elm.wire_style === global.CONSTANTS.WIRE_STYLE_0) {
            let collision_0 = global.line_collision(global.variables.mouse_x - (global.variables.node_space_x >> 1), global.variables.mouse_y - global.variables.canvas_stroke_width_1_zoom, global.variables.mouse_x + (global.variables.node_space_x >> 1), global.variables.mouse_y + global.variables.canvas_stroke_width_1_zoom, this.p1.x, this.p1.y, this.p2.x, this.p2.y);
            let collision_1 = global.line_collision(global.variables.mouse_x - global.variables.canvas_stroke_width_1_zoom, global.variables.mouse_y - (global.variables.node_space_x >> 1), global.variables.mouse_x + global.variables.canvas_stroke_width_1, global.variables.mouse_y + (global.variables.node_space_x >> 1), this.p1.x, this.p1.y, this.p2.x, this.p2.y);
            return collision_0 || collision_1;
        }
        else {
            let collision_2 = global.line_collision(global.variables.mouse_x - (global.variables.node_space_x >> 1), global.variables.mouse_y, global.variables.mouse_x + (global.variables.node_space_x >> 1), global.variables.mouse_y, this.p1.x, this.p1.y, this.wire_point.x, this.wire_point.y);
            let collision_3 = global.line_collision(global.variables.mouse_x, global.variables.mouse_y - (global.variables.node_space_x >> 1), global.variables.mouse_x, global.variables.mouse_y + global.variables.node_space_x / 2, this.p1.x, this.p1.y, this.wire_point.x, this.wire_point.y);
            let collision_4 = global.line_collision(global.variables.mouse_x - (global.variables.node_space_x >> 1), global.variables.mouse_y, global.variables.mouse_x + (global.variables.node_space_x >> 1), global.variables.mouse_y, this.wire_point.x, this.wire_point.y, this.p2.x, this.p2.y);
            let collision_5 = global.line_collision(global.variables.mouse_x, global.variables.mouse_y - (global.variables.node_space_x >> 1), global.variables.mouse_x, global.variables.mouse_y + global.variables.node_space_x / 2, this.wire_point.x, this.wire_point.y, this.p2.x, this.p2.y);
            ...
            if (global.flags.flag_simulating && simulation_manager.solutions_ready && this.is_selected_element() && global.simulation_time >= global.time_step + global.time_step) {
                if (this.elm.consistent()) {
                    ...
                    if ((this.angle > 170 && this.angle < 190) || (this.angle > -10 && this.angle < 10)) {
                        canvas.draw_text(global.ELEMENT_VAL_TEMPLATE.replace('{VAL}', global.utils.exponentiate_quickly(this.wire_voltage)).replace('{UNIT}', 'V'), this.c_x, this.c_y - this.y_space * 1.5, this.text_paint);
                    }
                    ...
                    if (global.variables.workspace_zoom_scale > 1.085 || (!global.CONSTANTS.MOBILE_MODE && global.variables.workspace_zoom_scale >= 0.99)) {
                        if (global.utils.norm(this.wire_point.x - this.p1.x, this.wire_point.y - this.p1.y) > global.utils.norm(this.p2.x - this.wire_point.x, this.p2.y - this.wire_point.y) * 1.05) {
                            ...
                            if ((this.angle > 170 && this.angle < 190) || (this.angle > -10 && global.retrieve_angle(this.wire_point.x - this.p1.x, this.wire_point.y - this.p1.y) < 10)) {
                                canvas.draw_text(global.ELEMENT_VAL_TEMPLATE.replace('{VAL}', global.utils.exponentiate_quickly(this.wire_voltage)).replace('{UNIT}', 'V'), global.get_average2(this.wire_point.x, this.p1.x), global.get_average2(this.wire_point.y, this.p1.y) - this.y_space * 1.5, this.text_paint);
                            }
                            else if ((this.angle > 260 && this.angle < 280) || (this.angle > 80 && this.angle < 100)) {
                            ...
                            if ((this.angle > 170 && this.angle < 190) || (this.angle > -10 && global.retrieve_angle(this.p2.x - this.wire_point.x, this.p2.y - this.wire_point.y) < 10)) {
                                canvas.draw_text(global.ELEMENT_VAL_TEMPLATE.replace('{VAL}', global.utils.exponentiate_quickly(this.wire_voltage)).replace('{UNIT}', 'V'), global.get_average2(this.wire_point.x, this.p2.x), global.get_average2(this.wire_point.y, this.p2.y) - this.y_space * 1.5, this.text_paint);
                            }
                            else if ((this.angle > 260 && this.angle < 280) || (this.angle > 80 && this.angle < 100)) {
