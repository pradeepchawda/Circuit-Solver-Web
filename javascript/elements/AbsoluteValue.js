 ...
 * File		        : AbsoluteValue.js
 * Author            : nboatengc
 * Date created      : 20190928
 *
 * Purpose           : A class to handle the absolute value element. It will automatically generate
...
var AbsoluteValue = /** @class */ (function () {
    function AbsoluteValue(type, id, n1, n2) {
    ...
    AbsoluteValue.prototype.refresh_bounds = function () {
        if (this.elm.consistent()) {
            this.p1 = new PointF(0, 0);
            this.p2 = new PointF(0, 0);
            /* Create some points to hold the node locations, this will be used for drawing components */
    ...
    AbsoluteValue.prototype.push_reference = function (ref) {
        this.wire_reference.push(ref);
    };
    /* General function to handle any processing required by the component */
    AbsoluteValue.prototype.update = function () {
    ...
    AbsoluteValue.prototype.stamp = function () {
        if (this.elm.consistent()) {
    ...
    AbsoluteValue.prototype.get_vertices = function () {
        var vertices = [];
        var p1 = [];
        var p2 = [];
    ...
    AbsoluteValue.prototype.release_wires = function () {
    ...
    AbsoluteValue.prototype.release_nodes = function () {
        if (this.elm.consistent()) {
    ...
    AbsoluteValue.prototype.capture_nodes = function () {
        var vertices = this.get_vertices();
        this.elm.map_node2(vertices[0], vertices[1], vertices[2], vertices[3]);
    ...
    AbsoluteValue.prototype.mouse_down = function () {
        if (global.FLAG_IDLE &&
    ...
    AbsoluteValue.prototype.handle_wire_builder = function (n, anchor) {
    ...
    AbsoluteValue.prototype.move_element = function (dx, dy) {
    ...
    AbsoluteValue.prototype.mouse_move = function () {
    ...
    AbsoluteValue.prototype.mouse_up = function () {
        if (global.FLAG_IDLE) {
            if (global.focused &&
                global.focused_id === this.elm.id &&
                global.focused_type === this.elm.type) {
    ...
    AbsoluteValue.prototype.select = function () {
        if (global.WIRE_BUILDER['step'] != 0) {
            wire_manager.reset_wire_builder();
        }
    ...
    AbsoluteValue.prototype.remove_focus = function () {
        if (global.focused &&
            global.focused_id === this.elm.id &&
            global.focused_type === this.elm.type) {
            global.focused_id = global.NULL;
    ...
    AbsoluteValue.prototype.remove_selection = function () {
        if (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type) {
            global.selected_id = global.NULL;
            global.selected_type = -1;
    ...
    AbsoluteValue.prototype.wire_reference_maintenance = function () {
    ...
    AbsoluteValue.prototype.unanchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    AbsoluteValue.prototype.anchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    AbsoluteValue.prototype.set_flip = function (flip) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    AbsoluteValue.prototype.set_rotation = function (rotation) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    AbsoluteValue.prototype.push_history = function () {
        if (this.INITIALIZED) {
            global.HISTORY_MANAGER['packet'].push(engine_functions.history_snapshot());
        }
    };
    /* Generate the SVG for the component. */
    AbsoluteValue.prototype.build_element = function () {
        if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
            var cache_0 = 1.3 * this.x_space;
            var cache_1 = 0.4 * this.x_space;
            ...
            this.gain_0.y =
                this.c_y -
                    ...
                    cache_2 * global.sine(this.theta_m90);
            this.gain_1.x =
                this.c_x -
                    cache_2 * global.cosine(this.theta) -
                    cache_2 * global.cosine(this.theta_m90);
            this.gain_1.y =
                this.c_y -
                    cache_2 * global.sine(this.theta) -
                    cache_2 * global.sine(this.theta_m90);
            this.gain_2.x = this.c_x + cache_2 * global.cosine(this.theta);
            this.gain_2.y = this.c_y + cache_2 * global.sine(this.theta);
            this.gain_3.x = this.c_x + cache_0 * global.cosine(this.theta);
            this.gain_3.y = this.c_y + cache_0 * global.sine(this.theta);
            this.gain_4.x = this.c_x - cache_1 * global.cosine(this.theta);
            this.gain_4.y = this.c_y - cache_1 * global.sine(this.theta);
    ...
    AbsoluteValue.prototype.resize = function () {
        if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
            ...
            var temp1 = global.CANVAS_STROKE_WIDTH_1_ZOOM;
            var temp2 = global.CANVAS_TEXT_SIZE_3_ZOOM;
    ...
    AbsoluteValue.prototype.refactor = function () {
    ...
    AbsoluteValue.prototype.increment_rotation = function () {
        this.elm.rotation++;
    ...
    AbsoluteValue.prototype.map_rotation = function () {
        if (this.elm.rotation === global.ROTATION_0 ||
    ...
    AbsoluteValue.prototype.increment_flip = function () { };
    AbsoluteValue.prototype.recolor = function () {
        if (global.selected) {
            if (global.selected_id === this.elm.id &&
                global.selected_type === this.elm.type) {
    ...
    AbsoluteValue.prototype.is_selected_element = function () {
        return (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type);
    };
    /* Draws the component */
    AbsoluteValue.prototype.draw_component = function (canvas) {
    ...
    AbsoluteValue.prototype.patch = function () {
    ...
    AbsoluteValue.prototype.time_data = function () {
    ...
    AbsoluteValue.prototype.reset = function () {
