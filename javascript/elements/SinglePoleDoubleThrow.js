 ...
 * File		        : SinglePoleDoubleThrow.js
 * Author            : nboatengc
 * Date created      : 20190928
 *
 * Purpose           : A class to handle the SPDT element. It will automatically generate
 ...
 *
 ***********************************************************************/
var SinglePoleDoubleThrow = /** @class */ (function () {
    function SinglePoleDoubleThrow(type, id, n1, n2, n3) {
      ...
      or overlapped)*/
        ...
        this.bounds = new RectF(0, 0, 0, 0);
        /* Inititalize the element2 class that will hold the basic data about our component */
        this.elm = new Element3(id, type, global.copy(global.PROPERTY_SPDT));
    ...
    SinglePoleDoubleThrow.prototype.refresh_bounds = function () {
        if (this.elm.consistent()) {
            this.p1 = new PointF(0, 0);
            this.p2 = new PointF(0, 0);
            this.p3 = new PointF(0, 0);
    ...
    SinglePoleDoubleThrow.prototype.push_reference = function (ref) {
        this.wire_reference.push(ref);
    };
    /* General function to handle any processing required by the component */
    SinglePoleDoubleThrow.prototype.update = function () { };
    SinglePoleDoubleThrow.prototype.stamp = function () {
        if (this.elm.consistent()) {
    ...
    SinglePoleDoubleThrow.prototype.get_vertices = function () {
        var vertices = [];
        var p1 = [];
        var p2 = [];
        var p3 = [];
    ...
    SinglePoleDoubleThrow.prototype.release_wires = function () {
    ...
    SinglePoleDoubleThrow.prototype.release_nodes = function () {
        if (this.elm.consistent()) {
    ...
    SinglePoleDoubleThrow.prototype.capture_nodes = function () {
        var vertices = this.get_vertices();
        this.elm.map_node3(vertices[0], vertices[1], vertices[2], vertices[3], vertices[4], vertices[5]);
    ...
    SinglePoleDoubleThrow.prototype.mouse_down = function () {
        if (global.FLAG_IDLE &&
    ...
    SinglePoleDoubleThrow.prototype.handle_wire_builder = function (n, anchor) {
    ...
    SinglePoleDoubleThrow.prototype.move_element = function (dx, dy) {
    ...
    SinglePoleDoubleThrow.prototype.mouse_move = function () {
    ...
    SinglePoleDoubleThrow.prototype.mouse_up = function () {
        if (global.FLAG_IDLE) {
            if (global.focused &&
                global.focused_id === this.elm.id &&
                global.focused_type === this.elm.type) {
    ...
    SinglePoleDoubleThrow.prototype.select = function () {
        if (global.WIRE_BUILDER['step'] != 0) {
            wire_manager.reset_wire_builder();
        }
    ...
    SinglePoleDoubleThrow.prototype.remove_focus = function () {
        if (global.focused &&
            global.focused_id === this.elm.id &&
            global.focused_type === this.elm.type) {
            global.focused_id = global.NULL;
    ...
    SinglePoleDoubleThrow.prototype.remove_selection = function () {
        if (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type) {
            global.selected_id = global.NULL;
            global.selected_type = -1;
    ...
    SinglePoleDoubleThrow.prototype.wire_reference_maintenance = function () {
    ...
    SinglePoleDoubleThrow.prototype.unanchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    SinglePoleDoubleThrow.prototype.anchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    SinglePoleDoubleThrow.prototype.set_flip = function (flip) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    SinglePoleDoubleThrow.prototype.set_rotation = function (rotation) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    SinglePoleDoubleThrow.prototype.push_history = function () {
        if (this.INITIALIZED) {
            global.HISTORY_MANAGER['packet'].push(engine_functions.history_snapshot());
        }
    };
    /* Generate the SVG for the component. */
    SinglePoleDoubleThrow.prototype.build_element = function () {
        if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
            ...
            this.spdt_2.x =
                this.p3.x + this.x_space * global.cosine(this.theta_m90 - Math.PI);
            this.spdt_2.y =
                this.p3.y + this.y_space * global.sine(this.theta_m90 - Math.PI);
            this.BUILD_ELEMENT = false;
        }
    };
    /* General function to help with resizing, i.e., canvas dimension change, zooming*/
    SinglePoleDoubleThrow.prototype.resize = function () {
        if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
    ...
    SinglePoleDoubleThrow.prototype.refactor = function () {
    ...
    SinglePoleDoubleThrow.prototype.increment_rotation = function () {
        this.elm.rotation++;
    ...
    SinglePoleDoubleThrow.prototype.increment_flip = function () { };
    SinglePoleDoubleThrow.prototype.recolor = function () {
        if (global.selected) {
            if (global.selected_id === this.elm.id &&
                global.selected_type === this.elm.type) {
    ...
    SinglePoleDoubleThrow.prototype.is_selected_element = function () {
        return (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type);
    };
    /* Draws the component */
    SinglePoleDoubleThrow.prototype.draw_component = function (canvas) {
        ...
        if (global.PICTURE_REQUEST ||
            ...
            if (this.elm.properties['Switch State'] === global.OFF) {
                this.LINE_BUFFER[this.indexer++] = Array(this.spdt_0.x, this.spdt_0.y, this.spdt_2.x, this.spdt_2.y);
            }
            else if (this.elm.properties['Switch State'] === global.ON) {
    ...
    SinglePoleDoubleThrow.prototype.patch = function () {
    ...
    SinglePoleDoubleThrow.prototype.time_data = function () {
    ...
    SinglePoleDoubleThrow.prototype.reset = function () { };
    return SinglePoleDoubleThrow;
}());
