 ...
 *
 * Purpose           : A class to handle the XORGate element. It will automatically generate
 ...
 *
 ***********************************************************************/
var XORGate = /** @class */ (function () {
    function XORGate(type, id, n1, n2, n3) {
      ...
      or overlapped)*/
        ...
        this.bounds = new RectF(0, 0, 0, 0);
        /* Inititalize the element2 class that will hold the basic data about our component */
        this.elm = new Element3(id, type, global.copy(global.PROPERTY_XOR));
    ...
    XORGate.prototype.refresh_bounds = function () {
        if (this.elm.consistent()) {
            this.p1 = new PointF(0, 0);
            this.p2 = new PointF(0, 0);
            this.p3 = new PointF(0, 0);
    ...
    XORGate.prototype.push_reference = function (ref) {
        this.wire_reference.push(ref);
    };
    /* General function to handle any processing required by the component */
    XORGate.prototype.update = function () {
    ...
    XORGate.prototype.stamp = function () {
        if (this.elm.consistent()) {
    ...
    XORGate.prototype.get_vertices = function () {
        var vertices = [];
        var p1 = [];
        var p2 = [];
        var p3 = [];
    ...
    XORGate.prototype.release_wires = function () {
    ...
    XORGate.prototype.release_nodes = function () {
        if (this.elm.consistent()) {
    ...
    XORGate.prototype.capture_nodes = function () {
        var vertices = this.get_vertices();
        this.elm.map_node3(vertices[0], vertices[1], vertices[2], vertices[3], vertices[4], vertices[5]);
    ...
    XORGate.prototype.mouse_down = function () {
        if (global.FLAG_IDLE &&
    ...
    XORGate.prototype.handle_wire_builder = function (n, anchor) {
    ...
    XORGate.prototype.move_element = function (dx, dy) {
    ...
    XORGate.prototype.mouse_move = function () {
    ...
    XORGate.prototype.mouse_up = function () {
        if (global.FLAG_IDLE) {
            if (global.focused &&
                global.focused_id === this.elm.id &&
                global.focused_type === this.elm.type) {
    ...
    XORGate.prototype.select = function () {
        if (global.WIRE_BUILDER['step'] != 0) {
            wire_manager.reset_wire_builder();
        }
    ...
    XORGate.prototype.remove_focus = function () {
        if (global.focused &&
            global.focused_id === this.elm.id &&
            global.focused_type === this.elm.type) {
            global.focused_id = global.NULL;
    ...
    XORGate.prototype.remove_selection = function () {
        if (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type) {
            global.selected_id = global.NULL;
            global.selected_type = -1;
    ...
    XORGate.prototype.wire_reference_maintenance = function () {
    ...
    XORGate.prototype.unanchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    XORGate.prototype.anchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    XORGate.prototype.set_flip = function (flip) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    XORGate.prototype.set_rotation = function (rotation) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    XORGate.prototype.push_history = function () {
        if (this.INITIALIZED) {
            global.HISTORY_MANAGER['packet'].push(engine_functions.history_snapshot());
        }
    };
    /* Generate the SVG for the component. */
    XORGate.prototype.build_element = function () {
        if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
            ...
            var cache_6 = 1.05 * this.x_space;
            var cache_7 = 1.05 * this.y_space;
            var cache_8 = 2.5 * this.x_space;
            var cache_9 = 2.5 * this.y_space;
            var cache_10 = this.x_space;
            var cache_11 = this.y_space;
            /* Top segment */
            this.xor_0.x = this.p1.x + cache_0 * global.cosine(this.theta);
            this.xor_0.y = this.p1.y + cache_1 * global.sine(this.theta);
            this.xor_1.x = this.xor_0.x + cache_2 * global.cosine(this.theta_m90);
            this.xor_1.y = this.xor_0.y + cache_3 * global.sine(this.theta_m90);
            this.xor_2.x =
                this.xor_1.x + cache_2 * global.cosine(this.theta - Math.PI);
            this.xor_2.y = this.xor_1.y + cache_3 * global.sine(this.theta - Math.PI);
            this.xor_9.x =
                this.xor_0.x +
            ...
            /* Overshoot of xor_1 */
            this.xor_7.x = this.xor_0.x + cache_6 * global.cosine(this.theta_m90);
            this.xor_7.y = this.xor_0.y + cache_7 * global.sine(this.theta_m90);
            /* Bottom segment */
            this.xor_3.x = this.p1.x + cache_8 * global.cosine(this.theta);
            this.xor_3.y = this.p1.y + cache_9 * global.sine(this.theta);
            this.xor_4.x = this.xor_3.x + cache_2 * global.cosine(this.theta_m90);
            this.xor_4.y = this.xor_3.y + cache_3 * global.sine(this.theta_m90);
            this.xor_5.x = this.xor_4.x + cache_2 * global.cosine(this.theta);
            this.xor_5.y = this.xor_4.y + cache_3 * global.sine(this.theta);
            this.xor_10.x =
                this.xor_3.x +
                    cache_4 * global.cosine(this.theta_m90) +
            ...
            /* Overshoot of xor_4 */
            this.xor_8.x = this.xor_3.x + cache_6 * global.cosine(this.theta_m90);
            this.xor_8.y = this.xor_3.y + cache_7 * global.sine(this.theta_m90);
            /* End Segment */
            this.xor_6.x = this.p3.x - cache_2 * global.cosine(this.theta_m90);
            this.xor_6.y = this.p3.y - cache_3 * global.sine(this.theta_m90);
            this.BUILD_ELEMENT = false;
        }
    };
    /* General function to help with resizing, i.e., canvas dimension change, zooming*/
    XORGate.prototype.resize = function () {
        if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
    ...
    XORGate.prototype.refactor = function () {
    ...
    XORGate.prototype.increment_rotation = function () {
        this.elm.rotation++;
    ...
    XORGate.prototype.increment_flip = function () { };
    XORGate.prototype.recolor = function () {
        if (global.selected) {
            if (global.selected_id === this.elm.id &&
                global.selected_type === this.elm.type) {
    ...
    XORGate.prototype.is_selected_element = function () {
        return (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type);
    };
    /* Draws the component */
    XORGate.prototype.draw_component = function (canvas) {
    ...
    XORGate.prototype.patch = function () {
    ...
    XORGate.prototype.time_data = function () {
    ...
    XORGate.prototype.reset = function () {
