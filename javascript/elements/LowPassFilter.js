 ...
 * File		        : LowPassFilter.js
 * Author            : nboatengc
 * Date created      : 20190928
 *
 * Purpose           : A class to handle the Low Pass Filter element. It will automatically generate
...
var LowPassFilter = /** @class */ (function () {
    function LowPassFilter(type, id, n1, n2) {
      ...
      or overlapped)*/
        ...
        this.bounds = new RectF(0, 0, 0, 0);
        /* Inititalize the element2 class that will hold the basic data about our component */
        this.elm = new Element2(id, type, global.copy(global.PROPERTY_LPF));
    ...
    LowPassFilter.prototype.refresh_bounds = function () {
        if (this.elm.consistent()) {
            this.p1 = new PointF(0, 0);
            this.p2 = new PointF(0, 0);
            /* Create some points to hold the node locations, this will be used for drawing components */
    ...
    LowPassFilter.prototype.push_reference = function (ref) {
        this.wire_reference.push(ref);
    };
    LowPassFilter.prototype.reset_lowpass = function () {
        this.elm.properties['Y Hat'] = 0;
        this.elm.properties['Y Out'] = 0;
        this.elm.properties['Output Voltage'] = 0;
    };
    /* General function to handle any processing required by the component */
    LowPassFilter.prototype.update = function () {
    ...
    LowPassFilter.prototype.stamp = function () {
        if (this.elm.consistent()) {
    ...
    LowPassFilter.prototype.lowpass_filter = function (input) {
        ...
        this.elm.properties['Y Hat'] =
            this.elm.properties['Alpha'] * input +
                (1 - this.elm.properties['Alpha']) * this.elm.properties['Y Out'];
    ...
    LowPassFilter.prototype.get_vertices = function () {
        var vertices = [];
        var p1 = [];
        var p2 = [];
    ...
    LowPassFilter.prototype.release_wires = function () {
    ...
    LowPassFilter.prototype.release_nodes = function () {
        if (this.elm.consistent()) {
    ...
    LowPassFilter.prototype.capture_nodes = function () {
        var vertices = this.get_vertices();
        this.elm.map_node2(vertices[0], vertices[1], vertices[2], vertices[3]);
    ...
    LowPassFilter.prototype.mouse_down = function () {
        if (global.FLAG_IDLE &&
    ...
    LowPassFilter.prototype.handle_wire_builder = function (n, anchor) {
    ...
    LowPassFilter.prototype.move_element = function (dx, dy) {
    ...
    LowPassFilter.prototype.mouse_move = function () {
    ...
    LowPassFilter.prototype.mouse_up = function () {
        if (global.FLAG_IDLE) {
            if (global.focused &&
                global.focused_id === this.elm.id &&
                global.focused_type === this.elm.type) {
    ...
    LowPassFilter.prototype.select = function () {
        if (global.WIRE_BUILDER['step'] != 0) {
            wire_manager.reset_wire_builder();
        }
    ...
    LowPassFilter.prototype.remove_focus = function () {
        if (global.focused &&
            global.focused_id === this.elm.id &&
            global.focused_type === this.elm.type) {
            global.focused_id = global.NULL;
    ...
    LowPassFilter.prototype.remove_selection = function () {
        if (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type) {
            global.selected_id = global.NULL;
            global.selected_type = -1;
    ...
    LowPassFilter.prototype.wire_reference_maintenance = function () {
    ...
    LowPassFilter.prototype.unanchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    LowPassFilter.prototype.anchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    LowPassFilter.prototype.set_flip = function (flip) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    LowPassFilter.prototype.set_rotation = function (rotation) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    LowPassFilter.prototype.push_history = function () {
        if (this.INITIALIZED) {
            global.HISTORY_MANAGER['packet'].push(engine_functions.history_snapshot());
        }
    };
    /* Generate the SVG for the component. */
    LowPassFilter.prototype.build_element = function () {
        if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
            ...
            var cache_5 = 0.25 * this.x_space;
            var cache_6 = 0.5 * this.y_space;
            ...
            this.lpf_4.y =
                this.c_y +
                    cache_9 * global.sine(this.theta) +
                    cache_9 * global.sine(this.theta_m90);
            this.lpf_5.x = this.c_x + cache_8 * global.cosine(this.theta);
            this.lpf_5.y = this.c_y + cache_9 * global.sine(this.theta);
            this.lpf_6.x =
                this.c_x -
    ...
    LowPassFilter.prototype.resize = function () {
        if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
    ...
    LowPassFilter.prototype.refactor = function () {
    ...
    LowPassFilter.prototype.increment_rotation = function () {
        this.elm.rotation++;
    ...
    LowPassFilter.prototype.increment_flip = function () { };
    LowPassFilter.prototype.map_rotation = function () {
        if (this.elm.rotation === global.ROTATION_0 ||
    ...
    LowPassFilter.prototype.recolor = function () {
        if (global.selected) {
            if (global.selected_id === this.elm.id &&
                global.selected_type === this.elm.type) {
    ...
    LowPassFilter.prototype.is_selected_element = function () {
        return (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type);
    };
    /* Draws the component */
    LowPassFilter.prototype.draw_component = function (canvas) {
    ...
    LowPassFilter.prototype.patch = function () {
    ...
    LowPassFilter.prototype.time_data = function () {
