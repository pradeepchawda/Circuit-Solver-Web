 ...
 *
 ***********************************************************************/
var IntegratorModule = /** @class */ (function () {
    function IntegratorModule(type, id, n1, n2) {
    ...
    IntegratorModule.prototype.refresh_bounds = function () {
        if (this.elm.consistent()) {
            this.p1 = new PointF(0, 0);
            this.p2 = new PointF(0, 0);
            /* Create some points to hold the node locations, this will be used for drawing components */
    ...
    IntegratorModule.prototype.push_reference = function (ref) {
        this.wire_reference.push(ref);
    };
    /* General function to handle any processing required by the component */
    IntegratorModule.prototype.update = function () {
    ...
    IntegratorModule.prototype.stamp = function () {
        if (this.elm.consistent()) {
    ...
    IntegratorModule.prototype.get_vertices = function () {
        var vertices = [];
        var p1 = [];
        var p2 = [];
    ...
    IntegratorModule.prototype.release_wires = function () {
    ...
    IntegratorModule.prototype.release_nodes = function () {
        if (this.elm.consistent()) {
    ...
    IntegratorModule.prototype.capture_nodes = function () {
        var vertices = this.get_vertices();
        this.elm.map_node2(vertices[0], vertices[1], vertices[2], vertices[3]);
    ...
    IntegratorModule.prototype.mouse_down = function () {
        if (global.FLAG_IDLE &&
    ...
    IntegratorModule.prototype.handle_wire_builder = function (n, anchor) {
    ...
    IntegratorModule.prototype.move_element = function (dx, dy) {
    ...
    IntegratorModule.prototype.mouse_move = function () {
    ...
    IntegratorModule.prototype.mouse_up = function () {
        if (global.FLAG_IDLE) {
            if (global.focused &&
                global.focused_id === this.elm.id &&
                global.focused_type === this.elm.type) {
    ...
    IntegratorModule.prototype.select = function () {
        if (global.WIRE_BUILDER['step'] != 0) {
            wire_manager.reset_wire_builder();
        }
    ...
    IntegratorModule.prototype.remove_focus = function () {
        if (global.focused &&
            global.focused_id === this.elm.id &&
            global.focused_type === this.elm.type) {
            global.focused_id = global.NULL;
    ...
    IntegratorModule.prototype.remove_selection = function () {
        if (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type) {
            global.selected_id = global.NULL;
            global.selected_type = -1;
    ...
    IntegratorModule.prototype.wire_reference_maintenance = function () {
    ...
    IntegratorModule.prototype.unanchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    IntegratorModule.prototype.anchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    IntegratorModule.prototype.set_flip = function (flip) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    IntegratorModule.prototype.set_rotation = function (rotation) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    IntegratorModule.prototype.push_history = function () {
        if (this.INITIALIZED) {
            global.HISTORY_MANAGER['packet'].push(engine_functions.history_snapshot());
        }
    };
    /* Generate the SVG for the component. */
    IntegratorModule.prototype.build_element = function () {
    ...
    IntegratorModule.prototype.resize = function () {
        if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
    ...
    IntegratorModule.prototype.refactor = function () {
    ...
    IntegratorModule.prototype.increment_rotation = function () {
        this.elm.rotation++;
    ...
    IntegratorModule.prototype.increment_flip = function () { };
    IntegratorModule.prototype.map_rotation = function () {
        if (this.elm.rotation === global.ROTATION_0 ||
    ...
    IntegratorModule.prototype.recolor = function () {
        if (global.selected) {
            if (global.selected_id === this.elm.id &&
                global.selected_type === this.elm.type) {
    ...
    IntegratorModule.prototype.is_selected_element = function () {
        return (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type);
    };
    /* Draws the component */
    IntegratorModule.prototype.draw_component = function (canvas) {
    ...
    IntegratorModule.prototype.patch = function () {
    ...
    IntegratorModule.prototype.time_data = function () {
    ...
    IntegratorModule.prototype.reset = function () {
