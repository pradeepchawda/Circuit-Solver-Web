        ...
        if (global.FLAG_SIMULATING && simulation_manager.SOLUTIONS_READY && simulation_manager.SIMULATION_STEP !== 0) {
            if (this.elm.consistent()) {
                ...
                if (this.elm.properties['Interpolate'] === global.ON) {
                    ...
                    this.elm.properties['Output Capacitance'] = [this.elm.properties['Elm0'], this.elm.properties['Elm1'], this.elm.properties['Elm2'], this.elm.properties['Elm3'], this.elm.properties['Elm4']][index];
                }
            }
        }
    }
