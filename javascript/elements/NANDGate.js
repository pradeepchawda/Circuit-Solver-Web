 ...
 *
 * Purpose           : A class to handle the NANDGate element. It will automatically generate
...
var NANDGate = /** @class */ (function () {
    function NANDGate(type, id, n1, n2, n3) {
      ...
      or overlapped)*/
        ...
        this.bounds = new RectF(0, 0, 0, 0);
        /* Inititalize the element2 class that will hold the basic data about our component */
        this.elm = new Element3(id, type, global.copy(global.PROPERTY_NAND));
    ...
    NANDGate.prototype.refresh_bounds = function () {
        if (this.elm.consistent()) {
            this.p1 = new PointF(0, 0);
            this.p2 = new PointF(0, 0);
            this.p3 = new PointF(0, 0);
    ...
    NANDGate.prototype.push_reference = function (ref) {
    ...
    NANDGate.prototype.stamp = function () {
        if (this.elm.consistent()) {
    ...
    NANDGate.prototype.get_vertices = function () {
        var vertices = [];
        var p1 = [];
        var p2 = [];
        var p3 = [];
    ...
    NANDGate.prototype.release_wires = function () {
    ...
    NANDGate.prototype.release_nodes = function () {
        if (this.elm.consistent()) {
    ...
    NANDGate.prototype.capture_nodes = function () {
        var vertices = this.get_vertices();
        this.elm.map_node3(vertices[0], vertices[1], vertices[2], vertices[3], vertices[4], vertices[5]);
    ...
    NANDGate.prototype.mouse_down = function () {
        if (global.FLAG_IDLE &&
    ...
    NANDGate.prototype.handle_wire_builder = function (n, anchor) {
    ...
    NANDGate.prototype.move_element = function (dx, dy) {
    ...
    NANDGate.prototype.mouse_move = function () {
    ...
    NANDGate.prototype.mouse_up = function () {
        if (global.FLAG_IDLE) {
            if (global.focused &&
                global.focused_id === this.elm.id &&
                global.focused_type === this.elm.type) {
    ...
    NANDGate.prototype.select = function () {
        if (global.WIRE_BUILDER['step'] != 0) {
            wire_manager.reset_wire_builder();
        }
    ...
    NANDGate.prototype.remove_focus = function () {
        if (global.focused &&
            global.focused_id === this.elm.id &&
            global.focused_type === this.elm.type) {
            global.focused_id = global.NULL;
    ...
    NANDGate.prototype.remove_selection = function () {
        if (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type) {
            global.selected_id = global.NULL;
            global.selected_type = -1;
    ...
    NANDGate.prototype.wire_reference_maintenance = function () {
    ...
    NANDGate.prototype.unanchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    NANDGate.prototype.anchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    NANDGate.prototype.set_flip = function (flip) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    NANDGate.prototype.set_rotation = function (rotation) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    NANDGate.prototype.push_history = function () {
        if (this.INITIALIZED) {
            global.HISTORY_MANAGER['packet'].push(engine_functions.history_snapshot());
        }
    };
    /* Generate the SVG for the component. */
    NANDGate.prototype.build_element = function () {
        if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
            ...
            var cache_6 = 0.9 * this.x_space;
            var cache_7 = 0.9 * this.y_space;
            var cache_8 = 0.6 * this.x_space;
            var cache_9 = 0.6 * this.y_space;
            var cache_10 = 0.3 * this.x_space;
            var cache_11 = 0.3 * this.y_space;
            var cache_12 = this.x_space;
            var cache_13 = this.y_space;
            /* Top segment */
            this.nand_0.x = this.p1.x + cache_0 * global.cosine(this.theta);
            this.nand_0.y = this.p1.y + cache_1 * global.sine(this.theta);
            this.nand_1.x = this.nand_0.x + cache_2 * global.cosine(this.theta_m90);
            this.nand_1.y = this.nand_0.y + cache_3 * global.sine(this.theta_m90);
            this.nand_2.x =
                this.nand_1.x + cache_2 * global.cosine(this.theta - Math.PI);
            this.nand_2.y =
                this.nand_1.y + cache_3 * global.sine(this.theta - Math.PI);
            /* Bottom segment */
            this.nand_3.x = this.p1.x + cache_4 * global.cosine(this.theta);
            this.nand_3.y = this.p1.y + cache_5 * global.sine(this.theta);
            this.nand_4.x = this.nand_3.x + cache_2 * global.cosine(this.theta_m90);
            this.nand_4.y = this.nand_3.y + cache_3 * global.sine(this.theta_m90);
            this.nand_5.x = this.nand_4.x + cache_2 * global.cosine(this.theta);
            this.nand_5.y = this.nand_4.y + cache_3 * global.sine(this.theta);
            /* End Segment */
            this.nand_6.x = this.p3.x - cache_6 * global.cosine(this.theta_m90);
            this.nand_6.y = this.p3.y - cache_7 * global.sine(this.theta_m90);
            this.nand_7.x = this.p3.x - cache_8 * global.cosine(this.theta_m90);
            this.nand_7.y = this.p3.y - cache_9 * global.sine(this.theta_m90);
            this.nand_8.x = this.p3.x - cache_10 * global.cosine(this.theta_m90);
            this.nand_8.y = this.p3.y - cache_11 * global.sine(this.theta_m90);
            this.BUILD_ELEMENT = false;
        }
    };
    /* General function to help with resizing, i.e., canvas dimension change, zooming*/
    NANDGate.prototype.resize = function () {
        if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
    ...
    NANDGate.prototype.refactor = function () {
    ...
    NANDGate.prototype.increment_rotation = function () {
        this.elm.rotation++;
    ...
    NANDGate.prototype.increment_flip = function () { };
    NANDGate.prototype.recolor = function () {
        if (global.selected) {
            if (global.selected_id === this.elm.id &&
                global.selected_type === this.elm.type) {
    ...
    NANDGate.prototype.is_selected_element = function () {
        return (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type);
    };
    /* Draws the component */
    NANDGate.prototype.draw_component = function (canvas) {
    ...
    NANDGate.prototype.patch = function () {
    ...
    NANDGate.prototype.time_data = function () {
    ...
    NANDGate.prototype.reset = function () {
