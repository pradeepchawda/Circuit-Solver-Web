...
var GreaterThan = /** @class */ (function () {
    function GreaterThan(type, id, n1, n2, n3) {
    ...
    GreaterThan.prototype.refresh_bounds = function () {
        if (this.elm.consistent()) {
            this.p1 = new PointF(0, 0);
            this.p2 = new PointF(0, 0);
            this.p3 = new PointF(0, 0);
    ...
    GreaterThan.prototype.push_reference = function (ref) {
        this.wire_reference.push(ref);
    };
    /* General function to handle any processing required by the component */
    GreaterThan.prototype.update = function () {
    ...
    GreaterThan.prototype.stamp = function () {
        if (this.elm.consistent()) {
    ...
    GreaterThan.prototype.get_vertices = function () {
        var vertices = [];
        var p1 = [];
        var p2 = [];
        var p3 = [];
    ...
    GreaterThan.prototype.release_wires = function () {
    ...
    GreaterThan.prototype.release_nodes = function () {
        if (this.elm.consistent()) {
    ...
    GreaterThan.prototype.capture_nodes = function () {
        var vertices = this.get_vertices();
        this.elm.map_node3(vertices[0], vertices[1], vertices[2], vertices[3], vertices[4], vertices[5]);
    ...
    GreaterThan.prototype.mouse_down = function () {
        if (global.FLAG_IDLE &&
    ...
    GreaterThan.prototype.handle_wire_builder = function (n, anchor) {
    ...
    GreaterThan.prototype.move_element = function (dx, dy) {
    ...
    GreaterThan.prototype.mouse_move = function () {
    ...
    GreaterThan.prototype.mouse_up = function () {
        if (global.FLAG_IDLE) {
            if (global.focused &&
                global.focused_id === this.elm.id &&
                global.focused_type === this.elm.type) {
    ...
    GreaterThan.prototype.select = function () {
        if (global.WIRE_BUILDER['step'] != 0) {
            wire_manager.reset_wire_builder();
        }
    ...
    GreaterThan.prototype.remove_focus = function () {
        if (global.focused &&
            global.focused_id === this.elm.id &&
            global.focused_type === this.elm.type) {
            global.focused_id = global.NULL;
    ...
    GreaterThan.prototype.remove_selection = function () {
        if (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type) {
            global.selected_id = global.NULL;
            global.selected_type = -1;
    ...
    GreaterThan.prototype.wire_reference_maintenance = function () {
    ...
    GreaterThan.prototype.unanchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    GreaterThan.prototype.anchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    GreaterThan.prototype.set_flip = function (flip) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    GreaterThan.prototype.set_rotation = function (rotation) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    GreaterThan.prototype.push_history = function () {
        if (this.INITIALIZED) {
            global.HISTORY_MANAGER['packet'].push(engine_functions.history_snapshot());
        }
    };
    /* Generate the SVG for the component. */
    GreaterThan.prototype.build_element = function () {
        if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
            ...
            var cache_8 = 0.25 * this.x_space;
            var cache_9 = 0.25 * this.y_space;
            var cache_10 = 0.4 * this.x_space;
            var cache_11 = 0.4 * this.y_space;
            ...
            this.greater_1.x =
                this.greater_0.x + cache_14 * global.cosine(this.theta);
            this.greater_1.y = this.greater_0.y + cache_15 * global.sine(this.theta);
            this.greater_2.x =
                this.greater_1.x + cache_6 * global.cosine(this.theta - Math.PI);
            this.greater_2.y =
                this.greater_1.y + cache_7 * global.sine(this.theta - Math.PI);
            /* Bottom segment */
            ...
            this.greater_4.x =
                this.greater_3.x - cache_14 * global.cosine(this.theta);
            ...
            /* Center piece */
            var adj_x = this.c_x - cache_8 * global.cosine(this.theta_m90);
            var adj_y = this.c_y - cache_9 * global.sine(this.theta_m90);
    ...
    GreaterThan.prototype.resize = function () {
        if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
    ...
    GreaterThan.prototype.refactor = function () {
    ...
    GreaterThan.prototype.increment_rotation = function () {
        this.elm.rotation++;
    ...
    GreaterThan.prototype.increment_flip = function () { };
    GreaterThan.prototype.recolor = function () {
        if (global.selected) {
            if (global.selected_id === this.elm.id &&
                global.selected_type === this.elm.type) {
    ...
    GreaterThan.prototype.is_selected_element = function () {
        return (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type);
    };
    /* Draws the component */
    GreaterThan.prototype.draw_component = function (canvas) {
    ...
    GreaterThan.prototype.patch = function () {
    ...
    GreaterThan.prototype.time_data = function () {
