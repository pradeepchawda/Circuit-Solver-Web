 ...
 * File		        : OperationalAmplifier.js
 * Author            : nboatengc
 * Date created      : 20190928
 *
 * Purpose           : A class to handle the Ideal Operational Amplifier element. It will automatically generate
 ...
 *
 ***********************************************************************/
var OperationalAmplifier = /** @class */ (function () {
    function OperationalAmplifier(type, id, n1, n2, n3) {
      ...
      or overlapped)*/
        ...
        this.bounds = new RectF(0, 0, 0, 0);
        /* Inititalize the element2 class that will hold the basic data about our component */
        this.elm = new Element3(id, type, global.copy(global.PROPERTY_OPAMP));
    ...
    OperationalAmplifier.prototype.refresh_bounds = function () {
        if (this.elm.consistent()) {
            this.p1 = new PointF(0, 0);
            this.p2 = new PointF(0, 0);
            this.p3 = new PointF(0, 0);
    ...
    OperationalAmplifier.prototype.push_reference = function (ref) {
        this.wire_reference.push(ref);
    };
    OperationalAmplifier.prototype.stamp = function () {
        if (this.elm.consistent()) {
    ...
    OperationalAmplifier.prototype.release_wires = function () {
    ...
    OperationalAmplifier.prototype.release_nodes = function () {
        if (this.elm.consistent()) {
    ...
    OperationalAmplifier.prototype.capture_nodes = function () {
        var vertices = this.get_vertices();
        this.elm.map_node3(vertices[0], vertices[1], vertices[2], vertices[3], vertices[4], vertices[5]);
    ...
    OperationalAmplifier.prototype.mouse_down = function () {
        if (global.FLAG_IDLE &&
    ...
    OperationalAmplifier.prototype.handle_wire_builder = function (n, anchor) {
    ...
    OperationalAmplifier.prototype.move_element = function (dx, dy) {
    ...
    OperationalAmplifier.prototype.mouse_move = function () {
    ...
    OperationalAmplifier.prototype.mouse_up = function () {
        if (global.FLAG_IDLE) {
            if (global.focused &&
                global.focused_id === this.elm.id &&
                global.focused_type === this.elm.type) {
    ...
    OperationalAmplifier.prototype.select = function () {
        if (global.WIRE_BUILDER['step'] != 0) {
            wire_manager.reset_wire_builder();
        }
    ...
    OperationalAmplifier.prototype.remove_focus = function () {
        if (global.focused &&
            global.focused_id === this.elm.id &&
            global.focused_type === this.elm.type) {
            global.focused_id = global.NULL;
    ...
    OperationalAmplifier.prototype.remove_selection = function () {
        if (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type) {
            global.selected_id = global.NULL;
            global.selected_type = -1;
    ...
    OperationalAmplifier.prototype.wire_reference_maintenance = function () {
    ...
    OperationalAmplifier.prototype.unanchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    OperationalAmplifier.prototype.anchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    OperationalAmplifier.prototype.set_flip = function (flip) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    OperationalAmplifier.prototype.set_rotation = function (rotation) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    OperationalAmplifier.prototype.push_history = function () {
        if (this.INITIALIZED) {
            global.HISTORY_MANAGER['packet'].push(engine_functions.history_snapshot());
        }
    };
    /* Generate the SVG for the component. */
    OperationalAmplifier.prototype.build_element = function () {
        if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
            ...
            var cache_4 = 2.5 * this.x_space;
            var cache_5 = 2.5 * this.y_space;
            var cache_6 = 1.4 * this.x_space;
            var cache_7 = 1.4 * this.y_space;
            var cache_8 = 1.3 * this.x_space;
            var cache_9 = 1.2 * this.x_space;
            var cache_10 = 1.3 * this.y_space;
            var cache_11 = 1.2 * this.y_space;
            var cache_12 = 1.7 * this.x_space;
            var cache_13 = 1.7 * this.y_space;
            var cache_14 = this.x_space;
            var cache_15 = this.y_space;
            /* Top segment */
            this.op_0.x = this.p1.x + cache_0 * global.cosine(this.theta);
            this.op_0.y = this.p1.y + cache_1 * global.sine(this.theta);
            this.op_1.x = this.op_0.x + cache_2 * global.cosine(this.theta_m90);
            this.op_1.y = this.op_0.y + cache_3 * global.sine(this.theta_m90);
            this.op_2.x = this.op_1.x + cache_2 * global.cosine(this.theta - Math.PI);
            this.op_2.y = this.op_1.y + cache_3 * global.sine(this.theta - Math.PI);
            /* Bottom segment */
            this.op_3.x = this.p1.x + cache_4 * global.cosine(this.theta);
            this.op_3.y = this.p1.y + cache_5 * global.sine(this.theta);
            this.op_4.x = this.op_3.x + cache_2 * global.cosine(this.theta_m90);
            this.op_4.y = this.op_3.y + cache_3 * global.sine(this.theta_m90);
            this.op_5.x = this.op_4.x + cache_2 * global.cosine(this.theta);
            this.op_5.y = this.op_4.y + cache_3 * global.sine(this.theta);
            /* End Segment */
            this.op_6.x = this.p3.x - cache_2 * global.cosine(this.theta_m90);
            this.op_6.y = this.p3.y - cache_3 * global.sine(this.theta_m90);
            /* Plus Point */
            this.op_7.x =
                this.p1.x +
                    cache_0 * global.cosine(this.theta) +
                    cache_14 * global.cosine(this.theta_m90);
            this.op_7.y =
                this.p1.y +
                    cache_1 * global.sine(this.theta) +
                    cache_15 * global.sine(this.theta_m90);
            this.op_8.x =
                this.p1.x +
                    cache_0 * global.cosine(this.theta) +
            ...
            this.op_9.x =
                this.p1.x +
                    ...
                    cache_9 * global.cosine(this.theta_m90);
            this.op_9.y =
                this.p1.y +
                    cache_10 * global.sine(this.theta) +
                    cache_11 * global.sine(this.theta_m90);
            this.op_10.x =
                this.p1.x +
                    cache_12 * global.cosine(this.theta) +
                    cache_9 * global.cosine(this.theta_m90);
            this.op_10.y =
                this.p1.y +
                    cache_13 * global.sine(this.theta) +
                    cache_11 * global.sine(this.theta_m90);
            /* Negative Point */
            this.op_11.x =
                this.p1.x +
    ...
    OperationalAmplifier.prototype.resize = function () {
        if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
    ...
    OperationalAmplifier.prototype.refactor = function () {
    ...
    OperationalAmplifier.prototype.increment_rotation = function () {
        this.elm.rotation++;
    ...
    OperationalAmplifier.prototype.increment_flip = function () {
        this.elm.flip++;
    ...
    OperationalAmplifier.prototype.recolor = function () {
        if (global.selected) {
            if (global.selected_id === this.elm.id &&
                global.selected_type === this.elm.type) {
    ...
    OperationalAmplifier.prototype.is_selected_element = function () {
        return (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type);
    };
    /* Draws the component */
    OperationalAmplifier.prototype.draw_component = function (canvas) {
    ...
    OperationalAmplifier.prototype.patch = function () {
    ...
    OperationalAmplifier.prototype.time_data = function () {
    ...
    OperationalAmplifier.prototype.reset = function () { };
