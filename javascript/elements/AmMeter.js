 ...
 *
 ***********************************************************************/
var AmMeter = /** @class */ (function () {
    function AmMeter(type, id, n1, n2) {
    ...
    AmMeter.prototype.refresh_bounds = function () {
        if (this.elm.consistent()) {
            this.p1 = new PointF(0, 0);
            this.p2 = new PointF(0, 0);
            /* Create some points to hold the node locations, this will be used for drawing components */
    ...
    AmMeter.prototype.push_reference = function (ref) {
        this.wire_reference.push(ref);
    };
    AmMeter.prototype.stamp = function () {
        if (this.elm.consistent()) {
    ...
    AmMeter.prototype.get_vertices = function () {
        var vertices = [];
        var p1 = [];
        var p2 = [];
    ...
    AmMeter.prototype.release_wires = function () {
    ...
    AmMeter.prototype.release_nodes = function () {
        if (this.elm.consistent()) {
    ...
    AmMeter.prototype.capture_nodes = function () {
        var vertices = this.get_vertices();
        this.elm.map_node2(vertices[0], vertices[1], vertices[2], vertices[3]);
    ...
    AmMeter.prototype.mouse_down = function () {
        if (global.FLAG_IDLE &&
    ...
    AmMeter.prototype.handle_wire_builder = function (n, anchor) {
    ...
    AmMeter.prototype.move_element = function (dx, dy) {
    ...
    AmMeter.prototype.mouse_up = function () {
        if (global.FLAG_IDLE) {
            if (global.focused &&
                global.focused_id === this.elm.id &&
                global.focused_type === this.elm.type) {
    ...
    AmMeter.prototype.select = function () {
        if (global.WIRE_BUILDER['step'] != 0) {
            wire_manager.reset_wire_builder();
        }
    ...
    AmMeter.prototype.remove_focus = function () {
        if (global.focused &&
            global.focused_id === this.elm.id &&
            global.focused_type === this.elm.type) {
            global.focused_id = global.NULL;
    ...
    AmMeter.prototype.remove_selection = function () {
        if (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type) {
            global.selected_id = global.NULL;
            global.selected_type = -1;
    ...
    AmMeter.prototype.wire_reference_maintenance = function () {
    ...
    AmMeter.prototype.unanchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    AmMeter.prototype.anchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    AmMeter.prototype.set_flip = function (flip) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    AmMeter.prototype.set_rotation = function (rotation) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    AmMeter.prototype.push_history = function () {
        if (this.INITIALIZED) {
            global.HISTORY_MANAGER['packet'].push(engine_functions.history_snapshot());
        }
    };
    /* Generate the SVG for the component. */
    AmMeter.prototype.build_element = function () {
    ...
    AmMeter.prototype.resize = function () {
        if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
    ...
    AmMeter.prototype.refactor = function () {
    ...
    AmMeter.prototype.update = function () { };
    AmMeter.prototype.increment_rotation = function () {
        this.elm.rotation++;
    ...
    AmMeter.prototype.increment_flip = function () { };
    AmMeter.prototype.map_rotation = function () {
        if (this.elm.rotation === global.ROTATION_0 ||
    ...
    AmMeter.prototype.reset_trace = function () {
        this.meter_trace.reset();
    };
    AmMeter.prototype.reset_meter = function () {
        this.elm.properties['Current'] = 0;
    };
    AmMeter.prototype.push_current = function (current) {
    ...
    AmMeter.prototype.get_simulation_index = function () {
        return (simulation_manager.NODE_SIZE +
            simulation_manager.ELEMENT_AMMETER_OFFSET +
            this.simulation_id);
    };
    AmMeter.prototype.recolor = function () {
        if (global.selected) {
            if (global.selected_id === this.elm.id &&
                global.selected_type === this.elm.type) {
    ...
    AmMeter.prototype.is_selected_element = function () {
        return (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type);
    };
    /* Draws the component */
    AmMeter.prototype.draw_component = function (canvas) {
    ...
    AmMeter.prototype.time_data = function () {
    ...
    AmMeter.prototype.reset = function () {
        this.elm.properties['Current'] = 0;
    };
    return AmMeter;
}());
