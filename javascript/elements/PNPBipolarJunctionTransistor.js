...
class PNPBipolarJunctionTransistor {
    constructor(type, id, n1, n2, n3) {
        ...
        this.elm = new Element3(id, type, global.utils.copy(global.PROPERTY_PNP));
    ...
    build_element() {
        if (this.build_element_flag || global.flags.signal_build_element) {
            ...
            if (this.elm.flip === global.FLIP_180) {
                this.pnp_1.x = this.pnp_0.x + cache_0 * global.utils.cosine(this.theta_m90 + global.PI_DIV_12);
                this.pnp_1.y = this.pnp_0.y + cache_1 * global.utils.sine(this.theta_m90 + global.PI_DIV_12);
            }
            else if (this.elm.flip === global.FLIP_0) {
                this.pnp_1.x = this.pnp_0.x + cache_0 * global.utils.cosine(this.theta_m90 - global.PI_DIV_12);
                this.pnp_1.y = this.pnp_0.y + cache_1 * global.utils.sine(this.theta_m90 - global.PI_DIV_12);
            ...
            if (this.elm.flip === global.FLIP_180) {
                this.pnp_4.x = this.pnp_3.x + cache_0 * global.utils.cosine(this.theta_m90 - global.PI_DIV_12);
                this.pnp_4.y = this.pnp_3.y + cache_1 * global.utils.sine(this.theta_m90 - global.PI_DIV_12);
            }
            else if (this.elm.flip === global.FLIP_0) {
                this.pnp_4.x = this.pnp_3.x + cache_0 * global.utils.cosine(this.theta_m90 + global.PI_DIV_12);
                this.pnp_4.y = this.pnp_3.y + cache_1 * global.utils.sine(this.theta_m90 + global.PI_DIV_12);
            ...
            if (this.elm.flip === global.FLIP_180) {
                this.pnp_7.x = this.pnp_1.x - cache_8 * global.utils.cosine(this.theta_m90 + global.PI_DIV_4);
                this.pnp_7.y = this.pnp_1.y - cache_9 * global.utils.sine(this.theta_m90 + global.PI_DIV_4);
                this.pnp_8.x = this.pnp_1.x - cache_8 * global.utils.cosine(this.theta_m90 - global.PI_DIV_12);
                this.pnp_8.y = this.pnp_1.y - cache_9 * global.utils.sine(this.theta_m90 - global.PI_DIV_12);
            }
            else if (this.elm.flip === global.FLIP_0) {
                this.pnp_7.x = this.pnp_1.x - cache_8 * global.utils.cosine(this.theta_m90 - global.PI_DIV_4);
                this.pnp_7.y = this.pnp_1.y - cache_9 * global.utils.sine(this.theta_m90 - global.PI_DIV_4);
