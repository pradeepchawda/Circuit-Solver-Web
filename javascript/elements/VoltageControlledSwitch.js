...
class VoltageControlledSwitch {
    constructor(type, id, n1, n2, n3) {
        ...
        this.elm = new Element3(id, type, global.utils.copy(global.PROPERTY_VCSW));
    ...
    build_element() {
        if (this.build_element_flag || global.flags.signal_build_element) {
            ...
            this.vcsw_2.x = this.vcsw_1.x + cache_4 * global.utils.cosine(this.theta - global.PI_DIV_6);
            this.vcsw_2.y = this.vcsw_1.y + cache_5 * global.utils.sine(this.theta - global.PI_DIV_6);
            this.vcsw_3.x = this.vcsw_1.x + cache_4 * global.utils.cosine(this.theta + global.PI_DIV_6);
            this.vcsw_3.y = this.vcsw_1.y + cache_5 * global.utils.sine(this.theta + global.PI_DIV_6);
            this.theta = global.utils.retrieve_angle_radian(this.p3.x - this.p1.x, this.p3.y - this.p1.y);
