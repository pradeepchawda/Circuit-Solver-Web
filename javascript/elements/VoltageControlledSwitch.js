 ...
 * File		        : VoltageControlledSwitch.js
 * Author            : nboatengc
 ...
 *
 ***********************************************************************/
var VoltageControlledSwitch = /** @class */ (function () {
    function VoltageControlledSwitch(type, id, n1, n2, n3) {
      ...
      or overlapped)*/
        ...
        this.bounds = new RectF(0, 0, 0, 0);
        /* Inititalize the element2 class that will hold the basic data about our component */
        this.elm = new Element3(id, type, global.copy(global.PROPERTY_VCSW));
    ...
    VoltageControlledSwitch.prototype.refresh_bounds = function () {
        if (this.elm.consistent()) {
            this.p1 = new PointF(0, 0);
            this.p2 = new PointF(0, 0);
            this.p3 = new PointF(0, 0);
    ...
    VoltageControlledSwitch.prototype.push_reference = function (ref) {
        this.wire_reference.push(ref);
    };
    /* General function to handle any processing required by the component */
    VoltageControlledSwitch.prototype.update = function () {
    ...
    VoltageControlledSwitch.prototype.stamp = function () {
        if (this.elm.consistent()) {
            if (this.elm.properties['Output Voltage'] <
    ...
    VoltageControlledSwitch.prototype.get_vertices = function () {
        var vertices = [];
        var p1 = [];
        var p2 = [];
        var p3 = [];
    ...
    VoltageControlledSwitch.prototype.release_wires = function () {
    ...
    VoltageControlledSwitch.prototype.release_nodes = function () {
        if (this.elm.consistent()) {
    ...
    VoltageControlledSwitch.prototype.capture_nodes = function () {
        var vertices = this.get_vertices();
        this.elm.map_node3(vertices[0], vertices[1], vertices[2], vertices[3], vertices[4], vertices[5]);
    ...
    VoltageControlledSwitch.prototype.mouse_down = function () {
        if (global.FLAG_IDLE &&
    ...
    VoltageControlledSwitch.prototype.handle_wire_builder = function (n, anchor) {
    ...
    VoltageControlledSwitch.prototype.move_element = function (dx, dy) {
    ...
    VoltageControlledSwitch.prototype.mouse_move = function () {
    ...
    VoltageControlledSwitch.prototype.mouse_up = function () {
        if (global.FLAG_IDLE) {
            if (global.focused &&
                global.focused_id === this.elm.id &&
                global.focused_type === this.elm.type) {
    ...
    VoltageControlledSwitch.prototype.select = function () {
        if (global.WIRE_BUILDER['step'] != 0) {
            wire_manager.reset_wire_builder();
        }
    ...
    VoltageControlledSwitch.prototype.remove_focus = function () {
        if (global.focused &&
            global.focused_id === this.elm.id &&
            global.focused_type === this.elm.type) {
            global.focused_id = global.NULL;
    ...
    VoltageControlledSwitch.prototype.remove_selection = function () {
        if (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type) {
            global.selected_id = global.NULL;
            global.selected_type = -1;
    ...
    VoltageControlledSwitch.prototype.wire_reference_maintenance = function () {
    ...
    VoltageControlledSwitch.prototype.unanchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    VoltageControlledSwitch.prototype.anchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    VoltageControlledSwitch.prototype.set_flip = function (flip) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    VoltageControlledSwitch.prototype.set_rotation = function (rotation) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    VoltageControlledSwitch.prototype.push_history = function () {
        if (this.INITIALIZED) {
            global.HISTORY_MANAGER['packet'].push(engine_functions.history_snapshot());
        }
    };
    /* Generate the SVG for the component. */
    VoltageControlledSwitch.prototype.build_element = function () {
        if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
            var cache_0 = 0.5 * this.x_space;
            var cache_1 = 0.5 * this.y_space;
            var cache_2 = 0.8 * this.x_space;
            var cache_3 = 0.8 * this.y_space;
            var cache_4 = 0.4 * this.x_space;
            var cache_5 = 0.4 * this.y_space;
            ...
            this.vcsw_1.x = this.p2.x + cache_2 * global.cosine(this.phi);
            this.vcsw_1.y = this.p2.y + cache_3 * global.sine(this.phi);
            this.vcsw_2.x =
                this.vcsw_1.x + cache_4 * global.cosine(this.theta - global.PI_DIV_6);
            this.vcsw_2.y =
                this.vcsw_1.y + cache_5 * global.sine(this.theta - global.PI_DIV_6);
            this.vcsw_3.x =
                this.vcsw_1.x + cache_4 * global.cosine(this.theta + global.PI_DIV_6);
            this.vcsw_3.y =
                this.vcsw_1.y + cache_5 * global.sine(this.theta + global.PI_DIV_6);
    ...
    VoltageControlledSwitch.prototype.resize = function () {
        if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
    ...
    VoltageControlledSwitch.prototype.refactor = function () {
    ...
    VoltageControlledSwitch.prototype.increment_rotation = function () {
        this.elm.rotation++;
    ...
    VoltageControlledSwitch.prototype.increment_flip = function () { };
    VoltageControlledSwitch.prototype.recolor = function () {
        if (global.selected) {
            if (global.selected_id === this.elm.id &&
                global.selected_type === this.elm.type) {
    ...
    VoltageControlledSwitch.prototype.is_selected_element = function () {
        return (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type);
    };
    /* Draws the component */
    VoltageControlledSwitch.prototype.draw_component = function (canvas) {
    ...
    VoltageControlledSwitch.prototype.patch = function () {
    ...
    VoltageControlledSwitch.prototype.time_data = function () {
    ...
    VoltageControlledSwitch.prototype.reset = function () {
