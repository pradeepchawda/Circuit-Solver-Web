 ...
 *
 * Purpose           : A class to handle the ORGate element. It will automatically generate
...
var ORGate = /** @class */ (function () {
    function ORGate(type, id, n1, n2, n3) {
      ...
      or overlapped)*/
        ...
        this.bounds = new RectF(0, 0, 0, 0);
        /* Inititalize the element2 class that will hold the basic data about our component */
        this.elm = new Element3(id, type, global.copy(global.PROPERTY_OR));
    ...
    ORGate.prototype.refresh_bounds = function () {
        if (this.elm.consistent()) {
            this.p1 = new PointF(0, 0);
            this.p2 = new PointF(0, 0);
            this.p3 = new PointF(0, 0);
    ...
    ORGate.prototype.push_reference = function (ref) {
    ...
    ORGate.prototype.stamp = function () {
        if (this.elm.consistent()) {
    ...
    ORGate.prototype.get_vertices = function () {
        var vertices = [];
        var p1 = [];
        var p2 = [];
        var p3 = [];
    ...
    ORGate.prototype.release_wires = function () {
    ...
    ORGate.prototype.release_nodes = function () {
        if (this.elm.consistent()) {
    ...
    ORGate.prototype.capture_nodes = function () {
        var vertices = this.get_vertices();
        this.elm.map_node3(vertices[0], vertices[1], vertices[2], vertices[3], vertices[4], vertices[5]);
    ...
    ORGate.prototype.mouse_down = function () {
        if (global.FLAG_IDLE &&
    ...
    ORGate.prototype.handle_wire_builder = function (n, anchor) {
    ...
    ORGate.prototype.move_element = function (dx, dy) {
    ...
    ORGate.prototype.mouse_move = function () {
    ...
    ORGate.prototype.mouse_up = function () {
        if (global.FLAG_IDLE) {
            if (global.focused &&
                global.focused_id === this.elm.id &&
                global.focused_type === this.elm.type) {
    ...
    ORGate.prototype.select = function () {
        if (global.WIRE_BUILDER['step'] != 0) {
            wire_manager.reset_wire_builder();
        }
    ...
    ORGate.prototype.remove_focus = function () {
        if (global.focused &&
            global.focused_id === this.elm.id &&
            global.focused_type === this.elm.type) {
            global.focused_id = global.NULL;
    ...
    ORGate.prototype.remove_selection = function () {
        if (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type) {
            global.selected_id = global.NULL;
            global.selected_type = -1;
    ...
    ORGate.prototype.wire_reference_maintenance = function () {
    ...
    ORGate.prototype.unanchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    ORGate.prototype.anchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    ORGate.prototype.set_flip = function (flip) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    ORGate.prototype.set_rotation = function (rotation) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    ORGate.prototype.push_history = function () {
        if (this.INITIALIZED) {
            global.HISTORY_MANAGER['packet'].push(engine_functions.history_snapshot());
        }
    };
    /* Generate the SVG for the component. */
    ORGate.prototype.build_element = function () {
        if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
            ...
            /* Top segment */
            this.or_0.x = this.p1.x + cache_0 * global.cosine(this.theta);
            this.or_0.y = this.p1.y + cache_1 * global.sine(this.theta);
            this.or_1.x = this.or_0.x + cache_2 * global.cosine(this.theta_m90);
            this.or_1.y = this.or_0.y + cache_3 * global.sine(this.theta_m90);
            this.or_2.x = this.or_1.x + cache_2 * global.cosine(this.theta - Math.PI);
            this.or_2.y = this.or_1.y + cache_3 * global.sine(this.theta - Math.PI);
            /* Overshoot of or_1 */
            this.or_7.x = this.or_0.x + cache_4 * global.cosine(this.theta_m90);
            this.or_7.y = this.or_0.y + cache_5 * global.sine(this.theta_m90);
            /* Bottom segment */
            this.or_3.x = this.p1.x + cache_6 * global.cosine(this.theta);
            this.or_3.y = this.p1.y + cache_7 * global.sine(this.theta);
            this.or_4.x = this.or_3.x + cache_2 * global.cosine(this.theta_m90);
            this.or_4.y = this.or_3.y + cache_3 * global.sine(this.theta_m90);
            this.or_5.x = this.or_4.x + cache_2 * global.cosine(this.theta);
            this.or_5.y = this.or_4.y + cache_3 * global.sine(this.theta);
            /* Overshoot of or_4 */
            this.or_8.x = this.or_3.x + cache_4 * global.cosine(this.theta_m90);
            this.or_8.y = this.or_3.y + cache_5 * global.sine(this.theta_m90);
            /* End Segment */
            this.or_6.x = this.p3.x - cache_2 * global.cosine(this.theta_m90);
            this.or_6.y = this.p3.y - cache_3 * global.sine(this.theta_m90);
            this.BUILD_ELEMENT = false;
        }
    };
    /* General function to help with resizing, i.e., canvas dimension change, zooming*/
    ORGate.prototype.resize = function () {
        if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
    ...
    ORGate.prototype.refactor = function () {
    ...
    ORGate.prototype.increment_rotation = function () {
        this.elm.rotation++;
    ...
    ORGate.prototype.increment_flip = function () { };
    ORGate.prototype.recolor = function () {
        if (global.selected) {
            if (global.selected_id === this.elm.id &&
                global.selected_type === this.elm.type) {
    ...
    ORGate.prototype.is_selected_element = function () {
        return (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type);
    };
    /* Draws the component */
    ORGate.prototype.draw_component = function (canvas) {
    ...
    ORGate.prototype.patch = function () {
    ...
    ORGate.prototype.time_data = function () {
    ...
    ORGate.prototype.reset = function () {
