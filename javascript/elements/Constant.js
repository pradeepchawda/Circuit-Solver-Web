 ...
 *
 * Purpose           : A class to handle the A constant voltage element. It will automatically generate
...
var Constant = /** @class */ (function () {
    function Constant(type, id, n1) {
        this.INITIALIZED = false;
        /* Create a new rectangle for the bounds of this component */
        this.bounds = new RectF(0, 0, 0, 0);
        /* Inititalize the element2 class that will hold the basic data about our component */
        this.elm = new Element1(-1, -1, global.NULL);
    ...
    Constant.prototype.refresh_bounds = function () {
        if (this.elm.consistent()) {
            this.p1 = new PointF(0, 0);
            /* Create some points to hold the node locations, this will be used for drawing components */
            this.p1.set_point(nodes[this.elm.n1].location.x, nodes[this.elm.n1].location.y);
    ...
    Constant.prototype.push_reference = function (ref) {
        this.wire_reference.push(ref);
    };
    Constant.prototype.stamp = function () {
        if (this.elm.consistent()) {
    ...
    Constant.prototype.release_nodes = function () {
        if (this.elm.consistent()) {
    ...
    Constant.prototype.capture_nodes = function () {
        var vertices = this.get_vertices();
        this.elm.map_node1(vertices[0], vertices[1]);
    ...
    Constant.prototype.mouse_down = function () {
        if (global.FLAG_IDLE &&
    ...
    Constant.prototype.handle_wire_builder = function (n, anchor) {
    ...
    Constant.prototype.move_element = function (dx, dy) {
    ...
    Constant.prototype.mouse_move = function () {
    ...
    Constant.prototype.mouse_up = function () {
        if (global.FLAG_IDLE) {
            if (global.focused &&
                global.focused_id === this.elm.id &&
                global.focused_type === this.elm.type) {
    ...
    Constant.prototype.select = function () {
        if (global.WIRE_BUILDER['step'] != 0) {
            wire_manager.reset_wire_builder();
        }
    ...
    Constant.prototype.remove_focus = function () {
        if (global.focused &&
            global.focused_id === this.elm.id &&
            global.focused_type === this.elm.type) {
            global.focused_id = global.NULL;
    ...
    Constant.prototype.remove_selection = function () {
        if (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type) {
            global.selected_id = global.NULL;
            global.selected_type = global.NULL;
    ...
    Constant.prototype.wire_reference_maintenance = function () {
    ...
    Constant.prototype.unanchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    Constant.prototype.anchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    Constant.prototype.update = function () { };
    Constant.prototype.set_flip = function (flip) { };
    /* Sets the rotation of the component */
    Constant.prototype.set_rotation = function (rotation) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.push_history();
        this.release_nodes();
    ...
    Constant.prototype.increment_rotation = function () {
        this.elm.rotation++;
    ...
    Constant.prototype.increment_flip = function () { };
    Constant.prototype.recolor = function () {
        if (global.selected) {
            if (global.selected_id === this.elm.id &&
                global.selected_type === this.elm.type) {
    ...
    Constant.prototype.is_selected_element = function () {
        return (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type);
    };
    /* Draws the component */
    Constant.prototype.draw_component = function (canvas) {
        ...
        if (global.PICTURE_REQUEST ||
            ...
            if (global.WORKSPACE_ZOOM_SCALE > 1.085 ||
                ...
                if (this.elm.rotation === global.ROTATION_90) {
                    canvas.draw_text(global.ELEMENT_VAL_TEMPLATE.replace('{VAL}', global.exponentiate_quickly(this.elm.properties['Voltage'])).replace('{UNIT}', this.elm.properties['units']), this.c_x, this.bounds.top + this.bounds.get_height() * 0.2, this.text_paint);
                }
                else if (this.elm.rotation === global.ROTATION_270) {
                    canvas.draw_text(global.ELEMENT_VAL_TEMPLATE.replace('{VAL}', global.exponentiate_quickly(this.elm.properties['Voltage'])).replace('{UNIT}', this.elm.properties['units']), this.c_x, this.bounds.bottom - this.bounds.get_height() * 0.2, this.text_paint);
                }
                else if (this.elm.rotation === global.ROTATION_0) {
                    canvas.rotate(this.bounds.left, this.c_y, -90);
                    canvas.draw_text(global.ELEMENT_VAL_TEMPLATE.replace('{VAL}', global.exponentiate_quickly(this.elm.properties['Voltage'])).replace('{UNIT}', this.elm.properties['units']), this.bounds.left, this.c_y + this.bounds.get_height() * 0.2, this.text_paint);
                    canvas.restore();
                }
                else if (this.elm.rotation === global.ROTATION_180) {
                    canvas.rotate(this.bounds.right, this.c_y, -90);
                    canvas.draw_text(global.ELEMENT_VAL_TEMPLATE.replace('{VAL}', global.exponentiate_quickly(this.elm.properties['Voltage'])).replace('{UNIT}', this.elm.properties['units']), this.bounds.right, this.c_y - this.bounds.get_height() * 0.2, this.text_paint);
                    canvas.restore();
                }
            }
    ...
    Constant.prototype.patch = function () {
    ...
    Constant.prototype.time_data = function () {
