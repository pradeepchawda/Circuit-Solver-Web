...
class TriangleWave {
    constructor(type, id, n1, n2) {
        ...
        this.elm = new Element2(id, type, global.utils.copy(global.PROPERTY_TRI));
    ...
    build_element() {
        if (this.build_element_flag || global.flags.signal_build_element) {
            ...
            this.sq_0.x = this.c_x - (cache_2 >> 2) * global.utils.cosine(this.theta - global.PI_DIV_4);
            this.sq_0.y = this.c_y - (cache_2 >> 2) * global.utils.sine(this.theta - global.PI_DIV_4);
            this.sq_1.x = this.c_x + (cache_2 >> 2) * global.utils.cosine(this.theta - global.PI_DIV_4);
            this.sq_1.y = this.c_y + (cache_2 >> 2) * global.utils.sine(this.theta - global.PI_DIV_4);
