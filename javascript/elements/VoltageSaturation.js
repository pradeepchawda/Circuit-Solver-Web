 ...
 * File		        : VoltageSaturation.js
 * Author            : nboatengc
 * Date created      : 20190928
 *
 * Purpose           : A class to handle the Voltage Saturation element. It will automatically generate
 ...
 *
 ***********************************************************************/
var VoltageSaturation = /** @class */ (function () {
    function VoltageSaturation(type, id, n1, n2) {
      ...
      or overlapped)*/
        ...
        this.bounds = new RectF(0, 0, 0, 0);
        /* Inititalize the element2 class that will hold the basic data about our component */
        this.elm = new Element2(id, type, global.copy(global.PROPERTY_VSAT));
    ...
    VoltageSaturation.prototype.refresh_bounds = function () {
        if (this.elm.consistent()) {
            this.p1 = new PointF(0, 0);
            this.p2 = new PointF(0, 0);
            /* Create some points to hold the node locations, this will be used for drawing components */
    ...
    VoltageSaturation.prototype.push_reference = function (ref) {
        this.wire_reference.push(ref);
    };
    /* General function to handle any processing required by the component */
    VoltageSaturation.prototype.update = function () {
    ...
    VoltageSaturation.prototype.stamp = function () {
        if (this.elm.consistent()) {
    ...
    VoltageSaturation.prototype.get_vertices = function () {
        var vertices = [];
        var p1 = [];
        var p2 = [];
    ...
    VoltageSaturation.prototype.release_wires = function () {
    ...
    VoltageSaturation.prototype.release_nodes = function () {
        if (this.elm.consistent()) {
    ...
    VoltageSaturation.prototype.capture_nodes = function () {
        var vertices = this.get_vertices();
        this.elm.map_node2(vertices[0], vertices[1], vertices[2], vertices[3]);
    ...
    VoltageSaturation.prototype.mouse_down = function () {
        if (global.FLAG_IDLE &&
    ...
    VoltageSaturation.prototype.handle_wire_builder = function (n, anchor) {
    ...
    VoltageSaturation.prototype.move_element = function (dx, dy) {
    ...
    VoltageSaturation.prototype.mouse_move = function () {
    ...
    VoltageSaturation.prototype.mouse_up = function () {
        if (global.FLAG_IDLE) {
            if (global.focused &&
                global.focused_id === this.elm.id &&
                global.focused_type === this.elm.type) {
    ...
    VoltageSaturation.prototype.select = function () {
        if (global.WIRE_BUILDER['step'] != 0) {
            wire_manager.reset_wire_builder();
        }
    ...
    VoltageSaturation.prototype.remove_focus = function () {
        if (global.focused &&
            global.focused_id === this.elm.id &&
            global.focused_type === this.elm.type) {
            global.focused_id = global.NULL;
    ...
    VoltageSaturation.prototype.remove_selection = function () {
        if (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type) {
            global.selected_id = global.NULL;
            global.selected_type = -1;
    ...
    VoltageSaturation.prototype.wire_reference_maintenance = function () {
    ...
    VoltageSaturation.prototype.unanchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    VoltageSaturation.prototype.anchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    VoltageSaturation.prototype.set_flip = function (flip) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    VoltageSaturation.prototype.set_rotation = function (rotation) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    VoltageSaturation.prototype.push_history = function () {
        if (this.INITIALIZED) {
            global.HISTORY_MANAGER['packet'].push(engine_functions.history_snapshot());
        }
    };
    /* Generate the SVG for the component. */
    VoltageSaturation.prototype.build_element = function () {
        if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
            var cache_0 = 1.5 * this.x_space;
            var cache_1 = 1.0 * this.x_space;
            var cache_2 = 1.5 * this.y_space;
            var cache_3 = 1.0 * this.y_space;
            var cache_4 = 0.5 * this.x_space;
            var cache_5 = 0.5 * this.y_space;
            var cache_6 = 0.25 * this.x_space;
            var cache_7 = 0.25 * this.y_space;
            ...
            this.vsat_4.y =
                this.c_y +
                    cache_9 * global.sine(this.theta) +
                    cache_9 * global.sine(this.theta_m90);
            this.vsat_5.x = this.c_x + cache_8 * global.cosine(this.theta);
            this.vsat_5.y = this.c_y + cache_9 * global.sine(this.theta);
            /* Saturation Symbol */
            ...
            this.vsat_6.x =
                this.connect1_x + cache_4 * global.cosine(this.theta + global.PI_DIV_4);
            this.vsat_6.y =
                this.connect1_y + cache_5 * global.sine(this.theta + global.PI_DIV_4);
            this.vsat_7.x =
                this.connect1_x +
                    cache_4 * global.cosine(this.theta + global.PI_DIV_4) +
                    cache_6 * global.cosine(this.theta);
            this.vsat_7.y =
                this.connect1_y +
                    cache_5 * global.sine(this.theta + global.PI_DIV_4) +
                    cache_7 * global.sine(this.theta);
            this.vsat_8.x =
                this.connect2_x +
                    cache_4 * global.cosine(this.theta - global.PI_DIV_2 - global.PI_DIV_4);
            this.vsat_8.y =
                this.connect2_y +
                    cache_5 * global.sine(this.theta - global.PI_DIV_2 - global.PI_DIV_4);
            this.vsat_9.x =
                this.connect2_x +
                    cache_4 *
                        global.cosine(this.theta - global.PI_DIV_2 - global.PI_DIV_4) +
                    cache_6 * global.cosine(this.theta - Math.PI);
            this.vsat_9.y =
                this.connect2_y +
                    cache_5 * global.sine(this.theta - global.PI_DIV_2 - global.PI_DIV_4) +
                    cache_7 * global.sine(this.theta - Math.PI);
            this.BUILD_ELEMENT = false;
        }
    };
    /* General function to help with resizing, i.e., canvas dimension change, zooming*/
    VoltageSaturation.prototype.resize = function () {
        if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
    ...
    VoltageSaturation.prototype.refactor = function () {
    ...
    VoltageSaturation.prototype.increment_rotation = function () {
        this.elm.rotation++;
    ...
    VoltageSaturation.prototype.increment_flip = function () { };
    VoltageSaturation.prototype.map_rotation = function () {
        if (this.elm.rotation === global.ROTATION_0 ||
    ...
    VoltageSaturation.prototype.recolor = function () {
        if (global.selected) {
            if (global.selected_id === this.elm.id &&
                global.selected_type === this.elm.type) {
    ...
    VoltageSaturation.prototype.is_selected_element = function () {
        return (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type);
    };
    /* Draws the component */
    VoltageSaturation.prototype.draw_component = function (canvas) {
        ...
        if (global.PICTURE_REQUEST ||
            ...
            if (global.WORKSPACE_ZOOM_SCALE > 1.085 ||
                ...
                if ((this.ANGLE > 170 && this.ANGLE < 190) ||
                    ...
                    canvas.draw_text(global.DIVISION_TEXT_TEMPLATE.replace('{A}', global.exponentiate_quickly(this.elm.properties['Low Voltage'])).replace('{B}', global.ELEMENT_VAL_TEMPLATE.replace('{VAL}', global.exponentiate_quickly(this.elm.properties['High Voltage'])).replace('{UNIT}', this.elm.properties['units'])), this.c_x, this.bounds.top + this.bounds.get_height() * 0.1, this.text_paint);
    ...
    VoltageSaturation.prototype.patch = function () {
    ...
    VoltageSaturation.prototype.time_data = function () {
    ...
    VoltageSaturation.prototype.reset = function () {
        this.elm.properties['Output Voltage'] = 0;
    };
    return VoltageSaturation;
}());
