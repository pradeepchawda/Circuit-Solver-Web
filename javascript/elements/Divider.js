 ...
 *
 * Purpose           : A class to handle the Voltage Adder element. It will automatically generate
...
var Divider = /** @class */ (function () {
    function Divider(type, id, n1, n2, n3) {
        ...
        this.temp_color = global.ELEMENT_COLOR;
    ...
    Divider.prototype.refresh_bounds = function () {
        if (this.elm.consistent()) {
            this.p1 = new PointF(0, 0);
            this.p2 = new PointF(0, 0);
            this.p3 = new PointF(0, 0);
    ...
    Divider.prototype.push_reference = function (ref) {
    ...
    Divider.prototype.stamp = function () {
        if (this.elm.consistent()) {
    ...
    Divider.prototype.get_vertices = function () {
        var vertices = [];
        var p1 = [];
        var p2 = [];
        var p3 = [];
    ...
    Divider.prototype.release_wires = function () {
    ...
    Divider.prototype.release_nodes = function () {
        if (this.elm.consistent()) {
    ...
    Divider.prototype.capture_nodes = function () {
        var vertices = this.get_vertices();
        this.elm.map_node3(vertices[0], vertices[1], vertices[2], vertices[3], vertices[4], vertices[5]);
    ...
    Divider.prototype.mouse_down = function () {
        if (global.FLAG_IDLE &&
    ...
    Divider.prototype.handle_wire_builder = function (n, anchor) {
    ...
    Divider.prototype.move_element = function (dx, dy) {
    ...
    Divider.prototype.mouse_move = function () {
    ...
    Divider.prototype.mouse_up = function () {
        if (global.FLAG_IDLE) {
            if (global.focused &&
                global.focused_id === this.elm.id &&
                global.focused_type === this.elm.type) {
    ...
    Divider.prototype.select = function () {
        if (global.WIRE_BUILDER['step'] != 0) {
            wire_manager.reset_wire_builder();
        }
    ...
    Divider.prototype.remove_focus = function () {
        if (global.focused &&
            global.focused_id === this.elm.id &&
            global.focused_type === this.elm.type) {
            global.focused_id = global.NULL;
    ...
    Divider.prototype.remove_selection = function () {
        if (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type) {
            global.selected_id = global.NULL;
            global.selected_type = -1;
    ...
    Divider.prototype.wire_reference_maintenance = function () {
    ...
    Divider.prototype.unanchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    Divider.prototype.anchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    Divider.prototype.set_flip = function (flip) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    Divider.prototype.set_rotation = function (rotation) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    Divider.prototype.push_history = function () {
        if (this.INITIALIZED) {
            global.HISTORY_MANAGER['packet'].push(engine_functions.history_snapshot());
        }
    };
    /* Generate the SVG for the component. */
    Divider.prototype.build_element = function () {
        if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
            ...
            var cache_6 = 1.5 * this.x_space;
            var cache_7 = 1.414 * this.x_space;
            var cache_8 = 1.5 * this.y_space;
            var cache_9 = 1.414 * this.y_space;
            this.plus_point.x =
                this.c_x -
            ...
            this.plus_point.y =
                this.c_y -
                    cache_8 * global.sine(this.theta) -
                    cache_9 * global.sine(this.theta_m90);
            /* Top segment */
            this.divider_0.x = this.p1.x + cache_0 * global.cosine(this.theta_m90);
            this.divider_0.y = this.p1.y + cache_1 * global.sine(this.theta_m90);
            this.divider_1.x = this.divider_0.x + cache_4 * global.cosine(this.theta);
            this.divider_1.y = this.divider_0.y + cache_5 * global.sine(this.theta);
            this.divider_2.x =
                this.divider_1.x + cache_2 * global.cosine(this.theta - Math.PI);
            this.divider_2.y =
                this.divider_1.y + cache_3 * global.sine(this.theta - Math.PI);
            /* Bottom segment */
            this.divider_3.x = this.p2.x + cache_0 * global.cosine(this.theta_m90);
            this.divider_3.y = this.p2.y + cache_1 * global.sine(this.theta_m90);
            this.divider_4.x = this.divider_3.x - cache_4 * global.cosine(this.theta);
            this.divider_4.y = this.divider_3.y - cache_5 * global.sine(this.theta);
            this.divider_5.x = this.divider_4.x + cache_2 * global.cosine(this.theta);
    ...
    Divider.prototype.refactor = function () {
    ...
    Divider.prototype.increment_rotation = function () {
        this.elm.rotation++;
    ...
    Divider.prototype.increment_flip = function () {
        this.elm.flip++;
    ...
    Divider.prototype.recolor = function () {
        if (global.selected) {
            if (global.selected_id === this.elm.id &&
                global.selected_type === this.elm.type) {
    ...
    Divider.prototype.is_selected_element = function () {
        return (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type);
    };
    /* Draws the component */
    Divider.prototype.draw_component = function (canvas) {
        ...
        if (global.PICTURE_REQUEST ||
            ...
            this.CIRCLE_BUFFER[this.indexer++] = Array(this.c_x, this.c_y + this.bounds.get_width() * 0.1, 0.75 * global.CANVAS_STROKE_WIDTH_2_ZOOM);
            this.CIRCLE_BUFFER[this.indexer++] = Array(this.c_x, this.c_y - this.bounds.get_width() * 0.1, 0.75 * global.CANVAS_STROKE_WIDTH_2_ZOOM);
    ...
    Divider.prototype.patch = function () {
    ...
    Divider.prototype.time_data = function () {
