 ...
 *
 * Purpose           : A class to handle the dc-current element. It will automatically generate
 ...
 *
 ***********************************************************************/
var DCCurrent = /** @class */ (function () {
    function DCCurrent(type, id, n1, n2) {
      ...
      or overlapped)*/
        ...
        this.bounds = new RectF(0, 0, 0, 0);
        /* Inititalize the element2 class that will hold the basic data about our component */
        this.elm = new Element2(id, type, global.copy(global.PROPERTY_DCCURRENT));
    ...
    DCCurrent.prototype.refresh_bounds = function () {
        if (this.elm.consistent()) {
            this.p1 = new PointF(0, 0);
            this.p2 = new PointF(0, 0);
            /* Create some points to hold the node locations, this will be used for drawing components */
    ...
    DCCurrent.prototype.release_wires = function () {
    ...
    DCCurrent.prototype.release_nodes = function () {
        if (this.elm.consistent()) {
    ...
    DCCurrent.prototype.capture_nodes = function () {
        var vertices = this.get_vertices();
        this.elm.map_node2(vertices[0], vertices[1], vertices[2], vertices[3]);
    ...
    DCCurrent.prototype.mouse_down = function () {
        if (global.FLAG_IDLE &&
    ...
    DCCurrent.prototype.handle_wire_builder = function (n, anchor) {
    ...
    DCCurrent.prototype.move_element = function (dx, dy) {
    ...
    DCCurrent.prototype.mouse_move = function () {
    ...
    DCCurrent.prototype.mouse_up = function () {
        if (global.FLAG_IDLE) {
            if (global.focused &&
                global.focused_id === this.elm.id &&
                global.focused_type === this.elm.type) {
    ...
    DCCurrent.prototype.select = function () {
        if (global.WIRE_BUILDER['step'] != 0) {
            wire_manager.reset_wire_builder();
        }
    ...
    DCCurrent.prototype.remove_focus = function () {
        if (global.focused &&
            global.focused_id === this.elm.id &&
            global.focused_type === this.elm.type) {
            global.focused_id = global.NULL;
    ...
    DCCurrent.prototype.remove_selection = function () {
        if (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type) {
            global.selected_id = global.NULL;
            global.selected_type = -1;
    ...
    DCCurrent.prototype.wire_reference_maintenance = function () {
    ...
    DCCurrent.prototype.unanchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    DCCurrent.prototype.anchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    DCCurrent.prototype.set_flip = function (flip) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    DCCurrent.prototype.set_rotation = function (rotation) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    DCCurrent.prototype.push_history = function () {
        if (this.INITIALIZED) {
            global.HISTORY_MANAGER['packet'].push(engine_functions.history_snapshot());
        }
    };
    /* Generate the SVG for the component. */
    DCCurrent.prototype.build_element = function () {
        if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
            var cache_0 = 0.5 * this.x_space;
            var cache_1 = 0.5 * this.y_space;
            var cache_2 = 0.125 * this.x_space;
            var cache_3 = 0.125 * this.y_space;
            var cache_4 = this.x_space;
            var cache_5 = this.y_space;
            this.dcc_0.x = this.c_x - cache_0 * global.cosine(this.theta);
            this.dcc_0.y = this.c_y - cache_1 * global.sine(this.theta);
            this.dcc_1.x = this.c_x + cache_0 * global.cosine(this.theta);
            this.dcc_1.y = this.c_y + cache_1 * global.sine(this.theta);
            this.dcc_2.x =
                this.c_x -
                    cache_2 * global.cosine(this.theta) +
                    (cache_5 >> 1) * global.cosine(this.theta_m90);
            this.dcc_2.y =
                this.c_y -
            ...
            this.dcc_3.x =
                this.c_x -
                    cache_2 * global.cosine(this.theta) +
                    (cache_5 >> 1) * global.cosine(Math.PI + this.theta_m90);
            this.dcc_3.y =
                this.c_y -
                    cache_3 * global.sine(this.theta) +
    ...
    DCCurrent.prototype.resize = function () {
        if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
    ...
    DCCurrent.prototype.refactor = function () {
    ...
    DCCurrent.prototype.update = function () { };
    DCCurrent.prototype.increment_rotation = function () {
        this.elm.rotation++;
    ...
    DCCurrent.prototype.increment_flip = function () { };
    DCCurrent.prototype.map_rotation = function () {
        if (this.elm.rotation === global.ROTATION_0 ||
    ...
    DCCurrent.prototype.recolor = function () {
        if (global.selected) {
            if (global.selected_id === this.elm.id &&
                global.selected_type === this.elm.type) {
    ...
    DCCurrent.prototype.is_selected_element = function () {
        return (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type);
    };
    /* Draws the component */
    DCCurrent.prototype.draw_component = function (canvas) {
    ...
    DCCurrent.prototype.patch = function () {
    ...
    DCCurrent.prototype.time_data = function () {
    ...
    DCCurrent.prototype.reset = function () { };
    return DCCurrent;
}());
