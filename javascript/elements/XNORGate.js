 ...
 *
 * Purpose           : A class to handle the XNORGate element. It will automatically generate
 ...
 *
 ***********************************************************************/
var XNORGate = /** @class */ (function () {
    function XNORGate(type, id, n1, n2, n3) {
      ...
      or overlapped)*/
        ...
        this.bounds = new RectF(0, 0, 0, 0);
        /* Inititalize the element2 class that will hold the basic data about our component */
        this.elm = new Element3(id, type, global.copy(global.PROPERTY_XNOR));
    ...
    XNORGate.prototype.refresh_bounds = function () {
        if (this.elm.consistent()) {
            this.p1 = new PointF(0, 0);
            this.p2 = new PointF(0, 0);
            this.p3 = new PointF(0, 0);
    ...
    XNORGate.prototype.push_reference = function (ref) {
        this.wire_reference.push(ref);
    };
    /* General function to handle any processing required by the component */
    XNORGate.prototype.update = function () {
    ...
    XNORGate.prototype.stamp = function () {
        if (this.elm.consistent()) {
    ...
    XNORGate.prototype.get_vertices = function () {
        var vertices = [];
        var p1 = [];
        var p2 = [];
        var p3 = [];
    ...
    XNORGate.prototype.release_wires = function () {
    ...
    XNORGate.prototype.release_nodes = function () {
        if (this.elm.consistent()) {
    ...
    XNORGate.prototype.capture_nodes = function () {
        var vertices = this.get_vertices();
        this.elm.map_node3(vertices[0], vertices[1], vertices[2], vertices[3], vertices[4], vertices[5]);
    ...
    XNORGate.prototype.mouse_down = function () {
        if (global.FLAG_IDLE &&
    ...
    XNORGate.prototype.handle_wire_builder = function (n, anchor) {
    ...
    XNORGate.prototype.move_element = function (dx, dy) {
    ...
    XNORGate.prototype.mouse_move = function () {
    ...
    XNORGate.prototype.mouse_up = function () {
        if (global.FLAG_IDLE) {
            if (global.focused &&
                global.focused_id === this.elm.id &&
                global.focused_type === this.elm.type) {
    ...
    XNORGate.prototype.select = function () {
        if (global.WIRE_BUILDER['step'] != 0) {
            wire_manager.reset_wire_builder();
        }
    ...
    XNORGate.prototype.remove_focus = function () {
        if (global.focused &&
            global.focused_id === this.elm.id &&
            global.focused_type === this.elm.type) {
            global.focused_id = global.NULL;
    ...
    XNORGate.prototype.remove_selection = function () {
        if (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type) {
            global.selected_id = global.NULL;
            global.selected_type = -1;
    ...
    XNORGate.prototype.wire_reference_maintenance = function () {
    ...
    XNORGate.prototype.unanchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    XNORGate.prototype.anchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    XNORGate.prototype.set_flip = function (flip) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    XNORGate.prototype.set_rotation = function (rotation) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    XNORGate.prototype.push_history = function () {
        if (this.INITIALIZED) {
            global.HISTORY_MANAGER['packet'].push(engine_functions.history_snapshot());
        }
    };
    /* Generate the SVG for the component. */
    XNORGate.prototype.build_element = function () {
        if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
            ...
            var cache_10 = 0.9 * this.x_space;
            var cache_11 = 0.9 * this.y_space;
            var cache_12 = 0.6 * this.x_space;
            var cache_13 = 0.6 * this.y_space;
            var cache_14 = 0.3 * this.x_space;
            var cache_15 = 0.3 * this.y_space;
            var cache_16 = this.x_space;
            var cache_17 = this.y_space;
            /* Top segment */
            this.xnor_0.x = this.p1.x + cache_0 * global.cosine(this.theta);
            ...
            /* Bottom segment */
            this.xnor_3.x = this.p1.x + cache_8 * global.cosine(this.theta);
            this.xnor_3.y = this.p1.y + cache_9 * global.sine(this.theta);
            this.xnor_4.x = this.xnor_3.x + cache_2 * global.cosine(this.theta_m90);
            ...
            /* End Segment */
            this.xnor_6.x = this.p3.x - cache_10 * global.cosine(this.theta_m90);
            this.xnor_6.y = this.p3.y - cache_11 * global.sine(this.theta_m90);
            this.xnor_9.x = this.p3.x - cache_12 * global.cosine(this.theta_m90);
            this.xnor_9.y = this.p3.y - cache_13 * global.sine(this.theta_m90);
            this.xnor_10.x = this.p3.x - cache_14 * global.cosine(this.theta_m90);
            this.xnor_10.y = this.p3.y - cache_15 * global.sine(this.theta_m90);
            this.BUILD_ELEMENT = false;
        }
    };
    /* General function to help with resizing, i.e., canvas dimension change, zooming*/
    XNORGate.prototype.resize = function () {
        if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
    ...
    XNORGate.prototype.refactor = function () {
    ...
    XNORGate.prototype.increment_rotation = function () {
        this.elm.rotation++;
    ...
    XNORGate.prototype.increment_flip = function () { };
    XNORGate.prototype.recolor = function () {
        if (global.selected) {
            if (global.selected_id === this.elm.id &&
                global.selected_type === this.elm.type) {
    ...
    XNORGate.prototype.is_selected_element = function () {
        return (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type);
    };
    /* Draws the component */
    XNORGate.prototype.draw_component = function (canvas) {
    ...
    XNORGate.prototype.patch = function () {
    ...
    XNORGate.prototype.time_data = function () {
    ...
    XNORGate.prototype.reset = function () {
