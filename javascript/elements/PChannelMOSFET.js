...
class PChannelMOSFET {
    constructor(type, id, n1, n2, n3) {
        ...
        this.elm = new Element3(id, type, global.utils.copy(global.PROPERTY_PMOS));
    ...
    build_element() {
        if (this.build_element_flag || global.flags.signal_build_element) {
            ...
            this.pmos_7.x = this.pmos_1.x - cache_8 * global.utils.cosine(this.theta_m90 + global.PI_DIV_6);
            this.pmos_7.y = this.pmos_1.y - cache_9 * global.utils.sine(this.theta_m90 + global.PI_DIV_6);
            this.pmos_8.x = this.pmos_1.x - cache_8 * global.utils.cosine(this.theta_m90 - global.PI_DIV_6);
            this.pmos_8.y = this.pmos_1.y - cache_9 * global.utils.sine(this.theta_m90 - global.PI_DIV_6);
