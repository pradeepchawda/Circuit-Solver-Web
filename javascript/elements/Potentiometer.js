...
class Potentiometer {
    constructor(type, id, n1, n2, n3) {
        ...
        this.elm = new Element3(id, type, global.utils.copy(global.PROPERTY_POTENTIOMETER));
    ...
    build_element() {
        if (this.build_element_flag || global.flags.signal_build_element) {
            ...
            this.pot_3.x = this.pot_12.x + cache_8 * global.utils.cosine(this.theta - global.PI_DIV_6);
            this.pot_3.y = this.pot_12.y + cache_9 * global.utils.sine(this.theta - global.PI_DIV_6);
            this.pot_5.x = this.pot_12.x + cache_8 * global.utils.cosine(this.theta + global.PI_DIV_6);
            this.pot_5.y = this.pot_12.y + cache_9 * global.utils.sine(this.theta + global.PI_DIV_6);
            this.theta = global.utils.retrieve_angle_radian(this.p3.x - this.p1.x, this.p3.y - this.p1.y);
        ...
        if (global.flags.picture_request_flag ||
            ...
            if (global.variables.workspace_zoom_scale > 1.085 || (!global.CONSTANTS.MOBILE_MODE && global.variables.workspace_zoom_scale >= 0.99)) {
                ...
                if (this.angle > 170 && this.angle < 190) {
                    canvas.draw_text(global.ELEMENT_VAL_TEMPLATE.replace('{VAL}', global.utils.exponentiate_quickly(this.elm.properties['Resistance'])).replace('{UNIT}', this.elm.properties['units']), this.c_x, this.bounds.top - this.bounds.get_height() * 0.1, this.text_paint);
                    ...
                    canvas.draw_text(global.ELEMENT_VAL_TEMPLATE.replace('{VAL}', global.utils.exponentiate_quickly(this.elm.properties['Resistance'])).replace('{UNIT}', this.elm.properties['units']), this.c_x, this.bounds.bottom - this.bounds.get_height() * 0.1, this.text_paint);
