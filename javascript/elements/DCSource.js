 ...
 *
 * Purpose           : A class to handle the dc-source element. It will automatically generate
 ...
 *
 ***********************************************************************/
var DCSource = /** @class */ (function () {
    function DCSource(type, id, n1, n2) {
    ...
    DCSource.prototype.refresh_bounds = function () {
        if (this.elm.consistent()) {
            this.p1 = new PointF(0, 0);
            this.p2 = new PointF(0, 0);
            /* Create some points to hold the node locations, this will be used for drawing components */
    ...
    DCSource.prototype.push_reference = function (ref) {
        this.wire_reference.push(ref);
    };
    DCSource.prototype.stamp = function () {
        if (this.elm.consistent()) {
    ...
    DCSource.prototype.get_vertices = function () {
        var vertices = [];
        var p1 = [];
        var p2 = [];
    ...
    DCSource.prototype.release_wires = function () {
    ...
    DCSource.prototype.release_nodes = function () {
        if (this.elm.consistent()) {
    ...
    DCSource.prototype.capture_nodes = function () {
        var vertices = this.get_vertices();
        this.elm.map_node2(vertices[0], vertices[1], vertices[2], vertices[3]);
    ...
    DCSource.prototype.mouse_down = function () {
        if (global.FLAG_IDLE &&
    ...
    DCSource.prototype.handle_wire_builder = function (n, anchor) {
    ...
    DCSource.prototype.move_element = function (dx, dy) {
    ...
    DCSource.prototype.mouse_move = function () {
    ...
    DCSource.prototype.mouse_up = function () {
        if (global.FLAG_IDLE) {
            if (global.focused &&
                global.focused_id === this.elm.id &&
                global.focused_type === this.elm.type) {
    ...
    DCSource.prototype.select = function () {
        if (global.WIRE_BUILDER['step'] != 0) {
            wire_manager.reset_wire_builder();
        }
    ...
    DCSource.prototype.remove_focus = function () {
        if (global.focused &&
            global.focused_id === this.elm.id &&
            global.focused_type === this.elm.type) {
            global.focused_id = global.NULL;
    ...
    DCSource.prototype.remove_selection = function () {
        if (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type) {
            global.selected_id = global.NULL;
            global.selected_type = -1;
    ...
    DCSource.prototype.wire_reference_maintenance = function () {
    ...
    DCSource.prototype.unanchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    DCSource.prototype.anchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    DCSource.prototype.set_flip = function (flip) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    DCSource.prototype.set_rotation = function (rotation) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    DCSource.prototype.push_history = function () {
        if (this.INITIALIZED) {
            global.HISTORY_MANAGER['packet'].push(engine_functions.history_snapshot());
        }
    };
    /* Generate the SVG for the component. */
    DCSource.prototype.build_element = function () {
        if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
            var cache_0 = 0.5 * this.x_space;
            var cache_1 = 0.5 * this.y_space;
            var cache_2 = 0.57142 * this.x_space;
            var cache_3 = 0.57142 * this.y_space;
            var cache_4 = 0.25 * this.x_space;
            var cache_5 = 0.25 * this.y_space;
            var cache_6 = 0.0625 * this.x_space;
            var cache_7 = 0.0625 * this.y_space;
            var cache_8 = this.x_space;
            var cache_9 = this.y_space;
            this.dc_0.x =
                this.c_x +
                    cache_0 * global.cosine(this.theta) +
                    (cache_8 >> 2) * global.cosine(this.theta_m90);
            this.dc_0.y =
                this.c_y +
                    cache_1 * global.sine(this.theta) +
                    (cache_8 >> 2) * global.sine(this.theta_m90);
            this.dc_1.x =
                this.c_x +
                    cache_0 * global.cosine(this.theta) +
                    (cache_8 >> 2) * global.cosine(Math.PI + this.theta_m90);
            this.dc_1.y =
                this.c_y +
                    cache_1 * global.sine(this.theta) +
                    (cache_8 >> 2) * global.sine(Math.PI + this.theta_m90);
    ...
    DCSource.prototype.resize = function () {
        if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
    ...
    DCSource.prototype.refactor = function () {
    ...
    DCSource.prototype.update = function () { };
    DCSource.prototype.increment_rotation = function () {
        this.elm.rotation++;
    ...
    DCSource.prototype.increment_flip = function () { };
    DCSource.prototype.map_rotation = function () {
        if (this.elm.rotation === global.ROTATION_0 ||
    ...
    DCSource.prototype.recolor = function () {
        if (global.selected) {
            if (global.selected_id === this.elm.id &&
                global.selected_type === this.elm.type) {
    ...
    DCSource.prototype.is_selected_element = function () {
        return (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type);
    };
    /* Draws the component */
    DCSource.prototype.draw_component = function (canvas) {
    ...
    DCSource.prototype.patch = function () {
    ...
    DCSource.prototype.time_data = function () {
    ...
    DCSource.prototype.reset = function () { };
    return DCSource;
}());
