 ...
 *
 * Purpose           : A class to handle the ac-source element. It will automatically generate
 ...
 *
 ***********************************************************************/
var ACSource = /** @class */ (function () {
    function ACSource(type, id, n1, n2) {
    ...
    ACSource.prototype.refresh_bounds = function () {
        if (this.elm.consistent()) {
            this.p1 = new PointF(0, 0);
            this.p2 = new PointF(0, 0);
            /* Create some points to hold the node locations, this will be used for drawing components */
    ...
    ACSource.prototype.push_reference = function (ref) {
        this.wire_reference.push(ref);
    };
    ACSource.prototype.stamp = function () {
        if (this.elm.consistent()) {
            engine_functions.stamp_voltage(this.elm.n1, this.elm.n2, global.sine(2 *
                Math.PI *
    ...
    ACSource.prototype.get_vertices = function () {
        var vertices = [];
        var p1 = [];
        var p2 = [];
    ...
    ACSource.prototype.release_wires = function () {
    ...
    ACSource.prototype.release_nodes = function () {
        if (this.elm.consistent()) {
    ...
    ACSource.prototype.capture_nodes = function () {
        var vertices = this.get_vertices();
        this.elm.map_node2(vertices[0], vertices[1], vertices[2], vertices[3]);
    ...
    ACSource.prototype.mouse_down = function () {
        if (global.FLAG_IDLE &&
    ...
    ACSource.prototype.handle_wire_builder = function (n, anchor) {
    ...
    ACSource.prototype.move_element = function (dx, dy) {
    ...
    ACSource.prototype.mouse_move = function () {
    ...
    ACSource.prototype.mouse_up = function () {
        if (global.FLAG_IDLE) {
            if (global.focused &&
                global.focused_id === this.elm.id &&
                global.focused_type === this.elm.type) {
    ...
    ACSource.prototype.select = function () {
        if (global.WIRE_BUILDER['step'] != 0) {
            wire_manager.reset_wire_builder();
        }
    ...
    ACSource.prototype.remove_focus = function () {
        if (global.focused &&
            global.focused_id === this.elm.id &&
            global.focused_type === this.elm.type) {
            global.focused_id = global.NULL;
    ...
    ACSource.prototype.remove_selection = function () {
        if (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type) {
            global.selected_id = global.NULL;
            global.selected_type = -1;
    ...
    ACSource.prototype.wire_reference_maintenance = function () {
    ...
    ACSource.prototype.unanchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    ACSource.prototype.anchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    ACSource.prototype.set_flip = function (flip) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    ACSource.prototype.set_rotation = function (rotation) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    ACSource.prototype.push_history = function () {
        if (this.INITIALIZED) {
            global.HISTORY_MANAGER['packet'].push(engine_functions.history_snapshot());
        }
    };
    /* Generate the SVG for the component. */
    ACSource.prototype.build_element = function () {
        if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
            ...
            this.sine_wave_p1.x =
                this.c_x - (cache_2 >> 1) * global.cosine(Math.PI + this.theta_m90);
            this.sine_wave_p1.y =
                this.c_y - (cache_3 >> 1) * global.sine(Math.PI + this.theta_m90);
            this.sine_wave_p2.x =
                this.c_x + (cache_2 >> 1) * global.cosine(Math.PI + this.theta_m90);
            this.sine_wave_p2.y =
                this.c_y + (cache_3 >> 1) * global.sine(Math.PI + this.theta_m90);
    ...
    ACSource.prototype.resize = function () {
        if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
    ...
    ACSource.prototype.refactor = function () {
    ...
    ACSource.prototype.update = function () { };
    ACSource.prototype.increment_rotation = function () {
        this.elm.rotation++;
    ...
    ACSource.prototype.increment_flip = function () { };
    ACSource.prototype.map_rotation = function () {
        if (this.elm.rotation === global.ROTATION_0 ||
    ...
    ACSource.prototype.recolor = function () {
        if (global.selected) {
            if (global.selected_id === this.elm.id &&
                global.selected_type === this.elm.type) {
                ...
                this.point_paint.set_color(global.ELEMENT_COLOR);
                this.text_paint.set_color(global.ELEMENT_COLOR);
                this.sine_wave.set_color(global.ELEMENT_COLOR);
            }
        }
        else {
            if (this.MULTI_SELECTED) {
                ...
                this.sine_wave.set_color(global.MULTI_SELECTED_COLOR);
            }
            else {
                this.line_paint.set_color(global.ELEMENT_COLOR);
                this.point_paint.set_color(global.ELEMENT_COLOR);
    ...
    ACSource.prototype.is_selected_element = function () {
        return (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type);
    };
    /* Draws the component */
    ACSource.prototype.draw_component = function (canvas) {
    ...
    ACSource.prototype.patch = function () {
    ...
    ACSource.prototype.time_data = function () {
    ...
    ACSource.prototype.reset = function () { };
    return ACSource;
}());
