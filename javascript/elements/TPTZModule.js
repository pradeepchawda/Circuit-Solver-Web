 ...
 *
 * Purpose           : A class to handle the Two Pole Two Zero compensator block.
 *
 ...
 *
 ***********************************************************************/
var TPTZModule = /** @class */ (function () {
    function TPTZModule(type, id, n1, n2) {
      ...
      or overlapped)*/
        ...
        this.m_x = 0;
        this.m_y = 0;
        this.tptz_controller = new TPTZController([
            this.elm.properties['A1'],
            this.elm.properties['A2'],
            this.elm.properties['B0'],
            this.elm.properties['B1'],
            this.elm.properties['B2']
        ]);
        ...
        this.bounds = new RectF(0, 0, 0, 0);
        /* Inititalize the element2 class that will hold the basic data about our component */
        this.elm = new Element2(id, type, global.copy(global.PROPERTY_TPTZ));
    ...
    TPTZModule.prototype.refresh_bounds = function () {
        if (this.elm.consistent()) {
            this.p1 = new PointF(0, 0);
            this.p2 = new PointF(0, 0);
            /* Create some points to hold the node locations, this will be used for drawing components */
    ...
    TPTZModule.prototype.push_reference = function (ref) {
        this.wire_reference.push(ref);
    };
    TPTZModule.prototype.reset_tptz = function () {
        this.tptz_controller.set_initial(0);
        this.elm.properties['Output Voltage'] = 0;
    };
    /* General function to handle any processing required by the component */
    TPTZModule.prototype.update = function () {
        if (global.FLAG_SIMULATING &&
            ...
            if (this.elm.consistent()) {
                ...
                this.tptz_controller.set_tptz_coefficients([
                    this.elm.properties['A1'],
                    this.elm.properties['A2'],
                    this.elm.properties['B0'],
                    this.elm.properties['B1'],
    ...
    TPTZModule.prototype.stamp = function () {
        if (this.elm.consistent()) {
    ...
    TPTZModule.prototype.get_vertices = function () {
        var vertices = [];
        var p1 = [];
        var p2 = [];
    ...
    TPTZModule.prototype.release_wires = function () {
    ...
    TPTZModule.prototype.release_nodes = function () {
        if (this.elm.consistent()) {
    ...
    TPTZModule.prototype.capture_nodes = function () {
        var vertices = this.get_vertices();
        this.elm.map_node2(vertices[0], vertices[1], vertices[2], vertices[3]);
    ...
    TPTZModule.prototype.mouse_down = function () {
        if (global.FLAG_IDLE &&
    ...
    TPTZModule.prototype.handle_wire_builder = function (n, anchor) {
    ...
    TPTZModule.prototype.move_element = function (dx, dy) {
    ...
    TPTZModule.prototype.mouse_move = function () {
    ...
    TPTZModule.prototype.mouse_up = function () {
        if (global.FLAG_IDLE) {
            if (global.focused &&
                global.focused_id === this.elm.id &&
                global.focused_type === this.elm.type) {
    ...
    TPTZModule.prototype.select = function () {
        if (global.WIRE_BUILDER['step'] != 0) {
            wire_manager.reset_wire_builder();
        }
    ...
    TPTZModule.prototype.remove_focus = function () {
        if (global.focused &&
            global.focused_id === this.elm.id &&
            global.focused_type === this.elm.type) {
            global.focused_id = global.NULL;
    ...
    TPTZModule.prototype.remove_selection = function () {
        if (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type) {
            global.selected_id = global.NULL;
            global.selected_type = -1;
    ...
    TPTZModule.prototype.wire_reference_maintenance = function () {
    ...
    TPTZModule.prototype.unanchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    TPTZModule.prototype.anchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    TPTZModule.prototype.set_flip = function (flip) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    TPTZModule.prototype.set_rotation = function (rotation) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    TPTZModule.prototype.push_history = function () {
        if (this.INITIALIZED) {
            global.HISTORY_MANAGER['packet'].push(engine_functions.history_snapshot());
        }
    };
    /* Generate the SVG for the component. */
    TPTZModule.prototype.build_element = function () {
        if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
            ...
            this.tptz_4.y =
                this.c_y +
                    cache_5 * global.sine(this.theta) +
                    cache_5 * global.sine(this.theta_m90);
            this.tptz_5.x = this.c_x + cache_4 * global.cosine(this.theta);
            this.tptz_5.y = this.c_y + cache_5 * global.sine(this.theta);
    ...
    TPTZModule.prototype.resize = function () {
        if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
    ...
    TPTZModule.prototype.refactor = function () {
    ...
    TPTZModule.prototype.increment_rotation = function () {
        this.elm.rotation++;
    ...
    TPTZModule.prototype.increment_flip = function () { };
    TPTZModule.prototype.map_rotation = function () {
        if (this.elm.rotation === global.ROTATION_0 ||
    ...
    TPTZModule.prototype.recolor = function () {
        if (global.selected) {
            if (global.selected_id === this.elm.id &&
                global.selected_type === this.elm.type) {
    ...
    TPTZModule.prototype.is_selected_element = function () {
        return (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type);
    };
    /* Draws the component */
    TPTZModule.prototype.draw_component = function (canvas) {
    ...
    TPTZModule.prototype.patch = function () {
    ...
    TPTZModule.prototype.time_data = function () {
    ...
    TPTZModule.prototype.reset = function () {
        this.elm.properties['Output Voltage'] = 0;
    };
    return TPTZModule;
}());
