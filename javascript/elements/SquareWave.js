 ...
 *
 * Purpose           : A class to handle the square wave element. It will automatically generate
 ...
 *
 ***********************************************************************/
var SquareWave = /** @class */ (function () {
    function SquareWave(type, id, n1, n2) {
      ...
      or overlapped)*/
        ...
        this.bounds = new RectF(0, 0, 0, 0);
        /* Inititalize the element2 class that will hold the basic data about our component */
        this.elm = new Element2(id, type, global.copy(global.PROPERTY_SQUAREWAVE));
    ...
    SquareWave.prototype.refresh_bounds = function () {
        if (this.elm.consistent()) {
            this.p1 = new PointF(0, 0);
            this.p2 = new PointF(0, 0);
            /* Create some points to hold the node locations, this will be used for drawing components */
    ...
    SquareWave.prototype.push_reference = function (ref) {
        this.wire_reference.push(ref);
    };
    SquareWave.prototype.stamp = function () {
        if (this.elm.consistent()) {
            engine_functions.stamp_voltage(this.elm.n1, this.elm.n2, this.elm.properties['Offset'] +
                this.elm.properties['Voltage'] *
                    (global.wrap(global.SIMULATION_TIME, 1.0 / this.elm.properties['Frequency']) <
                        this.elm.properties['Duty'] *
                            0.01 *
                            (1.0 / this.elm.properties['Frequency'])
                        ? 1
                        : 0), simulation_manager.ELEMENT_SQUAREWAVE_OFFSET + this.simulation_id);
        }
    };
    /* Vertex handling (for rotation) */
    SquareWave.prototype.get_vertices = function () {
        var vertices = [];
        var p1 = [];
        var p2 = [];
    ...
    SquareWave.prototype.release_wires = function () {
    ...
    SquareWave.prototype.release_nodes = function () {
        if (this.elm.consistent()) {
    ...
    SquareWave.prototype.capture_nodes = function () {
        var vertices = this.get_vertices();
        this.elm.map_node2(vertices[0], vertices[1], vertices[2], vertices[3]);
    ...
    SquareWave.prototype.mouse_down = function () {
        if (global.FLAG_IDLE &&
    ...
    SquareWave.prototype.handle_wire_builder = function (n, anchor) {
    ...
    SquareWave.prototype.move_element = function (dx, dy) {
    ...
    SquareWave.prototype.mouse_move = function () {
    ...
    SquareWave.prototype.mouse_up = function () {
        if (global.FLAG_IDLE) {
            if (global.focused &&
                global.focused_id === this.elm.id &&
                global.focused_type === this.elm.type) {
    ...
    SquareWave.prototype.select = function () {
        if (global.WIRE_BUILDER['step'] != 0) {
            wire_manager.reset_wire_builder();
        }
    ...
    SquareWave.prototype.remove_focus = function () {
        if (global.focused &&
            global.focused_id === this.elm.id &&
            global.focused_type === this.elm.type) {
            global.focused_id = global.NULL;
    ...
    SquareWave.prototype.remove_selection = function () {
        if (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type) {
            global.selected_id = global.NULL;
            global.selected_type = global.NULL;
    ...
    SquareWave.prototype.wire_reference_maintenance = function () {
    ...
    SquareWave.prototype.unanchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    SquareWave.prototype.anchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    SquareWave.prototype.set_flip = function (flip) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    SquareWave.prototype.set_rotation = function (rotation) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    SquareWave.prototype.push_history = function () {
        if (this.INITIALIZED) {
            global.HISTORY_MANAGER['packet'].push(engine_functions.history_snapshot());
        }
    };
    /* Generate the SVG for the component. */
    SquareWave.prototype.build_element = function () {
        if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
            ...
            this.sq_0.y = this.c_y - (cache_2 >> 2) * global.sine(this.theta);
            this.sq_1.x = this.c_x + (cache_2 >> 2) * global.cosine(this.theta);
            this.sq_1.y = this.c_y + (cache_2 >> 2) * global.sine(this.theta);
            this.sq_2.x =
                this.sq_0.x + (cache_2 >> 1) * global.cosine(this.theta_m90);
            this.sq_2.y = this.sq_0.y + (cache_2 >> 1) * global.sine(this.theta_m90);
            this.sq_3.x =
                this.sq_0.x - (cache_2 >> 1) * global.cosine(this.theta_m90);
            this.sq_3.y = this.sq_0.y - (cache_2 >> 1) * global.sine(this.theta_m90);
            this.sq_4.x =
                this.sq_1.x + (cache_2 >> 1) * global.cosine(this.theta_m90);
            this.sq_4.y = this.sq_1.y + (cache_2 >> 1) * global.sine(this.theta_m90);
            this.sq_5.x =
                this.sq_1.x - (cache_2 >> 1) * global.cosine(this.theta_m90);
            this.sq_5.y = this.sq_1.y - (cache_2 >> 1) * global.sine(this.theta_m90);
    ...
    SquareWave.prototype.resize = function () {
        if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
    ...
    SquareWave.prototype.refactor = function () {
    ...
    SquareWave.prototype.update = function () { };
    SquareWave.prototype.increment_rotation = function () {
        this.elm.rotation++;
    ...
    SquareWave.prototype.increment_flip = function () { };
    SquareWave.prototype.map_rotation = function () {
        if (this.elm.rotation === global.ROTATION_0 ||
    ...
    SquareWave.prototype.recolor = function () {
        if (global.selected) {
            if (global.selected_id === this.elm.id &&
                global.selected_type === this.elm.type) {
    ...
    SquareWave.prototype.is_selected_element = function () {
        return (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type);
    };
    /* Draws the component */
    SquareWave.prototype.draw_component = function (canvas) {
    ...
    SquareWave.prototype.patch = function () {
    ...
    SquareWave.prototype.time_data = function () {
    ...
    SquareWave.prototype.reset = function () { };
    return SquareWave;
}());
