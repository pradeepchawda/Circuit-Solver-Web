 ...
 *
 * Purpose           : A class to handle the Gain (Voltage) element. It will automatically generate
 ...
 *
 ***********************************************************************/
var GainBlock = /** @class */ (function () {
    function GainBlock(type, id, n1, n2) {
      ...
      or overlapped)*/
        ...
        this.bounds = new RectF(0, 0, 0, 0);
        /* Inititalize the element2 class that will hold the basic data about our component */
        this.elm = new Element2(id, type, global.copy(global.PROPERTY_GAIN));
    ...
    GainBlock.prototype.refresh_bounds = function () {
        if (this.elm.consistent()) {
            this.p1 = new PointF(0, 0);
            this.p2 = new PointF(0, 0);
            /* Create some points to hold the node locations, this will be used for drawing components */
    ...
    GainBlock.prototype.push_reference = function (ref) {
        this.wire_reference.push(ref);
    };
    /* General function to handle any processing required by the component */
    GainBlock.prototype.update = function () {
        if (global.FLAG_SIMULATING &&
            ...
            if (this.elm.consistent()) {
                ...
                this.elm.properties['Output Voltage'] =
                    this.elm.properties['Input Voltage'] * this.elm.properties['Gain'];
            }
        }
    };
    GainBlock.prototype.stamp = function () {
        if (this.elm.consistent()) {
    ...
    GainBlock.prototype.get_vertices = function () {
        var vertices = [];
        var p1 = [];
        var p2 = [];
    ...
    GainBlock.prototype.release_wires = function () {
    ...
    GainBlock.prototype.release_nodes = function () {
        if (this.elm.consistent()) {
    ...
    GainBlock.prototype.capture_nodes = function () {
        var vertices = this.get_vertices();
        this.elm.map_node2(vertices[0], vertices[1], vertices[2], vertices[3]);
    ...
    GainBlock.prototype.mouse_down = function () {
        if (global.FLAG_IDLE &&
    ...
    GainBlock.prototype.handle_wire_builder = function (n, anchor) {
    ...
    GainBlock.prototype.move_element = function (dx, dy) {
    ...
    GainBlock.prototype.mouse_move = function () {
    ...
    GainBlock.prototype.mouse_up = function () {
        if (global.FLAG_IDLE) {
            if (global.focused &&
                global.focused_id === this.elm.id &&
                global.focused_type === this.elm.type) {
    ...
    GainBlock.prototype.select = function () {
        if (global.WIRE_BUILDER['step'] != 0) {
            wire_manager.reset_wire_builder();
        }
    ...
    GainBlock.prototype.remove_focus = function () {
        if (global.focused &&
            global.focused_id === this.elm.id &&
            global.focused_type === this.elm.type) {
            global.focused_id = global.NULL;
    ...
    GainBlock.prototype.remove_selection = function () {
        if (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type) {
            global.selected_id = global.NULL;
            global.selected_type = -1;
    ...
    GainBlock.prototype.wire_reference_maintenance = function () {
    ...
    GainBlock.prototype.unanchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    GainBlock.prototype.anchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    GainBlock.prototype.set_flip = function (flip) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    GainBlock.prototype.set_rotation = function (rotation) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    GainBlock.prototype.push_history = function () {
        if (this.INITIALIZED) {
            global.HISTORY_MANAGER['packet'].push(engine_functions.history_snapshot());
        }
    };
    /* Generate the SVG for the component. */
    GainBlock.prototype.build_element = function () {
    ...
    GainBlock.prototype.resize = function () {
        if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
    ...
    GainBlock.prototype.refactor = function () {
    ...
    GainBlock.prototype.increment_rotation = function () {
        this.elm.rotation++;
    ...
    GainBlock.prototype.map_rotation = function () {
        if (this.elm.rotation === global.ROTATION_0 ||
    ...
    GainBlock.prototype.increment_flip = function () { };
    GainBlock.prototype.recolor = function () {
        if (global.selected) {
            if (global.selected_id === this.elm.id &&
                global.selected_type === this.elm.type) {
    ...
    GainBlock.prototype.is_selected_element = function () {
        return (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type);
    };
    /* Draws the component */
    GainBlock.prototype.draw_component = function (canvas) {
    ...
    GainBlock.prototype.patch = function () {
    ...
    GainBlock.prototype.time_data = function () {
    ...
    GainBlock.prototype.reset = function () {
