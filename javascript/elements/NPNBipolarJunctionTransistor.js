 ...
 *
 ***********************************************************************/
var NPNBipolarJunctionTransistor = /** @class */ (function () {
    function NPNBipolarJunctionTransistor(type, id, n1, n2, n3) {
    ...
    NPNBipolarJunctionTransistor.prototype.refresh_bounds = function () {
        if (this.elm.consistent()) {
            this.p1 = new PointF(0, 0);
            this.p2 = new PointF(0, 0);
            this.p3 = new PointF(0, 0);
    ...
    NPNBipolarJunctionTransistor.prototype.push_reference = function (ref) {
        this.wire_reference.push(ref);
    };
    NPNBipolarJunctionTransistor.prototype.stamp = function () {
        if (this.elm.consistent()) {
            var b = global.copy(this.elm.n3);
            var c = global.copy(this.elm.n1);
            var e = global.copy(this.elm.n2);
    ...
    NPNBipolarJunctionTransistor.prototype.calculate_vcrit = function () {
    ...
    NPNBipolarJunctionTransistor.prototype.is_converged = function () {
    ...
    NPNBipolarJunctionTransistor.prototype.reset_npn = function () {
    ...
    NPNBipolarJunctionTransistor.prototype.get_npnbjt_error = function () {
        return Math.abs(this.elm.properties['Vbe'] - this.elm.properties['Last Vbe']);
    };
    /* General function to handle any processing required by the component */
    NPNBipolarJunctionTransistor.prototype.update = function () {
        if (global.FLAG_SIMULATING && simulation_manager.SOLUTIONS_READY) {
            if (this.elm.consistent()) {
                ...
                /* Derive Vbe safely. */
                var next_vbe = engine_functions.get_voltage(this.elm.n3, this.elm.n2);
                ...
                /* Derive Vbc safely. */
                var next_vbc = engine_functions.get_voltage(this.elm.n3, this.elm.n1);
                var vbc = 0;
                ...
                this.elm.properties['g_ee'] =
                    (this.elm.properties['Saturation Current'] / global.vt) *
                        Math.exp(this.elm.properties['Vbe'] / global.vt);
                this.elm.properties['g_ec'] =
                    reverse_alpha *
                        (this.elm.properties['Saturation Current'] / global.vt) *
                        Math.exp(this.elm.properties['Vbc'] / global.vt);
                ...
                this.elm.properties['i_e'] =
                    -this.elm.properties['Saturation Current'] *
                        (Math.exp(this.elm.properties['Vbe'] / global.vt) - 1) +
                        reverse_alpha *
                            this.elm.properties['Saturation Current'] *
                            (Math.exp(this.elm.properties['Vbc'] / global.vt) - 1);
                ...
                this.elm.properties['I_e'] =
                    this.elm.properties['i_e'] +
                        this.elm.properties['g_ee'] * this.elm.properties['Vbe'] -
                        this.elm.properties['g_ec'] * this.elm.properties['Vbc'];
                this.elm.properties['I_c'] =
                    this.elm.properties['i_c'] -
                        this.elm.properties['g_ce'] * this.elm.properties['Vbe'] +
                        this.elm.properties['g_cc'] * this.elm.properties['Vbc'];
            }
        }
    };
    NPNBipolarJunctionTransistor.prototype.gmin_step = function (step, error) {
    ...
    NPNBipolarJunctionTransistor.prototype.get_vertices = function () {
        var vertices = [];
        var p1 = [];
        var p2 = [];
        var p3 = [];
    ...
    NPNBipolarJunctionTransistor.prototype.release_wires = function () {
    ...
    NPNBipolarJunctionTransistor.prototype.release_nodes = function () {
        if (this.elm.consistent()) {
    ...
    NPNBipolarJunctionTransistor.prototype.capture_nodes = function () {
        var vertices = this.get_vertices();
        this.elm.map_node3(vertices[0], vertices[1], vertices[2], vertices[3], vertices[4], vertices[5]);
    ...
    NPNBipolarJunctionTransistor.prototype.mouse_down = function () {
        if (global.FLAG_IDLE &&
    ...
    NPNBipolarJunctionTransistor.prototype.handle_wire_builder = function (n, anchor) {
    ...
    NPNBipolarJunctionTransistor.prototype.move_element = function (dx, dy) {
    ...
    NPNBipolarJunctionTransistor.prototype.mouse_move = function () {
    ...
    NPNBipolarJunctionTransistor.prototype.mouse_up = function () {
        if (global.FLAG_IDLE) {
            if (global.focused &&
                global.focused_id === this.elm.id &&
                global.focused_type === this.elm.type) {
    ...
    NPNBipolarJunctionTransistor.prototype.select = function () {
        if (global.WIRE_BUILDER['step'] != 0) {
            wire_manager.reset_wire_builder();
        }
    ...
    NPNBipolarJunctionTransistor.prototype.remove_focus = function () {
        if (global.focused &&
            global.focused_id === this.elm.id &&
            global.focused_type === this.elm.type) {
            global.focused_id = global.NULL;
    ...
    NPNBipolarJunctionTransistor.prototype.remove_selection = function () {
        if (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type) {
            global.selected_id = global.NULL;
            global.selected_type = global.NULL;
    ...
    NPNBipolarJunctionTransistor.prototype.wire_reference_maintenance = function () {
    ...
    NPNBipolarJunctionTransistor.prototype.unanchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    NPNBipolarJunctionTransistor.prototype.anchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    NPNBipolarJunctionTransistor.prototype.set_flip = function (flip) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    NPNBipolarJunctionTransistor.prototype.set_rotation = function (rotation) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    NPNBipolarJunctionTransistor.prototype.push_history = function () {
        if (this.INITIALIZED) {
            global.HISTORY_MANAGER['packet'].push(engine_functions.history_snapshot());
        }
    };
    /* Generate the SVG for the component. */
    NPNBipolarJunctionTransistor.prototype.build_element = function () {
    ...
    NPNBipolarJunctionTransistor.prototype.resize = function () {
        if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
    ...
    NPNBipolarJunctionTransistor.prototype.refactor = function () {
    ...
    NPNBipolarJunctionTransistor.prototype.increment_rotation = function () {
        this.elm.rotation++;
    ...
    NPNBipolarJunctionTransistor.prototype.increment_flip = function () {
        this.elm.flip++;
        if (this.elm.flip > global.FLIP_180) {
    ...
    NPNBipolarJunctionTransistor.prototype.recolor = function () {
        if (global.selected) {
            if (global.selected_id === this.elm.id &&
                global.selected_type === this.elm.type) {
    ...
    NPNBipolarJunctionTransistor.prototype.is_selected_element = function () {
        return (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type);
    };
    /* Draws the component */
    NPNBipolarJunctionTransistor.prototype.draw_component = function (canvas) {
    ...
    NPNBipolarJunctionTransistor.prototype.patch = function () {
    ...
    NPNBipolarJunctionTransistor.prototype.time_data = function () {
    ...
    NPNBipolarJunctionTransistor.prototype.reset = function () { };
    return NPNBipolarJunctionTransistor;
}());
