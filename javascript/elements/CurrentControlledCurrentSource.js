 ...
 * File		        : CurrentControlledCurrentSource.js
 * Author            : nboatengc
 * Date created      : 20190928
 *
 * Purpose           : A class to handle the Current Controlled Current Source element. It will automatically generate
 ...
 *
 ***********************************************************************/
var CurrentControlledCurrentSource = /** @class */ (function () {
    function CurrentControlledCurrentSource(type, id, n1, n2, n3, n4) {
    ...
    CurrentControlledCurrentSource.prototype.refresh_bounds = function () {
        if (this.elm.consistent()) {
            this.p1 = new PointF(0, 0);
            this.p2 = new PointF(0, 0);
            this.p3 = new PointF(0, 0);
    ...
    CurrentControlledCurrentSource.prototype.push_reference = function (ref) {
        this.wire_reference.push(ref);
    };
    /* General function to handle any processing required by the component */
    CurrentControlledCurrentSource.prototype.update = function () { };
    CurrentControlledCurrentSource.prototype.stamp = function () {
        if (this.elm.consistent()) {
    ...
    CurrentControlledCurrentSource.prototype.get_vertices = function () {
        var vertices = [];
        var p1 = [];
        var p2 = [];
        var p3 = [];
    ...
    CurrentControlledCurrentSource.prototype.release_wires = function () {
    ...
    CurrentControlledCurrentSource.prototype.release_nodes = function () {
        if (this.elm.consistent()) {
    ...
    CurrentControlledCurrentSource.prototype.capture_nodes = function () {
        var vertices = this.get_vertices();
        this.elm.map_node4(vertices[0], vertices[1], vertices[2], vertices[3], vertices[4], vertices[5], vertices[6], vertices[7]);
    ...
    CurrentControlledCurrentSource.prototype.mouse_down = function () {
        if (global.FLAG_IDLE &&
    ...
    CurrentControlledCurrentSource.prototype.handle_wire_builder = function (n, anchor) {
    ...
    CurrentControlledCurrentSource.prototype.move_element = function (dx, dy) {
    ...
    CurrentControlledCurrentSource.prototype.mouse_move = function () {
    ...
    CurrentControlledCurrentSource.prototype.mouse_up = function () {
        if (global.FLAG_IDLE) {
            if (global.focused &&
                global.focused_id === this.elm.id &&
                global.focused_type === this.elm.type) {
    ...
    CurrentControlledCurrentSource.prototype.select = function () {
        if (global.WIRE_BUILDER['step'] != 0) {
            wire_manager.reset_wire_builder();
        }
    ...
    CurrentControlledCurrentSource.prototype.remove_focus = function () {
        if (global.focused &&
            global.focused_id === this.elm.id &&
            global.focused_type === this.elm.type) {
            global.focused_id = global.NULL;
    ...
    CurrentControlledCurrentSource.prototype.remove_selection = function () {
        if (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type) {
            global.selected_id = global.NULL;
            global.selected_type = -1;
    ...
    CurrentControlledCurrentSource.prototype.wire_reference_maintenance = function () {
    ...
    CurrentControlledCurrentSource.prototype.unanchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    CurrentControlledCurrentSource.prototype.anchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    CurrentControlledCurrentSource.prototype.set_flip = function (flip) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    CurrentControlledCurrentSource.prototype.set_rotation = function (rotation) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    CurrentControlledCurrentSource.prototype.push_history = function () {
        if (this.INITIALIZED) {
            global.HISTORY_MANAGER['packet'].push(engine_functions.history_snapshot());
        }
    };
    /* Generate the SVG for the component. */
    CurrentControlledCurrentSource.prototype.build_element = function () {
        if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
            ...
            var cache_8 = 2.25 * this.x_space;
            var cache_9 = 2.25 * this.y_space;
            var cache_10 = 1.5 * this.x_space;
            var cache_11 = 1.5 * this.y_space;
            ...
            this.cccs_5.x =
                this.cccs_4.x + cache_2 * global.cosine(this.theta - global.PI_DIV_4);
            this.cccs_5.y =
                this.cccs_4.y + cache_3 * global.sine(this.theta - global.PI_DIV_4);
            this.cccs_6.x =
                this.cccs_4.x + cache_2 * global.cosine(this.theta + global.PI_DIV_4);
            this.cccs_6.y =
                this.cccs_4.y + cache_3 * global.sine(this.theta + global.PI_DIV_4);
            ...
            this.cccs_8.x =
                this.cccs_7.x - cache_2 * global.cosine(this.theta - global.PI_DIV_4);
            this.cccs_8.y =
                this.cccs_7.y - cache_3 * global.sine(this.theta - global.PI_DIV_4);
            this.cccs_9.x =
                this.cccs_7.x - cache_2 * global.cosine(this.theta + global.PI_DIV_4);
            this.cccs_9.y =
                this.cccs_7.y - cache_3 * global.sine(this.theta + global.PI_DIV_4);
    ...
    CurrentControlledCurrentSource.prototype.resize = function () {
        if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
    ...
    CurrentControlledCurrentSource.prototype.refactor = function () {
    ...
    CurrentControlledCurrentSource.prototype.increment_rotation = function () {
        this.elm.rotation++;
    ...
    CurrentControlledCurrentSource.prototype.increment_flip = function () { };
    CurrentControlledCurrentSource.prototype.recolor = function () {
        if (global.selected) {
            if (global.selected_id === this.elm.id &&
                global.selected_type === this.elm.type) {
    ...
    CurrentControlledCurrentSource.prototype.is_selected_element = function () {
        return (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type);
    };
    /* Draws the component */
    CurrentControlledCurrentSource.prototype.draw_component = function (canvas) {
    ...
    CurrentControlledCurrentSource.prototype.patch = function () {
    ...
    CurrentControlledCurrentSource.prototype.time_data = function () {
    ...
    CurrentControlledCurrentSource.prototype.reset = function () { };
