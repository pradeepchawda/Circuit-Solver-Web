...
class CurrentControlledCurrentSource {
    constructor(type, id, n1, n2, n3, n4) {
        ...
        this.elm = new Element4(id, type, global.utils.copy(global.PROPERTY_CCCS));
    ...
    build_element() {
        if (this.build_element_flag || global.flags.signal_build_element) {
            ...
            this.cccs_5.x = this.cccs_4.x + cache_2 * global.utils.cosine(this.theta - global.PI_DIV_4);
            this.cccs_5.y = this.cccs_4.y + cache_3 * global.utils.sine(this.theta - global.PI_DIV_4);
            this.cccs_6.x = this.cccs_4.x + cache_2 * global.utils.cosine(this.theta + global.PI_DIV_4);
            this.cccs_6.y = this.cccs_4.y + cache_3 * global.utils.sine(this.theta + global.PI_DIV_4);
            ...
            this.cccs_8.x = this.cccs_7.x - cache_2 * global.utils.cosine(this.theta - global.PI_DIV_4);
            this.cccs_8.y = this.cccs_7.y - cache_3 * global.utils.sine(this.theta - global.PI_DIV_4);
            this.cccs_9.x = this.cccs_7.x - cache_2 * global.utils.cosine(this.theta + global.PI_DIV_4);
            this.cccs_9.y = this.cccs_7.y - cache_3 * global.utils.sine(this.theta + global.PI_DIV_4);
            ...
            this.cccs_16.x = this.p1.x + cache_12 * global.utils.cosine(this.theta_m90 + global.PI_DIV_4);
            this.cccs_16.y = this.p1.y + cache_13 * global.utils.sine(this.theta_m90 + global.PI_DIV_4);
        ...
        if (global.flags.picture_request_flag ||
            ...
            if (global.variables.workspace_zoom_scale > 1.085 || (!global.CONSTANTS.MOBILE_MODE && global.variables.workspace_zoom_scale >= 0.99)) {
                ...
                if ((this.angle > 170 && this.angle < 190) || (this.angle > -10 && this.angle < 10)) {
                    ...
                    canvas.draw_text(global.ELEMENT_VAL_TEMPLATE.replace('{VAL}', global.utils.exponentiate_quickly(this.elm.properties['Gain'])).replace('{UNIT}', this.elm.properties['units']), this.c_x, this.bounds.top - this.bounds.get_height() * 0.15, this.text_paint);
