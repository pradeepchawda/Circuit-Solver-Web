 ...
 *
 * Purpose           : A class to handle the DAC (Digital to Analog Converter) element. It will automatically generate
 ...
 *
 ***********************************************************************/
var DACModule = /** @class */ (function () {
    function DACModule(type, id, n1, n2) {
      ...
      or overlapped)*/
        ...
        this.bounds = new RectF(0, 0, 0, 0);
        /* Inititalize the element2 class that will hold the basic data about our component */
        this.elm = new Element2(id, type, global.copy(global.PROPERTY_DAC));
    ...
    DACModule.prototype.refresh_bounds = function () {
        if (this.elm.consistent()) {
            this.p1 = new PointF(0, 0);
            this.p2 = new PointF(0, 0);
            /* Create some points to hold the node locations, this will be used for drawing components */
    ...
    DACModule.prototype.push_reference = function (ref) {
        this.wire_reference.push(ref);
    };
    /* General function to handle any processing required by the component */
    DACModule.prototype.update = function () {
        if (global.FLAG_SIMULATING &&
            ...
            if (this.elm.consistent()) {
                ...
                this.elm.properties['Max Bits'] =
                    Math.pow(2, this.elm.properties['Bit Resolution']) - 1;
                this.elm.properties['LSB'] =
                    this.elm.properties['Reference Voltage'] /
                        this.elm.properties['Max Bits'];
                this.elm.properties['Output Voltage'] = global.limit(this.elm.properties['Input Voltage'] * this.elm.properties['LSB'], 0, this.elm.properties['Reference Voltage'] - this.elm.properties['LSB']);
            }
        }
    };
    DACModule.prototype.stamp = function () {
        if (this.elm.consistent()) {
    ...
    DACModule.prototype.get_vertices = function () {
        var vertices = [];
        var p1 = [];
        var p2 = [];
    ...
    DACModule.prototype.release_wires = function () {
    ...
    DACModule.prototype.release_nodes = function () {
        if (this.elm.consistent()) {
    ...
    DACModule.prototype.capture_nodes = function () {
        var vertices = this.get_vertices();
        this.elm.map_node2(vertices[0], vertices[1], vertices[2], vertices[3]);
    ...
    DACModule.prototype.mouse_down = function () {
        if (global.FLAG_IDLE &&
    ...
    DACModule.prototype.handle_wire_builder = function (n, anchor) {
    ...
    DACModule.prototype.move_element = function (dx, dy) {
    ...
    DACModule.prototype.mouse_move = function () {
    ...
    DACModule.prototype.mouse_up = function () {
        if (global.FLAG_IDLE) {
            if (global.focused &&
                global.focused_id === this.elm.id &&
                global.focused_type === this.elm.type) {
    ...
    DACModule.prototype.select = function () {
        if (global.WIRE_BUILDER['step'] != 0) {
            wire_manager.reset_wire_builder();
        }
    ...
    DACModule.prototype.remove_focus = function () {
        if (global.focused &&
            global.focused_id === this.elm.id &&
            global.focused_type === this.elm.type) {
            global.focused_id = global.NULL;
    ...
    DACModule.prototype.remove_selection = function () {
        if (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type) {
            global.selected_id = global.NULL;
            global.selected_type = global.NULL;
    ...
    DACModule.prototype.wire_reference_maintenance = function () {
    ...
    DACModule.prototype.unanchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    DACModule.prototype.anchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    DACModule.prototype.set_flip = function (flip) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    DACModule.prototype.set_rotation = function (rotation) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    DACModule.prototype.push_history = function () {
        if (this.INITIALIZED) {
            global.HISTORY_MANAGER['packet'].push(engine_functions.history_snapshot());
        }
    };
    /* Generate the SVG for the component. */
    DACModule.prototype.build_element = function () {
        if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
            ...
            this.dac_4.y =
                this.c_y +
                    cache_5 * global.sine(this.theta) +
                    cache_5 * global.sine(this.theta_m90);
            this.dac_5.x = this.c_x + cache_4 * global.cosine(this.theta);
            this.dac_5.y = this.c_y + cache_5 * global.sine(this.theta);
    ...
    DACModule.prototype.resize = function () {
        if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
    ...
    DACModule.prototype.refactor = function () {
    ...
    DACModule.prototype.increment_rotation = function () {
        this.elm.rotation++;
    ...
    DACModule.prototype.increment_flip = function () { };
    DACModule.prototype.map_rotation = function () {
        if (this.elm.rotation === global.ROTATION_0 ||
    ...
    DACModule.prototype.recolor = function () {
        if (global.selected) {
            if (global.selected_id === this.elm.id &&
                global.selected_type === this.elm.type) {
    ...
    DACModule.prototype.is_selected_element = function () {
        return (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type);
    };
    /* Draws the component */
    DACModule.prototype.draw_component = function (canvas) {
    ...
    DACModule.prototype.patch = function () {
    ...
    DACModule.prototype.time_data = function () {
    ...
    DACModule.prototype.reset = function () {
