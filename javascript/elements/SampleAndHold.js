 ...
 * File		        : SampleAndHold.js
 * Author            : nboatengc
 * Date created      : 20190928
 *
 * Purpose           : A class to handle the Sample and Hold element. It will automatically generate
 ...
 *
 ***********************************************************************/
var SampleAndHold = /** @class */ (function () {
    function SampleAndHold(type, id, n1, n2, n3) {
    ...
    SampleAndHold.prototype.refresh_bounds = function () {
        if (this.elm.consistent()) {
            this.p1 = new PointF(0, 0);
            this.p2 = new PointF(0, 0);
            this.p3 = new PointF(0, 0);
    ...
    SampleAndHold.prototype.push_reference = function (ref) {
        this.wire_reference.push(ref);
    };
    SampleAndHold.prototype.reset_samplers = function () {
        this.elm.properties['Output Voltage'] = 0;
    };
    /* General function to handle any processing required by the component */
    SampleAndHold.prototype.update = function () {
    ...
    SampleAndHold.prototype.stamp = function () {
        if (this.elm.consistent()) {
    ...
    SampleAndHold.prototype.get_vertices = function () {
        var vertices = [];
        var p1 = [];
        var p2 = [];
        var p3 = [];
    ...
    SampleAndHold.prototype.release_wires = function () {
    ...
    SampleAndHold.prototype.release_nodes = function () {
        if (this.elm.consistent()) {
    ...
    SampleAndHold.prototype.capture_nodes = function () {
        var vertices = this.get_vertices();
        this.elm.map_node3(vertices[0], vertices[1], vertices[2], vertices[3], vertices[4], vertices[5]);
    ...
    SampleAndHold.prototype.mouse_down = function () {
        if (global.FLAG_IDLE &&
    ...
    SampleAndHold.prototype.handle_wire_builder = function (n, anchor) {
    ...
    SampleAndHold.prototype.move_element = function (dx, dy) {
    ...
    SampleAndHold.prototype.mouse_move = function () {
    ...
    SampleAndHold.prototype.mouse_up = function () {
        if (global.FLAG_IDLE) {
            if (global.focused &&
                global.focused_id === this.elm.id &&
                global.focused_type === this.elm.type) {
    ...
    SampleAndHold.prototype.select = function () {
        if (global.WIRE_BUILDER['step'] != 0) {
            wire_manager.reset_wire_builder();
        }
    ...
    SampleAndHold.prototype.remove_focus = function () {
        if (global.focused &&
            global.focused_id === this.elm.id &&
            global.focused_type === this.elm.type) {
            global.focused_id = global.NULL;
    ...
    SampleAndHold.prototype.remove_selection = function () {
        if (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type) {
            global.selected_id = global.NULL;
            global.selected_type = -1;
    ...
    SampleAndHold.prototype.wire_reference_maintenance = function () {
    ...
    SampleAndHold.prototype.unanchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    SampleAndHold.prototype.anchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    SampleAndHold.prototype.set_flip = function (flip) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    SampleAndHold.prototype.set_rotation = function (rotation) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    SampleAndHold.prototype.push_history = function () {
        if (this.INITIALIZED) {
            global.HISTORY_MANAGER['packet'].push(engine_functions.history_snapshot());
        }
    };
    /* Generate the SVG for the component. */
    SampleAndHold.prototype.build_element = function () {
        if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
            ...
            this.sah_2.x =
                this.sah_1.x + cache_2 * global.cosine(this.theta - Math.PI);
    ...
    SampleAndHold.prototype.resize = function () {
        if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
    ...
    SampleAndHold.prototype.refactor = function () {
    ...
    SampleAndHold.prototype.increment_rotation = function () {
        this.elm.rotation++;
    ...
    SampleAndHold.prototype.increment_flip = function () {
        this.elm.flip++;
    ...
    SampleAndHold.prototype.recolor = function () {
        if (global.selected) {
            if (global.selected_id === this.elm.id &&
                global.selected_type === this.elm.type) {
    ...
    SampleAndHold.prototype.is_selected_element = function () {
        return (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type);
    };
    /* Draws the component */
    SampleAndHold.prototype.draw_component = function (canvas) {
    ...
    SampleAndHold.prototype.patch = function () {
    ...
    SampleAndHold.prototype.time_data = function () {
    ...
    SampleAndHold.prototype.reset = function () {
        this.elm.properties['Output Voltage'] = 0;
    };
