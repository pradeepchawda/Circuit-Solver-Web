...
class SampleAndHold {
    constructor(type, id, n1, n2, n3) {
        ...
        this.elm = new Element3(id, type, global.utils.copy(global.PROPERTY_SAH));
    ...
    build_element() {
        if (this.build_element_flag || global.flags.signal_build_element) {
            ...
            if (this.elm.flip === global.FLIP_0) {
                this.sah_7.x = this.p1.x + cache_4 * global.utils.cosine(this.theta_m90 + global.PI_DIV_4);
                this.sah_7.y = this.p1.y + cache_5 * global.utils.sine(this.theta_m90 + global.PI_DIV_4);
                this.sah_8.x = this.p2.x + cache_4 * global.utils.cosine(this.theta_m90 - global.PI_DIV_4);
                this.sah_8.y = this.p2.y + cache_5 * global.utils.sine(this.theta_m90 - global.PI_DIV_4);
            }
            else if (this.elm.flip === global.FLIP_180) {
                this.sah_7.x = this.p1.x + cache_4 * global.utils.cosine(this.theta_m90 - global.PI_DIV_4);
                this.sah_7.y = this.p1.y + cache_5 * global.utils.sine(this.theta_m90 - global.PI_DIV_4);
