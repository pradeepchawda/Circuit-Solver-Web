 ...
 * File		        : HighPassFilter.js
 * Author            : nboatengc
 * Date created      : 20190928
 *
 * Purpose           : A class to handle the High Pass Filter element. It will automatically generate
 ...
 *
 ***********************************************************************/
var HighPassFilter = /** @class */ (function () {
    function HighPassFilter(type, id, n1, n2) {
    ...
    HighPassFilter.prototype.refresh_bounds = function () {
        if (this.elm.consistent()) {
            this.p1 = new PointF(0, 0);
            this.p2 = new PointF(0, 0);
            /* Create some points to hold the node locations, this will be used for drawing components */
    ...
    HighPassFilter.prototype.push_reference = function (ref) {
        this.wire_reference.push(ref);
    };
    HighPassFilter.prototype.reset_highpass = function () {
    ...
    HighPassFilter.prototype.update = function () {
    ...
    HighPassFilter.prototype.stamp = function () {
        if (this.elm.consistent()) {
    ...
    HighPassFilter.prototype.highpass_filter = function (input) {
    ...
    HighPassFilter.prototype.get_vertices = function () {
        var vertices = [];
        var p1 = [];
        var p2 = [];
    ...
    HighPassFilter.prototype.release_wires = function () {
    ...
    HighPassFilter.prototype.release_nodes = function () {
        if (this.elm.consistent()) {
    ...
    HighPassFilter.prototype.capture_nodes = function () {
        var vertices = this.get_vertices();
        this.elm.map_node2(vertices[0], vertices[1], vertices[2], vertices[3]);
    ...
    HighPassFilter.prototype.mouse_down = function () {
        if (global.FLAG_IDLE &&
    ...
    HighPassFilter.prototype.handle_wire_builder = function (n, anchor) {
    ...
    HighPassFilter.prototype.move_element = function (dx, dy) {
    ...
    HighPassFilter.prototype.mouse_move = function () {
    ...
    HighPassFilter.prototype.mouse_up = function () {
        if (global.FLAG_IDLE) {
            if (global.focused &&
                global.focused_id === this.elm.id &&
                global.focused_type === this.elm.type) {
    ...
    HighPassFilter.prototype.select = function () {
        if (global.WIRE_BUILDER['step'] != 0) {
            wire_manager.reset_wire_builder();
        }
    ...
    HighPassFilter.prototype.remove_focus = function () {
        if (global.focused &&
            global.focused_id === this.elm.id &&
            global.focused_type === this.elm.type) {
            global.focused_id = global.NULL;
    ...
    HighPassFilter.prototype.remove_selection = function () {
        if (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type) {
            global.selected_id = global.NULL;
            global.selected_type = -1;
    ...
    HighPassFilter.prototype.wire_reference_maintenance = function () {
    ...
    HighPassFilter.prototype.unanchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    HighPassFilter.prototype.anchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    HighPassFilter.prototype.set_flip = function (flip) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    HighPassFilter.prototype.set_rotation = function (rotation) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    HighPassFilter.prototype.push_history = function () {
        if (this.INITIALIZED) {
            global.HISTORY_MANAGER['packet'].push(engine_functions.history_snapshot());
        }
    };
    /* Generate the SVG for the component. */
    HighPassFilter.prototype.build_element = function () {
    ...
    HighPassFilter.prototype.resize = function () {
        if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
    ...
    HighPassFilter.prototype.refactor = function () {
    ...
    HighPassFilter.prototype.increment_rotation = function () {
        this.elm.rotation++;
    ...
    HighPassFilter.prototype.increment_flip = function () { };
    HighPassFilter.prototype.map_rotation = function () {
        if (this.elm.rotation === global.ROTATION_0 ||
    ...
    HighPassFilter.prototype.recolor = function () {
        if (global.selected) {
            if (global.selected_id === this.elm.id &&
                global.selected_type === this.elm.type) {
    ...
    HighPassFilter.prototype.is_selected_element = function () {
        return (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type);
    };
    /* Draws the component */
    HighPassFilter.prototype.draw_component = function (canvas) {
    ...
    HighPassFilter.prototype.patch = function () {
    ...
    HighPassFilter.prototype.time_data = function () {
    ...
    HighPassFilter.prototype.reset = function () {
        this.elm.properties['Y Hat'] = 0;
        this.elm.properties['Y Out'] = 0;
        this.elm.properties['X Hat'] = 0;
        this.elm.properties['Output Voltage'] = 0;
