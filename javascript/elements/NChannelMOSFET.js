 ...
 *
 ***********************************************************************/
var NChannelMOSFET = /** @class */ (function () {
    function NChannelMOSFET(type, id, n1, n2, n3) {
    ...
    NChannelMOSFET.prototype.lpf = function (inp) {
        this._alpha =
    ...
    NChannelMOSFET.prototype.refresh_bounds = function () {
        if (this.elm.consistent()) {
            this.p1 = new PointF(0, 0);
            this.p2 = new PointF(0, 0);
            this.p3 = new PointF(0, 0);
    ...
    NChannelMOSFET.prototype.push_reference = function (ref) {
        this.wire_reference.push(ref);
    };
    NChannelMOSFET.prototype.stamp = function () {
        if (this.elm.consistent()) {
    ...
    NChannelMOSFET.prototype.is_converged = function () {
    ...
    NChannelMOSFET.prototype.reset_nmosfet = function () {
        this.y_out = 0;
        this.y_hat = 0;
    ...
    NChannelMOSFET.prototype.get_nmosfet_error = function () {
        return Math.abs(this.elm.properties['Vgs'] - this.elm.properties['Last Vgs']);
    };
    /* General function to handle any processing required by the component */
    NChannelMOSFET.prototype.update = function () {
        if (global.FLAG_SIMULATING && simulation_manager.SOLUTIONS_READY) {
            if (this.elm.consistent()) {
                ...
                var kn = 0.5 * this.elm.properties['W/L Ratio'] * this.elm.properties["K'n"];
                if (this.elm.properties['Vgs'] <= this.elm.properties['VTN']) {
                ...
                else if (this.elm.properties['Vds'] <=
                    this.elm.properties['Vgs'] - this.elm.properties['VTN']) {
                    this.elm.properties['Mosfet Mode'] = 1;
                    this.elm.properties['gds'] =
                        2.0 *
                            kn *
                            (this.elm.properties['Vgs'] -
                                this.elm.properties['VTN'] -
                                this.elm.properties['Vds']);
                    ...
                    this.elm.properties['Io'] =
                        2.0 *
                            ...
                            ((this.elm.properties['Vgs'] - this.elm.properties['VTN']) *
                                this.elm.properties['Vds'] -
                                0.5 * this.elm.properties['Vds'] * this.elm.properties['Vds']) -
                    ...
                    this.elm.properties['gds'] =
                        kn *
                            ...
                            Math.pow(this.elm.properties['Vgs'] - this.elm.properties['VTN'], 2);
                    this.elm.properties['gm'] =
                        2.0 *
                            kn *
                            ((this.elm.properties['Vgs'] - this.elm.properties['VTN']) *
                                (1.0 +
                                    this.elm.properties['Lambda'] * this.elm.properties['Vds']));
                    this.elm.properties['Io'] =
                        kn *
                            Math.pow(this.elm.properties['Vgs'] - this.elm.properties['VTN'], 2) *
                            (1.0 +
    ...
    NChannelMOSFET.prototype.gmin_step = function (step, error) {
    ...
    NChannelMOSFET.prototype.get_vertices = function () {
        var vertices = [];
        var p1 = [];
        var p2 = [];
        var p3 = [];
    ...
    NChannelMOSFET.prototype.release_wires = function () {
    ...
    NChannelMOSFET.prototype.release_nodes = function () {
        if (this.elm.consistent()) {
    ...
    NChannelMOSFET.prototype.capture_nodes = function () {
        var vertices = this.get_vertices();
        this.elm.map_node3(vertices[0], vertices[1], vertices[2], vertices[3], vertices[4], vertices[5]);
    ...
    NChannelMOSFET.prototype.mouse_down = function () {
        if (global.FLAG_IDLE &&
    ...
    NChannelMOSFET.prototype.handle_wire_builder = function (n, anchor) {
    ...
    NChannelMOSFET.prototype.move_element = function (dx, dy) {
    ...
    NChannelMOSFET.prototype.mouse_move = function () {
    ...
    NChannelMOSFET.prototype.mouse_up = function () {
        if (global.FLAG_IDLE) {
            if (global.focused &&
                global.focused_id === this.elm.id &&
                global.focused_type === this.elm.type) {
    ...
    NChannelMOSFET.prototype.select = function () {
        if (global.WIRE_BUILDER['step'] != 0) {
            wire_manager.reset_wire_builder();
        }
    ...
    NChannelMOSFET.prototype.remove_focus = function () {
        if (global.focused &&
            global.focused_id === this.elm.id &&
            global.focused_type === this.elm.type) {
            global.focused_id = global.NULL;
    ...
    NChannelMOSFET.prototype.remove_selection = function () {
        if (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type) {
            global.selected_id = global.NULL;
            global.selected_type = -1;
    ...
    NChannelMOSFET.prototype.wire_reference_maintenance = function () {
    ...
    NChannelMOSFET.prototype.unanchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    NChannelMOSFET.prototype.anchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    NChannelMOSFET.prototype.set_flip = function (flip) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    NChannelMOSFET.prototype.set_rotation = function (rotation) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    NChannelMOSFET.prototype.push_history = function () {
        if (this.INITIALIZED) {
            global.HISTORY_MANAGER['packet'].push(engine_functions.history_snapshot());
        }
    };
    /* Generate the SVG for the component. */
    NChannelMOSFET.prototype.build_element = function () {
        if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
            ...
            var cache_8 = 0.7 * this.x_space;
            var cache_9 = 0.7 * this.y_space;
            ...
            this.nmos_1.x =
                this.nmos_0.x + 2 * cache_10 * global.cosine(this.theta_m90);
            this.nmos_1.y =
                this.nmos_0.y + 2 * cache_11 * global.sine(this.theta_m90);
            this.nmos_2.x =
                this.p1.x +
            ...
            this.nmos_3.x = this.p1.x + cache_4 * global.cosine(this.theta);
            this.nmos_3.y = this.p1.y + cache_5 * global.sine(this.theta);
            this.nmos_4.x =
                this.nmos_3.x + 2 * cache_10 * global.cosine(this.theta_m90);
            this.nmos_4.y =
                this.nmos_3.y + 2 * cache_11 * global.sine(this.theta_m90);
            this.nmos_5.x =
                this.p1.x +
            ...
            this.nmos_7.y =
                this.nmos_3.y + cache_9 * global.sine(this.theta_m90 + global.PI_DIV_6);
            this.nmos_8.x =
                this.nmos_3.x +
                    cache_8 * global.cosine(this.theta_m90 - global.PI_DIV_6);
            this.nmos_8.y =
    ...
    NChannelMOSFET.prototype.resize = function () {
        if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
    ...
    NChannelMOSFET.prototype.refactor = function () {
    ...
    NChannelMOSFET.prototype.increment_rotation = function () {
        this.elm.rotation++;
    ...
    NChannelMOSFET.prototype.increment_flip = function () {
        this.elm.flip++;
        if (this.elm.flip > global.FLIP_180) {
    ...
    NChannelMOSFET.prototype.recolor = function () {
        if (global.selected) {
            if (global.selected_id === this.elm.id &&
                global.selected_type === this.elm.type) {
    ...
    NChannelMOSFET.prototype.is_selected_element = function () {
        return (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type);
    };
    /* Draws the component */
    NChannelMOSFET.prototype.draw_component = function (canvas) {
    ...
    NChannelMOSFET.prototype.patch = function () {
    ...
    NChannelMOSFET.prototype.time_data = function () {
    ...
    NChannelMOSFET.prototype.reset = function () { };
    return NChannelMOSFET;
}());
