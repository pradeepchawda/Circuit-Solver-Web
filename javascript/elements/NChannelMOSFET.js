...
class NChannelMOSFET {
    constructor(type, id, n1, n2, n3) {
        ...
        this.elm = new Element3(id, type, global.utils.copy(global.PROPERTY_NMOS));
    ...
    build_element() {
        if (this.build_element_flag || global.flags.signal_build_element) {
            ...
            this.nmos_7.x = this.nmos_3.x + cache_8 * global.utils.cosine(this.theta_m90 + global.PI_DIV_6);
            this.nmos_7.y = this.nmos_3.y + cache_9 * global.utils.sine(this.theta_m90 + global.PI_DIV_6);
            this.nmos_8.x = this.nmos_3.x + cache_8 * global.utils.cosine(this.theta_m90 - global.PI_DIV_6);
            this.nmos_8.y = this.nmos_3.y + cache_9 * global.utils.sine(this.theta_m90 - global.PI_DIV_6);
        ...
        if (global.flags.picture_request_flag ||
            ...
            if (global.variables.workspace_zoom_scale > 1.085 || (!global.CONSTANTS.MOBILE_MODE && global.variables.workspace_zoom_scale >= 0.99)) {
                ...
                if ((this.angle > 170 && this.angle < 190) || (this.angle > -10 && this.angle < 10)) {
                    ...
                    canvas.draw_text(global.ELEMENT_VAL_TEMPLATE.replace('{VAL}', global.utils.exponentiate_quickly(this.elm.properties['W/L Ratio'])).replace('{UNIT}', this.elm.properties['units']), this.c_x, this.bounds.top - this.bounds.get_height() * 0.15, this.text_paint);
