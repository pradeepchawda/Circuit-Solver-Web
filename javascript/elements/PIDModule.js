 ...
 *
 * Purpose           : A class to handle the PID Module element. It will automatically generate
 ...
 *
 ***********************************************************************/
var PIDModule = /** @class */ (function () {
    function PIDModule(type, id, n1, n2, n3) {
      ...
      or overlapped)*/
        ...
        this.bounds = new RectF(0, 0, 0, 0);
        /* Inititalize the element2 class that will hold the basic data about our component */
        this.elm = new Element3(id, type, global.copy(global.PROPERTY_PID));
    ...
    PIDModule.prototype.refresh_bounds = function () {
        if (this.elm.consistent()) {
            this.p1 = new PointF(0, 0);
            this.p2 = new PointF(0, 0);
            this.p3 = new PointF(0, 0);
    ...
    PIDModule.prototype.push_reference = function (ref) {
        this.wire_reference.push(ref);
    };
    PIDModule.prototype.reset_pid = function () {
        this.pid_controller.reset();
    };
    /* General function to handle any processing required by the component */
    PIDModule.prototype.update = function () {
        if (global.FLAG_SIMULATING &&
            ...
            if (this.elm.consistent()) {
                ...
                if (this.elm.properties['Input Voltage2'] >
                    0.5 * this.elm.properties['High Voltage']) {
                    this.pid_controller.reset();
                }
                this.elm.properties['Output Voltage'] = this.pid_controller.get_output(global.SIMULATION_TIME, this.elm.properties['Input Voltage1']);
            }
        }
        else {
            this.pid_controller.reset();
    ...
    PIDModule.prototype.stamp = function () {
        if (this.elm.consistent()) {
    ...
    PIDModule.prototype.get_vertices = function () {
        var vertices = [];
        var p1 = [];
        var p2 = [];
        var p3 = [];
    ...
    PIDModule.prototype.release_wires = function () {
    ...
    PIDModule.prototype.release_nodes = function () {
        if (this.elm.consistent()) {
    ...
    PIDModule.prototype.capture_nodes = function () {
        var vertices = this.get_vertices();
        this.elm.map_node3(vertices[0], vertices[1], vertices[2], vertices[3], vertices[4], vertices[5]);
    ...
    PIDModule.prototype.mouse_down = function () {
        if (global.FLAG_IDLE &&
    ...
    PIDModule.prototype.handle_wire_builder = function (n, anchor) {
    ...
    PIDModule.prototype.move_element = function (dx, dy) {
    ...
    PIDModule.prototype.mouse_move = function () {
    ...
    PIDModule.prototype.mouse_up = function () {
        if (global.FLAG_IDLE) {
            if (global.focused &&
                global.focused_id === this.elm.id &&
                global.focused_type === this.elm.type) {
    ...
    PIDModule.prototype.select = function () {
        if (global.WIRE_BUILDER['step'] != 0) {
            wire_manager.reset_wire_builder();
        }
    ...
    PIDModule.prototype.remove_focus = function () {
        if (global.focused &&
            global.focused_id === this.elm.id &&
            global.focused_type === this.elm.type) {
            global.focused_id = global.NULL;
    ...
    PIDModule.prototype.remove_selection = function () {
        if (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type) {
            global.selected_id = global.NULL;
            global.selected_type = -1;
    ...
    PIDModule.prototype.wire_reference_maintenance = function () {
    ...
    PIDModule.prototype.unanchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    PIDModule.prototype.anchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    PIDModule.prototype.set_flip = function (flip) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    PIDModule.prototype.set_rotation = function (rotation) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    PIDModule.prototype.push_history = function () {
        if (this.INITIALIZED) {
            global.HISTORY_MANAGER['packet'].push(engine_functions.history_snapshot());
        }
    };
    /* Generate the SVG for the component. */
    PIDModule.prototype.build_element = function () {
        if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
            var cache_0 = 2.0 * this.x_space;
            var cache_1 = 2.0 * this.y_space;
            var cache_2 = 0.75 * this.x_space;
            var cache_3 = 0.75 * this.y_space;
            var cache_4 = 0.6 * this.x_space;
            var cache_5 = 1.4 * this.y_space;
            ...
            this.pid_1.x = this.pid_0.x + cache_6 * global.cosine(this.theta);
            this.pid_1.y = this.pid_0.y + cache_7 * global.sine(this.theta);
            this.pid_2.x =
                this.pid_1.x + cache_2 * global.cosine(this.theta - Math.PI);
            this.pid_2.y = this.pid_1.y + cache_3 * global.sine(this.theta - Math.PI);
            /* Bottom segment */
            this.pid_3.x = this.p2.x + cache_0 * global.cosine(this.theta_m90);
            this.pid_3.y = this.p2.y + cache_1 * global.sine(this.theta_m90);
            this.pid_4.x = this.pid_3.x - cache_6 * global.cosine(this.theta);
            this.pid_4.y = this.pid_3.y - cache_7 * global.sine(this.theta);
            this.pid_5.x = this.pid_4.x + cache_2 * global.cosine(this.theta);
            this.pid_5.y = this.pid_4.y + cache_3 * global.sine(this.theta);
            /* End Segment */
            this.pid_6.x = this.p3.x - cache_6 * global.cosine(this.theta_m90);
            this.pid_6.y = this.p3.y - cache_7 * global.sine(this.theta_m90);
            if (this.elm.flip === global.FLIP_0) {
                /* Reference polarity point */
                this.pid_7.x =
                    this.p1.x + cache_4 * global.cosine(this.theta_m90 + global.PI_DIV_4);
                this.pid_7.y =
                    this.p1.y + cache_5 * global.sine(this.theta_m90 + global.PI_DIV_4);
                /* Reference polarity point */
                this.pid_8.x =
                    this.p2.x + cache_4 * global.cosine(this.theta_m90 - global.PI_DIV_4);
                this.pid_8.y =
                    this.p2.y + cache_5 * global.sine(this.theta_m90 - global.PI_DIV_4);
            }
            else if (this.elm.flip === global.FLIP_180) {
                /* Reference polarity point */
                this.pid_7.x =
    ...
    PIDModule.prototype.resize = function () {
        if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
    ...
    PIDModule.prototype.refactor = function () {
    ...
    PIDModule.prototype.increment_rotation = function () {
        this.elm.rotation++;
    ...
    PIDModule.prototype.increment_flip = function () {
        this.elm.flip++;
    ...
    PIDModule.prototype.recolor = function () {
        if (global.selected) {
            if (global.selected_id === this.elm.id &&
                global.selected_type === this.elm.type) {
    ...
    PIDModule.prototype.is_selected_element = function () {
        return (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type);
    };
    /* Draws the component */
    PIDModule.prototype.draw_component = function (canvas) {
    ...
    PIDModule.prototype.patch = function () {
        if (!global.not_null(this.pid_0)) {
            this.pid_0 = new PointF(0, 0);
        }
        if (!global.not_null(this.pid_1)) {
            this.pid_1 = new PointF(0, 0);
        }
        if (!global.not_null(this.pid_2)) {
            this.pid_2 = new PointF(0, 0);
        }
        if (!global.not_null(this.pid_3)) {
            this.pid_3 = new PointF(0, 0);
        }
        if (!global.not_null(this.pid_4)) {
            this.pid_4 = new PointF(0, 0);
        }
        if (!global.not_null(this.pid_5)) {
            this.pid_5 = new PointF(0, 0);
        }
        if (!global.not_null(this.pid_6)) {
            this.pid_6 = new PointF(0, 0);
        }
        if (!global.not_null(this.pid_7)) {
            this.pid_7 = new PointF(0, 0);
        }
        if (!global.not_null(this.pid_8)) {
            this.pid_8 = new PointF(0, 0);
        }
    ...
    PIDModule.prototype.time_data = function () {
    ...
    PIDModule.prototype.reset = function () {
        this.pid_controller.reset();
