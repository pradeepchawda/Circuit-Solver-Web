 ...
 *
 * Purpose           : A class to handle the Lookup Table element. It will automatically generate
 ...
 *
 ***********************************************************************/
var LookUpTable = /** @class */ (function () {
    function LookUpTable(type, id, n1, n2) {
      ...
      or overlapped)*/
        ...
        this.bounds = new RectF(0, 0, 0, 0);
        /* Inititalize the element2 class that will hold the basic data about our component */
        this.elm = new Element2(id, type, global.copy(global.PROPERTY_LUT));
    ...
    LookUpTable.prototype.refresh_bounds = function () {
        if (this.elm.consistent()) {
            this.p1 = new PointF(0, 0);
            this.p2 = new PointF(0, 0);
            /* Create some points to hold the node locations, this will be used for drawing components */
    ...
    LookUpTable.prototype.push_reference = function (ref) {
        this.wire_reference.push(ref);
    };
    /* General function to handle any processing required by the component */
    LookUpTable.prototype.update = function () {
        if (global.FLAG_SIMULATING &&
            ...
            if (this.elm.consistent()) {
                ...
                if (this.elm.properties['Interpolate'] === global.ON) {
                    this.elm.properties['Output Voltage'] = global.linterp([
    ...
    LookUpTable.prototype.stamp = function () {
        if (this.elm.consistent()) {
    ...
    LookUpTable.prototype.get_vertices = function () {
        var vertices = [];
        var p1 = [];
        var p2 = [];
    ...
    LookUpTable.prototype.release_wires = function () {
    ...
    LookUpTable.prototype.release_nodes = function () {
        if (this.elm.consistent()) {
    ...
    LookUpTable.prototype.capture_nodes = function () {
        var vertices = this.get_vertices();
        this.elm.map_node2(vertices[0], vertices[1], vertices[2], vertices[3]);
    ...
    LookUpTable.prototype.mouse_down = function () {
        if (global.FLAG_IDLE &&
    ...
    LookUpTable.prototype.handle_wire_builder = function (n, anchor) {
    ...
    LookUpTable.prototype.move_element = function (dx, dy) {
    ...
    LookUpTable.prototype.mouse_move = function () {
    ...
    LookUpTable.prototype.mouse_up = function () {
        if (global.FLAG_IDLE) {
            if (global.focused &&
                global.focused_id === this.elm.id &&
                global.focused_type === this.elm.type) {
    ...
    LookUpTable.prototype.select = function () {
        if (global.WIRE_BUILDER['step'] != 0) {
            wire_manager.reset_wire_builder();
        }
    ...
    LookUpTable.prototype.remove_focus = function () {
        if (global.focused &&
            global.focused_id === this.elm.id &&
            global.focused_type === this.elm.type) {
            global.focused_id = global.NULL;
    ...
    LookUpTable.prototype.remove_selection = function () {
        if (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type) {
            global.selected_id = global.NULL;
            global.selected_type = -1;
    ...
    LookUpTable.prototype.wire_reference_maintenance = function () {
    ...
    LookUpTable.prototype.unanchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    LookUpTable.prototype.anchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    LookUpTable.prototype.set_flip = function (flip) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    LookUpTable.prototype.set_rotation = function (rotation) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    LookUpTable.prototype.push_history = function () {
        if (this.INITIALIZED) {
            global.HISTORY_MANAGER['packet'].push(engine_functions.history_snapshot());
        }
    };
    /* Generate the SVG for the component. */
    LookUpTable.prototype.build_element = function () {
    ...
    LookUpTable.prototype.resize = function () {
        if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
    ...
    LookUpTable.prototype.refactor = function () {
    ...
    LookUpTable.prototype.increment_rotation = function () {
        this.elm.rotation++;
    ...
    LookUpTable.prototype.increment_flip = function () { };
    LookUpTable.prototype.map_rotation = function () {
        if (this.elm.rotation === global.ROTATION_0 ||
    ...
    LookUpTable.prototype.recolor = function () {
        if (global.selected) {
            if (global.selected_id === this.elm.id &&
                global.selected_type === this.elm.type) {
    ...
    LookUpTable.prototype.is_selected_element = function () {
        return (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type);
    };
    /* Draws the component */
    LookUpTable.prototype.draw_component = function (canvas) {
    ...
    LookUpTable.prototype.patch = function () {
    ...
    LookUpTable.prototype.time_data = function () {
    ...
    LookUpTable.prototype.reset = function () {
