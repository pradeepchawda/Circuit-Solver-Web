...
var Fuse = /** @class */ (function () {
    ...
    Fuse.prototype.refresh_bounds = function () {
        if (this.elm.consistent()) {
            this.p1 = new PointF(0, 0);
            this.p2 = new PointF(0, 0);
            /* Create some points to hold the node locations, this will be used for drawing components */
    ...
    Fuse.prototype.push_reference = function (ref) {
        this.wire_reference.push(ref);
    };
    Fuse.prototype.stamp = function () {
        if (this.elm.consistent()) {
    ...
    Fuse.prototype.get_vertices = function () {
        var vertices = [];
        var p1 = [];
        var p2 = [];
    ...
    Fuse.prototype.release_wires = function () {
    ...
    Fuse.prototype.release_nodes = function () {
        if (this.elm.consistent()) {
    ...
    Fuse.prototype.capture_nodes = function () {
        var vertices = this.get_vertices();
        this.elm.map_node2(vertices[0], vertices[1], vertices[2], vertices[3]);
    ...
    Fuse.prototype.mouse_down = function () {
        if (global.FLAG_IDLE &&
    ...
    Fuse.prototype.handle_wire_builder = function (n, anchor) {
    ...
    Fuse.prototype.move_element = function (dx, dy) {
    ...
    Fuse.prototype.mouse_move = function () {
    ...
    Fuse.prototype.mouse_up = function () {
        if (global.FLAG_IDLE) {
            if (global.focused &&
                global.focused_id === this.elm.id &&
                global.focused_type === this.elm.type) {
    ...
    Fuse.prototype.select = function () {
        if (global.WIRE_BUILDER['step'] != 0) {
            wire_manager.reset_wire_builder();
        }
    ...
    Fuse.prototype.remove_focus = function () {
        if (global.focused &&
            global.focused_id === this.elm.id &&
            global.focused_type === this.elm.type) {
            global.focused_id = global.NULL;
    ...
    Fuse.prototype.remove_selection = function () {
        if (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type) {
            global.selected_id = global.NULL;
            global.selected_type = -1;
    ...
    Fuse.prototype.wire_reference_maintenance = function () {
    ...
    Fuse.prototype.unanchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    Fuse.prototype.anchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    Fuse.prototype.set_flip = function (flip) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    Fuse.prototype.set_rotation = function (rotation) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    Fuse.prototype.push_history = function () {
        if (this.INITIALIZED) {
            global.HISTORY_MANAGER['packet'].push(engine_functions.history_snapshot());
        }
    };
    /* Generate the SVG for the component. */
    Fuse.prototype.build_element = function () {
    ...
    Fuse.prototype.resize = function () {
        if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
    ...
    Fuse.prototype.refactor = function () {
    ...
    Fuse.prototype.reset_fuse = function () {
    ...
    Fuse.prototype.update = function () {
        if (global.FLAG_SIMULATING &&
            ...
            if (this.elm.consistent()) {
                ...
                if (this.elm.properties['Voltage'] / this.elm.properties['Resistance'] >=
                    this.elm.properties['Current Rating']) {
    ...
    Fuse.prototype.increment_rotation = function () {
        this.elm.rotation++;
    ...
    Fuse.prototype.increment_flip = function () { };
    Fuse.prototype.recolor = function () {
        if (global.selected) {
            if (global.selected_id === this.elm.id &&
                global.selected_type === this.elm.type) {
    ...
    Fuse.prototype.is_selected_element = function () {
        return (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type);
    };
    /* Draws the component */
    Fuse.prototype.draw_component = function (canvas) {
        ...
        if (global.PICTURE_REQUEST ||
            ...
            if (this.elm.properties['Broken'] === false) {
                ...
                this.CIRCLE_BUFFER[this.indexer++] = Array(this.connect1_x, this.connect1_y, global.CANVAS_STROKE_WIDTH_2_ZOOM);
                this.CIRCLE_BUFFER[this.indexer++] = Array(this.connect2_x, this.connect2_y, global.CANVAS_STROKE_WIDTH_2_ZOOM);
            }
            ...
            if (global.WORKSPACE_ZOOM_SCALE > 1.085 ||
                ...
                if ((this.ANGLE > 170 && this.ANGLE < 190) ||
                    ...
                    canvas.draw_text(global.ELEMENT_VAL_TEMPLATE.replace('{VAL}', global.exponentiate_quickly(this.elm.properties['Current Rating'])).replace('{UNIT}', this.elm.properties['units']), this.c_x, this.bounds.top + this.bounds.get_height() * 0.1, this.text_paint);
    ...
    Fuse.prototype.time_data = function () {
