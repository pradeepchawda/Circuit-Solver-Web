 ...
 *
 * Purpose           : A class to handle the ADC (Analog to digital Converter) element. It will automatically generate
 ...
 *
 ***********************************************************************/
var ADCModule = /** @class */ (function () {
    function ADCModule(type, id, n1, n2) {
      ...
      or overlapped)*/
        ...
        this.bounds = new RectF(0, 0, 0, 0);
        /* Inititalize the element2 class that will hold the basic data about our component */
        this.elm = new Element2(id, type, global.copy(global.PROPERTY_ADC));
    ...
    ADCModule.prototype.refresh_bounds = function () {
        if (this.elm.consistent()) {
            this.p1 = new PointF(0, 0);
            this.p2 = new PointF(0, 0);
            /* Create some points to hold the node locations, this will be used for drawing components */
    ...
    ADCModule.prototype.push_reference = function (ref) {
        this.wire_reference.push(ref);
    };
    /* General function to handle any processing required by the component */
    ADCModule.prototype.update = function () {
            ...
            if (this.elm.consistent()) {
                ...
                this.elm.properties['LSB'] =
                    this.elm.properties['Reference Voltage'] /
                        this.elm.properties['Max Bits'];
                this.elm.properties['Output Voltage'] = global.limit(global.cast_int(this.elm.properties['Input Voltage'] / this.elm.properties['LSB']), 0, this.elm.properties['Max Bits']);
            }
        }
    };
    ADCModule.prototype.stamp = function () {
        if (this.elm.consistent()) {
    ...
    ADCModule.prototype.get_vertices = function () {
        var vertices = [];
        var p1 = [];
        var p2 = [];
    ...
    ADCModule.prototype.release_wires = function () {
    ...
    ADCModule.prototype.release_nodes = function () {
        if (this.elm.consistent()) {
    ...
    ADCModule.prototype.capture_nodes = function () {
        var vertices = this.get_vertices();
        this.elm.map_node2(vertices[0], vertices[1], vertices[2], vertices[3]);
    ...
    ADCModule.prototype.mouse_down = function () {
        if (global.FLAG_IDLE &&
    ...
    ADCModule.prototype.handle_wire_builder = function (n, anchor) {
    ...
    ADCModule.prototype.move_element = function (dx, dy) {
    ...
    ADCModule.prototype.mouse_move = function () {
    ...
    ADCModule.prototype.mouse_up = function () {
        if (global.FLAG_IDLE) {
            if (global.focused &&
                global.focused_id === this.elm.id &&
                global.focused_type === this.elm.type) {
    ...
    ADCModule.prototype.select = function () {
        if (global.WIRE_BUILDER['step'] != 0) {
            wire_manager.reset_wire_builder();
        }
    ...
    ADCModule.prototype.remove_focus = function () {
        if (global.focused &&
            global.focused_id === this.elm.id &&
            global.focused_type === this.elm.type) {
            global.focused_id = global.NULL;
    ...
    ADCModule.prototype.remove_selection = function () {
        if (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type) {
            global.selected_id = global.NULL;
            global.selected_type = -1;
    ...
    ADCModule.prototype.wire_reference_maintenance = function () {
    ...
    ADCModule.prototype.unanchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    ADCModule.prototype.anchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    ADCModule.prototype.set_flip = function (flip) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    ADCModule.prototype.set_rotation = function (rotation) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    ADCModule.prototype.push_history = function () {
        if (this.INITIALIZED) {
            global.HISTORY_MANAGER['packet'].push(engine_functions.history_snapshot());
        }
    };
    /* Generate the SVG for the component. */
    ADCModule.prototype.build_element = function () {
        if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
            ...
            this.adc_4.y =
                this.c_y +
                    cache_5 * global.sine(this.theta) +
                    cache_5 * global.sine(this.theta_m90);
            this.adc_5.x = this.c_x + cache_4 * global.cosine(this.theta);
            this.adc_5.y = this.c_y + cache_5 * global.sine(this.theta);
    ...
    ADCModule.prototype.resize = function () {
        if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
    ...
    ADCModule.prototype.refactor = function () {
    ...
    ADCModule.prototype.increment_rotation = function () {
        this.elm.rotation++;
    ...
    ADCModule.prototype.increment_flip = function () { };
    ADCModule.prototype.map_rotation = function () {
        if (this.elm.rotation === global.ROTATION_0 ||
    ...
    ADCModule.prototype.recolor = function () {
        if (global.selected) {
            if (global.selected_id === this.elm.id &&
                global.selected_type === this.elm.type) {
    ...
    ADCModule.prototype.is_selected_element = function () {
        return (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type);
    };
    /* Draws the component */
    ADCModule.prototype.draw_component = function (canvas) {
    ...
    ADCModule.prototype.patch = function () {
    ...
    ADCModule.prototype.time_data = function () {
    ...
    ADCModule.prototype.reset = function () {
