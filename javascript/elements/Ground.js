 ...
 *
 * Purpose           : A class to handle the ground element. It will automatically generate
...
var Ground = /** @class */ (function () {
    ...
    Ground.prototype.refresh_bounds = function () {
        if (this.elm.consistent()) {
            this.p1 = new PointF(0, 0);
            /* Create some points to hold the node locations, this will be used for drawing components */
            this.p1.set_point(nodes[this.elm.n1].location.x, nodes[this.elm.n1].location.y);
    ...
    Ground.prototype.release_nodes = function () {
        if (this.elm.consistent()) {
    ...
    Ground.prototype.capture_nodes = function () {
        var vertices = this.get_vertices();
        this.elm.map_node1(vertices[0], vertices[1]);
    ...
    Ground.prototype.mouse_down = function () {
        if (global.FLAG_IDLE &&
    ...
    Ground.prototype.handle_wire_builder = function (n, anchor) {
    ...
    Ground.prototype.move_element = function (dx, dy) {
    ...
    Ground.prototype.mouse_move = function () {
    ...
    Ground.prototype.mouse_up = function () {
        if (global.FLAG_IDLE) {
            if (global.focused &&
                global.focused_id === this.elm.id &&
                global.focused_type === this.elm.type) {
    ...
    Ground.prototype.select = function () {
        if (global.WIRE_BUILDER['step'] != 0) {
            wire_manager.reset_wire_builder();
        }
    ...
    Ground.prototype.remove_focus = function () {
        if (global.focused &&
            global.focused_id === this.elm.id &&
            global.focused_type === this.elm.type) {
            global.focused_id = global.NULL;
    ...
    Ground.prototype.remove_selection = function () {
        if (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type) {
            global.selected_id = global.NULL;
            global.selected_type = global.NULL;
    ...
    Ground.prototype.wire_reference_maintenance = function () {
    ...
    Ground.prototype.unanchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    Ground.prototype.anchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    Ground.prototype.push_history = function () {
        if (this.INITIALIZED) {
    ...
    Ground.prototype.refactor = function () {
    ...
    Ground.prototype.set_flip = function (flip) { };
    /* Sets the rotation of the component */
    Ground.prototype.set_rotation = function (rotation) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.push_history();
        this.release_nodes();
    ...
    Ground.prototype.increment_rotation = function () {
        this.elm.rotation++;
    ...
    Ground.prototype.increment_flip = function () { };
    Ground.prototype.recolor = function () {
        if (global.selected) {
            if (global.selected_id === this.elm.id &&
                global.selected_type === this.elm.type) {
    ...
    Ground.prototype.is_selected_element = function () {
        return (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type);
    };
    /* Draws the component */
    Ground.prototype.draw_component = function (canvas) {
    ...
    Ground.prototype.patch = function () {
    ...
    Ground.prototype.time_data = function () {
