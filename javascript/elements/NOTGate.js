 ...
 *
 * Purpose           : A class to handle the NOTGate element. It will automatically generate
...
var NOTGate = /** @class */ (function () {
    function NOTGate(type, id, n1, n2) {
      ...
      or overlapped)*/
        ...
        this.bounds = new RectF(0, 0, 0, 0);
        /* Inititalize the element2 class that will hold the basic data about our component */
        this.elm = new Element2(id, type, global.copy(global.PROPERTY_NOT));
    ...
    NOTGate.prototype.refresh_bounds = function () {
        if (this.elm.consistent()) {
            this.p1 = new PointF(0, 0);
            this.p2 = new PointF(0, 0);
            /* Create some points to hold the node locations, this will be used for drawing components */
    ...
    NOTGate.prototype.push_reference = function (ref) {
    ...
    NOTGate.prototype.stamp = function () {
        if (this.elm.consistent()) {
    ...
    NOTGate.prototype.get_vertices = function () {
        var vertices = [];
        var p1 = [];
        var p2 = [];
    ...
    NOTGate.prototype.release_wires = function () {
    ...
    NOTGate.prototype.release_nodes = function () {
        if (this.elm.consistent()) {
    ...
    NOTGate.prototype.capture_nodes = function () {
        var vertices = this.get_vertices();
        this.elm.map_node2(vertices[0], vertices[1], vertices[2], vertices[3]);
    ...
    NOTGate.prototype.mouse_down = function () {
        if (global.FLAG_IDLE &&
    ...
    NOTGate.prototype.handle_wire_builder = function (n, anchor) {
    ...
    NOTGate.prototype.move_element = function (dx, dy) {
    ...
    NOTGate.prototype.mouse_move = function () {
    ...
    NOTGate.prototype.mouse_up = function () {
        if (global.FLAG_IDLE) {
            if (global.focused &&
                global.focused_id === this.elm.id &&
                global.focused_type === this.elm.type) {
    ...
    NOTGate.prototype.select = function () {
        if (global.WIRE_BUILDER['step'] != 0) {
            wire_manager.reset_wire_builder();
        }
    ...
    NOTGate.prototype.remove_focus = function () {
        if (global.focused &&
            global.focused_id === this.elm.id &&
            global.focused_type === this.elm.type) {
            global.focused_id = global.NULL;
    ...
    NOTGate.prototype.remove_selection = function () {
        if (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type) {
            global.selected_id = global.NULL;
            global.selected_type = -1;
    ...
    NOTGate.prototype.wire_reference_maintenance = function () {
    ...
    NOTGate.prototype.unanchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    NOTGate.prototype.anchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    NOTGate.prototype.set_flip = function (flip) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    NOTGate.prototype.set_rotation = function (rotation) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    NOTGate.prototype.push_history = function () {
        if (this.INITIALIZED) {
            global.HISTORY_MANAGER['packet'].push(engine_functions.history_snapshot());
        }
    };
    /* Generate the SVG for the component. */
    NOTGate.prototype.build_element = function () {
        if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
            var cache_0 = 1.3 * this.x_space;
            var cache_1 = 1.3 * this.y_space;
            var cache_2 = 1.6 * this.x_space;
            var cache_3 = 1.6 * this.y_space;
            ...
            this.not_3.y = this.c_y + cache_1 * global.sine(this.theta);
    ...
    NOTGate.prototype.resize = function () {
        if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
    ...
    NOTGate.prototype.refactor = function () {
    ...
    NOTGate.prototype.increment_rotation = function () {
        this.elm.rotation++;
    ...
    NOTGate.prototype.increment_flip = function () { };
    NOTGate.prototype.map_rotation = function () {
        if (this.elm.rotation === global.ROTATION_0 ||
    ...
    NOTGate.prototype.recolor = function () {
        if (global.selected) {
            if (global.selected_id === this.elm.id &&
                global.selected_type === this.elm.type) {
    ...
    NOTGate.prototype.is_selected_element = function () {
        return (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type);
    };
    /* Draws the component */
    NOTGate.prototype.draw_component = function (canvas) {
        ...
        if (global.PICTURE_REQUEST ||
            ...
            this.indexer = 0;
            canvas.draw_circle(this.not_3.x, this.not_3.y, 1.3 * global.CANVAS_STROKE_WIDTH_2_ZOOM, this.line_paint);
    ...
    NOTGate.prototype.patch = function () {
    ...
    NOTGate.prototype.time_data = function () {
    ...
    NOTGate.prototype.reset = function () {
