 ...
 *
 * Purpose           : A class to handle the saw wave element. It will automatically generate
 ...
 *
 ***********************************************************************/
var SawWave = /** @class */ (function () {
    function SawWave(type, id, n1, n2) {
      ...
      or overlapped)*/
        ...
        this.bounds = new RectF(0, 0, 0, 0);
        /* Inititalize the element2 class that will hold the basic data about our component */
        this.elm = new Element2(id, type, global.copy(global.PROPERTY_SAW));
    ...
    SawWave.prototype.refresh_bounds = function () {
        if (this.elm.consistent()) {
            this.p1 = new PointF(0, 0);
            this.p2 = new PointF(0, 0);
            /* Create some points to hold the node locations, this will be used for drawing components */
    ...
    SawWave.prototype.push_reference = function (ref) {
        this.wire_reference.push(ref);
    };
    SawWave.prototype.stamp = function () {
        if (this.elm.consistent()) {
                ...
                ((2 * this.elm.properties['Voltage']) / Math.PI) *
                    Math.atan(1.0 /
                        Math.tan(global.SIMULATION_TIME *
                            ...
                            global.to_radians(this.elm.properties['Phase']))), simulation_manager.ELEMENT_SAW_OFFSET + this.simulation_id);
        }
    };
    /* Vertex handling (for rotation) */
    SawWave.prototype.get_vertices = function () {
        var vertices = [];
        var p1 = [];
        var p2 = [];
    ...
    SawWave.prototype.release_wires = function () {
    ...
    SawWave.prototype.release_nodes = function () {
        if (this.elm.consistent()) {
    ...
    SawWave.prototype.capture_nodes = function () {
        var vertices = this.get_vertices();
        this.elm.map_node2(vertices[0], vertices[1], vertices[2], vertices[3]);
    ...
    SawWave.prototype.mouse_down = function () {
        if (global.FLAG_IDLE &&
    ...
    SawWave.prototype.handle_wire_builder = function (n, anchor) {
    ...
    SawWave.prototype.move_element = function (dx, dy) {
    ...
    SawWave.prototype.mouse_move = function () {
    ...
    SawWave.prototype.mouse_up = function () {
        if (global.FLAG_IDLE) {
            if (global.focused &&
                global.focused_id === this.elm.id &&
                global.focused_type === this.elm.type) {
    ...
    SawWave.prototype.select = function () {
        if (global.WIRE_BUILDER['step'] != 0) {
            wire_manager.reset_wire_builder();
        }
    ...
    SawWave.prototype.remove_focus = function () {
        if (global.focused &&
            global.focused_id === this.elm.id &&
            global.focused_type === this.elm.type) {
            global.focused_id = global.NULL;
    ...
    SawWave.prototype.remove_selection = function () {
        if (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type) {
            global.selected_id = global.NULL;
            global.selected_type = -1;
    ...
    SawWave.prototype.wire_reference_maintenance = function () {
    ...
    SawWave.prototype.unanchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    SawWave.prototype.anchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    SawWave.prototype.set_flip = function (flip) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    SawWave.prototype.set_rotation = function (rotation) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    SawWave.prototype.push_history = function () {
        if (this.INITIALIZED) {
            global.HISTORY_MANAGER['packet'].push(engine_functions.history_snapshot());
        }
    };
    /* Generate the SVG for the component. */
    SawWave.prototype.build_element = function () {
        if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
            ...
            this.sq_3.x =
                this.sq_0.x -
                    (cache_2 >> 1) * global.cosine(this.theta_m90 - global.PI_DIV_4);
            this.sq_3.y =
                this.sq_0.y -
                    (cache_2 >> 1) * global.sine(this.theta_m90 - global.PI_DIV_4);
            this.sq_4.x =
                this.sq_1.x +
                    (cache_2 >> 1) * global.cosine(this.theta_m90 - global.PI_DIV_4);
            this.sq_4.y =
    ...
    SawWave.prototype.resize = function () {
        if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
    ...
    SawWave.prototype.refactor = function () {
    ...
    SawWave.prototype.update = function () { };
    SawWave.prototype.increment_rotation = function () {
        this.elm.rotation++;
    ...
    SawWave.prototype.increment_flip = function () { };
    SawWave.prototype.map_rotation = function () {
        if (this.elm.rotation === global.ROTATION_0 ||
    ...
    SawWave.prototype.recolor = function () {
        if (global.selected) {
            if (global.selected_id === this.elm.id &&
                global.selected_type === this.elm.type) {
    ...
    SawWave.prototype.is_selected_element = function () {
        return (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type);
    };
    /* Draws the component */
    SawWave.prototype.draw_component = function (canvas) {
    ...
    SawWave.prototype.patch = function () {
    ...
    SawWave.prototype.time_data = function () {
    ...
    SawWave.prototype.reset = function () { };
    return SawWave;
}());
