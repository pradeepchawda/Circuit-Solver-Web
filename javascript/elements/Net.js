...
var Net = /** @class */ (function () {
    ...
    Net.prototype.refresh_bounds = function () {
        if (this.elm.consistent()) {
            this.p1 = new PointF(0, 0);
            /* Create some points to hold the node locations, this will be used for drawing components */
            this.p1.set_point(nodes[this.elm.n1].location.x, nodes[this.elm.n1].location.y);
    ...
    Net.prototype.push_reference = function (ref) {
        this.wire_reference.push(ref);
    };
    Net.prototype.stamp = function () { };
    /* Vertex handling (for rotation) */
    Net.prototype.get_vertices = function () {
        var p1 = this.elm.snap_to_grid(this.bounds.get_center_x(), this.bounds.get_center_y());
        var vertices = Array(p1[0], p1[1]);
        return vertices;
    };
    Net.prototype.release_wires = function () {
    ...
    Net.prototype.release_nodes = function () {
        if (this.elm.consistent()) {
    ...
    Net.prototype.capture_nodes = function () {
        var vertices = this.get_vertices();
        this.elm.map_node1(vertices[0], vertices[1]);
    ...
    Net.prototype.mouse_down = function () {
        if (global.FLAG_IDLE &&
    ...
    Net.prototype.handle_wire_builder = function (n, anchor) {
    ...
    Net.prototype.move_element = function (dx, dy) {
    ...
    Net.prototype.mouse_move = function () {
    ...
    Net.prototype.mouse_up = function () {
        if (global.FLAG_IDLE) {
            if (global.focused &&
                global.focused_id === this.elm.id &&
                global.focused_type === this.elm.type) {
    ...
    Net.prototype.remove_focus = function () {
        if (global.focused &&
            global.focused_id === this.elm.id &&
            global.focused_type === this.elm.type) {
            global.focused_id = global.NULL;
    ...
    Net.prototype.remove_selection = function () {
        if (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type) {
            global.selected_id = global.NULL;
            global.selected_type = global.NULL;
    ...
    Net.prototype.wire_reference_maintenance = function () {
    ...
    Net.prototype.unanchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    Net.prototype.anchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    Net.prototype.push_history = function () {
        if (this.INITIALIZED) {
    ...
    Net.prototype.refactor = function () {
    ...
    Net.prototype.set_flip = function (flip) { };
    /* Sets the rotation of the component */
    Net.prototype.set_rotation = function (rotation) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.push_history();
        this.release_nodes();
    ...
    Net.prototype.increment_rotation = function () {
        this.elm.rotation++;
    ...
    Net.prototype.increment_flip = function () { };
    Net.prototype.recolor = function () {
        if (global.selected) {
            if (global.selected_id === this.elm.id &&
                global.selected_type === this.elm.type) {
    ...
    Net.prototype.is_selected_element = function () {
        return (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type);
    };
    /* Draws the component */
    Net.prototype.draw_component = function (canvas) {
        ...
        if (global.PICTURE_REQUEST ||
            ...
            if (global.WORKSPACE_ZOOM_SCALE > 1.085 ||
                ...
                if (this.elm.properties['Show Name'] === global.ON) {
                    if (this.elm.rotation === global.ROTATION_90) {
                        canvas.draw_text(global.ELEMENT_VAL_TEMPLATE.replace('{VAL}', this.elm.properties['Name']).replace('{UNIT}', this.elm.properties['units']), this.c_x, this.bounds.top + this.bounds.get_height() * 0.2, this.text_paint);
                    }
                    else if (this.elm.rotation === global.ROTATION_270) {
                        canvas.draw_text(global.ELEMENT_VAL_TEMPLATE.replace('{VAL}', this.elm.properties['Name']).replace('{UNIT}', this.elm.properties['units']), this.c_x, this.bounds.bottom - this.bounds.get_height() * 0.2, this.text_paint);
                    }
                    else if (this.elm.rotation === global.ROTATION_0) {
                        canvas.rotate(this.bounds.left, this.c_y, -90);
                        canvas.draw_text(global.ELEMENT_VAL_TEMPLATE.replace('{VAL}', this.elm.properties['Name']).replace('{UNIT}', this.elm.properties['units']), this.bounds.left, this.c_y + this.bounds.get_height() * 0.2, this.text_paint);
                        canvas.restore();
                    }
                    else if (this.elm.rotation === global.ROTATION_180) {
                        canvas.rotate(this.bounds.right, this.c_y, -90);
                        canvas.draw_text(global.ELEMENT_VAL_TEMPLATE.replace('{VAL}', this.elm.properties['Name']).replace('{UNIT}', this.elm.properties['units']), this.bounds.right, this.c_y - this.bounds.get_height() * 0.2, this.text_paint);
                        canvas.restore();
                    }
                }
            }
    ...
    Net.prototype.time_data = function () {
