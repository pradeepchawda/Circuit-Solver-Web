 ...
 *
 * Purpose           : A class to handle the Voltage Multiplier element. It will automatically generate
...
var Multiplier = /** @class */ (function () {
    function Multiplier(type, id, n1, n2, n3) {
    ...
    Multiplier.prototype.refresh_bounds = function () {
        if (this.elm.consistent()) {
            this.p1 = new PointF(0, 0);
            this.p2 = new PointF(0, 0);
            this.p3 = new PointF(0, 0);
    ...
    Multiplier.prototype.push_reference = function (ref) {
    ...
    Multiplier.prototype.stamp = function () {
        if (this.elm.consistent()) {
    ...
    Multiplier.prototype.get_vertices = function () {
        var vertices = [];
        var p1 = [];
        var p2 = [];
        var p3 = [];
    ...
    Multiplier.prototype.release_wires = function () {
    ...
    Multiplier.prototype.release_nodes = function () {
        if (this.elm.consistent()) {
    ...
    Multiplier.prototype.capture_nodes = function () {
        var vertices = this.get_vertices();
        this.elm.map_node3(vertices[0], vertices[1], vertices[2], vertices[3], vertices[4], vertices[5]);
    ...
    Multiplier.prototype.mouse_down = function () {
        if (global.FLAG_IDLE &&
    ...
    Multiplier.prototype.handle_wire_builder = function (n, anchor) {
    ...
    Multiplier.prototype.move_element = function (dx, dy) {
    ...
    Multiplier.prototype.mouse_move = function () {
    ...
    Multiplier.prototype.mouse_up = function () {
        if (global.FLAG_IDLE) {
            if (global.focused &&
                global.focused_id === this.elm.id &&
                global.focused_type === this.elm.type) {
    ...
    Multiplier.prototype.select = function () {
        if (global.WIRE_BUILDER['step'] != 0) {
            wire_manager.reset_wire_builder();
        }
    ...
    Multiplier.prototype.remove_focus = function () {
        if (global.focused &&
            global.focused_id === this.elm.id &&
            global.focused_type === this.elm.type) {
            global.focused_id = global.NULL;
    ...
    Multiplier.prototype.remove_selection = function () {
        if (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type) {
            global.selected_id = global.NULL;
            global.selected_type = -1;
    ...
    Multiplier.prototype.wire_reference_maintenance = function () {
    ...
    Multiplier.prototype.unanchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    Multiplier.prototype.anchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    Multiplier.prototype.set_flip = function (flip) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    Multiplier.prototype.set_rotation = function (rotation) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    Multiplier.prototype.push_history = function () {
        if (this.INITIALIZED) {
            global.HISTORY_MANAGER['packet'].push(engine_functions.history_snapshot());
        }
    };
    /* Generate the SVG for the component. */
    Multiplier.prototype.build_element = function () {
        if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
            ...
            /* Top segment */
            this.multiplier_0.x = this.p1.x + cache_0 * global.cosine(this.theta_m90);
            this.multiplier_0.y = this.p1.y + cache_1 * global.sine(this.theta_m90);
            this.multiplier_1.x =
                this.multiplier_0.x + cache_4 * global.cosine(this.theta);
            this.multiplier_1.y =
                this.multiplier_0.y + cache_5 * global.sine(this.theta);
            this.multiplier_2.x =
                this.multiplier_1.x + cache_2 * global.cosine(this.theta - Math.PI);
            this.multiplier_2.y =
                this.multiplier_1.y + cache_3 * global.sine(this.theta - Math.PI);
            /* Bottom segment */
            this.multiplier_3.x = this.p2.x + cache_0 * global.cosine(this.theta_m90);
            this.multiplier_3.y = this.p2.y + cache_1 * global.sine(this.theta_m90);
            this.multiplier_4.x =
                this.multiplier_3.x - cache_4 * global.cosine(this.theta);
            this.multiplier_4.y =
                this.multiplier_3.y - cache_5 * global.sine(this.theta);
            this.multiplier_5.x =
                this.multiplier_4.x + cache_2 * global.cosine(this.theta);
            this.multiplier_5.y =
                this.multiplier_4.y + cache_3 * global.sine(this.theta);
            /* End Segment */
    ...
    Multiplier.prototype.resize = function () {
        if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
    ...
    Multiplier.prototype.refactor = function () {
    ...
    Multiplier.prototype.increment_rotation = function () {
        this.elm.rotation++;
    ...
    Multiplier.prototype.increment_flip = function () { };
    Multiplier.prototype.recolor = function () {
        if (global.selected) {
            if (global.selected_id === this.elm.id &&
                global.selected_type === this.elm.type) {
    ...
    Multiplier.prototype.is_selected_element = function () {
        return (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type);
    };
    /* Draws the component */
    Multiplier.prototype.draw_component = function (canvas) {
    ...
    Multiplier.prototype.patch = function () {
    ...
    Multiplier.prototype.time_data = function () {
