...
class VoltageControlledCurrentSource {
    constructor(type, id, n1, n2, n3, n4) {
        ...
        this.elm = new Element4(id, type, global.utils.copy(global.PROPERTY_VCCS));
    ...
    build_element() {
        if (this.build_element_flag || global.flags.signal_build_element) {
            ...
            this.vccs_5.x = this.vccs_4.x + cache_2 * global.utils.cosine(this.theta - global.PI_DIV_4);
            this.vccs_5.y = this.vccs_4.y + cache_3 * global.utils.sine(this.theta - global.PI_DIV_4);
            this.vccs_6.x = this.vccs_4.x + cache_2 * global.utils.cosine(this.theta + global.PI_DIV_4);
            this.vccs_6.y = this.vccs_4.y + cache_3 * global.utils.sine(this.theta + global.PI_DIV_4);
            ...
            this.vccs_8.x = this.vccs_7.x - cache_2 * global.utils.cosine(this.theta - global.PI_DIV_4);
            this.vccs_8.y = this.vccs_7.y - cache_3 * global.utils.sine(this.theta - global.PI_DIV_4);
            this.vccs_9.x = this.vccs_7.x - cache_2 * global.utils.cosine(this.theta + global.PI_DIV_4);
            this.vccs_9.y = this.vccs_7.y - cache_3 * global.utils.sine(this.theta + global.PI_DIV_4);
            ...
            this.vccs_16.x = this.p1.x + cache_12 * global.utils.cosine(this.theta_m90 + global.PI_DIV_4);
            this.vccs_16.y = this.p1.y + cache_13 * global.utils.sine(this.theta_m90 + global.PI_DIV_4);
