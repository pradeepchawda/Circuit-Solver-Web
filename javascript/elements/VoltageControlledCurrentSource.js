 ...
 *
 ***********************************************************************/
var VoltageControlledCurrentSource = /** @class */ (function () {
    function VoltageControlledCurrentSource(type, id, n1, n2, n3, n4) {
    ...
    VoltageControlledCurrentSource.prototype.refresh_bounds = function () {
        if (this.elm.consistent()) {
            this.p1 = new PointF(0, 0);
            this.p2 = new PointF(0, 0);
            this.p3 = new PointF(0, 0);
    ...
    VoltageControlledCurrentSource.prototype.push_reference = function (ref) {
        this.wire_reference.push(ref);
    };
    /* General function to handle any processing required by the component */
    VoltageControlledCurrentSource.prototype.update = function () { };
    VoltageControlledCurrentSource.prototype.stamp = function () {
        if (this.elm.consistent()) {
    ...
    VoltageControlledCurrentSource.prototype.get_vertices = function () {
        var vertices = [];
        var p1 = [];
        var p2 = [];
        var p3 = [];
    ...
    VoltageControlledCurrentSource.prototype.release_wires = function () {
    ...
    VoltageControlledCurrentSource.prototype.release_nodes = function () {
        if (this.elm.consistent()) {
    ...
    VoltageControlledCurrentSource.prototype.capture_nodes = function () {
        var vertices = this.get_vertices();
        this.elm.map_node4(vertices[0], vertices[1], vertices[2], vertices[3], vertices[4], vertices[5], vertices[6], vertices[7]);
    ...
    VoltageControlledCurrentSource.prototype.mouse_down = function () {
        if (global.FLAG_IDLE &&
    ...
    VoltageControlledCurrentSource.prototype.handle_wire_builder = function (n, anchor) {
    ...
    VoltageControlledCurrentSource.prototype.move_element = function (dx, dy) {
    ...
    VoltageControlledCurrentSource.prototype.mouse_move = function () {
    ...
    VoltageControlledCurrentSource.prototype.mouse_up = function () {
        if (global.FLAG_IDLE) {
            if (global.focused &&
                global.focused_id === this.elm.id &&
                global.focused_type === this.elm.type) {
    ...
    VoltageControlledCurrentSource.prototype.select = function () {
        if (global.WIRE_BUILDER['step'] != 0) {
            wire_manager.reset_wire_builder();
        }
    ...
    VoltageControlledCurrentSource.prototype.remove_focus = function () {
        if (global.focused &&
            global.focused_id === this.elm.id &&
            global.focused_type === this.elm.type) {
            global.focused_id = global.NULL;
    ...
    VoltageControlledCurrentSource.prototype.remove_selection = function () {
        if (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type) {
            global.selected_id = global.NULL;
            global.selected_type = -1;
    ...
    VoltageControlledCurrentSource.prototype.wire_reference_maintenance = function () {
    ...
    VoltageControlledCurrentSource.prototype.unanchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    VoltageControlledCurrentSource.prototype.anchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    VoltageControlledCurrentSource.prototype.set_flip = function (flip) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    VoltageControlledCurrentSource.prototype.set_rotation = function (rotation) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    VoltageControlledCurrentSource.prototype.push_history = function () {
        if (this.INITIALIZED) {
            global.HISTORY_MANAGER['packet'].push(engine_functions.history_snapshot());
        }
    };
    /* Generate the SVG for the component. */
    VoltageControlledCurrentSource.prototype.build_element = function () {
        if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
            ...
            this.vccs_5.x =
                this.vccs_4.x + cache_2 * global.cosine(this.theta - global.PI_DIV_4);
            this.vccs_5.y =
                this.vccs_4.y + cache_3 * global.sine(this.theta - global.PI_DIV_4);
            this.vccs_6.x =
                this.vccs_4.x + cache_2 * global.cosine(this.theta + global.PI_DIV_4);
            this.vccs_6.y =
                this.vccs_4.y + cache_3 * global.sine(this.theta + global.PI_DIV_4);
            ...
            this.vccs_8.x =
                this.vccs_7.x - cache_2 * global.cosine(this.theta - global.PI_DIV_4);
            this.vccs_8.y =
                this.vccs_7.y - cache_3 * global.sine(this.theta - global.PI_DIV_4);
            this.vccs_9.x =
                this.vccs_7.x - cache_2 * global.cosine(this.theta + global.PI_DIV_4);
            this.vccs_9.y =
                this.vccs_7.y - cache_3 * global.sine(this.theta + global.PI_DIV_4);
    ...
    VoltageControlledCurrentSource.prototype.resize = function () {
        if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
    ...
    VoltageControlledCurrentSource.prototype.refactor = function () {
    ...
    VoltageControlledCurrentSource.prototype.increment_rotation = function () {
        this.elm.rotation++;
    ...
    VoltageControlledCurrentSource.prototype.increment_flip = function () { };
    VoltageControlledCurrentSource.prototype.recolor = function () {
        if (global.selected) {
            if (global.selected_id === this.elm.id &&
                global.selected_type === this.elm.type) {
    ...
    VoltageControlledCurrentSource.prototype.is_selected_element = function () {
        return (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type);
    };
    /* Draws the component */
    VoltageControlledCurrentSource.prototype.draw_component = function (canvas) {
    ...
    VoltageControlledCurrentSource.prototype.patch = function () {
    ...
    VoltageControlledCurrentSource.prototype.time_data = function () {
    ...
    VoltageControlledCurrentSource.prototype.reset = function () { };
