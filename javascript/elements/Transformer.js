...
var Transformer = /** @class */ (function () {
    function Transformer(type, id, n1, n2, n3, n4) {
    ...
    Transformer.prototype.refresh_bounds = function () {
        if (this.elm.consistent()) {
            this.p1 = new PointF(0, 0);
            this.p2 = new PointF(0, 0);
            this.p3 = new PointF(0, 0);
    ...
    Transformer.prototype.push_reference = function (ref) {
        this.wire_reference.push(ref);
    };
    /* General function to handle any processing required by the component */
    Transformer.prototype.update = function () { };
    Transformer.prototype.stamp = function () {
        if (this.elm.consistent()) {
    ...
    Transformer.prototype.get_vertices = function () {
        var vertices = [];
        var p1 = [];
        var p2 = [];
        var p3 = [];
    ...
    Transformer.prototype.release_wires = function () {
    ...
    Transformer.prototype.release_nodes = function () {
        if (this.elm.consistent()) {
    ...
    Transformer.prototype.capture_nodes = function () {
        var vertices = this.get_vertices();
        this.elm.map_node4(vertices[0], vertices[1], vertices[2], vertices[3], vertices[4], vertices[5], vertices[6], vertices[7]);
    ...
    Transformer.prototype.mouse_down = function () {
        if (global.FLAG_IDLE &&
    ...
    Transformer.prototype.handle_wire_builder = function (n, anchor) {
    ...
    Transformer.prototype.move_element = function (dx, dy) {
    ...
    Transformer.prototype.mouse_move = function () {
    ...
    Transformer.prototype.mouse_up = function () {
        if (global.FLAG_IDLE) {
            if (global.focused &&
                global.focused_id === this.elm.id &&
                global.focused_type === this.elm.type) {
    ...
    Transformer.prototype.select = function () {
        if (global.WIRE_BUILDER['step'] != 0) {
            wire_manager.reset_wire_builder();
        }
    ...
    Transformer.prototype.remove_focus = function () {
        if (global.focused &&
            global.focused_id === this.elm.id &&
            global.focused_type === this.elm.type) {
            global.focused_id = global.NULL;
    ...
    Transformer.prototype.remove_selection = function () {
        if (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type) {
            global.selected_id = global.NULL;
            global.selected_type = -1;
    ...
    Transformer.prototype.wire_reference_maintenance = function () {
    ...
    Transformer.prototype.unanchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    Transformer.prototype.anchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    Transformer.prototype.set_flip = function (flip) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    Transformer.prototype.set_rotation = function (rotation) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    Transformer.prototype.push_history = function () {
        if (this.INITIALIZED) {
            global.HISTORY_MANAGER['packet'].push(engine_functions.history_snapshot());
        }
    };
    /* Generate the SVG for the component. */
    Transformer.prototype.build_element = function () {
        if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
            ...
            /* Left current dot */
            this.trans_10.x =
                this.trans_4.x - cache_4 * global.cosine(this.theta_m90);
            ...
            this.trans_11.x =
                this.trans_7.x + cache_4 * global.cosine(this.theta_m90);
            this.BUILD_ELEMENT = false;
        }
    };
    /* General function to help with resizing, i.e., canvas dimension change, zooming*/
    Transformer.prototype.resize = function () {
        if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
    ...
    Transformer.prototype.refactor = function () {
    ...
    Transformer.prototype.increment_rotation = function () {
        this.elm.rotation++;
    ...
    Transformer.prototype.increment_flip = function () { };
    Transformer.prototype.recolor = function () {
        if (global.selected) {
            if (global.selected_id === this.elm.id &&
                global.selected_type === this.elm.type) {
    ...
    Transformer.prototype.is_selected_element = function () {
        return (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type);
    };
    /* Draws the component */
    Transformer.prototype.draw_component = function (canvas) {
        ...
        if (global.PICTURE_REQUEST ||
            ...
            this.CIRCLE_BUFFER[this.indexer++] = Array(this.trans_10.x, this.trans_10.y, global.CANVAS_STROKE_WIDTH_2_ZOOM);
            this.CIRCLE_BUFFER[this.indexer++] = Array(this.trans_11.x, this.trans_11.y, global.CANVAS_STROKE_WIDTH_2_ZOOM);
            ...
            if (global.WORKSPACE_ZOOM_SCALE > 1.085 ||
                ...
                if ((this.ANGLE > 170 && this.ANGLE < 190) ||
                    ...
                    canvas.draw_text(global.ELEMENT_VAL_TEMPLATE.replace('{VAL}', global.exponentiate_quickly(this.elm.properties['Turns Ratio'])).replace('{UNIT}', this.elm.properties['units']), this.c_x, this.bounds.top - this.bounds.get_height() * 0.15, this.text_paint);
    ...
    Transformer.prototype.patch = function () {
    ...
    Transformer.prototype.time_data = function () {
