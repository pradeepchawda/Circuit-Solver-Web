...
var Adder = /** @class */ (function () {
    function Adder(type, id, n1, n2, n3) {
      ...
      or overlapped)*/
        ...
        this.bounds = new RectF(0, 0, 0, 0);
        /* Inititalize the element2 class that will hold the basic data about our component */
        this.elm = new Element3(id, type, global.copy(global.PROPERTY_ADD));
    ...
    Adder.prototype.refresh_bounds = function () {
        if (this.elm.consistent()) {
            this.p1 = new PointF(0, 0);
            this.p2 = new PointF(0, 0);
            this.p3 = new PointF(0, 0);
    ...
    Adder.prototype.push_reference = function (ref) {
    ...
    Adder.prototype.stamp = function () {
        if (this.elm.consistent()) {
    ...
    Adder.prototype.get_vertices = function () {
        var vertices = [];
        var p1 = [];
        var p2 = [];
        var p3 = [];
    ...
    Adder.prototype.release_wires = function () {
    ...
    Adder.prototype.release_nodes = function () {
        if (this.elm.consistent()) {
    ...
    Adder.prototype.capture_nodes = function () {
        var vertices = this.get_vertices();
        this.elm.map_node3(vertices[0], vertices[1], vertices[2], vertices[3], vertices[4], vertices[5]);
    ...
    Adder.prototype.mouse_down = function () {
        if (global.FLAG_IDLE &&
    ...
    Adder.prototype.handle_wire_builder = function (n, anchor) {
    ...
    Adder.prototype.move_element = function (dx, dy) {
    ...
    Adder.prototype.mouse_move = function () {
    ...
    Adder.prototype.mouse_up = function () {
        if (global.FLAG_IDLE) {
            if (global.focused &&
                global.focused_id === this.elm.id &&
                global.focused_type === this.elm.type) {
    ...
    Adder.prototype.select = function () {
        if (global.WIRE_BUILDER['step'] != 0) {
            wire_manager.reset_wire_builder();
        }
    ...
    Adder.prototype.remove_focus = function () {
        if (global.focused &&
            global.focused_id === this.elm.id &&
            global.focused_type === this.elm.type) {
            global.focused_id = global.NULL;
    ...
    Adder.prototype.remove_selection = function () {
        if (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type) {
            global.selected_id = global.NULL;
            global.selected_type = -1;
    ...
    Adder.prototype.wire_reference_maintenance = function () {
    ...
    Adder.prototype.unanchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    Adder.prototype.anchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    Adder.prototype.set_flip = function (flip) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    Adder.prototype.set_rotation = function (rotation) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    Adder.prototype.push_history = function () {
        if (this.INITIALIZED) {
            global.HISTORY_MANAGER['packet'].push(engine_functions.history_snapshot());
        }
    };
    /* Generate the SVG for the component. */
    Adder.prototype.build_element = function () {
        if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
            ...
            /* Top segment */
            this.adder_0.x = this.p1.x + cache_0 * global.cosine(this.theta_m90);
            this.adder_0.y = this.p1.y + cache_1 * global.sine(this.theta_m90);
            this.adder_1.x = this.adder_0.x + cache_4 * global.cosine(this.theta);
            this.adder_1.y = this.adder_0.y + cache_5 * global.sine(this.theta);
            this.adder_2.x =
                this.adder_1.x + cache_2 * global.cosine(this.theta - Math.PI);
            this.adder_2.y =
                this.adder_1.y + cache_3 * global.sine(this.theta - Math.PI);
            /* Bottom segment */
            this.adder_3.x = this.p2.x + cache_0 * global.cosine(this.theta_m90);
            this.adder_3.y = this.p2.y + cache_1 * global.sine(this.theta_m90);
            this.adder_4.x = this.adder_3.x - cache_4 * global.cosine(this.theta);
            this.adder_4.y = this.adder_3.y - cache_5 * global.sine(this.theta);
            this.adder_5.x = this.adder_4.x + cache_2 * global.cosine(this.theta);
            this.adder_5.y = this.adder_4.y + cache_3 * global.sine(this.theta);
            /* End Segment */
            this.adder_6.x = this.p3.x - cache_4 * global.cosine(this.theta_m90);
            this.adder_6.y = this.p3.y - cache_5 * global.sine(this.theta_m90);
            this.BUILD_ELEMENT = false;
        }
    };
    /* General function to help with resizing, i.e., canvas dimension change, zooming*/
    Adder.prototype.resize = function () {
        if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
    ...
    Adder.prototype.refactor = function () {
    ...
    Adder.prototype.increment_rotation = function () {
        this.elm.rotation++;
    ...
    Adder.prototype.increment_flip = function () { };
    Adder.prototype.recolor = function () {
        if (global.selected) {
            if (global.selected_id === this.elm.id &&
                global.selected_type === this.elm.type) {
    ...
    Adder.prototype.is_selected_element = function () {
        return (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type);
    };
    /* Draws the component */
    Adder.prototype.draw_component = function (canvas) {
    ...
    Adder.prototype.patch = function () {
    ...
    Adder.prototype.time_data = function () {
    ...
    Adder.prototype.reset = function () {
