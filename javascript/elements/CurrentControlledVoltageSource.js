...
class CurrentControlledVoltageSource {
    constructor(type, id, n1, n2, n3, n4) {
        ...
        this.elm = new Element4(id, type, global.utils.copy(global.PROPERTY_CCVS));
    ...
    build_element() {
        if (this.build_element_flag || global.flags.signal_build_element) {
            ...
            this.vcvs_5.x = this.vcvs_4.x + cache_2 * global.utils.cosine(this.theta - global.PI_DIV_4);
            this.vcvs_5.y = this.vcvs_4.y + cache_3 * global.utils.sine(this.theta - global.PI_DIV_4);
            this.vcvs_6.x = this.vcvs_4.x + cache_2 * global.utils.cosine(this.theta + global.PI_DIV_4);
            this.vcvs_6.y = this.vcvs_4.y + cache_3 * global.utils.sine(this.theta + global.PI_DIV_4);
            ...
            this.vcvs_8.x = this.vcvs_7.x - cache_2 * global.utils.cosine(this.theta - global.PI_DIV_4);
            this.vcvs_8.y = this.vcvs_7.y - cache_3 * global.utils.sine(this.theta - global.PI_DIV_4);
            this.vcvs_9.x = this.vcvs_7.x - cache_2 * global.utils.cosine(this.theta + global.PI_DIV_4);
            this.vcvs_9.y = this.vcvs_7.y - cache_3 * global.utils.sine(this.theta + global.PI_DIV_4);
            ...
            this.vcvs_16.x = this.p1.x + cache_12 * global.utils.cosine(this.theta_m90 + global.PI_DIV_4);
            this.vcvs_16.y = this.p1.y + cache_13 * global.utils.sine(this.theta_m90 + global.PI_DIV_4);
