 ...
 * File		        : CurrentControlledVoltageSource.js
 * Author            : nboatengc
 * Date created      : 20190928
 *
 * Purpose           : A class to handle the Current Controlled Voltage Source element. It will automatically generate
 ...
 *
 ***********************************************************************/
var CurrentControlledVoltageSource = /** @class */ (function () {
    function CurrentControlledVoltageSource(type, id, n1, n2, n3, n4) {
      ...
      or overlapped)*/
        ...
        this.bounds = new RectF(0, 0, 0, 0);
        /* Inititalize the element2 class that will hold the basic data about our component */
        this.elm = new Element4(id, type, global.copy(global.PROPERTY_CCVS));
    ...
    CurrentControlledVoltageSource.prototype.refresh_bounds = function () {
        if (this.elm.consistent()) {
            this.p1 = new PointF(0, 0);
            this.p2 = new PointF(0, 0);
            this.p3 = new PointF(0, 0);
    ...
    CurrentControlledVoltageSource.prototype.push_reference = function (ref) {
        this.wire_reference.push(ref);
    };
    /* General function to handle any processing required by the component */
    CurrentControlledVoltageSource.prototype.update = function () { };
    CurrentControlledVoltageSource.prototype.stamp = function () {
        if (this.elm.consistent()) {
    ...
    CurrentControlledVoltageSource.prototype.get_vertices = function () {
        var vertices = [];
        var p1 = [];
        var p2 = [];
        var p3 = [];
    ...
    CurrentControlledVoltageSource.prototype.release_wires = function () {
    ...
    CurrentControlledVoltageSource.prototype.release_nodes = function () {
        if (this.elm.consistent()) {
    ...
    CurrentControlledVoltageSource.prototype.capture_nodes = function () {
        var vertices = this.get_vertices();
        this.elm.map_node4(vertices[0], vertices[1], vertices[2], vertices[3], vertices[4], vertices[5], vertices[6], vertices[7]);
    ...
    CurrentControlledVoltageSource.prototype.mouse_down = function () {
        if (global.FLAG_IDLE &&
    ...
    CurrentControlledVoltageSource.prototype.handle_wire_builder = function (n, anchor) {
    ...
    CurrentControlledVoltageSource.prototype.move_element = function (dx, dy) {
    ...
    CurrentControlledVoltageSource.prototype.mouse_move = function () {
    ...
    CurrentControlledVoltageSource.prototype.mouse_up = function () {
        if (global.FLAG_IDLE) {
            if (global.focused &&
                global.focused_id === this.elm.id &&
                global.focused_type === this.elm.type) {
    ...
    CurrentControlledVoltageSource.prototype.select = function () {
        if (global.WIRE_BUILDER['step'] != 0) {
            wire_manager.reset_wire_builder();
        }
    ...
    CurrentControlledVoltageSource.prototype.remove_focus = function () {
        if (global.focused &&
            global.focused_id === this.elm.id &&
            global.focused_type === this.elm.type) {
            global.focused_id = global.NULL;
    ...
    CurrentControlledVoltageSource.prototype.remove_selection = function () {
        if (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type) {
            global.selected_id = global.NULL;
            global.selected_type = -1;
    ...
    CurrentControlledVoltageSource.prototype.wire_reference_maintenance = function () {
    ...
    CurrentControlledVoltageSource.prototype.unanchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    CurrentControlledVoltageSource.prototype.anchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    CurrentControlledVoltageSource.prototype.set_flip = function (flip) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    CurrentControlledVoltageSource.prototype.set_rotation = function (rotation) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    CurrentControlledVoltageSource.prototype.push_history = function () {
        if (this.INITIALIZED) {
            global.HISTORY_MANAGER['packet'].push(engine_functions.history_snapshot());
        }
    };
    /* Generate the SVG for the component. */
    CurrentControlledVoltageSource.prototype.build_element = function () {
        if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
            ...
            /* Bottom Segment (left) */
            this.vcvs_1.x = this.p2.x + cache_14 * global.cosine(this.theta_m90);
            this.vcvs_1.y = this.p2.y + cache_15 * global.sine(this.theta_m90);
            /* Top segment (right) */
            this.vcvs_2.x = this.p1.x + cache_0 * global.cosine(this.theta_m90);
            this.vcvs_2.y = this.p1.y + cache_1 * global.sine(this.theta_m90);
            /* Bottom Segment (right)  */
            this.vcvs_3.x = this.p2.x + cache_0 * global.cosine(this.theta_m90);
            this.vcvs_3.y = this.p2.y + cache_1 * global.sine(this.theta_m90);
            /* Diamond */
            this.vcvs_4.x = this.vcvs_2.x + cache_14 * global.cosine(this.theta);
            this.vcvs_4.y = this.vcvs_2.y + cache_15 * global.sine(this.theta);
            this.vcvs_5.x =
                this.vcvs_4.x + cache_2 * global.cosine(this.theta - global.PI_DIV_4);
            this.vcvs_5.y =
                this.vcvs_4.y + cache_3 * global.sine(this.theta - global.PI_DIV_4);
            this.vcvs_6.x =
                this.vcvs_4.x + cache_2 * global.cosine(this.theta + global.PI_DIV_4);
            this.vcvs_6.y =
                this.vcvs_4.y + cache_3 * global.sine(this.theta + global.PI_DIV_4);
            /* Bottom Half of Diamond */
            this.vcvs_7.x = this.vcvs_2.x + cache_0 * global.cosine(this.theta);
            this.vcvs_7.y = this.vcvs_2.y + cache_1 * global.sine(this.theta);
            this.vcvs_8.x =
                this.vcvs_7.x - cache_2 * global.cosine(this.theta - global.PI_DIV_4);
            this.vcvs_8.y =
                this.vcvs_7.y - cache_3 * global.sine(this.theta - global.PI_DIV_4);
            this.vcvs_9.x =
                this.vcvs_7.x - cache_2 * global.cosine(this.theta + global.PI_DIV_4);
            this.vcvs_9.y =
                this.vcvs_7.y - cache_3 * global.sine(this.theta + global.PI_DIV_4);
            /* Plus point */
            this.vcvs_10.x = this.vcvs_2.x + cache_4 * global.cosine(this.theta);
            this.vcvs_10.y = this.vcvs_2.y + cache_5 * global.sine(this.theta);
            this.vcvs_11.x = this.vcvs_2.x + cache_6 * global.cosine(this.theta);
            this.vcvs_11.y = this.vcvs_2.y + cache_7 * global.sine(this.theta);
            this.vcvs_12.x =
                this.vcvs_2.x +
                    cache_8 * global.cosine(this.theta) +
                    (cache_14 >> 2) * global.cosine(this.theta_m90);
            this.vcvs_12.y =
                this.vcvs_2.y +
                    cache_9 * global.sine(this.theta) +
                    (cache_15 >> 2) * global.sine(this.theta_m90);
            this.vcvs_13.x =
                this.vcvs_2.x +
                    cache_8 * global.cosine(this.theta) -
                    (cache_14 >> 2) * global.cosine(this.theta_m90);
            ...
            this.vcvs_16.x =
                this.p1.x + cache_12 * global.cosine(this.theta_m90 + global.PI_DIV_4);
            this.vcvs_16.y =
    ...
    CurrentControlledVoltageSource.prototype.resize = function () {
        if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
    ...
    CurrentControlledVoltageSource.prototype.refactor = function () {
    ...
    CurrentControlledVoltageSource.prototype.increment_rotation = function () {
        this.elm.rotation++;
    ...
    CurrentControlledVoltageSource.prototype.increment_flip = function () { };
    CurrentControlledVoltageSource.prototype.recolor = function () {
        if (global.selected) {
            if (global.selected_id === this.elm.id &&
                global.selected_type === this.elm.type) {
    ...
    CurrentControlledVoltageSource.prototype.is_selected_element = function () {
        return (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type);
    };
    /* Draws the component */
    CurrentControlledVoltageSource.prototype.draw_component = function (canvas) {
    ...
    CurrentControlledVoltageSource.prototype.patch = function () {
    ...
    CurrentControlledVoltageSource.prototype.time_data = function () {
    ...
    CurrentControlledVoltageSource.prototype.reset = function () { };
