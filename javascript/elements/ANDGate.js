 ...
 *
 * Purpose           : A class to handle the ANDGate element. It will automatically generate
...
var ANDGate = /** @class */ (function () {
    function ANDGate(type, id, n1, n2, n3) {
    ...
    ANDGate.prototype.refresh_bounds = function () {
        if (this.elm.consistent()) {
            this.p1 = new PointF(0, 0);
            this.p2 = new PointF(0, 0);
            this.p3 = new PointF(0, 0);
    ...
    ANDGate.prototype.push_reference = function (ref) {
            ...
            if (this.elm.consistent()) {
                ...
                this.elm.properties['Output Voltage'] =
                    (this.elm.properties['High Voltage'] * 2.0) /
                        (2 / (1 + this.elm.properties['Input Voltage1']) +
                            2.0 / (1 + this.elm.properties['Input Voltage2']));
            }
        }
    };
    ANDGate.prototype.stamp = function () {
        if (this.elm.consistent()) {
    ...
    ANDGate.prototype.get_vertices = function () {
        var vertices = [];
        var p1 = [];
        var p2 = [];
        var p3 = [];
    ...
    ANDGate.prototype.release_wires = function () {
    ...
    ANDGate.prototype.release_nodes = function () {
        if (this.elm.consistent()) {
    ...
    ANDGate.prototype.capture_nodes = function () {
        var vertices = this.get_vertices();
        this.elm.map_node3(vertices[0], vertices[1], vertices[2], vertices[3], vertices[4], vertices[5]);
    ...
    ANDGate.prototype.mouse_down = function () {
        if (global.FLAG_IDLE &&
    ...
    ANDGate.prototype.handle_wire_builder = function (n, anchor) {
    ...
    ANDGate.prototype.move_element = function (dx, dy) {
    ...
    ANDGate.prototype.mouse_move = function () {
    ...
    ANDGate.prototype.mouse_up = function () {
        if (global.FLAG_IDLE) {
            if (global.focused &&
                global.focused_id === this.elm.id &&
                global.focused_type === this.elm.type) {
    ...
    ANDGate.prototype.select = function () {
        if (global.WIRE_BUILDER['step'] != 0) {
            wire_manager.reset_wire_builder();
        }
    ...
    ANDGate.prototype.remove_focus = function () {
        if (global.focused &&
            global.focused_id === this.elm.id &&
            global.focused_type === this.elm.type) {
            global.focused_id = global.NULL;
    ...
    ANDGate.prototype.remove_selection = function () {
        if (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type) {
            global.selected_id = global.NULL;
            global.selected_type = -1;
    ...
    ANDGate.prototype.wire_reference_maintenance = function () {
    ...
    ANDGate.prototype.unanchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    ANDGate.prototype.anchor_wires = function () {
        if (this.wire_reference.length > 0) {
            var vertices = this.get_vertices();
            var id = -1;
            for (var i = this.wire_reference.length - 1; i > -1; i--) {
    ...
    ANDGate.prototype.set_flip = function (flip) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    ANDGate.prototype.set_rotation = function (rotation) {
        this.BUILD_ELEMENT = true;
        wire_manager.reset_wire_builder();
        this.unanchor_wires();
        this.push_history();
    ...
    ANDGate.prototype.push_history = function () {
        if (this.INITIALIZED) {
            global.HISTORY_MANAGER['packet'].push(engine_functions.history_snapshot());
        }
    };
    /* Generate the SVG for the component. */
    ANDGate.prototype.build_element = function () {
        if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
            ...
            this.and_2.x =
                this.and_1.x + cache_2 * global.cosine(this.theta - Math.PI);
    ...
    ANDGate.prototype.resize = function () {
        if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
    ...
    ANDGate.prototype.refactor = function () {
    ...
    ANDGate.prototype.increment_rotation = function () {
        this.elm.rotation++;
    ...
    ANDGate.prototype.increment_flip = function () { };
    ANDGate.prototype.recolor = function () {
        if (global.selected) {
            if (global.selected_id === this.elm.id &&
                global.selected_type === this.elm.type) {
    ...
    ANDGate.prototype.is_selected_element = function () {
        return (global.selected_id === this.elm.id &&
            global.selected_type === this.elm.type);
    };
    /* Draws the component */
    ANDGate.prototype.draw_component = function (canvas) {
    ...
    ANDGate.prototype.patch = function () {
    ...
    ANDGate.prototype.time_data = function () {
    ...
    ANDGate.prototype.reset = function () {
