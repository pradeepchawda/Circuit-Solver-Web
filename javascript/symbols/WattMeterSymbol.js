 ...
 *
 ***********************************************************************/
var WattMeterSymbol = /** @class */ (function () {
    function WattMeterSymbol(rect, index, page) {
    ...
    WattMeterSymbol.prototype.update = function () {
    ...
    WattMeterSymbol.prototype.mouse_down = function (page, width, height) {
        if (this.page === page) {
    ...
    WattMeterSymbol.prototype.mouse_move = function (page, width, height) {
        if (this.bounds.contains_xywh(global.mouse_x, global.mouse_y, width, height) &&
            !global.MOBILE_MODE) {
            this.DRAW_TAG = true;
        }
    ...
    WattMeterSymbol.prototype.mouse_up = function (page, width, height) {
        if (this.page === page) {
            if (this.bounds.contains_xywh(global.mouse_x, global.mouse_y, width, height)) {
            }
            this.FLAG_ADD_ELEMENT = false;
    ...
    WattMeterSymbol.prototype.build_element = function () {
        /* Top segment */
        this.wattmeter_0.x =
        ...
        this.wattmeter_1.x =
            this.wattmeter_0.x + this.x_space * global.cosine(this.theta);
        this.wattmeter_1.y =
            this.wattmeter_0.y + this.y_space * global.sine(this.theta);
        this.wattmeter_2.x =
            this.wattmeter_1.x +
        ...
        this.wattmeter_4.x =
            this.wattmeter_3.x - this.x_space * global.cosine(this.theta);
        this.wattmeter_4.y =
            this.wattmeter_3.y - this.y_space * global.sine(this.theta);
        this.wattmeter_5.x =
            this.wattmeter_4.x + 0.75 * this.x_space * global.cosine(this.theta);
        this.wattmeter_5.y =
            this.wattmeter_4.y + 0.75 * this.y_space * global.sine(this.theta);
        /* End Segment */
        this.wattmeter_6.x =
            this.p3.x - this.x_space * global.cosine(this.theta_m90);
    ...
    WattMeterSymbol.prototype.resize = function (rect) {
        /* Create a new rectangle for the bounds of this component */
        this.bounds.set_bounds(rect.left, rect.top, rect.right, rect.bottom);
        /* The center (x-coord) of the bounds */
        this.c_x = this.bounds.get_center_x();
    ...
    WattMeterSymbol.prototype.recolor = function () {
        if (this.FLAG_ADD_ELEMENT) {
    ...
    /* Draws the Symbol */
    WattMeterSymbol.prototype.draw_symbol = function (canvas, page) {
        this.recolor();
        if (this.page === page) {
            var indexer = 0;
            this.CIRCLE_BUFFER = [];
