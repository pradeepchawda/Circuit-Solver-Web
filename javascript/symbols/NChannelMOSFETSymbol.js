 ...
 *
 ***********************************************************************/
var NChannelMOSFETSymbol = /** @class */ (function () {
    function NChannelMOSFETSymbol(rect, index, page) {
    ...
    NChannelMOSFETSymbol.prototype.update = function () {
    ...
    NChannelMOSFETSymbol.prototype.mouse_down = function (page, width, height) {
        if (this.page === page) {
    ...
    NChannelMOSFETSymbol.prototype.mouse_move = function (page, width, height) {
        if (this.bounds.contains_xywh(global.mouse_x, global.mouse_y, width, height) &&
            !global.MOBILE_MODE) {
            this.DRAW_TAG = true;
        }
    ...
    NChannelMOSFETSymbol.prototype.mouse_up = function (page, width, height) {
        if (this.page === page) {
            if (this.bounds.contains_xywh(global.mouse_x, global.mouse_y, width, height)) {
            }
            this.FLAG_ADD_ELEMENT = false;
    ...
    NChannelMOSFETSymbol.prototype.build_element = function () {
        /* Top segment */
        this.nmos_0.x = this.p1.x + this.x_space * global.cosine(this.theta);
        this.nmos_0.y = this.p1.y + this.y_space * global.sine(this.theta);
        this.nmos_1.x =
            this.nmos_0.x + 2 * this.x_space * global.cosine(this.theta_m90);
        this.nmos_1.y =
            this.nmos_0.y + 2 * this.y_space * global.sine(this.theta_m90);
        this.nmos_2.x =
            this.p1.x +
        ...
        this.nmos_4.x =
            this.nmos_3.x + 2 * this.x_space * global.cosine(this.theta_m90);
        this.nmos_4.y =
            this.nmos_3.y + 2 * this.y_space * global.sine(this.theta_m90);
        this.nmos_5.x =
            this.p1.x +
    ...
    NChannelMOSFETSymbol.prototype.resize = function (rect) {
        /* Create a new rectangle for the bounds of this component */
        this.bounds.set_bounds(rect.left, rect.top, rect.right, rect.bottom);
        /* The center (x-coord) of the bounds */
        this.c_x = this.bounds.get_center_x();
    ...
    NChannelMOSFETSymbol.prototype.recolor = function () {
        if (this.FLAG_ADD_ELEMENT) {
    ...
    /* Draws the Symbol */
    NChannelMOSFETSymbol.prototype.draw_symbol = function (canvas, page) {
        this.recolor();
        if (this.page === page) {
            var indexer = 0;
            this.CIRCLE_BUFFER = [];
