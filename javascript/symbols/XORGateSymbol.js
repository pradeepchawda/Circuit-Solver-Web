 ...
 *
 ***********************************************************************/
var XORGateSymbol = /** @class */ (function () {
    function XORGateSymbol(rect, index, page) {
    ...
    XORGateSymbol.prototype.update = function () {
    ...
    XORGateSymbol.prototype.mouse_down = function (page, width, height) {
        if (this.page === page) {
    ...
    XORGateSymbol.prototype.mouse_move = function (page, width, height) {
        if (this.bounds.contains_xywh(global.mouse_x, global.mouse_y, width, height) &&
            !global.MOBILE_MODE) {
            this.DRAW_TAG = true;
        }
    ...
    XORGateSymbol.prototype.mouse_up = function (page, width, height) {
        if (this.page === page) {
            if (this.bounds.contains_xywh(global.mouse_x, global.mouse_y, width, height)) {
            }
            this.FLAG_ADD_ELEMENT = false;
    ...
    XORGateSymbol.prototype.build_element = function () {
        /* Top segment */
        ...
        this.xor_1.x =
            this.xor_0.x + 0.75 * this.x_space * global.cosine(this.theta_m90);
        this.xor_1.y =
            this.xor_0.y + 0.75 * this.y_space * global.sine(this.theta_m90);
        this.xor_2.x =
            this.xor_1.x + 0.75 * this.x_space * global.cosine(this.theta - Math.PI);
        this.xor_2.y =
            this.xor_1.y + 0.75 * this.y_space * global.sine(this.theta - Math.PI);
        this.xor_9.x =
            this.xor_0.x +
        ...
        /* Overshoot of xor_1 */
        this.xor_7.x =
            this.xor_0.x + 1.05 * this.x_space * global.cosine(this.theta_m90);
        this.xor_7.y =
            this.xor_0.y + 1.05 * this.y_space * global.sine(this.theta_m90);
        /* Bottom segment */
        ...
        this.xor_4.x =
            this.xor_3.x + 0.75 * this.x_space * global.cosine(this.theta_m90);
        this.xor_4.y =
            this.xor_3.y + 0.75 * this.y_space * global.sine(this.theta_m90);
        this.xor_5.x =
            this.xor_4.x + 0.75 * this.x_space * global.cosine(this.theta);
        ...
        /* Overshoot of xor_4 */
        this.xor_8.x =
            this.xor_3.x + 1.05 * this.x_space * global.cosine(this.theta_m90);
        this.xor_8.y =
            this.xor_3.y + 1.05 * this.y_space * global.sine(this.theta_m90);
        /* End Segment */
        this.xor_6.x =
    ...
    XORGateSymbol.prototype.resize = function (rect) {
        /* Create a new rectangle for the bounds of this component */
        this.bounds.set_bounds(rect.left, rect.top, rect.right, rect.bottom);
        /* The center (x-coord) of the bounds */
        this.c_x = this.bounds.get_center_x();
    ...
    XORGateSymbol.prototype.recolor = function () {
        if (this.FLAG_ADD_ELEMENT) {
    ...
    /* Draws the Symbol */
    XORGateSymbol.prototype.draw_symbol = function (canvas, page) {
        this.recolor();
        if (this.page === page) {
            var indexer = 0;
            this.CIRCLE_BUFFER = [];
