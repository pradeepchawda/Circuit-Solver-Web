 ...
 * File		        : DCSourceSymbol.js
 * Author            : nboatengc
 * Date created      : 20190928
 *
 * Purpose           : A class to draw the dcsource element without worrying about the
 ...
 *
 ***********************************************************************/
var DCSourceSymbol = /** @class */ (function () {
    function DCSourceSymbol(rect, index, page) {
    ...
    DCSourceSymbol.prototype.update = function () {
    ...
    DCSourceSymbol.prototype.mouse_down = function (page, width, height) {
        if (this.page === page) {
    ...
    DCSourceSymbol.prototype.mouse_move = function (page, width, height) {
        if (this.bounds.contains_xywh(global.mouse_x, global.mouse_y, width, height) &&
            !global.MOBILE_MODE) {
            this.DRAW_TAG = true;
        }
    ...
    DCSourceSymbol.prototype.mouse_up = function (page, width, height) {
        if (this.page === page) {
            if (this.bounds.contains_xywh(global.mouse_x, global.mouse_y, width, height)) {
            }
            this.FLAG_ADD_ELEMENT = false;
    ...
    DCSourceSymbol.prototype.build_element = function () {
        this.dc_0.x =
            this.c_x +
    ...
    DCSourceSymbol.prototype.resize = function (rect) {
        /* Create a new rectangle for the bounds of this component */
        this.bounds.set_bounds(rect.left, rect.top, rect.right, rect.bottom);
        /* The center (x-coord) of the bounds */
        this.c_x = this.bounds.get_center_x();
    ...
    DCSourceSymbol.prototype.recolor = function () {
        if (this.FLAG_ADD_ELEMENT) {
    ...
    /* Draws the Symbol */
    DCSourceSymbol.prototype.draw_symbol = function (canvas, page) {
        this.recolor();
        if (this.page === page) {
            var indexer = 0;
            this.CIRCLE_BUFFER = [];
