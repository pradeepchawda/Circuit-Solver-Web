 ...
 *
 ***********************************************************************/
var DividerSymbol = /** @class */ (function () {
    function DividerSymbol(rect, index, page) {
    ...
    DividerSymbol.prototype.update = function () {
    ...
    DividerSymbol.prototype.mouse_down = function (page, width, height) {
        if (this.page === page) {
    ...
    DividerSymbol.prototype.mouse_move = function (page, width, height) {
        if (this.bounds.contains_xywh(global.mouse_x, global.mouse_y, width, height) &&
            !global.MOBILE_MODE) {
            this.DRAW_TAG = true;
        }
    ...
    DividerSymbol.prototype.mouse_up = function (page, width, height) {
        if (this.page === page) {
            if (this.bounds.contains_xywh(global.mouse_x, global.mouse_y, width, height)) {
            }
            this.FLAG_ADD_ELEMENT = false;
    ...
    DividerSymbol.prototype.build_element = function () {
        /* Top segment */
        this.divider_0.x =
        ...
        this.divider_1.x =
            this.divider_0.x + this.x_space * global.cosine(this.theta);
        this.divider_1.y =
            this.divider_0.y + this.y_space * global.sine(this.theta);
        this.divider_2.x =
            this.divider_1.x +
        ...
        this.divider_4.x =
            this.divider_3.x - this.x_space * global.cosine(this.theta);
        this.divider_4.y =
            this.divider_3.y - this.y_space * global.sine(this.theta);
        this.divider_5.x =
            this.divider_4.x + 0.75 * this.x_space * global.cosine(this.theta);
        this.divider_5.y =
            this.divider_4.y + 0.75 * this.y_space * global.sine(this.theta);
        /* End Segment */
        this.divider_6.x =
    ...
    DividerSymbol.prototype.resize = function (rect) {
        /* Create a new rectangle for the bounds of this component */
        this.bounds.set_bounds(rect.left, rect.top, rect.right, rect.bottom);
        /* The center (x-coord) of the bounds */
        this.c_x = this.bounds.get_center_x();
    ...
    DividerSymbol.prototype.recolor = function () {
        if (this.FLAG_ADD_ELEMENT) {
    ...
    /* Draws the Symbol */
    DividerSymbol.prototype.draw_symbol = function (canvas, page) {
        this.recolor();
        if (this.page === page) {
            var indexer = 0;
            this.CIRCLE_BUFFER = [];
