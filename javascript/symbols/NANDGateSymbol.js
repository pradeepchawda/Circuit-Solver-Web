 ...
 *
 ***********************************************************************/
var NANDGateSymbol = /** @class */ (function () {
    function NANDGateSymbol(rect, index, page) {
    ...
    NANDGateSymbol.prototype.update = function () {
    ...
    NANDGateSymbol.prototype.mouse_down = function (page, width, height) {
        if (this.page === page) {
    ...
    NANDGateSymbol.prototype.mouse_move = function (page, width, height) {
        if (this.bounds.contains_xywh(global.mouse_x, global.mouse_y, width, height) &&
            !global.MOBILE_MODE) {
            this.DRAW_TAG = true;
        }
    ...
    NANDGateSymbol.prototype.mouse_up = function (page, width, height) {
        if (this.page === page) {
            if (this.bounds.contains_xywh(global.mouse_x, global.mouse_y, width, height)) {
            }
            this.FLAG_ADD_ELEMENT = false;
    ...
    NANDGateSymbol.prototype.build_element = function () {
        /* Top segment */
        ...
        this.nand_1.x =
            this.nand_0.x + 0.75 * this.x_space * global.cosine(this.theta_m90);
        this.nand_1.y =
            this.nand_0.y + 0.75 * this.y_space * global.sine(this.theta_m90);
        this.nand_2.x =
            this.nand_1.x + 0.75 * this.x_space * global.cosine(this.theta - Math.PI);
        this.nand_2.y =
            this.nand_1.y + 0.75 * this.y_space * global.sine(this.theta - Math.PI);
        /* Bottom segment */
        ...
        this.nand_4.x =
            this.nand_3.x + 0.75 * this.x_space * global.cosine(this.theta_m90);
        this.nand_4.y =
            this.nand_3.y + 0.75 * this.y_space * global.sine(this.theta_m90);
        this.nand_5.x =
            this.nand_4.x + 0.75 * this.x_space * global.cosine(this.theta);
        this.nand_5.y =
            this.nand_4.y + 0.75 * this.y_space * global.sine(this.theta);
        /* End Segment */
        this.nand_6.x =
    ...
    NANDGateSymbol.prototype.resize = function (rect) {
        /* Create a new rectangle for the bounds of this component */
        this.bounds.set_bounds(rect.left, rect.top, rect.right, rect.bottom);
        /* The center (x-coord) of the bounds */
        this.c_x = this.bounds.get_center_x();
    ...
    NANDGateSymbol.prototype.recolor = function () {
        if (this.FLAG_ADD_ELEMENT) {
    ...
    /* Draws the Symbol */
    NANDGateSymbol.prototype.draw_symbol = function (canvas, page) {
        this.recolor();
        if (this.page === page) {
            var indexer = 0;
            this.CIRCLE_BUFFER = [];
