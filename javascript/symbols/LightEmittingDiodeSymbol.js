 ...
 * File		        : LightEmittingDiodeSymbol.js
 * Author            : nboatengc
 * Date created      : 20190928
 *
 * Purpose           : A class to draw the led element without worrying about the
 ...
 *
 ***********************************************************************/
var LightEmittingDiodeSymbol = /** @class */ (function () {
    function LightEmittingDiodeSymbol(rect, index, page) {
    ...
    LightEmittingDiodeSymbol.prototype.update = function () {
    ...
    LightEmittingDiodeSymbol.prototype.mouse_down = function (page, width, height) {
        if (this.page === page) {
    ...
    LightEmittingDiodeSymbol.prototype.mouse_move = function (page, width, height) {
        if (this.bounds.contains_xywh(global.mouse_x, global.mouse_y, width, height) &&
            !global.MOBILE_MODE) {
            this.DRAW_TAG = true;
        }
    ...
    LightEmittingDiodeSymbol.prototype.mouse_up = function (page, width, height) {
        if (this.page === page) {
            if (this.bounds.contains_xywh(global.mouse_x, global.mouse_y, width, height)) {
            }
            this.FLAG_ADD_ELEMENT = false;
    ...
    LightEmittingDiodeSymbol.prototype.build_element = function () {
        var delta_x = 0;
        var delta_y = 0;
        this.led_0.x =
            this.c_x +
        ...
        this.led_8.x =
            this.c_x -
                (this.x_space >> 1) * global.cosine(this.theta) +
                this.x_space * 1.25 * global.cosine(this.theta_m90);
        this.led_8.y =
            this.c_y -
                (this.y_space >> 1) * global.sine(this.theta) +
                this.y_space * 1.25 * global.sine(this.theta_m90);
        this.led_10.x =
            this.c_x +
                (this.x_space >> 1) * global.cosine(this.theta) +
                this.x_space * 1.25 * global.cosine(this.theta_m90);
        ...
        this.led_1.x =
            this.c_x -
                ((this.x_space >> 1) - (this.x_space >> 2)) * global.cosine(this.theta) +
                this.x_space * 2.25 * global.cosine(this.theta_m90);
        this.led_1.y =
            this.c_y -
                ((this.y_space >> 1) - (this.y_space >> 2)) * global.sine(this.theta) +
                this.y_space * 2.25 * global.sine(this.theta_m90);
        this.led_3.x =
            this.c_x +
                ((this.x_space >> 1) + (this.x_space >> 2)) * global.cosine(this.theta) +
                this.x_space * 2.25 * global.cosine(this.theta_m90);
        ...
        this.led_5.x =
            this.led_1.x + (this.x_space >> 1) * global.cosine(this.theta - 35);
        this.led_5.y =
            this.led_1.y + this.y_space * 0.5 * global.sine(this.theta - 35);
        this.led_7.x =
            this.led_1.x + (this.x_space >> 1) * global.cosine(this.theta + 35);
        this.led_7.y =
            this.led_1.y + this.y_space * 0.5 * global.sine(this.theta + 35);
        this.led_9.x =
            this.led_3.x + (this.x_space >> 1) * global.cosine(this.theta - 35);
        this.led_9.y =
            this.led_3.y + this.y_space * 0.5 * global.sine(this.theta - 35);
        this.led_11.x =
            this.led_3.x + (this.x_space >> 1) * global.cosine(this.theta + 35);
        this.led_11.y =
            this.led_3.y + this.y_space * 0.5 * global.sine(this.theta + 35);
    };
    LightEmittingDiodeSymbol.prototype.resize = function (rect) {
        /* Create a new rectangle for the bounds of this component */
        this.bounds.set_bounds(rect.left, rect.top, rect.right, rect.bottom);
        /* The center (x-coord) of the bounds */
        this.c_x = this.bounds.get_center_x();
    ...
    LightEmittingDiodeSymbol.prototype.recolor = function () {
        if (this.FLAG_ADD_ELEMENT) {
    ...
    /* Draws the Symbol */
    LightEmittingDiodeSymbol.prototype.draw_symbol = function (canvas, page) {
        this.recolor();
        if (this.page === page) {
            var indexer = 0;
            this.CIRCLE_BUFFER = [];
    ...
    return LightEmittingDiodeSymbol;
}());
