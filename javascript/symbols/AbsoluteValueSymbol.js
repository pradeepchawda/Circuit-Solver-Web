 ...
 *
 ***********************************************************************/
var AbsoluteValueSymbol = /** @class */ (function () {
    function AbsoluteValueSymbol(rect, index, page) {
    ...
    AbsoluteValueSymbol.prototype.update = function () {
    ...
    AbsoluteValueSymbol.prototype.mouse_down = function (page, width, height) {
        if (this.page === page) {
    ...
    AbsoluteValueSymbol.prototype.mouse_move = function (page, width, height) {
        if (this.bounds.contains_xywh(global.mouse_x, global.mouse_y, width, height) &&
            !global.MOBILE_MODE) {
            this.DRAW_TAG = true;
        }
    ...
    AbsoluteValueSymbol.prototype.mouse_up = function (page, width, height) {
        if (this.page === page) {
            if (this.bounds.contains_xywh(global.mouse_x, global.mouse_y, width, height)) {
            }
            this.FLAG_ADD_ELEMENT = false;
    ...
    AbsoluteValueSymbol.prototype.build_element = function () {
        this.gain_0.x =
            this.c_x -
    ...
    AbsoluteValueSymbol.prototype.resize = function (rect) {
        /* Create a new rectangle for the bounds of this component */
        this.bounds.set_bounds(rect.left, rect.top, rect.right, rect.bottom);
        /* The center (x-coord) of the bounds */
        this.c_x = this.bounds.get_center_x();
    ...
    AbsoluteValueSymbol.prototype.recolor = function () {
        if (this.FLAG_ADD_ELEMENT) {
    ...
    /* Draws the Symbol */
    AbsoluteValueSymbol.prototype.draw_symbol = function (canvas, page) {
        this.recolor();
        if (this.page === page) {
            var indexer = 0;
            this.CIRCLE_BUFFER = [];
