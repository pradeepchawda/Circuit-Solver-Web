 ...
 *
 ***********************************************************************/
var SquareWaveSymbol = /** @class */ (function () {
    function SquareWaveSymbol(rect, index, page) {
    ...
    SquareWaveSymbol.prototype.update = function () {
    ...
    SquareWaveSymbol.prototype.mouse_down = function (page, width, height) {
        if (this.page === page) {
    ...
    SquareWaveSymbol.prototype.mouse_move = function (page, width, height) {
        if (this.bounds.contains_xywh(global.mouse_x, global.mouse_y, width, height) &&
            !global.MOBILE_MODE) {
            this.DRAW_TAG = true;
        }
    ...
    SquareWaveSymbol.prototype.mouse_up = function (page, width, height) {
        if (this.page === page) {
            if (this.bounds.contains_xywh(global.mouse_x, global.mouse_y, width, height)) {
            }
            this.FLAG_ADD_ELEMENT = false;
    ...
    SquareWaveSymbol.prototype.build_element = function () {
        ...
        this.sq_3.y =
            this.sq_0.y - (this.x_space >> 1) * global.sine(this.theta_m90);
        this.sq_4.x =
            this.sq_1.x + (this.x_space >> 1) * global.cosine(this.theta_m90);
        this.sq_4.y =
            this.sq_1.y + (this.x_space >> 1) * global.sine(this.theta_m90);
        this.sq_5.x =
            this.sq_1.x - (this.x_space >> 1) * global.cosine(this.theta_m90);
        this.sq_5.y =
            this.sq_1.y - (this.x_space >> 1) * global.sine(this.theta_m90);
    ...
    SquareWaveSymbol.prototype.resize = function (rect) {
        /* Create a new rectangle for the bounds of this component */
        this.bounds.set_bounds(rect.left, rect.top, rect.right, rect.bottom);
        /* The center (x-coord) of the bounds */
        this.c_x = this.bounds.get_center_x();
    ...
    SquareWaveSymbol.prototype.recolor = function () {
        if (this.FLAG_ADD_ELEMENT) {
    ...
    /* Draws the Symbol */
    SquareWaveSymbol.prototype.draw_symbol = function (canvas, page) {
        this.recolor();
        if (this.page === page) {
