 ...
 *
 ***********************************************************************/
var HighPassFilterSymbol = /** @class */ (function () {
    function HighPassFilterSymbol(rect, index, page) {
    ...
    HighPassFilterSymbol.prototype.update = function () {
    ...
    HighPassFilterSymbol.prototype.mouse_down = function (page, width, height) {
        if (this.page === page) {
    ...
    HighPassFilterSymbol.prototype.mouse_move = function (page, width, height) {
        if (this.bounds.contains_xywh(global.mouse_x, global.mouse_y, width, height) &&
            !global.MOBILE_MODE) {
            this.DRAW_TAG = true;
        }
    ...
    HighPassFilterSymbol.prototype.mouse_up = function (page, width, height) {
        if (this.page === page) {
            if (this.bounds.contains_xywh(global.mouse_x, global.mouse_y, width, height)) {
            }
            this.FLAG_ADD_ELEMENT = false;
    ...
    HighPassFilterSymbol.prototype.build_element = function () {
        this.hpf_0.x =
            this.c_x -
        ...
        this.hpf_6.x =
            this.c_x -
                0.5 * this.x_space * global.cosine(this.theta) -
                0.25 * this.x_space * global.cosine(this.theta_m90);
        this.hpf_6.y =
            this.c_y -
                0.5 * this.y_space * global.sine(this.theta) -
                0.25 * this.y_space * global.sine(this.theta_m90);
        this.hpf_7.x =
            this.c_x +
    ...
    HighPassFilterSymbol.prototype.resize = function (rect) {
        /* Create a new rectangle for the bounds of this component */
        this.bounds.set_bounds(rect.left, rect.top, rect.right, rect.bottom);
        /* The center (x-coord) of the bounds */
        this.c_x = this.bounds.get_center_x();
    ...
    HighPassFilterSymbol.prototype.recolor = function () {
        if (this.FLAG_ADD_ELEMENT) {
    ...
    /* Draws the Symbol */
    HighPassFilterSymbol.prototype.draw_symbol = function (canvas, page) {
        this.recolor();
        if (this.page === page) {
