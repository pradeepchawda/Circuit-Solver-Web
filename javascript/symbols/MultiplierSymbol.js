 ...
 *
 ***********************************************************************/
var MultiplierSymbol = /** @class */ (function () {
    function MultiplierSymbol(rect, index, page) {
    ...
    MultiplierSymbol.prototype.update = function () {
    ...
    MultiplierSymbol.prototype.mouse_down = function (page, width, height) {
        if (this.page === page) {
    ...
    MultiplierSymbol.prototype.mouse_move = function (page, width, height) {
        if (this.bounds.contains_xywh(global.mouse_x, global.mouse_y, width, height) &&
            !global.MOBILE_MODE) {
            this.DRAW_TAG = true;
        }
    ...
    MultiplierSymbol.prototype.mouse_up = function (page, width, height) {
        if (this.page === page) {
            if (this.bounds.contains_xywh(global.mouse_x, global.mouse_y, width, height)) {
            }
            this.FLAG_ADD_ELEMENT = false;
    ...
    MultiplierSymbol.prototype.build_element = function () {
        /* Top segment */
        this.multiplier_0.x =
        ...
        this.multiplier_1.x =
            this.multiplier_0.x + this.x_space * global.cosine(this.theta);
        this.multiplier_1.y =
            this.multiplier_0.y + this.y_space * global.sine(this.theta);
        this.multiplier_2.x =
            this.multiplier_1.x +
        ...
        this.multiplier_4.x =
            this.multiplier_3.x - this.x_space * global.cosine(this.theta);
        this.multiplier_4.y =
            this.multiplier_3.y - this.y_space * global.sine(this.theta);
        this.multiplier_5.x =
            this.multiplier_4.x + 0.75 * this.x_space * global.cosine(this.theta);
        this.multiplier_5.y =
            this.multiplier_4.y + 0.75 * this.y_space * global.sine(this.theta);
        /* End Segment */
        this.multiplier_6.x =
            this.p3.x - this.x_space * global.cosine(this.theta_m90);
        this.multiplier_6.y =
            this.p3.y - this.y_space * global.sine(this.theta_m90);
    };
    MultiplierSymbol.prototype.resize = function (rect) {
        /* Create a new rectangle for the bounds of this component */
        this.bounds.set_bounds(rect.left, rect.top, rect.right, rect.bottom);
        /* The center (x-coord) of the bounds */
        this.c_x = this.bounds.get_center_x();
    ...
    MultiplierSymbol.prototype.recolor = function () {
        if (this.FLAG_ADD_ELEMENT) {
    ...
    /* Draws the Symbol */
    MultiplierSymbol.prototype.draw_symbol = function (canvas, page) {
        this.recolor();
        if (this.page === page) {
            var indexer = 0;
            this.CIRCLE_BUFFER = [];
