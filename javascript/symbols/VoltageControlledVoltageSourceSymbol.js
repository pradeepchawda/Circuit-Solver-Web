 ...
 *
 ***********************************************************************/
var VoltageControlledVoltageSourceSymbol = /** @class */ (function () {
    function VoltageControlledVoltageSourceSymbol(rect, index, page) {
    ...
    VoltageControlledVoltageSourceSymbol.prototype.update = function () {
    ...
    VoltageControlledVoltageSourceSymbol.prototype.mouse_down = function (page, width, height) {
        if (this.page === page) {
    ...
    VoltageControlledVoltageSourceSymbol.prototype.mouse_move = function (page, width, height) {
        if (this.bounds.contains_xywh(global.mouse_x, global.mouse_y, width, height) &&
            !global.MOBILE_MODE) {
            this.DRAW_TAG = true;
        }
    ...
    VoltageControlledVoltageSourceSymbol.prototype.mouse_up = function (page, width, height) {
        if (this.page === page) {
            if (this.bounds.contains_xywh(global.mouse_x, global.mouse_y, width, height)) {
            }
            this.FLAG_ADD_ELEMENT = false;
    ...
    VoltageControlledVoltageSourceSymbol.prototype.build_element = function () {
        /* Top segment (left) */
        ...
        this.vcvs_7.x =
            this.vcvs_2.x + 3.0 * this.x_space * global.cosine(this.theta);
        this.vcvs_7.y =
            this.vcvs_2.y + 3.0 * this.y_space * global.sine(this.theta);
        this.vcvs_8.x =
            this.vcvs_7.x -
                1.414 * this.x_space * global.cosine(this.theta - global.PI_DIV_4);
        this.vcvs_8.y =
        ...
        /* Plus point */
        this.vcvs_10.x =
            this.vcvs_2.x + 1.5 * this.x_space * global.cosine(this.theta);
        this.vcvs_10.y =
            this.vcvs_2.y + 1.5 * this.y_space * global.sine(this.theta);
        this.vcvs_11.x =
            this.vcvs_2.x + 2.0 * this.x_space * global.cosine(this.theta);
        this.vcvs_11.y =
            this.vcvs_2.y + 2.0 * this.y_space * global.sine(this.theta);
        this.vcvs_12.x =
            this.vcvs_2.x +
                1.75 * this.x_space * global.cosine(this.theta) +
                (this.x_space >> 2) * global.cosine(this.theta_m90);
        this.vcvs_12.y =
            this.vcvs_2.y +
                1.75 * this.y_space * global.sine(this.theta) +
    ...
    VoltageControlledVoltageSourceSymbol.prototype.resize = function (rect) {
        /* Create a new rectangle for the bounds of this component */
        this.bounds.set_bounds(rect.left, rect.top, rect.right, rect.bottom);
        /* The center (x-coord) of the bounds */
        this.c_x = this.bounds.get_center_x();
    ...
    VoltageControlledVoltageSourceSymbol.prototype.recolor = function () {
        if (this.FLAG_ADD_ELEMENT) {
    ...
    /* Draws the Symbol */
    VoltageControlledVoltageSourceSymbol.prototype.draw_symbol = function (canvas, page) {
        this.recolor();
        if (this.page === page) {
            var indexer = 0;
            this.CIRCLE_BUFFER = [];
    ...
    return VoltageControlledVoltageSourceSymbol;
}());
