 ...
 *
 ***********************************************************************/
var ORGateSymbol = /** @class */ (function () {
    function ORGateSymbol(rect, index, page) {
    ...
    ORGateSymbol.prototype.update = function () {
    ...
    ORGateSymbol.prototype.mouse_down = function (page, width, height) {
        if (this.page === page) {
    ...
    ORGateSymbol.prototype.mouse_move = function (page, width, height) {
        if (this.bounds.contains_xywh(global.mouse_x, global.mouse_y, width, height) &&
            !global.MOBILE_MODE) {
            this.DRAW_TAG = true;
        }
    ...
    ORGateSymbol.prototype.mouse_up = function (page, width, height) {
        if (this.page === page) {
            if (this.bounds.contains_xywh(global.mouse_x, global.mouse_y, width, height)) {
            }
            this.FLAG_ADD_ELEMENT = false;
    ...
    ORGateSymbol.prototype.build_element = function () {
        /* Top segment */
        ...
        this.or_1.x =
            this.or_0.x + 0.75 * this.x_space * global.cosine(this.theta_m90);
        this.or_1.y =
            this.or_0.y + 0.75 * this.y_space * global.sine(this.theta_m90);
        this.or_2.x =
            this.or_1.x + 0.75 * this.x_space * global.cosine(this.theta - Math.PI);
        this.or_2.y =
            this.or_1.y + 0.75 * this.y_space * global.sine(this.theta - Math.PI);
        /* Overshoot of or_1 */
        this.or_7.x =
            this.or_0.x + 1.05 * this.x_space * global.cosine(this.theta_m90);
        this.or_7.y =
            this.or_0.y + 1.05 * this.y_space * global.sine(this.theta_m90);
        /* Bottom segment */
        ...
        this.or_4.x =
            this.or_3.x + 0.75 * this.x_space * global.cosine(this.theta_m90);
        this.or_4.y =
            this.or_3.y + 0.75 * this.y_space * global.sine(this.theta_m90);
        ...
        /* Overshoot of or_4 */
        this.or_8.x =
            this.or_3.x + 1.05 * this.x_space * global.cosine(this.theta_m90);
        this.or_8.y =
            this.or_3.y + 1.05 * this.y_space * global.sine(this.theta_m90);
        /* End Segment */
        this.or_6.x =
    ...
    ORGateSymbol.prototype.resize = function (rect) {
        /* Create a new rectangle for the bounds of this component */
        this.bounds.set_bounds(rect.left, rect.top, rect.right, rect.bottom);
        /* The center (x-coord) of the bounds */
        this.c_x = this.bounds.get_center_x();
    ...
    ORGateSymbol.prototype.recolor = function () {
        if (this.FLAG_ADD_ELEMENT) {
    ...
    /* Draws the Symbol */
    ORGateSymbol.prototype.draw_symbol = function (canvas, page) {
        this.recolor();
        if (this.page === page) {
            var indexer = 0;
            this.CIRCLE_BUFFER = [];
