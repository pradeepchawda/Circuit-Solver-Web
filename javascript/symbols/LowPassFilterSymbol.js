 ...
 *
 ***********************************************************************/
var LowPassFilterSymbol = /** @class */ (function () {
    function LowPassFilterSymbol(rect, index, page) {
    ...
    LowPassFilterSymbol.prototype.update = function () {
    ...
    LowPassFilterSymbol.prototype.mouse_down = function (page, width, height) {
        if (this.page === page) {
    ...
    LowPassFilterSymbol.prototype.mouse_move = function (page, width, height) {
        if (this.bounds.contains_xywh(global.mouse_x, global.mouse_y, width, height) &&
            !global.MOBILE_MODE) {
            this.DRAW_TAG = true;
        }
    ...
    LowPassFilterSymbol.prototype.mouse_up = function (page, width, height) {
        if (this.page === page) {
            if (this.bounds.contains_xywh(global.mouse_x, global.mouse_y, width, height)) {
            }
            this.FLAG_ADD_ELEMENT = false;
    ...
    LowPassFilterSymbol.prototype.build_element = function () {
        this.lpf_0.x =
            this.c_x -
    ...
    LowPassFilterSymbol.prototype.resize = function (rect) {
        /* Create a new rectangle for the bounds of this component */
        this.bounds.set_bounds(rect.left, rect.top, rect.right, rect.bottom);
        /* The center (x-coord) of the bounds */
        this.c_x = this.bounds.get_center_x();
    ...
    LowPassFilterSymbol.prototype.recolor = function () {
        if (this.FLAG_ADD_ELEMENT) {
    ...
    /* Draws the Symbol */
    LowPassFilterSymbol.prototype.draw_symbol = function (canvas, page) {
        this.recolor();
        if (this.page === page) {
