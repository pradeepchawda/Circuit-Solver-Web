 ...
 *
 ***********************************************************************/
var TransformerSymbol = /** @class */ (function () {
    function TransformerSymbol(rect, index, page) {
    ...
    TransformerSymbol.prototype.update = function () {
    ...
    TransformerSymbol.prototype.mouse_down = function (page, width, height) {
        if (this.page === page) {
    ...
    TransformerSymbol.prototype.mouse_move = function (page, width, height) {
        if (this.bounds.contains_xywh(global.mouse_x, global.mouse_y, width, height) &&
            !global.MOBILE_MODE) {
            this.DRAW_TAG = true;
        }
    ...
    TransformerSymbol.prototype.mouse_up = function (page, width, height) {
        if (this.page === page) {
            if (this.bounds.contains_xywh(global.mouse_x, global.mouse_y, width, height)) {
            }
            this.FLAG_ADD_ELEMENT = false;
    ...
    TransformerSymbol.prototype.build_element = function () {
        /* Top segment (left) */
        ...
        this.trans_5.x =
            this.trans_0.x + 2.0 * this.x_space * global.cosine(this.theta);
        this.trans_5.y =
            this.trans_0.y + 2.0 * this.y_space * global.sine(this.theta);
        this.trans_6.x =
            this.trans_0.x + 3.0 * this.x_space * global.cosine(this.theta);
        this.trans_6.y =
            this.trans_0.y + 3.0 * this.y_space * global.sine(this.theta);
        /* right Arc */
        ...
        this.trans_8.x =
            this.trans_2.x + 2.0 * this.x_space * global.cosine(this.theta);
        this.trans_8.y =
            this.trans_2.y + 2.0 * this.y_space * global.sine(this.theta);
        this.trans_9.x =
            this.trans_2.x + 3.0 * this.x_space * global.cosine(this.theta);
        this.trans_9.y =
            this.trans_2.y + 3.0 * this.y_space * global.sine(this.theta);
        /* Left current dot */
        this.trans_10.x =
            this.trans_4.x - 0.75 * this.x_space * global.cosine(this.theta_m90);
        this.trans_10.y =
            this.trans_4.y - 0.5 * this.y_space * global.sine(this.theta_m90);
        /* Right current dot */
        this.trans_11.y =
            this.trans_7.y + 0.75 * this.y_space * global.sine(this.theta_m90);
        this.trans_11.x =
            this.trans_7.x + 0.75 * this.x_space * global.cosine(this.theta_m90);
    };
    TransformerSymbol.prototype.resize = function (rect) {
        /* Create a new rectangle for the bounds of this component */
        this.bounds.set_bounds(rect.left, rect.top, rect.right, rect.bottom);
        /* The center (x-coord) of the bounds */
        this.c_x = this.bounds.get_center_x();
    ...
    TransformerSymbol.prototype.recolor = function () {
        if (this.FLAG_ADD_ELEMENT) {
    ...
    /* Draws the Symbol */
    TransformerSymbol.prototype.draw_symbol = function (canvas, page) {
        this.recolor();
        if (this.page === page) {
            var indexer = 0;
            this.CIRCLE_BUFFER = [];
