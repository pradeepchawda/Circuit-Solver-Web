 ...
 *
 ***********************************************************************/
var LookUpTableSymbol = /** @class */ (function () {
    function LookUpTableSymbol(rect, index, page) {
    ...
    LookUpTableSymbol.prototype.update = function () {
    ...
    LookUpTableSymbol.prototype.mouse_down = function (page, width, height) {
        if (this.page === page) {
    ...
    LookUpTableSymbol.prototype.mouse_move = function (page, width, height) {
        if (this.bounds.contains_xywh(global.mouse_x, global.mouse_y, width, height) &&
            !global.MOBILE_MODE) {
            this.DRAW_TAG = true;
        }
    ...
    LookUpTableSymbol.prototype.mouse_up = function (page, width, height) {
        if (this.page === page) {
            if (this.bounds.contains_xywh(global.mouse_x, global.mouse_y, width, height)) {
            }
            this.FLAG_ADD_ELEMENT = false;
    ...
    LookUpTableSymbol.prototype.build_element = function () {
        this.adc_0.x =
            this.c_x -
    ...
    LookUpTableSymbol.prototype.resize = function (rect) {
        /* Create a new rectangle for the bounds of this component */
        this.bounds.set_bounds(rect.left, rect.top, rect.right, rect.bottom);
        /* The center (x-coord) of the bounds */
        this.c_x = this.bounds.get_center_x();
    ...
    LookUpTableSymbol.prototype.recolor = function () {
        if (this.FLAG_ADD_ELEMENT) {
    ...
    /* Draws the Symbol */
    LookUpTableSymbol.prototype.draw_symbol = function (canvas, page) {
        this.recolor();
        if (this.page === page) {
            var indexer = 0;
            this.CIRCLE_BUFFER = [];
