 ...
 *
 ***********************************************************************/
var CapacitorSymbol = /** @class */ (function () {
    function CapacitorSymbol(rect, index, page) {
    ...
    CapacitorSymbol.prototype.update = function () {
    ...
    CapacitorSymbol.prototype.mouse_down = function (page, width, height) {
        if (this.page === page) {
    ...
    CapacitorSymbol.prototype.mouse_move = function (page, width, height) {
        if (this.bounds.contains_xywh(global.mouse_x, global.mouse_y, width, height) &&
            !global.MOBILE_MODE) {
            this.DRAW_TAG = true;
        }
    ...
    CapacitorSymbol.prototype.mouse_up = function (page, width, height) {
        if (this.page === page) {
            if (this.bounds.contains_xywh(global.mouse_x, global.mouse_y, width, height)) {
            }
            this.FLAG_ADD_ELEMENT = false;
    ...
    CapacitorSymbol.prototype.build_element = function () {
        this.cap_0.x =
            this.c_x +
        ...
        this.cap_3.y =
            this.c_y -
                ...
                this.y_space * 0.667 * global.sine(Math.PI + this.theta_m90);
        this.connect1_x =
            this.c_x - 0.75 * this.x_space * global.cosine(this.theta);
    ...
    CapacitorSymbol.prototype.resize = function (rect) {
        /* Create a new rectangle for the bounds of this component */
        this.bounds.set_bounds(rect.left, rect.top, rect.right, rect.bottom);
        /* The center (x-coord) of the bounds */
        this.c_x = this.bounds.get_center_x();
    ...
    CapacitorSymbol.prototype.recolor = function () {
        if (this.FLAG_ADD_ELEMENT) {
    ...
    /* Draws the Symbol */
    CapacitorSymbol.prototype.draw_symbol = function (canvas, page) {
        this.recolor();
        if (this.page === page) {
            var indexer = 0;
            this.CIRCLE_BUFFER = [];
