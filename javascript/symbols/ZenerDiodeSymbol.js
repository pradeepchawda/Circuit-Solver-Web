 ...
 *
 ***********************************************************************/
var ZenerDiodeSymbol = /** @class */ (function () {
    function ZenerDiodeSymbol(rect, index, page) {
    ...
    ZenerDiodeSymbol.prototype.update = function () {
    ...
    ZenerDiodeSymbol.prototype.mouse_down = function (page, width, height) {
        if (this.page === page) {
    ...
    ZenerDiodeSymbol.prototype.mouse_move = function (page, width, height) {
        if (this.bounds.contains_xywh(global.mouse_x, global.mouse_y, width, height) &&
            !global.MOBILE_MODE) {
            this.DRAW_TAG = true;
        }
    ...
    ZenerDiodeSymbol.prototype.mouse_up = function (page, width, height) {
        if (this.page === page) {
            if (this.bounds.contains_xywh(global.mouse_x, global.mouse_y, width, height)) {
            }
            this.FLAG_ADD_ELEMENT = false;
    ...
    ZenerDiodeSymbol.prototype.build_element = function () {
        this.zen_0.x =
            this.c_x +
        ...
        this.zen_4.x =
            this.c_x +
                ...
                this.x_space * 0.7 * global.cosine(this.theta_m90);
        this.zen_4.y =
            this.c_y +
                (this.y_space >> 2) * global.sine(this.theta) +
                this.y_space * 0.7 * global.sine(this.theta_m90);
        this.zen_1.x =
            this.c_x -
                (this.x_space >> 1) * global.cosine(this.theta) +
                (this.x_space >> 1) * global.cosine(this.theta_m90);
        ...
        this.zen_5.x =
            this.c_x +
                this.x_space * 0.75 * global.cosine(this.theta) +
                this.x_space * 0.7 * global.cosine(Math.PI + this.theta_m90);
        this.zen_5.y =
            this.c_y +
                this.y_space * 0.75 * global.sine(this.theta) +
                this.y_space * 0.7 * global.sine(Math.PI + this.theta_m90);
        this.zen_2.x =
            this.c_x -
                (this.x_space >> 1) * global.cosine(this.theta) +
                (this.x_space >> 1) * global.cosine(Math.PI + this.theta_m90);
    ...
    ZenerDiodeSymbol.prototype.resize = function (rect) {
        /* Create a new rectangle for the bounds of this component */
        this.bounds.set_bounds(rect.left, rect.top, rect.right, rect.bottom);
        /* The center (x-coord) of the bounds */
        this.c_x = this.bounds.get_center_x();
    ...
    ZenerDiodeSymbol.prototype.recolor = function () {
        if (this.FLAG_ADD_ELEMENT) {
    ...
    /* Draws the Symbol */
    ZenerDiodeSymbol.prototype.draw_symbol = function (canvas, page) {
        this.recolor();
        if (this.page === page) {
            var indexer = 0;
            this.CIRCLE_BUFFER = [];
