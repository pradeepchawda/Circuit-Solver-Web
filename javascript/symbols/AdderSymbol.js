 ...
 *
 ***********************************************************************/
var AdderSymbol = /** @class */ (function () {
    function AdderSymbol(rect, index, page) {
    ...
    AdderSymbol.prototype.update = function () {
    ...
    AdderSymbol.prototype.mouse_down = function (page, width, height) {
        if (this.page === page) {
    ...
    AdderSymbol.prototype.mouse_move = function (page, width, height) {
        if (this.bounds.contains_xywh(global.mouse_x, global.mouse_y, width, height) &&
            !global.MOBILE_MODE) {
            this.DRAW_TAG = true;
        }
    ...
    AdderSymbol.prototype.mouse_up = function (page, width, height) {
        if (this.page === page) {
            if (this.bounds.contains_xywh(global.mouse_x, global.mouse_y, width, height)) {
            }
            this.FLAG_ADD_ELEMENT = false;
    ...
    AdderSymbol.prototype.build_element = function () {
        /* Top segment */
        this.adder_0.x =
        ...
        this.adder_2.y =
            this.adder_1.y + 0.75 * this.y_space * global.sine(this.theta - Math.PI);
        /* Bottom segment */
        this.adder_3.x =
        ...
        this.adder_5.x =
            this.adder_4.x + 0.75 * this.x_space * global.cosine(this.theta);
        this.adder_5.y =
            this.adder_4.y + 0.75 * this.y_space * global.sine(this.theta);
        /* End Segment */
        this.adder_6.x =
    ...
    AdderSymbol.prototype.resize = function (rect) {
        /* Create a new rectangle for the bounds of this component */
        this.bounds.set_bounds(rect.left, rect.top, rect.right, rect.bottom);
        /* The center (x-coord) of the bounds */
        this.c_x = this.bounds.get_center_x();
    ...
    AdderSymbol.prototype.recolor = function () {
        if (this.FLAG_ADD_ELEMENT) {
    ...
    /* Draws the Symbol */
    AdderSymbol.prototype.draw_symbol = function (canvas, page) {
        this.recolor();
        if (this.page === page) {
            var indexer = 0;
            this.CIRCLE_BUFFER = [];
