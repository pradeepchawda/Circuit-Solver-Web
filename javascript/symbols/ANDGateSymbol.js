 ...
 *
 ***********************************************************************/
var ANDGateSymbol = /** @class */ (function () {
    function ANDGateSymbol(rect, index, page) {
    ...
    ANDGateSymbol.prototype.update = function () {
    ...
    ANDGateSymbol.prototype.mouse_down = function (page, width, height) {
        if (this.page === page) {
    ...
    ANDGateSymbol.prototype.mouse_move = function (page, width, height) {
        if (this.bounds.contains_xywh(global.mouse_x, global.mouse_y, width, height) &&
            !global.MOBILE_MODE) {
            this.DRAW_TAG = true;
        }
    ...
    ANDGateSymbol.prototype.mouse_up = function (page, width, height) {
        if (this.page === page) {
            if (this.bounds.contains_xywh(global.mouse_x, global.mouse_y, width, height)) {
            }
            this.FLAG_ADD_ELEMENT = false;
    ...
    ANDGateSymbol.prototype.build_element = function () {
        /* Top segment */
        this.and_0.x = this.p1.x + 1.5 * this.x_space * global.cosine(this.theta);
        this.and_0.y = this.p1.y + 1.5 * this.y_space * global.sine(this.theta);
        this.and_1.x =
            this.and_0.x + 0.75 * this.x_space * global.cosine(this.theta_m90);
        this.and_1.y =
            this.and_0.y + 0.75 * this.y_space * global.sine(this.theta_m90);
        this.and_2.x =
            this.and_1.x + 0.75 * this.x_space * global.cosine(this.theta - Math.PI);
        this.and_2.y =
            this.and_1.y + 0.75 * this.y_space * global.sine(this.theta - Math.PI);
        /* Bottom segment */
        this.and_3.x = this.p1.x + 2.5 * this.x_space * global.cosine(this.theta);
        this.and_3.y = this.p1.y + 2.5 * this.y_space * global.sine(this.theta);
        this.and_4.x =
            this.and_3.x + 0.75 * this.x_space * global.cosine(this.theta_m90);
        this.and_4.y =
            this.and_3.y + 0.75 * this.y_space * global.sine(this.theta_m90);
        this.and_5.x =
            this.and_4.x + 0.75 * this.x_space * global.cosine(this.theta);
        this.and_5.y = this.and_4.y + 0.75 * this.y_space * global.sine(this.theta);
        /* End Segment */
        this.and_6.x =
    ...
    ANDGateSymbol.prototype.resize = function (rect) {
        /* Create a new rectangle for the bounds of this component */
        this.bounds.set_bounds(rect.left, rect.top, rect.right, rect.bottom);
        /* The center (x-coord) of the bounds */
        this.c_x = this.bounds.get_center_x();
    ...
    ANDGateSymbol.prototype.recolor = function () {
        if (this.FLAG_ADD_ELEMENT) {
    ...
    /* Draws the Symbol */
    ANDGateSymbol.prototype.draw_symbol = function (canvas, page) {
        this.recolor();
        if (this.page === page) {
            var indexer = 0;
            this.CIRCLE_BUFFER = [];
