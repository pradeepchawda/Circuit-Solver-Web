...
var MenuBar = /** @class */ (function () {
    function MenuBar() {
      ...
      during simulation. */
        ...
        this.element_window = new ElementWindow(this.bounds.left, this.bounds.bottom + (global.CANVAS_STROKE_WIDTH_4 >> 1), this.bounds.right, this.bounds.bottom +
    ...
    MenuBar.prototype.load_icons = function () {
    ...
    MenuBar.prototype.load_svg = function () {
        ...
        for (var i = 0; i < holder_x.length; i++) {
            points.push(new PointF(this.menu_icons[this.SAVE_INDEX].left +
                this.menu_icons[this.SAVE_INDEX].get_width() *
                    parseFloat(holder_x[i]), this.menu_icons[this.SAVE_INDEX].top +
        ...
        points = [];
        for (var i = 0; i < holder_x.length; i++) {
            points.push(new PointF(this.menu_icons[this.GO_INDEX].left +
                this.menu_icons[this.GO_INDEX].get_width() *
                    parseFloat(holder_x[i]), this.menu_icons[this.GO_INDEX].top +
        ...
        points = [];
        for (var i = 0; i < holder_x.length; i++) {
            points.push(new PointF(this.menu_icons[this.UNDO_INDEX].left +
                this.menu_icons[this.UNDO_INDEX].get_width() *
                    parseFloat(holder_x[i]), this.menu_icons[this.UNDO_INDEX].top +
        ...
        points = [];
        for (var i = 0; i < holder_x.length; i++) {
            points.push(new PointF(this.menu_icons[this.REDO_INDEX].left +
                this.menu_icons[this.REDO_INDEX].get_width() *
                    parseFloat(holder_x[i]), this.menu_icons[this.REDO_INDEX].top +
        ...
        points = [];
        for (var i = 0; i < holder_x.length; i++) {
            points.push(new PointF(this.menu_icons[this.SAVE_IMG_INDEX].left +
                this.menu_icons[this.SAVE_IMG_INDEX].get_width() *
                    parseFloat(holder_x[i]), this.menu_icons[this.SAVE_IMG_INDEX].top +
        ...
        var scale = 0.9;
        for (var i = 0; i < holder_x.length; i++) {
            points.push(new PointF(this.settings_button.left +
                this.settings_button.get_width() * (1 - scale) +
                (1 - 2 * (1 - scale)) *
                    this.settings_button.get_width() *
                    parseFloat(holder_x[i]), this.settings_button.top +
    ...
    MenuBar.prototype.resize_menu_bar = function () {
        var temp_stroke_width = 0.65 * global.CANVAS_STROKE_WIDTH_3;
        if (global.MOBILE_MODE) {
            temp_stroke_width = 0.85 * global.CANVAS_STROKE_WIDTH_3;
        }
        ...
        this.save_image_fill_paint.set_stroke_width(temp_stroke_width);
        this.save_image_fill_paint.set_text_size(global.CANVAS_TEXT_SIZE_5);
        this.element_window.resize_window(this.bounds.left, this.bounds.bottom + (global.CANVAS_STROKE_WIDTH_4 >> 1), this.bounds.right, this.bounds.bottom +
            this.bounds.get_height() -
            (global.CANVAS_STROKE_WIDTH_4 >> 1));
        this.sine_wave.resize(this.sine_wave.STYLE_1);
    ...
    MenuBar.prototype.mouse_wheel = function () {
        if (!global.focused) {
            this.element_window.mouse_wheel();
        }
    };
    MenuBar.prototype.mouse_down = function () {
        if (!global.focused) {
            ...
            if (this.contains(this.graph_button, false) ||
        ...
        if (!global.IS_RIGHT_CLICK && !this.ESCAPE_INTERRUPT) {
            if (!global.MOUSE_KEYBOARD_LOCK &&
                ...
                if (this.contains(this.menu_icons[this.UP_DOWN_INDEX], true) &&
                    ...
                    if (!global.FLAG_ZOOM &&
                        ...
                        if (global.FLAG_MENU_OPEN) {
                            if (this.contains(this.menu_icons[this.ADD_INDEX], true)) {
                                ...
                                if (global.FLAG_MENU_OPEN_DOWN &&
                                    !global.SIGNAL_ADD_ELEMENT &&
                                    !this.element_window.bounds.contains_xy(this.first_touch_x, this.first_touch_y)) {
                                    this.handle_menu_open_down_flag(!global.FLAG_MENU_OPEN_DOWN);
                                    /* Block out the reset selection portion of the code! */
                                    global.component_touched = true;
                                }
                    ...
                    if (this.contains(this.graph_button, false) &&
                        this.graph_button.contains_xywh(this.first_touch_x, this.first_touch_y, cached_value, this.bounds.get_height())) {
            ...
            else if (!global.MOUSE_KEYBOARD_LOCK &&
                !multi_select_manager.CTRL_PRESSED) {
                if ((this.contains(this.menu_icons[this.ADD_INDEX], true) ||
                    (!this.contains(this.element_window.bounds, false) &&
                        global.FLAG_MENU_OPEN_DOWN)) &&
    ...
    MenuBar.prototype.handle_element_options_flag = function (ON) {
    ...
    MenuBar.prototype.handle_element_options_edit_flag = function (ON) {
        global.MOUSE_KEYBOARD_LOCK = true;
        if (ON) {
    ...
    MenuBar.prototype.handle_undo_flag = function () {
        global.MOUSE_KEYBOARD_LOCK = true;
    ...
    MenuBar.prototype.handle_redo_flag = function () {
        global.MOUSE_KEYBOARD_LOCK = true;
    ...
    MenuBar.prototype.handle_menu_open_flag = function (ON) {
        global.MOUSE_KEYBOARD_LOCK = true;
    ...
    MenuBar.prototype.handle_menu_open_down_flag = function (ON) {
        global.MOUSE_KEYBOARD_LOCK = true;
        global.FLAG_MENU_OPEN_DOWN = ON;
        if (global.DEVELOPER_MODE) {
    ...
    MenuBar.prototype.handle_save_image_flag = function (ON) {
        if (ON) {
    ...
    MenuBar.prototype.handle_save_circuit_flag = function (ON) {
        if (ON) {
    ...
    MenuBar.prototype.handle_select_settings_flag = function (ON) {
        global.MOUSE_KEYBOARD_LOCK = true;
    ...
    MenuBar.prototype.handle_simulation_flag = function (ON) {
        global.MOUSE_KEYBOARD_LOCK = true;
    ...
    MenuBar.prototype.handle_graph_flag = function (ON) {
        global.MOUSE_KEYBOARD_LOCK = true;
    ...
    MenuBar.prototype.handle_remove_all_flag = function (ON) {
        global.MOUSE_KEYBOARD_LOCK = true;
    ...
    MenuBar.prototype.handle_zoom_flag = function (ON) {
        global.MOUSE_KEYBOARD_LOCK = true;
        global.FLAG_ZOOM = ON;
        if (global.DEVELOPER_MODE) {
            console.log('ZOOM');
    ...
    MenuBar.prototype.key_down = function (key_event) {
        if (global.FLAG_MENU_OPEN) {
            if (!global.FLAG_ZOOM &&
                !global.FLAG_SAVE_IMAGE &&
                !global.FLAG_SAVE_CIRCUIT &&
    ...
    MenuBar.prototype.contains = function (rect, adjust) {
        if (!adjust) {
    ...
    MenuBar.prototype.recolor = function () {
        if (global.FLAG_SIMULATING) {
    ...
    MenuBar.prototype.draw_menu_bar = function (canvas) {
        this.recolor();
        var temp_stroke_width = 0.65 * global.CANVAS_STROKE_WIDTH_3;
        if (global.MOBILE_MODE) {
            temp_stroke_width = 0.85 * global.CANVAS_STROKE_WIDTH_3;
        ...
        if (global.FLAG_MENU_OPEN) {
            ...
            var width_mul_0p64 = this.menu_icons[this.REMOVE_ALL_INDEX].get_width() * 0.64;
            var height_mul_0p64 = this.menu_icons[this.REMOVE_ALL_INDEX].get_height() * 0.64;
            ...
            indexer = 0;
            this.LINE_BUFFER = [];
            if (global.SYSTEM_OPTIONS['values'][global.SYSTEM_OPTION_SHORTCUT_HINTS] ===
                global.ON) {
            ...
            var width_rshift_3 = this.menu_icons[this.ADD_INDEX].get_width() >> 3;
            var height_rshift_3 = this.menu_icons[this.ADD_INDEX].get_height() >> 3;
            var width_rshift_4 = this.menu_icons[this.ADD_INDEX].get_width() >> 4;
            var height_rshift_4 = this.menu_icons[this.ADD_INDEX].get_height() >> 4;
            ...
            if (!global.FLAG_SIMULATING) {
                ...
                var w_pad = this.menu_icons[this.GO_INDEX].get_width() * 0.333;
                var h_pad = this.menu_icons[this.GO_INDEX].get_height() * 0.333;
            ...
            if (this.menu_icons[this.REMOVE_ALL_INDEX].contains_xy(global.mouse_x, global.mouse_y) &&
                ...
                !multi_select_manager.CTRL_PRESSED_STARTED &&
                !global.MOBILE_MODE) {
                canvas.draw_round_rect3(this.menu_icons[this.REMOVE_ALL_INDEX].get_center_x(), this.menu_icons[this.REMOVE_ALL_INDEX].get_center_y(), this.menu_icons[this.REMOVE_ALL_INDEX].get_width(), this.menu_icons[this.REMOVE_ALL_INDEX].get_height(), temp_stroke_width, this.hover_paint);
            }
            /* Drawing the background for the up down icon */
            canvas.draw_round_rect3(this.menu_icons[this.UP_DOWN_INDEX].get_center_x(), this.menu_icons[this.UP_DOWN_INDEX].get_center_y(), this.menu_icons[this.UP_DOWN_INDEX].get_width(), this.menu_icons[this.UP_DOWN_INDEX].get_height(), temp_stroke_width, this.fill_paint);
            if (this.menu_icons[this.UP_DOWN_INDEX].contains_xy(global.mouse_x, global.mouse_y) &&
                ...
                !multi_select_manager.CTRL_PRESSED_STARTED &&
                !global.MOBILE_MODE) {
                canvas.draw_round_rect3(this.menu_icons[this.UP_DOWN_INDEX].get_center_x(), this.menu_icons[this.UP_DOWN_INDEX].get_center_y(), this.menu_icons[this.UP_DOWN_INDEX].get_width(), this.menu_icons[this.UP_DOWN_INDEX].get_height(), temp_stroke_width, this.hover_paint);
            }
            ...
            var pad_w = this.menu_icons[this.REMOVE_ALL_INDEX].get_width() * 0.075;
            var pad_h = this.menu_icons[this.REMOVE_ALL_INDEX].get_height() * 0.075;
            var width_rshift_3 = this.menu_icons[this.REMOVE_ALL_INDEX].get_width() >> 3;
            var width_rshift_2 = this.menu_icons[this.REMOVE_ALL_INDEX].get_width() >> 2;
            this.LINE_BUFFER = [];
            indexer = 0;
            ...
            this.LINE_BUFFER[indexer++] = Array(this.menu_icons[this.REMOVE_ALL_INDEX].get_center_x() +
                (this.menu_icons[this.REMOVE_ALL_INDEX].get_width() >> 4), this.menu_icons[this.REMOVE_ALL_INDEX].get_center_y() +
                (this.menu_icons[this.REMOVE_ALL_INDEX].get_height() >> 4), this.menu_icons[this.REMOVE_ALL_INDEX].get_center_x() + width_rshift_2, this.menu_icons[this.REMOVE_ALL_INDEX].get_center_y() + width_rshift_2);
            this.LINE_BUFFER[indexer++] = Array(this.menu_icons[this.REMOVE_ALL_INDEX].get_center_x() -
                width_rshift_3 -
                pad_w, this.menu_icons[this.REMOVE_ALL_INDEX].get_center_y() - width_rshift_3, this.menu_icons[this.REMOVE_ALL_INDEX].get_center_x() -
                width_rshift_3 +
                pad_w, this.menu_icons[this.REMOVE_ALL_INDEX].get_center_y() - width_rshift_3);
            this.LINE_BUFFER[indexer++] = Array(this.menu_icons[this.REMOVE_ALL_INDEX].get_center_x() - width_rshift_3, this.menu_icons[this.REMOVE_ALL_INDEX].get_center_y() -
                width_rshift_3 -
                pad_h, this.menu_icons[this.REMOVE_ALL_INDEX].get_center_x() - width_rshift_3, this.menu_icons[this.REMOVE_ALL_INDEX].get_center_y() -
                width_rshift_3 +
                pad_h);
