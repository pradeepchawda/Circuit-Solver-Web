...
class Global {
	...
	public 'signal_wire_element': boolean;
	...
	public readonly 'KEY_EVENT_KEYS': Array<string>;
	...
	constructor() {
		...
		this.signal_wire_element = false;
		...
		this.language_index_counter = 0;
		this.LANGUAGE_INDEX_ENGLISH = this.language_index_counter++;
		this.LANGUAGE_INDEX_SPANISH = this.language_index_counter++;
		this.LANGUAGE_INDEX_FRENCH = this.language_index_counter++;
		this.LANGUAGE_INDEX_ITALIAN = this.language_index_counter++;
		this.LANGUAGE_INDEX_DUTCH = this.language_index_counter++;
		this.LANGUAGE_INDEX_RUSSIAN = this.language_index_counter++;
		this.LANGUAGE_INDEX_GERMAN = this.language_index_counter++;
		this.LANGUAGE_INDEX_INDONESIAN = this.language_index_counter++;
