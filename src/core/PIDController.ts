...
class PIDController {
  /* User set-point */
  public set_point: number = 0;
  /* PID Coefficients */
  public k_p: number = 0;
  public k_i: number = 0;
  public k_d: number = 0;
  /* Limit the bounds of the output */
  public min_limit: number = -global.settings.MAX_VOLTAGE;
  public max_limit: number = global.settings.MAX_VOLTAGE;
  /* Dynamic Variables */
  public previous_time: number = 0;
  public last_error: number = 0;
  public integral_error: number = 0;
