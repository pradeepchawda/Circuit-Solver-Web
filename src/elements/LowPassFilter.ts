...
class LowPassFilter {
  ...
  public lpf_0: PointF = new PointF(0, 0);
  public lpf_1: PointF = new PointF(0, 0);
  public lpf_2: PointF = new PointF(0, 0);
  public lpf_3: PointF = new PointF(0, 0);
  public lpf_4: PointF = new PointF(0, 0);
  public lpf_5: PointF = new PointF(0, 0);
  public lpf_6: PointF = new PointF(0, 0);
  public lpf_7: PointF = new PointF(0, 0);
  public lpf_8: PointF = new PointF(0, 0);
...
or overlapped)*/
  ...
  build_element(): void {
    if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
      ...
      this.lpf_0.x = this.c_x - cache_8 * global.cosine(this.theta) + cache_8 * global.cosine(this.theta_m90);
      this.lpf_0.y = this.c_y - cache_9 * global.sine(this.theta) + cache_9 * global.sine(this.theta_m90);
      this.lpf_2.x = this.c_x - cache_8 * global.cosine(this.theta) - cache_8 * global.cosine(this.theta_m90);
      this.lpf_2.y = this.c_y - cache_9 * global.sine(this.theta) - cache_9 * global.sine(this.theta_m90);
      this.lpf_3.x = this.c_x + cache_8 * global.cosine(this.theta) - cache_8 * global.cosine(this.theta_m90);
      this.lpf_3.y = this.c_y + cache_9 * global.sine(this.theta) - cache_9 * global.sine(this.theta_m90);
      this.lpf_4.x = this.c_x + cache_8 * global.cosine(this.theta) + cache_8 * global.cosine(this.theta_m90);
      this.lpf_4.y = this.c_y + cache_9 * global.sine(this.theta) + cache_9 * global.sine(this.theta_m90);
      this.lpf_5.x = this.c_x + cache_8 * global.cosine(this.theta);
      this.lpf_5.y = this.c_y + cache_9 * global.sine(this.theta);
      this.lpf_6.x = this.c_x - cache_4 * global.cosine(this.theta) + cache_5 * global.cosine(this.theta_m90);
      this.lpf_6.y = this.c_y - cache_6 * global.sine(this.theta) + cache_7 * global.sine(this.theta_m90);
      this.lpf_7.x = this.c_x + cache_5 * global.cosine(this.theta) + cache_5 * global.cosine(this.theta_m90);
      this.lpf_7.y = this.c_y + cache_7 * global.sine(this.theta) + cache_7 * global.sine(this.theta_m90);
      this.lpf_8.x = this.c_x + cache_4 * global.cosine(this.theta) - cache_5 * global.cosine(this.theta_m90);
      this.lpf_8.y = this.c_y + cache_6 * global.sine(this.theta) - cache_7 * global.sine(this.theta_m90);
