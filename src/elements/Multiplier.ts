...
class Multiplier {
  ...
  public multiplier_0: PointF = new PointF(0, 0);
  public multiplier_1: PointF = new PointF(0, 0);
  public multiplier_2: PointF = new PointF(0, 0);
  public multiplier_3: PointF = new PointF(0, 0);
  public multiplier_4: PointF = new PointF(0, 0);
  public multiplier_5: PointF = new PointF(0, 0);
  public multiplier_6: PointF = new PointF(0, 0);
...
or overlapped)*/
  ...
  build_element(): void {
    if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
      ...
      this.multiplier_1.x = this.multiplier_0.x + cache_4 * global.cosine(this.theta);
      this.multiplier_1.y = this.multiplier_0.y + cache_5 * global.sine(this.theta);
      this.multiplier_2.x = this.multiplier_1.x + cache_2 * global.cosine(this.theta - Math.PI);
      this.multiplier_2.y = this.multiplier_1.y + cache_3 * global.sine(this.theta - Math.PI);
      /* Bottom segment */
      ...
      this.multiplier_4.x = this.multiplier_3.x - cache_4 * global.cosine(this.theta);
      this.multiplier_4.y = this.multiplier_3.y - cache_5 * global.sine(this.theta);
      this.multiplier_5.x = this.multiplier_4.x + cache_2 * global.cosine(this.theta);
