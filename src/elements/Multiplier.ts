...
class Multiplier {
  ...
  public multiplier_0 = new PointF(0, 0);
  public multiplier_1 = new PointF(0, 0);
  public multiplier_2 = new PointF(0, 0);
  public multiplier_3 = new PointF(0, 0);
  public multiplier_4 = new PointF(0, 0);
  public multiplier_5 = new PointF(0, 0);
  public multiplier_6 = new PointF(0, 0);
  ...
  stamp() {
    if (this.elm.consistent()) {
      engine_functions.stamp_voltage(
        ...
        -1,
        this.elm.properties['Output Voltage'],
        simulation_manager.ELEMENT_MUL_OFFSET + this.simulation_id
      );
    }
  }
