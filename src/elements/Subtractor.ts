...
class Subtractor {
  ...
  public subtractor_0 = new PointF(0, 0);
  public subtractor_1 = new PointF(0, 0);
  public subtractor_2 = new PointF(0, 0);
  public subtractor_3 = new PointF(0, 0);
  public subtractor_4 = new PointF(0, 0);
  ...
  stamp() {
    if (this.elm.consistent()) {
      engine_functions.stamp_voltage(
        ...
        -1,
        this.elm.properties['Output Voltage'],
        simulation_manager.ELEMENT_SUB_OFFSET + this.simulation_id
      );
    }
  }
