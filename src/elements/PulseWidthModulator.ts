...
class PulseWidthModulator {
  ...
  public pwm_0 = new PointF(0, 0);
  public pwm_1 = new PointF(0, 0);
  public pwm_2 = new PointF(0, 0);
  public pwm_3 = new PointF(0, 0);
  public pwm_4 = new PointF(0, 0);
  public pwm_5 = new PointF(0, 0);
  public pwm_6 = new PointF(0, 0);
  public pwm_7 = new PointF(0, 0);
  public pwm_8 = new PointF(0, 0);
  ...
  update() {
    if (
      ...
      if (this.elm.consistent()) {
        ...
        /* Falling edge update. */
        this.elm.properties['Last Output Voltage'] = this.elm.properties[
          'Output Voltage'
        ];
        this.elm.properties['Output Voltage'] = global.copy(
          this.elm.properties['A']
        );
        if (
          Math.abs(
            this.elm.properties['Last Output Voltage'] -
              this.elm.properties['Output Voltage']
          ) > 0 ||
          global.SIMULATION_TIME < global.TIME_STEP + global.TIME_STEP
        ) {
          this.elm.properties['Frequency'] = global.map_range(
            this.elm.properties['Input Voltage1'],
            this.elm.properties['Min Frequency'],
            this.elm.properties['Max Frequency']
          );
          this.elm.properties['Duty'] = global.map_range(
            this.elm.properties['Input Voltage2'],
            this.elm.properties['Min Duty'],
            this.elm.properties['Max Duty']
          );
        ...
        if (
          ...
          this.elm.properties['A'] = global.copy(
            this.elm.properties['High Voltage']
          );
        } else {
          this.elm.properties['A'] = global.copy(
  ...
  stamp() {
    if (this.elm.consistent()) {
      engine_functions.stamp_voltage(
        ...
        -1,
        this.elm.properties['Output Voltage'],
        simulation_manager.ELEMENT_PWM_OFFSET + this.simulation_id
      );
    }
  }
