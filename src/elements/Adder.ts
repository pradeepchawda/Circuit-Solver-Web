...
class Adder {
  ...
  public adder_0 = new PointF(0, 0);
  public adder_1 = new PointF(0, 0);
  public adder_2 = new PointF(0, 0);
  public adder_3 = new PointF(0, 0);
  public adder_4 = new PointF(0, 0);
  public adder_5 = new PointF(0, 0);
  public adder_6 = new PointF(0, 0);
  ...
  update() {
    if (
      ...
      if (this.elm.consistent()) {
        ...
        this.elm.properties['Input Voltage2'] = engine_functions.get_voltage(
          this.elm.n2,
          -1
        );
  ...
  stamp() {
    if (this.elm.consistent()) {
      engine_functions.stamp_voltage(
        ...
        -1,
        this.elm.properties['Output Voltage'],
        simulation_manager.ELEMENT_ADD_OFFSET + this.simulation_id
      );
    }
  }
