...
class Adder {
  ...
  public adder_0: PointF = new PointF(0, 0);
  public adder_1: PointF = new PointF(0, 0);
  public adder_2: PointF = new PointF(0, 0);
  public adder_3: PointF = new PointF(0, 0);
  public adder_4: PointF = new PointF(0, 0);
  public adder_5: PointF = new PointF(0, 0);
  public adder_6: PointF = new PointF(0, 0);
...
or overlapped)*/
  ...
  build_element(): void {
    if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
      ...
      this.adder_2.x = this.adder_1.x + cache_2 * global.cosine(this.theta - Math.PI);
      this.adder_2.y = this.adder_1.y + cache_3 * global.sine(this.theta - Math.PI);
      /* Bottom segment */
