  ...
  draw_component(canvas) {
    ...
    if (
      ...
      if (this.elm.rotation === global.ROTATION_0) {
        ...
        this.LINE_BUFFER[this.indexer++] = Array(
          this.c_x - this.x_space * 0.6667,
          this.c_y + this.y_space * 1.5,
          this.c_x + this.x_space * 0.6667,
          this.c_y + 1.5 * this.y_space
        );
        this.LINE_BUFFER[this.indexer++] = Array(
          this.c_x - this.x_space * 0.25,
          this.c_y + this.y_space * 2.0,
          this.c_x + this.x_space * 0.25,
          this.c_y + 2.0 * this.y_space
        );
        ...
        this.LINE_BUFFER[this.indexer++] = Array(
          this.c_x - 1.5 * this.x_space,
          this.c_y - 0.6667 * this.y_space,
          this.c_x - 1.5 * this.x_space,
          this.c_y + 0.6667 * this.y_space
        );
        this.LINE_BUFFER[this.indexer++] = Array(
          this.c_x - 2.0 * this.x_space,
          this.c_y - 0.25 * this.y_space,
          this.c_x - 2.0 * this.x_space,
          this.c_y + 0.25 * this.y_space
        );
