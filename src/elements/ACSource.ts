	...
	stamp(): void {
		if (this.elm.consistent()) {
			engine_functions.stamp_voltage(
				this.elm.n1,
				this.elm.n2,
				global.utils.sine(2 * Math.PI * this.elm.properties['Frequency'] * global.simulation_time + global.to_radians(this.elm.properties['Phase'])) * this.elm.properties['Voltage'] +
