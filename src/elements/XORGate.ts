...
class XORGate {
  ...
  public xor_0 = new PointF(0, 0);
  public xor_1 = new PointF(0, 0);
  public xor_2 = new PointF(0, 0);
  public xor_3 = new PointF(0, 0);
  public xor_4 = new PointF(0, 0);
  public xor_5 = new PointF(0, 0);
  public xor_6 = new PointF(0, 0);
  public xor_7 = new PointF(0, 0);
  public xor_8 = new PointF(0, 0);
  public xor_9 = new PointF(0, 0);
  public xor_10 = new PointF(0, 0);
...
or overlapped)*/
  ...
  update() {
    if (global.FLAG_SIMULATING && simulation_manager.SOLUTIONS_READY) {
      if (this.elm.consistent()) {
        this.elm.properties['Input Voltage1'] = Math.tanh(
          10 *
            (engine_functions.get_voltage(this.elm.n1, -1) /
              this.elm.properties['High Voltage'] -
              0.5)
        );
        this.elm.properties['Input Voltage2'] = Math.tanh(
          10 *
        ...
        if (
          ...
          canvas.draw_text(
            global.ELEMENT_VAL_TEMPLATE.replace(
              '{VAL}',
              global.exponentiate_quickly(this.elm.properties['High Voltage'])
