...
class XORGate {
  ...
  public xor_0: PointF = new PointF(0, 0);
  public xor_1: PointF = new PointF(0, 0);
  public xor_2: PointF = new PointF(0, 0);
  public xor_3: PointF = new PointF(0, 0);
  public xor_4: PointF = new PointF(0, 0);
  public xor_5: PointF = new PointF(0, 0);
  public xor_6: PointF = new PointF(0, 0);
  public xor_7: PointF = new PointF(0, 0);
  public xor_8: PointF = new PointF(0, 0);
  public xor_9: PointF = new PointF(0, 0);
  public xor_10: PointF = new PointF(0, 0);
...
or overlapped)*/
  ...
  build_element(): void {
    if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
      ...
      this.xor_2.x = this.xor_1.x + cache_2 * global.cosine(this.theta - Math.PI);
      this.xor_2.y = this.xor_1.y + cache_3 * global.sine(this.theta - Math.PI);
      this.xor_9.x = this.xor_0.x + cache_4 * global.cosine(this.theta_m90) + cache_2 * global.cosine(this.theta - Math.PI);
      this.xor_9.y = this.xor_0.y + cache_5 * global.sine(this.theta_m90) + cache_3 * global.sine(this.theta - Math.PI);
      /* Overshoot of xor_1 */
      ...
      this.xor_10.x = this.xor_3.x + cache_4 * global.cosine(this.theta_m90) + cache_2 * global.cosine(this.theta);
      this.xor_10.y = this.xor_3.y + cache_5 * global.sine(this.theta_m90) + cache_3 * global.sine(this.theta);
      /* Overshoot of xor_4 */
