...
class NPNBipolarJunctionTransistor {
  ...
  public npn_0: PointF = new PointF(0, 0);
  public npn_1: PointF = new PointF(0, 0);
  public npn_2: PointF = new PointF(0, 0);
  public npn_3: PointF = new PointF(0, 0);
  public npn_4: PointF = new PointF(0, 0);
  public npn_5: PointF = new PointF(0, 0);
  public npn_6: PointF = new PointF(0, 0);
  public npn_7: PointF = new PointF(0, 0);
  public npn_8: PointF = new PointF(0, 0);
...
or overlapped)*/
  ...
  stamp(): void {
    if (this.elm.consistent()) {
      ...
      let c: number = global.copy(this.elm.n1);
      let e: number = global.copy(this.elm.n2);
