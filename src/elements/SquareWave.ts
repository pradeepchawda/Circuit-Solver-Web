...
class SquareWave {
  ...
  public sq_0: PointF = new PointF(0, 0);
  public sq_1: PointF = new PointF(0, 0);
  public sq_2: PointF = new PointF(0, 0);
  public sq_3: PointF = new PointF(0, 0);
  public sq_4: PointF = new PointF(0, 0);
  public sq_5: PointF = new PointF(0, 0);
...
or overlapped)*/
      ...
      engine_functions.stamp_voltage(
        ...
        this.elm.properties['Offset'] +
          this.elm.properties['Voltage'] *
            (global.wrap(global.simulation_time, 1.0 / this.elm.properties['Frequency']) < this.elm.properties['Duty'] * 0.01 * (1.0 / this.elm.properties['Frequency']) ? 1 : 0),
  ...
  build_element(): void {
    if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
      ...
      this.sq_3.x = this.sq_0.x - (cache_2 >> 1) * global.cosine(this.theta_m90);
      this.sq_3.y = this.sq_0.y - (cache_2 >> 1) * global.sine(this.theta_m90);
      this.sq_4.x = this.sq_1.x + (cache_2 >> 1) * global.cosine(this.theta_m90);
      this.sq_4.y = this.sq_1.y + (cache_2 >> 1) * global.sine(this.theta_m90);
      this.sq_5.x = this.sq_1.x - (cache_2 >> 1) * global.cosine(this.theta_m90);
    ...
    if (
      ...
      if (global.workspace_zoom_scale > 1.085 || (!global.MOBILE_MODE && global.workspace_zoom_scale >= 0.99)) {
        ...
        if ((this.ANGLE > 170 && this.ANGLE < 190) || (this.ANGLE > -10 && this.ANGLE < 10)) {
          ...
          canvas.draw_text(
            global.exponentiate_quickly(this.elm.properties['Frequency']) + this.elm.properties['options_units'][1],
            this.c_x,
