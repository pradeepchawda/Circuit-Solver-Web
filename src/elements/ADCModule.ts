...
class ADCModule {
  ...
  public adc_0: PointF = new PointF(0, 0);
  public adc_1: PointF = new PointF(0, 0);
  public adc_2: PointF = new PointF(0, 0);
  public adc_3: PointF = new PointF(0, 0);
  public adc_4: PointF = new PointF(0, 0);
  public adc_5: PointF = new PointF(0, 0);
...
or overlapped)*/
  ...
  build_element(): void {
    if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
      ...
      this.adc_0.x = this.c_x - cache_4 * global.cosine(this.theta) + cache_4 * global.cosine(this.theta_m90);
      this.adc_0.y = this.c_y - cache_5 * global.sine(this.theta) + cache_5 * global.sine(this.theta_m90);
      this.adc_2.x = this.c_x - cache_4 * global.cosine(this.theta) - cache_4 * global.cosine(this.theta_m90);
      this.adc_2.y = this.c_y - cache_5 * global.sine(this.theta) - cache_5 * global.sine(this.theta_m90);
      this.adc_3.x = this.c_x + cache_4 * global.cosine(this.theta) - cache_4 * global.cosine(this.theta_m90);
      this.adc_3.y = this.c_y + cache_5 * global.sine(this.theta) - cache_5 * global.sine(this.theta_m90);
      this.adc_4.x = this.c_x + cache_4 * global.cosine(this.theta) + cache_4 * global.cosine(this.theta_m90);
      this.adc_4.y = this.c_y + cache_5 * global.sine(this.theta) + cache_5 * global.sine(this.theta_m90);
