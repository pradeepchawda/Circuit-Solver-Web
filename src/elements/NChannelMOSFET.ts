...
class NChannelMOSFET {
  ...
  public nmos_0: PointF = new PointF(0, 0);
  public nmos_1: PointF = new PointF(0, 0);
  public nmos_2: PointF = new PointF(0, 0);
  public nmos_3: PointF = new PointF(0, 0);
  public nmos_4: PointF = new PointF(0, 0);
  public nmos_5: PointF = new PointF(0, 0);
  public nmos_6: PointF = new PointF(0, 0);
  public nmos_7: PointF = new PointF(0, 0);
  public nmos_8: PointF = new PointF(0, 0);
...
or overlapped)*/
  ...
  build_element(): void {
    if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
      ...
      this.nmos_1.y = this.nmos_0.y + 2 * cache_11 * global.sine(this.theta_m90);
      this.nmos_2.x = this.p1.x + cache_0 * global.cosine(this.theta) + cache_1 * global.cosine(this.theta_m90);
      this.nmos_2.y = this.p1.y + cache_2 * global.sine(this.theta) + cache_3 * global.sine(this.theta_m90);
      this.nmos_3.x = this.p1.x + cache_4 * global.cosine(this.theta);
      this.nmos_3.y = this.p1.y + cache_5 * global.sine(this.theta);
      this.nmos_4.x = this.nmos_3.x + 2 * cache_10 * global.cosine(this.theta_m90);
      this.nmos_4.y = this.nmos_3.y + 2 * cache_11 * global.sine(this.theta_m90);
      this.nmos_5.x = this.p1.x + cache_1 * global.cosine(this.theta) + cache_1 * global.cosine(this.theta_m90);
      ...
      this.nmos_8.y = this.nmos_3.y + cache_9 * global.sine(this.theta_m90 - global.PI_DIV_6);
    ...
    if (
      ...
      if (global.workspace_zoom_scale > 1.085 || (!global.MOBILE_MODE && global.workspace_zoom_scale >= 0.99)) {
        ...
        if ((this.ANGLE > 170 && this.ANGLE < 190) || (this.ANGLE > -10 && this.ANGLE < 10)) {
          ...
          canvas.draw_text(
            global.ELEMENT_VAL_TEMPLATE.replace('{VAL}', global.exponentiate_quickly(this.elm.properties['W/L Ratio'])).replace('{UNIT}', this.elm.properties['units']),
            this.c_x,
