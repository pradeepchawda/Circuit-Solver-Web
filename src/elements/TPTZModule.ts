...
or overlapped)*/
  ...
  public m_x = 0;
  public m_y = 0;
  public tptz_controller = new TPTZController([
  ...
  update() {
    if (
      ...
      if (this.elm.consistent()) {
        ...
        this.elm.properties['Output Voltage'] = this.tptz_controller.get_output(
  ...
  stamp() {
    if (this.elm.consistent()) {
      engine_functions.stamp_voltage(
        ...
        simulation_manager.ELEMENT_TPTZ_OFFSET + this.simulation_id
      );
    }
  }
