...
class VoltageControlledSwitch {
  ...
  public vcsw_0: PointF = new PointF(0, 0);
  public vcsw_1: PointF = new PointF(0, 0);
  public vcsw_2: PointF = new PointF(0, 0);
  public vcsw_4: PointF = new PointF(0, 0);
  public vcsw_3: PointF = new PointF(0, 0);
...
or overlapped)*/
  ...
  build_element(): void {
    if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
      ...
      this.vcsw_0.x = this.connect1_x + cache_6 * global.cosine(this.theta) + cache_0 * global.cosine(this.theta_m90);
      this.vcsw_0.y = this.connect1_y + cache_7 * global.sine(this.theta) + cache_1 * global.sine(this.theta_m90);
      ...
      this.vcsw_2.x = this.vcsw_1.x + cache_4 * global.cosine(this.theta - global.PI_DIV_6);
      this.vcsw_2.y = this.vcsw_1.y + cache_5 * global.sine(this.theta - global.PI_DIV_6);
      this.vcsw_3.x = this.vcsw_1.x + cache_4 * global.cosine(this.theta + global.PI_DIV_6);
      this.vcsw_3.y = this.vcsw_1.y + cache_5 * global.sine(this.theta + global.PI_DIV_6);
      /* Angle from p1 to p3 */
      this.theta = global.retrieve_angle_radian(this.p3.x - this.p1.x, this.p3.y - this.p1.y);
