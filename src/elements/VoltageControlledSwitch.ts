...
class VoltageControlledSwitch {
  ...
  public vcsw_0 = new PointF(0, 0);
  public vcsw_1 = new PointF(0, 0);
  public vcsw_2 = new PointF(0, 0);
  public vcsw_4 = new PointF(0, 0);
  public vcsw_3 = new PointF(0, 0);
...
or overlapped)*/
  ...
  update() {
    if (
      ...
      if (this.elm.consistent()) {
        this.elm.properties['Input Voltage'] = Math.tanh(
          10 *
  ...
  get_vertices() {
    ...
    if (this.elm.rotation === global.ROTATION_0) {
      ...
      p2 = this.elm.snap_to_grid(
        ...
        this.bounds.get_center_y() - global.node_space_y
      );
