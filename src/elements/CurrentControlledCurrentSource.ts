...
class CurrentControlledCurrentSource {
  ...
  public cccs_0 = new PointF(0, 0);
  public cccs_1 = new PointF(0, 0);
  public cccs_2 = new PointF(0, 0);
  public cccs_3 = new PointF(0, 0);
  public cccs_4 = new PointF(0, 0);
  public cccs_5 = new PointF(0, 0);
  public cccs_6 = new PointF(0, 0);
  public cccs_7 = new PointF(0, 0);
  public cccs_8 = new PointF(0, 0);
  public cccs_9 = new PointF(0, 0);
  public cccs_10 = new PointF(0, 0);
  public cccs_11 = new PointF(0, 0);
  public cccs_12 = new PointF(0, 0);
  public cccs_13 = new PointF(0, 0);
  public cccs_14 = new PointF(0, 0);
  public cccs_15 = new PointF(0, 0);
  public cccs_16 = new PointF(0, 0);
...
or overlapped)*/
  ...
  stamp() {
    if (this.elm.consistent()) {
      engine_functions.stamp_cccs(
        this.elm.n1,
        this.elm.n2,
        this.elm.n3,
        this.elm.n4,
        -this.elm.properties['Gain'],
        simulation_manager.ELEMENT_CCCS_OFFSET + this.simulation_id
      );
    }
  }
  ...
  draw_component(canvas) {
    ...
    if (
      ...
      /* Reference polarity point */
      this.LINE_BUFFER[this.indexer++] = Array(
        this.cccs_16.x - this.bounds.get_width() * 0.05,
        this.cccs_16.y,
        this.cccs_16.x + this.bounds.get_width() * 0.05,
        this.cccs_16.y
      );
      this.LINE_BUFFER[this.indexer++] = Array(
        this.cccs_16.x,
        this.cccs_16.y + this.bounds.get_width() * 0.05,
        this.cccs_16.x,
        this.cccs_16.y - this.bounds.get_width() * 0.05
      );
