...
class DCCurrent {
  ...
  /* DCCurrent point 0 */
  public dcc_0: PointF = new PointF(0, 0);
  /* DCCurrent point 1 */
  public dcc_1: PointF = new PointF(0, 0);
  /* DCCurrent point 2 */
  public dcc_2: PointF = new PointF(0, 0);
  /* DCCurrent point 3 */
  public dcc_3: PointF = new PointF(0, 0);
...
or overlapped)*/
  ...
  build_element(): void {
    if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
      ...
      this.dcc_2.x = this.c_x - cache_2 * global.cosine(this.theta) + (cache_5 >> 1) * global.cosine(this.theta_m90);
      this.dcc_2.y = this.c_y - cache_3 * global.sine(this.theta) + (cache_5 >> 1) * global.sine(this.theta_m90);
      this.dcc_3.x = this.c_x - cache_2 * global.cosine(this.theta) + (cache_5 >> 1) * global.cosine(Math.PI + this.theta_m90);
      this.dcc_3.y = this.c_y - cache_3 * global.sine(this.theta) + (cache_5 >> 1) * global.sine(Math.PI + this.theta_m90);
