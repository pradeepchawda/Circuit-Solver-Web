...
or overlapped)*/
  ...
  stamp() {
    if (this.elm.consistent()) {
      engine_functions.stamp_transformer(
        this.elm.n1,
        this.elm.n2,
        this.elm.n3,
        this.elm.n4,
        this.elm.properties['Turns Ratio'],
        simulation_manager.ELEMENT_TRAN_OFFSET + this.simulation_id
      );
    }
  }
        ...
        if (
          ...
          canvas.draw_text(
            global.ELEMENT_VAL_TEMPLATE.replace(
              '{VAL}',
              global.exponentiate_quickly(this.elm.properties['Turns Ratio'])
