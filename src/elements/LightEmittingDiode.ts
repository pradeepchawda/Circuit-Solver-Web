 ...
 * File		        : LightEmittingDiode.js
 * Author            : nboatengc
 * Date created      : 20190928
 *
 * Purpose           : A class to handle the LED element. It will automatically generate
...
class LightEmittingDiode {
  ...
  public led_0 = new PointF(0, 0);
  public led_1 = new PointF(0, 0);
  public led_2 = new PointF(0, 0);
  public led_3 = new PointF(0, 0);
  public led_4 = new PointF(0, 0);
  public led_5 = new PointF(0, 0);
  public led_6 = new PointF(0, 0);
  public led_7 = new PointF(0, 0);
  public led_8 = new PointF(0, 0);
  public led_9 = new PointF(0, 0);
  public led_10 = new PointF(0, 0);
  public led_11 = new PointF(0, 0);
...
or overlapped)*/
  ...
  constructor(type, id, n1, n2) {
    ...
    /* Inititalize the element2 class that will hold the basic data about our component */
    this.elm = new Element2(id, type, global.copy(global.PROPERTY_LED));
  ...
  turn_on_check() {
    if (
      Math.abs(this.elm.properties['Equivalent Current']) >
  ...
  draw_component(canvas) {
    ...
    if (
      ...
      if (global.FLAG_SIMULATING && this.LED_STATUS === global.ON) {
        ...
        let new_color = this.wavelength_to_color(
          this.elm.properties['Wavelength']
        );
