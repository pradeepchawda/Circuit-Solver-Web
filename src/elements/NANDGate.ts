...
class NANDGate {
  ...
  public nand_0: PointF = new PointF(0, 0);
  public nand_1: PointF = new PointF(0, 0);
  public nand_2: PointF = new PointF(0, 0);
  public nand_3: PointF = new PointF(0, 0);
  public nand_4: PointF = new PointF(0, 0);
  public nand_5: PointF = new PointF(0, 0);
  public nand_6: PointF = new PointF(0, 0);
  public nand_7: PointF = new PointF(0, 0);
  public nand_8: PointF = new PointF(0, 0);
...
or overlapped)*/
  ...
  build_element(): void {
    if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
      ...
      this.nand_2.x = this.nand_1.x + cache_2 * global.cosine(this.theta - Math.PI);
      this.nand_2.y = this.nand_1.y + cache_3 * global.sine(this.theta - Math.PI);
      /* Bottom segment */
