...
class Divider {
  ...
  public divider_0 = new PointF(0, 0);
  public divider_1 = new PointF(0, 0);
  public divider_2 = new PointF(0, 0);
  public divider_3 = new PointF(0, 0);
  public divider_4 = new PointF(0, 0);
  public divider_5 = new PointF(0, 0);
  public divider_6 = new PointF(0, 0);
  ...
  public temp_color = global.ELEMENT_COLOR;
  ...
  stamp() {
    if (this.elm.consistent()) {
      engine_functions.stamp_voltage(
        ...
        -1,
        this.elm.properties['Output Voltage'],
        simulation_manager.ELEMENT_DIV_OFFSET + this.simulation_id
      );
    }
  }
  ...
  draw_component(canvas) {
    ...
    if (
      ...
      this.CIRCLE_BUFFER[this.indexer++] = Array(
        ...
        0.75 * global.CANVAS_STROKE_WIDTH_2_ZOOM
      );
      this.CIRCLE_BUFFER[this.indexer++] = Array(
        this.c_x,
        this.c_y - this.bounds.get_width() * 0.1,
