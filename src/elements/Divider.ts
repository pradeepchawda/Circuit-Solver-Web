...
class Divider {
  ...
  public divider_0: PointF = new PointF(0, 0);
  public divider_1: PointF = new PointF(0, 0);
  public divider_2: PointF = new PointF(0, 0);
  public divider_3: PointF = new PointF(0, 0);
  public divider_4: PointF = new PointF(0, 0);
  public divider_5: PointF = new PointF(0, 0);
  public divider_6: PointF = new PointF(0, 0);
  ...
  public temp_color : string = global.ELEMENT_COLOR;
...
or overlapped)*/
  ...
  build_element(): void {
    if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
      ...
      this.plus_point.x = this.c_x - cache_6 * global.cosine(this.theta) - cache_7 * global.cosine(this.theta_m90);
      this.plus_point.y = this.c_y - cache_8 * global.sine(this.theta) - cache_9 * global.sine(this.theta_m90);
      /* Top segment */
      ...
      this.divider_2.x = this.divider_1.x + cache_2 * global.cosine(this.theta - Math.PI);
      this.divider_2.y = this.divider_1.y + cache_3 * global.sine(this.theta - Math.PI);
      /* Bottom segment */
