...
class SampleAndHold {
  ...
  public sah_2 = new PointF(0, 0);
  public sah_3 = new PointF(0, 0);
  public sah_4 = new PointF(0, 0);
  public sah_5 = new PointF(0, 0);
  public sah_6 = new PointF(0, 0);
  public sah_7 = new PointF(0, 0);
  public sah_8 = new PointF(0, 0);
  ...
  update() {
    if (
      ...
      if (this.elm.consistent()) {
        ...
        this.elm.properties['Output Voltage'] = this.elm.properties[
          'Input Voltage1'
        ];
      }
    } else {
  ...
  stamp() {
    if (this.elm.consistent()) {
      engine_functions.stamp_voltage(
        ...
        simulation_manager.ELEMENT_SAH_OFFSET + this.simulation_id
      );
    }
  }
