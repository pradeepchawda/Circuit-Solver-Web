...
class DACModule {
  ...
  public dac_0: PointF = new PointF(0, 0);
  public dac_1: PointF = new PointF(0, 0);
  public dac_2: PointF = new PointF(0, 0);
  public dac_3: PointF = new PointF(0, 0);
  public dac_4: PointF = new PointF(0, 0);
  public dac_5: PointF = new PointF(0, 0);
...
or overlapped)*/
  ...
  build_element(): void {
    if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
      ...
      this.dac_0.x = this.c_x - cache_4 * global.cosine(this.theta) + cache_4 * global.cosine(this.theta_m90);
      this.dac_0.y = this.c_y - cache_5 * global.sine(this.theta) + cache_5 * global.sine(this.theta_m90);
      this.dac_2.x = this.c_x - cache_4 * global.cosine(this.theta) - cache_4 * global.cosine(this.theta_m90);
      this.dac_2.y = this.c_y - cache_5 * global.sine(this.theta) - cache_5 * global.sine(this.theta_m90);
      this.dac_3.x = this.c_x + cache_4 * global.cosine(this.theta) - cache_4 * global.cosine(this.theta_m90);
      this.dac_3.y = this.c_y + cache_5 * global.sine(this.theta) - cache_5 * global.sine(this.theta_m90);
      this.dac_4.x = this.c_x + cache_4 * global.cosine(this.theta) + cache_4 * global.cosine(this.theta_m90);
      this.dac_4.y = this.c_y + cache_5 * global.sine(this.theta) + cache_5 * global.sine(this.theta_m90);
