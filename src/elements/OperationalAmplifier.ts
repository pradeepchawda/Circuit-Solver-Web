...
class OperationalAmplifier {
  ...
  public op_0: PointF = new PointF(0, 0);
  public op_1: PointF = new PointF(0, 0);
  public op_2: PointF = new PointF(0, 0);
  public op_3: PointF = new PointF(0, 0);
  public op_4: PointF = new PointF(0, 0);
  public op_5: PointF = new PointF(0, 0);
  public op_6: PointF = new PointF(0, 0);
  public op_7: PointF = new PointF(0, 0);
  public op_8: PointF = new PointF(0, 0);
  public op_9: PointF = new PointF(0, 0);
  public op_10: PointF = new PointF(0, 0);
  public op_11: PointF = new PointF(0, 0);
  public op_12: PointF = new PointF(0, 0);
...
or overlapped)*/
  ...
  build_element(): void {
    if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
      ...
      /* Plus Point */
      this.op_7.x = this.p1.x + cache_0 * global.cosine(this.theta) + cache_14 * global.cosine(this.theta_m90);
      this.op_7.y = this.p1.y + cache_1 * global.sine(this.theta) + cache_15 * global.sine(this.theta_m90);
      this.op_8.x = this.p1.x + cache_0 * global.cosine(this.theta) + cache_6 * global.cosine(this.theta_m90);
      this.op_8.y = this.p1.y + cache_1 * global.sine(this.theta) + cache_7 * global.sine(this.theta_m90);
      this.op_9.x = this.p1.x + cache_8 * global.cosine(this.theta) + cache_9 * global.cosine(this.theta_m90);
      this.op_9.y = this.p1.y + cache_10 * global.sine(this.theta) + cache_11 * global.sine(this.theta_m90);
      this.op_10.x = this.p1.x + cache_12 * global.cosine(this.theta) + cache_9 * global.cosine(this.theta_m90);
      this.op_10.y = this.p1.y + cache_13 * global.sine(this.theta) + cache_11 * global.sine(this.theta_m90);
      /* Negative Point */
      this.op_11.x = this.p1.x + cache_4 * global.cosine(this.theta) + cache_14 * global.cosine(this.theta_m90);
      this.op_11.y = this.p1.y + cache_5 * global.sine(this.theta) + cache_15 * global.sine(this.theta_m90);
      this.op_12.x = this.p1.x + cache_4 * global.cosine(this.theta) + cache_6 * global.cosine(this.theta_m90);
      this.op_12.y = this.p1.y + cache_5 * global.sine(this.theta) + cache_7 * global.sine(this.theta_m90);
