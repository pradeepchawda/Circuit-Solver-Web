 ...
 * File		        : TriangleWave.js
 * Author            : nboatengc
 * Date created      : 20190928
 *
 * Purpose           : A class to handle the triangle wave element. It will automatically generate
...
or overlapped)*/
  ...
  build_element() {
    if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
      ...
      this.sq_0.x =
        this.c_x - (cache_2 >> 2) * global.cosine(this.theta - global.PI_DIV_4);
      this.sq_0.y =
        this.c_y - (cache_2 >> 2) * global.sine(this.theta - global.PI_DIV_4);
      this.sq_1.x =
        this.c_x + (cache_2 >> 2) * global.cosine(this.theta - global.PI_DIV_4);
      this.sq_1.y =
        this.c_y + (cache_2 >> 2) * global.sine(this.theta - global.PI_DIV_4);
