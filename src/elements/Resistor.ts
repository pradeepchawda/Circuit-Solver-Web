...
class Resistor {
  ...
  /* Resistor point 0 */
  public res_0: PointF = new PointF(0, 0);
  /* Resistor point 1 */
  public res_1: PointF = new PointF(0, 0);
  /* Resistor point 2 */
  public res_2: PointF = new PointF(0, 0);
  /* Resistor point 3 */
  public res_3: PointF = new PointF(0, 0);
  /* Resistor point 4 */
  public res_4: PointF = new PointF(0, 0);
  /* Resistor point 5 */
  public res_5: PointF = new PointF(0, 0);
  /* Resistor point 6 */
  public res_6: PointF = new PointF(0, 0);
  /* Resistor point 7 */
  public res_7: PointF = new PointF(0, 0);
  /* Resistor point 8 */
  public res_8: PointF = new PointF(0, 0);
