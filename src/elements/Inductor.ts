 ...
 *
 * Purpose           : A class to handle the inductor element. It will automatically generate
...
class Inductor {
  ...
  public inductor_arc_0: Arc = new Arc(0, 0, 0, 0, global.CANVAS_STROKE_WIDTH_5_ZOOM);
  public inductor_arc_1: Arc = new Arc(0, 0, 0, 0, global.CANVAS_STROKE_WIDTH_5_ZOOM);
  public inductor_arc_2: Arc = new Arc(0, 0, 0, 0, global.CANVAS_STROKE_WIDTH_5_ZOOM);
  public inductor_arc_3: Arc = new Arc(0, 0, 0, 0, global.CANVAS_STROKE_WIDTH_5_ZOOM);
  /* Inductor point 0 */
  public ind_0: PointF = new PointF(0, 0);
  /* Inductor point 1 */
  public ind_1: PointF = new PointF(0, 0);
  /* Inductor point 2 */
  public ind_2: PointF = new PointF(0, 0);
  /* Inductor point 3 */
  public ind_3: PointF = new PointF(0, 0);
  /* Inductor point 0 */
  public ind_4: PointF = new PointF(0, 0);
  /* Inductor point 1 */
  public ind_5: PointF = new PointF(0, 0);
  /* Inductor point 2 */
  public ind_6: PointF = new PointF(0, 0);
  /* Inductor point 3 */
  public ind_7: PointF = new PointF(0, 0);
...
or overlapped)*/
  ...
  constructor(type: number, id: number, n1: number, n2: number) {
    ...
    /* Inititalize the element2 class that will hold the basic data about our component */
    this.elm = new Element2(id, type, global.copy(global.PROPERTY_INDUCTOR));
    ...
    this.inductor_arc_1 = new Arc(0, 0, 0, 0, global.CANVAS_STROKE_WIDTH_5_ZOOM);
    this.inductor_arc_2 = new Arc(0, 0, 0, 0, global.CANVAS_STROKE_WIDTH_5_ZOOM);
    this.inductor_arc_3 = new Arc(0, 0, 0, 0, global.CANVAS_STROKE_WIDTH_5_ZOOM);
    /* Inductor point 0 */
  ...
  build_element(): void {
    if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
      ...
      this.ind_0.x = this.c_x + cache_2 * global.cosine(this.theta);
      ...
      this.inductor_arc_1.amplitude = global.CANVAS_STROKE_WIDTH_5_ZOOM;
      this.inductor_arc_2.set_points(this.c_x, this.c_y, this.ind_2.x, this.ind_2.y);
      this.inductor_arc_2.amplitude = global.CANVAS_STROKE_WIDTH_5_ZOOM;
  ...
  recolor(): void {
    if (global.selected) {
      if (global.selected_id === this.elm.id && global.selected_type === this.elm.type) {
        ...
        this.point_paint.set_color(global.ELEMENT_COLOR);
        this.text_paint.set_color(global.ELEMENT_COLOR);
        this.inductor_arc_0.set_color(global.ELEMENT_COLOR);
        this.inductor_arc_1.set_color(global.ELEMENT_COLOR);
        this.inductor_arc_2.set_color(global.ELEMENT_COLOR);
