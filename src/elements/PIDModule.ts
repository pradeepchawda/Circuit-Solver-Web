...
class PIDModule {
  ...
  public pid_0 = new PointF(0, 0);
  public pid_1 = new PointF(0, 0);
  public pid_2 = new PointF(0, 0);
  public pid_3 = new PointF(0, 0);
  public pid_4 = new PointF(0, 0);
  public pid_5 = new PointF(0, 0);
  public pid_6 = new PointF(0, 0);
...
or overlapped)*/
  ...
  public m_x = 0;
  public m_y = 0;
  public pid_controller = new PIDController(
    this.elm.properties['Setpoint'],
    this.elm.properties['Kp'],
    this.elm.properties['Ki'],
    this.elm.properties['Kd']
  );
  ...
  or overlapped)*/
    ...
    this.pid_controller.set_output_limits(
      this.elm.properties['Min Output'],
      this.elm.properties['Max Output']
    );
  ...
  update() {
    if (
      ...
      if (this.elm.consistent()) {
        ...
        this.elm.properties['Input Voltage1'] = engine_functions.get_voltage(
          this.elm.n1,
          -1
        );
        ...
        this.elm.properties['Output Voltage'] = this.pid_controller.get_output(
  ...
  stamp() {
    if (this.elm.consistent()) {
      engine_functions.stamp_voltage(
        ...
        simulation_manager.ELEMENT_PID_OFFSET + this.simulation_id
      );
    }
  }
  ...
  draw_component(canvas) {
    ...
    if (
      ...
      canvas.draw_rect3(
        this.bounds.get_center_x(),
        this.bounds.get_center_y(),
        this.bounds.get_width() * 0.5128,
        this.bounds.get_height() * 0.5128,
        this.line_paint
      );
