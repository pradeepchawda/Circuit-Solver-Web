...
class PIDModule {
  ...
  public pid_0: PointF = new PointF(0, 0);
  public pid_1: PointF = new PointF(0, 0);
  public pid_2: PointF = new PointF(0, 0);
  public pid_3: PointF = new PointF(0, 0);
  public pid_4: PointF = new PointF(0, 0);
  public pid_5: PointF = new PointF(0, 0);
  public pid_6: PointF = new PointF(0, 0);
  public pid_7: PointF = new PointF(0, 0);
  public pid_8: PointF = new PointF(0, 0);
...
or overlapped)*/
  ...
  build_element(): void {
    if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
      ...
      this.pid_2.x = this.pid_1.x + cache_2 * global.cosine(this.theta - Math.PI);
      ...
      if (this.elm.flip === global.FLIP_0) {
        ...
        this.pid_7.x = this.p1.x + cache_4 * global.cosine(this.theta_m90 + global.PI_DIV_4);
        this.pid_7.y = this.p1.y + cache_5 * global.sine(this.theta_m90 + global.PI_DIV_4);
        /* Reference polarity point */
        this.pid_8.x = this.p2.x + cache_4 * global.cosine(this.theta_m90 - global.PI_DIV_4);
        this.pid_8.y = this.p2.y + cache_5 * global.sine(this.theta_m90 - global.PI_DIV_4);
      } else if (this.elm.flip === global.FLIP_180) {
        /* Reference polarity point */
        this.pid_7.x = this.p1.x + cache_4 * global.cosine(this.theta_m90 - global.PI_DIV_4);
        this.pid_7.y = this.p1.y + cache_5 * global.sine(this.theta_m90 - global.PI_DIV_4);
