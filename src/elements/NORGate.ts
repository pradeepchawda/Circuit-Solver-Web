 ...
 *
 * Purpose           : A class to handle the NORGate element. It will automatically generate
...
or overlapped)*/
  ...
  constructor(type, id, n1, n2, n3) {
    ...
    /* Inititalize the element2 class that will hold the basic data about our component */
    this.elm = new Element3(id, type, global.copy(global.PROPERTY_NOR));
  ...
  build_element() {
    if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
      ...
      this.nor_7.y = this.nor_0.y + cache_5 * global.sine(this.theta_m90);
      /* Bottom segment */
      this.nor_3.x = this.p1.x + cache_6 * global.cosine(this.theta);
      this.nor_3.y = this.p1.y + cache_7 * global.sine(this.theta);
      this.nor_4.x = this.nor_3.x + cache_2 * global.cosine(this.theta_m90);
      this.nor_4.y = this.nor_3.y + cache_3 * global.sine(this.theta_m90);
      this.nor_5.x = this.nor_4.x + cache_2 * global.cosine(this.theta);
      this.nor_5.y = this.nor_4.y + cache_3 * global.sine(this.theta);
      /* Overshoot of nor_4 */
      this.nor_8.x = this.nor_3.x + cache_4 * global.cosine(this.theta_m90);
      this.nor_8.y = this.nor_3.y + cache_5 * global.sine(this.theta_m90);
      /* End Segment */
      this.nor_6.x = this.p3.x - cache_8 * global.cosine(this.theta_m90);
      this.nor_6.y = this.p3.y - cache_9 * global.sine(this.theta_m90);
      this.nor_9.x = this.p3.x - cache_10 * global.cosine(this.theta_m90);
      this.nor_9.y = this.p3.y - cache_11 * global.sine(this.theta_m90);
      this.nor_10.x = this.p3.x - cache_12 * global.cosine(this.theta_m90);
