...
class VoltageSaturation {
  ...
  public vsat_0: PointF = new PointF(0, 0);
  public vsat_1: PointF = new PointF(0, 0);
  public vsat_2: PointF = new PointF(0, 0);
  public vsat_3: PointF = new PointF(0, 0);
  public vsat_4: PointF = new PointF(0, 0);
  public vsat_5: PointF = new PointF(0, 0);
  public vsat_6: PointF = new PointF(0, 0);
  public vsat_7: PointF = new PointF(0, 0);
  public vsat_8: PointF = new PointF(0, 0);
  public vsat_9: PointF = new PointF(0, 0);
...
or overlapped)*/
  ...
  build_element(): void {
    if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
      ...
      this.vsat_0.x = this.c_x - cache_8 * global.cosine(this.theta) + cache_8 * global.cosine(this.theta_m90);
      this.vsat_0.y = this.c_y - cache_9 * global.sine(this.theta) + cache_9 * global.sine(this.theta_m90);
      this.vsat_2.x = this.c_x - cache_8 * global.cosine(this.theta) - cache_8 * global.cosine(this.theta_m90);
      this.vsat_2.y = this.c_y - cache_9 * global.sine(this.theta) - cache_9 * global.sine(this.theta_m90);
      this.vsat_3.x = this.c_x + cache_8 * global.cosine(this.theta) - cache_8 * global.cosine(this.theta_m90);
      this.vsat_3.y = this.c_y + cache_9 * global.sine(this.theta) - cache_9 * global.sine(this.theta_m90);
      this.vsat_4.x = this.c_x + cache_8 * global.cosine(this.theta) + cache_8 * global.cosine(this.theta_m90);
      this.vsat_4.y = this.c_y + cache_9 * global.sine(this.theta) + cache_9 * global.sine(this.theta_m90);
      ...
      this.vsat_6.x = this.connect1_x + cache_4 * global.cosine(this.theta + global.PI_DIV_4);
      this.vsat_6.y = this.connect1_y + cache_5 * global.sine(this.theta + global.PI_DIV_4);
      this.vsat_7.x = this.connect1_x + cache_4 * global.cosine(this.theta + global.PI_DIV_4) + cache_6 * global.cosine(this.theta);
      this.vsat_7.y = this.connect1_y + cache_5 * global.sine(this.theta + global.PI_DIV_4) + cache_7 * global.sine(this.theta);
      this.vsat_8.x = this.connect2_x + cache_4 * global.cosine(this.theta - global.PI_DIV_2 - global.PI_DIV_4);
      this.vsat_8.y = this.connect2_y + cache_5 * global.sine(this.theta - global.PI_DIV_2 - global.PI_DIV_4);
      this.vsat_9.x = this.connect2_x + cache_4 * global.cosine(this.theta - global.PI_DIV_2 - global.PI_DIV_4) + cache_6 * global.cosine(this.theta - Math.PI);
      this.vsat_9.y = this.connect2_y + cache_5 * global.sine(this.theta - global.PI_DIV_2 - global.PI_DIV_4) + cache_7 * global.sine(this.theta - Math.PI);
    ...
    if (
      ...
      if (global.workspace_zoom_scale > 1.085 || (!global.MOBILE_MODE && global.workspace_zoom_scale >= 0.99)) {
        ...
        if ((this.ANGLE > 170 && this.ANGLE < 190) || (this.ANGLE > -10 && this.ANGLE < 10)) {
          canvas.draw_text(
            global.DIVISION_TEXT_TEMPLATE.replace('{A}', global.exponentiate_quickly(this.elm.properties['Low Voltage'])).replace(
              '{B}',
              global.ELEMENT_VAL_TEMPLATE.replace('{VAL}', global.exponentiate_quickly(this.elm.properties['High Voltage'])).replace('{UNIT}', this.elm.properties['units'])
            ),
            this.c_x,
