...
class VoltageSaturation {
	...
	/* Angle from p1 to p2 */
	public theta: number;
	public vsat_0: PointF;
	public vsat_1: PointF;
	public vsat_2: PointF;
	public vsat_3: PointF;
	public vsat_4: PointF;
	public vsat_5: PointF;
	public vsat_6: PointF;
	public vsat_7: PointF;
	public vsat_8: PointF;
	public vsat_9: PointF;
