...
class DCSource {
  ...
  /* Resistor point 0 */
  public dc_0 = new PointF(0, 0);
  /* Resistor point 1 */
  public dc_1 = new PointF(0, 0);
  /* Resistor point 2 */
  public dc_2 = new PointF(0, 0);
  /* Resistor point 3 */
  public dc_3 = new PointF(0, 0);
  /* Resistor point 4 */
  public dc_4 = new PointF(0, 0);
  /* Resistor point 5 */
  public dc_5 = new PointF(0, 0);
  ...
  stamp() {
    if (this.elm.consistent()) {
      engine_functions.stamp_voltage(
        ...
        simulation_manager.ELEMENT_DCSOURCE_OFFSET + this.simulation_id
      );
    }
  }
