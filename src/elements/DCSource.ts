...
class DCSource {
  ...
  /* Resistor point 0 */
  public dc_0: PointF = new PointF(0, 0);
  /* Resistor point 1 */
  public dc_1: PointF = new PointF(0, 0);
  /* Resistor point 2 */
  public dc_2: PointF = new PointF(0, 0);
  /* Resistor point 3 */
  public dc_3: PointF = new PointF(0, 0);
  /* Resistor point 4 */
  public dc_4: PointF = new PointF(0, 0);
  /* Resistor point 5 */
  public dc_5: PointF = new PointF(0, 0);
