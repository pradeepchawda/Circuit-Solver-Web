...
class VoltageControlledResistor {
  ...
  public vcr_0: PointF = new PointF(0, 0);
  public vcr_1: PointF = new PointF(0, 0);
  public vcr_2: PointF = new PointF(0, 0);
  public vcr_3: PointF = new PointF(0, 0);
  /* Resistor point 0 */
  public vcr_4: PointF = new PointF(0, 0);
  /* Resistor point 1 */
  public vcr_6: PointF = new PointF(0, 0);
  /* Resistor point 2 */
  public vcr_5: PointF = new PointF(0, 0);
  /* Resistor point 3 */
  public vcr_7: PointF = new PointF(0, 0);
  /* Resistor point 4 */
  public vcr_8: PointF = new PointF(0, 0);
  /* Resistor point 5 */
  public vcr_9: PointF = new PointF(0, 0);
  /* Resistor point 6 */
  public vcr_10: PointF = new PointF(0, 0);
  /* Resistor point 7 */
  public vcr_11: PointF = new PointF(0, 0);
  /* Resistor point 8 */
  public vcr_12: PointF = new PointF(0, 0);
