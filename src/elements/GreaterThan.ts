...
class GreaterThan {
  ...
  public greater_2 = new PointF(0, 0);
  public greater_3 = new PointF(0, 0);
  public greater_4 = new PointF(0, 0);
  public greater_5 = new PointF(0, 0);
  public greater_6 = new PointF(0, 0);
  public greater_7 = new PointF(0, 0);
  public greater_8 = new PointF(0, 0);
  public greater_9 = new PointF(0, 0);
  ...
  stamp() {
    if (this.elm.consistent()) {
      engine_functions.stamp_voltage(
        ...
        -1,
        this.elm.properties['Output Voltage'],
        simulation_manager.ELEMENT_GRT_OFFSET + this.simulation_id
      );
    }
  }
