...
class DifferentiatorModule {
  ...
  public diff_0: PointF = new PointF(0, 0);
  public diff_1: PointF = new PointF(0, 0);
  public diff_2: PointF = new PointF(0, 0);
  public diff_3: PointF = new PointF(0, 0);
  public diff_4: PointF = new PointF(0, 0);
  public diff_5: PointF = new PointF(0, 0);
...
or overlapped)*/
    ...
    if (global.FLAG_SIMULATING && simulation_manager.SOLUTIONS_READY && simulation_manager.SIMULATION_STEP != 0) {
      if (this.elm.consistent()) {
        if (global.simulation_time < global.time_step * 1.5) {
          ...
          this.elm.properties['Input Voltage'] = engine_functions.get_voltage(this.elm.n1, -1);
          this.elm.properties['Output Voltage'] = (this.elm.properties['Input Voltage'] - this.elm.properties['Last Value']) / global.time_step;
        }
  ...
  build_element(): void {
    if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
      ...
      this.diff_0.x = this.c_x - cache_4 * global.cosine(this.theta) + cache_4 * global.cosine(this.theta_m90);
      this.diff_0.y = this.c_y - cache_5 * global.sine(this.theta) + cache_5 * global.sine(this.theta_m90);
      this.diff_2.x = this.c_x - cache_4 * global.cosine(this.theta) - cache_4 * global.cosine(this.theta_m90);
      this.diff_2.y = this.c_y - cache_5 * global.sine(this.theta) - cache_5 * global.sine(this.theta_m90);
      this.diff_3.x = this.c_x + cache_4 * global.cosine(this.theta) - cache_4 * global.cosine(this.theta_m90);
      this.diff_3.y = this.c_y + cache_5 * global.sine(this.theta) - cache_5 * global.sine(this.theta_m90);
      this.diff_4.x = this.c_x + cache_4 * global.cosine(this.theta) + cache_4 * global.cosine(this.theta_m90);
      this.diff_4.y = this.c_y + cache_5 * global.sine(this.theta) + cache_5 * global.sine(this.theta_m90);
