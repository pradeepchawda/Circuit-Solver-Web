...
class Relay {
  ...
  public relay_0: PointF = new PointF(0, 0);
  public relay_1: PointF = new PointF(0, 0);
  public relay_2: PointF = new PointF(0, 0);
  public relay_3: PointF = new PointF(0, 0);
  public relay_4: PointF = new PointF(0, 0);
  public relay_5: PointF = new PointF(0, 0);
  public relay_6: PointF = new PointF(0, 0);
  public relay_7: PointF = new PointF(0, 0);
  public relay_8: PointF = new PointF(0, 0);
  public relay_9: PointF = new PointF(0, 0);
  public relay_10: PointF = new PointF(0, 0);
  public relay_11: PointF = new PointF(0, 0);
...
or overlapped)*/
  ...
  build_element(): void {
    if (this.BUILD_ELEMENT || global.SIGNAL_BUILD_ELEMENT) {
      ...
      this.relay_8.x = this.relay_2.x + cache_2 * global.cosine(this.theta) + cache_7 * global.cosine(this.theta_m90);
      this.relay_8.y = this.relay_2.y + cache_3 * global.sine(this.theta) + cache_8 * global.sine(this.theta_m90);
      ...
      /* Left current dot */
      this.relay_10.x = this.relay_4.x - cache_4 * global.cosine(this.theta_m90);
      ...
      this.relay_11.x = this.relay_7.x + cache_4 * global.cosine(this.theta_m90);
    ...
    if (
      ...
      if (global.workspace_zoom_scale > 1.085 || (!global.MOBILE_MODE && global.workspace_zoom_scale >= 0.99)) {
        ...
        if ((this.ANGLE > 170 && this.ANGLE < 190) || (this.ANGLE > -10 && this.ANGLE < 10)) {
          ...
          canvas.draw_text(
            global.ELEMENT_VAL_TEMPLATE.replace('{VAL}', global.exponentiate_quickly(this.elm.properties['Inductance'])).replace('{UNIT}', this.elm.properties['units']),
            this.c_x,
