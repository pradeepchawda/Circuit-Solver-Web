...
class WireManager {
  ...
  watch() {
    if (global.WIRE_BUILDER['step'] > 0) {
      if (global.WIRE_BUILDER['step'] >= 2) {
        if (
          (global.WIRE_BUILDER['n1'] != global.WIRE_BUILDER['n2'] &&
            !(
          ...
          for (var i = 0; i < wires.length; i++) {
            if (
              (wires[i].elm.n1 === global.WIRE_BUILDER['n1'] &&
          ...
          if (this.unique_wire) {
            wires.push(
              new Wire(
                global.TYPE_WIRE,
                this.wire_id,
                global.copy(global.WIRE_BUILDER['n1']),
                global.copy(global.WIRE_BUILDER['n2'])
              )
            );
          ...
          if (
            ...
            toast.set_text(
              language_manager.CONNECTION_NOT_ALLOWED[
  ...
  exclude_nmosfet() {
    return (
      global.WIRE_BUILDER['type1'] === global.TYPE_NMOS &&
      global.WIRE_BUILDER['type2'] === global.TYPE_NMOS
    );
  }
  exclude_pmosfet() {
    return (
      global.WIRE_BUILDER['type1'] === global.TYPE_PMOS &&
      global.WIRE_BUILDER['type2'] === global.TYPE_PMOS
    );
  }
  exclude_npn() {
    return (
      global.WIRE_BUILDER['type1'] === global.TYPE_NPN &&
      global.WIRE_BUILDER['type2'] === global.TYPE_NPN
    );
  }
  exclude_pnp() {
    return (
      global.WIRE_BUILDER['type1'] === global.TYPE_PNP &&
      global.WIRE_BUILDER['type2'] === global.TYPE_PNP
    );
  }
  exclude_opamps() {
    return (
      global.WIRE_BUILDER['type1'] === global.TYPE_OPAMP &&
      global.WIRE_BUILDER['type2'] === global.TYPE_OPAMP
    );
  }
  exclude_vcvs() {
    return (
      global.WIRE_BUILDER['type1'] === global.TYPE_VCVS &&
      global.WIRE_BUILDER['type2'] === global.TYPE_VCVS
    );
  }
  exclude_vccs() {
    return (
      global.WIRE_BUILDER['type1'] === global.TYPE_VCCS &&
      global.WIRE_BUILDER['type2'] === global.TYPE_VCCS
    );
  }
  exclude_ccvs() {
    return (
      global.WIRE_BUILDER['type1'] === global.TYPE_CCVS &&
      global.WIRE_BUILDER['type2'] === global.TYPE_CCVS
    );
  }
  exclude_cccs() {
    return (
      global.WIRE_BUILDER['type1'] === global.TYPE_CCCS &&
      global.WIRE_BUILDER['type2'] === global.TYPE_CCCS
    );
  }
  exclude_dffs() {
    return (
      global.WIRE_BUILDER['type1'] === global.TYPE_DFF &&
  ...
  handle_wire_references(wire_id) {
    ...
    if (global.WIRE_BUILDER['type1'] === global.TYPE_RESISTOR) {
      var index = engine_functions.get_resistor(global.WIRE_BUILDER['id1']);

      if (index < resistors.length) {
        global.WIRE_REFERENCE['wire_id'] = wire_id;
        global.WIRE_REFERENCE['linkage'] = global.copy(
          global.WIRE_BUILDER['linkage1']['wire']
        );
        global.WIRE_REFERENCE['anchor_point'] = global.copy(
          global.WIRE_BUILDER['anchor_point1']
        );
      ...
      var index = engine_functions.get_capacitor(global.WIRE_BUILDER['id1']);
      ...
      var index = engine_functions.get_inductor(global.WIRE_BUILDER['id1']);
      ...
      var index = engine_functions.get_ground(global.WIRE_BUILDER['id1']);
      ...
      var index = engine_functions.get_dcsource(global.WIRE_BUILDER['id1']);
      ...
      var index = engine_functions.get_dccurrent(global.WIRE_BUILDER['id1']);
      ...
      var index = engine_functions.get_acsource(global.WIRE_BUILDER['id1']);
      ...
      var index = engine_functions.get_accurrent(global.WIRE_BUILDER['id1']);
      ...
      var index = engine_functions.get_squarewave(global.WIRE_BUILDER['id1']);
      ...
      var index = engine_functions.get_sawwave(global.WIRE_BUILDER['id1']);
      ...
      var index = engine_functions.get_trianglewave(global.WIRE_BUILDER['id1']);
      ...
      var index = engine_functions.get_constant(global.WIRE_BUILDER['id1']);
      ...
      var index = engine_functions.get_net(global.WIRE_BUILDER['id1']);
      ...
      var index = engine_functions.get_note(global.WIRE_BUILDER['id1']);
      ...
      var index = engine_functions.get_rail(global.WIRE_BUILDER['id1']);
      ...
      var index = engine_functions.get_voltmeter(global.WIRE_BUILDER['id1']);
      ...
      var index = engine_functions.get_ohmmeter(global.WIRE_BUILDER['id1']);
      ...
      var index = engine_functions.get_ammeter(global.WIRE_BUILDER['id1']);
      ...
      var index = engine_functions.get_wattmeter(global.WIRE_BUILDER['id1']);
      ...
      var index = engine_functions.get_fuse(global.WIRE_BUILDER['id1']);
      ...
      var index = engine_functions.get_spst(global.WIRE_BUILDER['id1']);
      ...
      var index = engine_functions.get_spdt(global.WIRE_BUILDER['id1']);
      ...
      var index = engine_functions.get_not(global.WIRE_BUILDER['id1']);
      ...
      var index = engine_functions.get_diode(global.WIRE_BUILDER['id1']);
      ...
      var index = engine_functions.get_led(global.WIRE_BUILDER['id1']);
      ...
      var index = engine_functions.get_zener(global.WIRE_BUILDER['id1']);
      ...
      var index = engine_functions.get_potentiometer(
        global.WIRE_BUILDER['id1']
      );
      ...
      if (index < potentiometers.length) {
        ...
        potentiometers[index].push_reference(
          global.copy(global.WIRE_REFERENCE)
        );
        potentiometers[index].unanchor_wires();
        potentiometers[index].anchor_wires();
      }
    } else if (global.WIRE_BUILDER['type1'] === global.TYPE_AND) {
      var index = engine_functions.get_and(global.WIRE_BUILDER['id1']);
      ...
      var index = engine_functions.get_or(global.WIRE_BUILDER['id1']);
      ...
      var index = engine_functions.get_nand(global.WIRE_BUILDER['id1']);
      ...
      var index = engine_functions.get_nor(global.WIRE_BUILDER['id1']);
      ...
      var index = engine_functions.get_xor(global.WIRE_BUILDER['id1']);
      ...
      var index = engine_functions.get_xnor(global.WIRE_BUILDER['id1']);
      ...
      var index = engine_functions.get_dff(global.WIRE_BUILDER['id1']);
      ...
      var index = engine_functions.get_vsat(global.WIRE_BUILDER['id1']);
      ...
      var index = engine_functions.get_adder(global.WIRE_BUILDER['id1']);
      ...
      var index = engine_functions.get_subtractor(global.WIRE_BUILDER['id1']);
      ...
      var index = engine_functions.get_multiplier(global.WIRE_BUILDER['id1']);
      ...
      var index = engine_functions.get_divider(global.WIRE_BUILDER['id1']);
      ...
      var index = engine_functions.get_gain(global.WIRE_BUILDER['id1']);
      ...
      var index = engine_functions.get_absval(global.WIRE_BUILDER['id1']);
      ...
      var index = engine_functions.get_vcsw(global.WIRE_BUILDER['id1']);
      ...
      var index = engine_functions.get_vcvs(global.WIRE_BUILDER['id1']);
      ...
      var index = engine_functions.get_vccs(global.WIRE_BUILDER['id1']);
      ...
      var index = engine_functions.get_cccs(global.WIRE_BUILDER['id1']);
      ...
      var index = engine_functions.get_ccvs(global.WIRE_BUILDER['id1']);
      ...
      var index = engine_functions.get_opamp(global.WIRE_BUILDER['id1']);
      ...
      var index = engine_functions.get_nmosfet(global.WIRE_BUILDER['id1']);
      ...
      var index = engine_functions.get_pmosfet(global.WIRE_BUILDER['id1']);
      ...
      var index = engine_functions.get_npn(global.WIRE_BUILDER['id1']);
      ...
      var index = engine_functions.get_pnp(global.WIRE_BUILDER['id1']);
      ...
      var index = engine_functions.get_adc(global.WIRE_BUILDER['id1']);
      ...
      var index = engine_functions.get_dac(global.WIRE_BUILDER['id1']);
      ...
      var index = engine_functions.get_samplers(global.WIRE_BUILDER['id1']);
      ...
      var index = engine_functions.get_pwm(global.WIRE_BUILDER['id1']);
      ...
      var index = engine_functions.get_integrator(global.WIRE_BUILDER['id1']);
      ...
      var index = engine_functions.get_differentiator(
        global.WIRE_BUILDER['id1']
      );
      ...
      if (index < differentiators.length) {
        ...
        differentiators[index].push_reference(
          global.copy(global.WIRE_REFERENCE)
        );
      ...
      var index = engine_functions.get_lowpass(global.WIRE_BUILDER['id1']);
      ...
      var index = engine_functions.get_highpass(global.WIRE_BUILDER['id1']);
      ...
      var index = engine_functions.get_relay(global.WIRE_BUILDER['id1']);
      ...
      var index = engine_functions.get_pid(global.WIRE_BUILDER['id1']);
      ...
      var index = engine_functions.get_lut(global.WIRE_BUILDER['id1']);
      ...
      var index = engine_functions.get_vcr(global.WIRE_BUILDER['id1']);
      ...
      var index = engine_functions.get_tptz(global.WIRE_BUILDER['id1']);
      ...
      var index = engine_functions.get_transformer(global.WIRE_BUILDER['id1']);
    ...
    if (global.WIRE_BUILDER['type2'] === global.TYPE_RESISTOR) {
      var index = engine_functions.get_resistor(global.WIRE_BUILDER['id2']);

      if (index < resistors.length) {
        global.WIRE_REFERENCE['wire_id'] = wire_id;
        global.WIRE_REFERENCE['linkage'] = global.copy(
          global.WIRE_BUILDER['linkage2']['wire']
        );
        global.WIRE_REFERENCE['anchor_point'] = global.copy(
          global.WIRE_BUILDER['anchor_point2']
        );
      ...
      var index = engine_functions.get_capacitor(global.WIRE_BUILDER['id2']);
      ...
      var index = engine_functions.get_inductor(global.WIRE_BUILDER['id2']);
      ...
      var index = engine_functions.get_ground(global.WIRE_BUILDER['id2']);
      ...
      var index = engine_functions.get_dcsource(global.WIRE_BUILDER['id2']);
      ...
      var index = engine_functions.get_dccurrent(global.WIRE_BUILDER['id2']);
      ...
      var index = engine_functions.get_acsource(global.WIRE_BUILDER['id2']);
      ...
      var index = engine_functions.get_accurrent(global.WIRE_BUILDER['id2']);
      ...
      var index = engine_functions.get_squarewave(global.WIRE_BUILDER['id2']);
      ...
      var index = engine_functions.get_sawwave(global.WIRE_BUILDER['id2']);
      ...
      var index = engine_functions.get_trianglewave(global.WIRE_BUILDER['id2']);
      ...
      var index = engine_functions.get_constant(global.WIRE_BUILDER['id2']);
      ...
      var index = engine_functions.get_net(global.WIRE_BUILDER['id2']);
      ...
      var index = engine_functions.get_note(global.WIRE_BUILDER['id2']);
      ...
      var index = engine_functions.get_rail(global.WIRE_BUILDER['id2']);
      ...
      var index = engine_functions.get_voltmeter(global.WIRE_BUILDER['id2']);
      ...
      var index = engine_functions.get_ohmmeter(global.WIRE_BUILDER['id2']);
      ...
      var index = engine_functions.get_ammeter(global.WIRE_BUILDER['id2']);
      ...
      var index = engine_functions.get_wattmeter(global.WIRE_BUILDER['id2']);
      ...
      var index = engine_functions.get_fuse(global.WIRE_BUILDER['id2']);
      ...
      var index = engine_functions.get_spst(global.WIRE_BUILDER['id2']);
      ...
      var index = engine_functions.get_spdt(global.WIRE_BUILDER['id2']);
      ...
      var index = engine_functions.get_not(global.WIRE_BUILDER['id2']);
      ...
      var index = engine_functions.get_diode(global.WIRE_BUILDER['id2']);
      ...
      var index = engine_functions.get_led(global.WIRE_BUILDER['id2']);
      ...
      var index = engine_functions.get_zener(global.WIRE_BUILDER['id2']);
      ...
      var index = engine_functions.get_and(global.WIRE_BUILDER['id2']);
      ...
      var index = engine_functions.get_or(global.WIRE_BUILDER['id2']);
      ...
      var index = engine_functions.get_nand(global.WIRE_BUILDER['id2']);
      ...
      var index = engine_functions.get_nor(global.WIRE_BUILDER['id2']);
      ...
      var index = engine_functions.get_xor(global.WIRE_BUILDER['id2']);
      ...
      var index = engine_functions.get_xnor(global.WIRE_BUILDER['id2']);
      ...
      var index = engine_functions.get_dff(global.WIRE_BUILDER['id2']);
      ...
      var index = engine_functions.get_vsat(global.WIRE_BUILDER['id2']);
      ...
      var index = engine_functions.get_adder(global.WIRE_BUILDER['id2']);
      ...
      var index = engine_functions.get_subtractor(global.WIRE_BUILDER['id2']);
      ...
      var index = engine_functions.get_multiplier(global.WIRE_BUILDER['id2']);
      ...
      var index = engine_functions.get_divider(global.WIRE_BUILDER['id2']);
      ...
      var index = engine_functions.get_gain(global.WIRE_BUILDER['id2']);
      ...
      var index = engine_functions.get_absval(global.WIRE_BUILDER['id2']);
      ...
      var index = engine_functions.get_vcsw(global.WIRE_BUILDER['id2']);
      ...
      var index = engine_functions.get_vcvs(global.WIRE_BUILDER['id2']);
      ...
      var index = engine_functions.get_vccs(global.WIRE_BUILDER['id2']);
      ...
      var index = engine_functions.get_cccs(global.WIRE_BUILDER['id2']);
      ...
      var index = engine_functions.get_ccvs(global.WIRE_BUILDER['id2']);
      ...
      var index = engine_functions.get_opamp(global.WIRE_BUILDER['id2']);
      ...
      var index = engine_functions.get_nmosfet(global.WIRE_BUILDER['id2']);
      ...
      var index = engine_functions.get_pmosfet(global.WIRE_BUILDER['id2']);
      ...
      var index = engine_functions.get_npn(global.WIRE_BUILDER['id2']);
      ...
      var index = engine_functions.get_pnp(global.WIRE_BUILDER['id2']);
      ...
      var index = engine_functions.get_adc(global.WIRE_BUILDER['id2']);
      ...
      var index = engine_functions.get_dac(global.WIRE_BUILDER['id2']);
      ...
      var index = engine_functions.get_samplers(global.WIRE_BUILDER['id2']);
      ...
      var index = engine_functions.get_pwm(global.WIRE_BUILDER['id2']);
      ...
      var index = engine_functions.get_integrator(global.WIRE_BUILDER['id2']);
      ...
      var index = engine_functions.get_lowpass(global.WIRE_BUILDER['id2']);
      ...
      var index = engine_functions.get_highpass(global.WIRE_BUILDER['id2']);
      ...
      var index = engine_functions.get_relay(global.WIRE_BUILDER['id2']);
      ...
      var index = engine_functions.get_pid(global.WIRE_BUILDER['id2']);
      ...
      var index = engine_functions.get_lut(global.WIRE_BUILDER['id2']);
      ...
      var index = engine_functions.get_vcr(global.WIRE_BUILDER['id2']);
      ...
      var index = engine_functions.get_grt(global.WIRE_BUILDER['id2']);
      ...
      var index = engine_functions.get_tptz(global.WIRE_BUILDER['id2']);
      ...
      var index = engine_functions.get_transformer(global.WIRE_BUILDER['id2']);
