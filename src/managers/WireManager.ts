		...
		if (global.variables.wire_builder['step'] > 0) {
			if (global.variables.wire_builder['step'] >= 2) {
				if (
					...
					if (this.unique_wire) {
						wires.push(new Wire(global.ELEMENT_TYPES.TYPE_WIRE, this.wire_id, global.copy(global.variables.wire_builder['n1']), global.copy(global.variables.wire_builder['n2'])));
	...
	handle_wire_references(wire_id: number): void {
		...
		if (global.variables.wire_builder['type1'] === global.ELEMENT_TYPES.TYPE_RESISTOR) {
			...
			if (index < resistors.length) {
				...
				global.WIRE_REFERENCE['linkage'] = global.copy(global.variables.wire_builder['linkage1']['wire']);
				global.WIRE_REFERENCE['anchor_point'] = global.copy(global.variables.wire_builder['anchor_point1']);
		...
		if (global.variables.wire_builder['type2'] === global.ELEMENT_TYPES.TYPE_RESISTOR) {
			...
			if (index < resistors.length) {
				global.WIRE_REFERENCE['wire_id'] = wire_id;
				global.WIRE_REFERENCE['linkage'] = global.copy(global.variables.wire_builder['linkage2']['wire']);
				global.WIRE_REFERENCE['anchor_point'] = global.copy(global.variables.wire_builder['anchor_point2']);
