 ...
 * File		        : IntegratorModuleSymbol.js
 * Author            : nboatengc
...
class IntegratorModuleSymbol {
	...
	/* Angle from p1 to p2 */
	public theta: number;
	public integ_0: PointF;
	public integ_1: PointF;
	public integ_2: PointF;
	public integ_3: PointF;
	public integ_4: PointF;
	public integ_5: PointF;
	...
	build_element() {
		this.integ_0.x = this.c_x - this.x_space * global.cosine(this.theta) + this.x_space * global.cosine(this.theta_m90);
		this.integ_0.y = this.c_y - this.y_space * global.sine(this.theta) + this.y_space * global.sine(this.theta_m90);
		this.integ_2.x = this.c_x - this.x_space * global.cosine(this.theta) - this.x_space * global.cosine(this.theta_m90);
		this.integ_2.y = this.c_y - this.y_space * global.sine(this.theta) - this.y_space * global.sine(this.theta_m90);
		this.integ_3.x = this.c_x + this.x_space * global.cosine(this.theta) - this.x_space * global.cosine(this.theta_m90);
		this.integ_3.y = this.c_y + this.y_space * global.sine(this.theta) - this.y_space * global.sine(this.theta_m90);
		this.integ_4.x = this.c_x + this.x_space * global.cosine(this.theta) + this.x_space * global.cosine(this.theta_m90);
		this.integ_4.y = this.c_y + this.y_space * global.sine(this.theta) + this.y_space * global.sine(this.theta_m90);
		this.integ_5.x = this.c_x + this.x_space * global.cosine(this.theta);
		this.integ_5.y = this.c_y + this.y_space * global.sine(this.theta);
