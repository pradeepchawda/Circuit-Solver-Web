...
class MeterSymbols {
  ...
  populate() {
    ...
    if (this.meter_type === this.METER_CURRENT) {
      ...
      this.points.push(
        new PointF(
          this.bounds.get_center_x() - temp_width,
      ...
      this.points.push(
        new PointF(this.bounds.get_center_x(), this.bounds.bottom)
      );
      this.points.push(new PointF(this.bounds.right, this.bounds.top));
    } else if (this.meter_type === this.METER_RESISTANCE) {
      this.points.push(new PointF(this.bounds.left, this.bounds.bottom));
      this.points.push(
        new PointF(this.bounds.left + temp_width, this.bounds.bottom)
      );
      this.points.push(
        new PointF(
          this.bounds.left + temp_width,
          this.bounds.bottom - temp_height
        )
      );
      this.points.push(
        new PointF(this.bounds.left, this.bounds.bottom - temp_height * 1.6)
      );
      this.points.push(
        new PointF(this.bounds.left, this.bounds.top + temp_height)
      );
      this.points.push(
        new PointF(this.bounds.left + temp_width, this.bounds.top)
      );
      this.points.push(
        new PointF(this.bounds.right - temp_width, this.bounds.top)
      );
      this.points.push(
        new PointF(this.bounds.right, this.bounds.top + temp_height)
      );
      this.points.push(
        new PointF(this.bounds.right, this.bounds.bottom - temp_height * 1.6)
      );
      this.points.push(
        new PointF(
          this.bounds.right - temp_width,
          this.bounds.bottom - temp_height
        )
      );
      this.points.push(
        new PointF(this.bounds.right - temp_width, this.bounds.bottom)
      );
      this.points.push(new PointF(this.bounds.right, this.bounds.bottom));
      ...
      this.points.push(
        new PointF(
          this.bounds.left + this.bounds.get_width() * 0.25,
          this.bounds.bottom
        )
      );
      this.points.push(
        new PointF(this.bounds.get_center_x(), this.bounds.get_center_y())
      );
      this.points.push(
        new PointF(
          this.bounds.left + this.bounds.get_width() * 0.75,
          this.bounds.bottom
        )
      );
      this.points.push(new PointF(this.bounds.right, this.bounds.top));
