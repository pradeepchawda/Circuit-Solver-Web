 ...
 * File		        : CapacitorSymbol.js
 * Author            : nboatengc
 * Date created      : 20190928
 *
 * Purpose           : A class to draw the capacitor element without worrying about the
...
class CapacitorSymbol {
  ...
  /* Capacitor point 0 */
  public cap_0 = new PointF(0, 0);
  /* Capacitor point 1 */
  public cap_1 = new PointF(0, 0);
  /* Capacitor point 2 */
  public cap_2 = new PointF(0, 0);
  /* Capacitor point 3 */
  public cap_3 = new PointF(0, 0);
  ...
  public TAG = language_manager.TAG_CAPACITOR;
  ...
  build_element() {
    this.cap_0.x = this.c_x + 0.75 * this.x_space * global.cosine(this.theta) + this.x_space * 0.667 * global.cosine(this.theta_m90);
    this.cap_0.y = this.c_y + 0.75 * this.y_space * global.sine(this.theta) + this.y_space * 0.667 * global.sine(this.theta_m90);
    this.cap_1.x = this.c_x - 0.75 * this.x_space * global.cosine(this.theta) + this.x_space * 0.667 * global.cosine(this.theta_m90);
    this.cap_1.y = this.c_y - 0.75 * this.y_space * global.sine(this.theta) + this.y_space * 0.667 * global.sine(this.theta_m90);
    this.cap_2.x = this.c_x + 0.75 * this.x_space * global.cosine(this.theta) + this.x_space * 0.667 * global.cosine(Math.PI + this.theta_m90);
    this.cap_2.y = this.c_y + 0.75 * this.y_space * global.sine(this.theta) + this.y_space * 0.667 * global.sine(Math.PI + this.theta_m90);
    this.cap_3.x = this.c_x - 0.75 * this.x_space * global.cosine(this.theta) + this.x_space * 0.667 * global.cosine(Math.PI + this.theta_m90);
    this.cap_3.y = this.c_y - 0.75 * this.y_space * global.sine(this.theta) + this.y_space * 0.667 * global.sine(Math.PI + this.theta_m90);
    this.connect1_x = this.c_x - 0.75 * this.x_space * global.cosine(this.theta);
    this.connect1_y = this.c_y - 0.75 * this.y_space * global.sine(this.theta);
    this.connect2_x = this.c_x + 0.75 * this.x_space * global.cosine(this.theta);
    this.connect2_y = this.c_y + 0.75 * this.y_space * global.sine(this.theta);
  }
  resize(rect: RectF) {
    /* Create a new rectangle for the bounds of this component */
    this.bounds.set_bounds(rect.left, rect.top, rect.right, rect.bottom);
