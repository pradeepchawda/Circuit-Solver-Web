...
class NOTGateSymbol {
  ...
  public not_0 = new PointF(0, 0);
  public not_1 = new PointF(0, 0);
  public not_2 = new PointF(0, 0);
  public not_3 = new PointF(0, 0);
  ...
  public TAG = language_manager.TAG_NOT;
  ...
  build_element() {
    this.not_0.x = this.c_x - this.x_space * global.cosine(this.theta) + this.x_space * global.cosine(this.theta_m90);
    this.not_0.y = this.c_y - this.x_space * global.sine(this.theta) + this.x_space * global.sine(this.theta_m90);
    this.not_1.x = this.c_x - this.x_space * global.cosine(this.theta) - this.x_space * global.cosine(this.theta_m90);
    this.not_1.y = this.c_y - this.x_space * global.sine(this.theta) - this.x_space * global.sine(this.theta_m90);
    this.not_2.x = this.c_x + this.x_space * global.cosine(this.theta);
    this.not_2.y = this.c_y + this.x_space * global.sine(this.theta);
    this.not_3.x = this.c_x + this.x_space * 1.3 * global.cosine(this.theta);
    this.not_3.y = this.c_y + this.x_space * 1.3 * global.sine(this.theta);
  ...
  draw_symbol(canvas: GraphicsEngine, page: number) {
    ...
    if (this.page === page) {
      ...
      indexer = 0;
      canvas.draw_circle(this.not_3.x, this.not_3.y, 1.3 * global.CANVAS_STROKE_WIDTH_2, this.line_paint);
