...
class TriangleWaveSymbol {
  ...
  build_element() {
    this.sq_0.x = this.c_x - (this.x_space >> 2) * global.cosine(this.theta - global.PI_DIV_4);
    this.sq_0.y = this.c_y - (this.x_space >> 2) * global.sine(this.theta - global.PI_DIV_4);
    this.sq_1.x = this.c_x + (this.x_space >> 2) * global.cosine(this.theta - global.PI_DIV_4);
    this.sq_1.y = this.c_y + (this.x_space >> 2) * global.sine(this.theta - global.PI_DIV_4);
