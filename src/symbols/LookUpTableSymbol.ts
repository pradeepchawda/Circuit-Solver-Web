...
class LookUpTableSymbol {
  ...
  public TAG = language_manager.TAG_LUT;
  ...
  build_element() {
    this.adc_0.x = this.c_x - this.x_space * global.cosine(this.theta) + this.x_space * global.cosine(this.theta_m90);
    this.adc_0.y = this.c_y - this.y_space * global.sine(this.theta) + this.y_space * global.sine(this.theta_m90);
    this.adc_2.x = this.c_x - this.x_space * global.cosine(this.theta) - this.x_space * global.cosine(this.theta_m90);
    this.adc_2.y = this.c_y - this.y_space * global.sine(this.theta) - this.y_space * global.sine(this.theta_m90);
    this.adc_3.x = this.c_x + this.x_space * global.cosine(this.theta) - this.x_space * global.cosine(this.theta_m90);
    this.adc_3.y = this.c_y + this.y_space * global.sine(this.theta) - this.y_space * global.sine(this.theta_m90);
    this.adc_4.x = this.c_x + this.x_space * global.cosine(this.theta) + this.x_space * global.cosine(this.theta_m90);
    this.adc_4.y = this.c_y + this.y_space * global.sine(this.theta) + this.y_space * global.sine(this.theta_m90);
    this.adc_5.x = this.c_x + this.x_space * global.cosine(this.theta);
    this.adc_5.y = this.c_y + this.y_space * global.sine(this.theta);
