 ...
 * File		        : DifferentiatorModuleSymbol.js
 * Author            : nboatengc
...
class DifferentiatorModuleSymbol {
  ...
  public TAG = language_manager.TAG_DIFFERENTIATOR;
  ...
  build_element() {
    this.diff_0.x = this.c_x - this.x_space * global.cosine(this.theta) + this.x_space * global.cosine(this.theta_m90);
    this.diff_0.y = this.c_y - this.y_space * global.sine(this.theta) + this.y_space * global.sine(this.theta_m90);
    this.diff_2.x = this.c_x - this.x_space * global.cosine(this.theta) - this.x_space * global.cosine(this.theta_m90);
    this.diff_2.y = this.c_y - this.y_space * global.sine(this.theta) - this.y_space * global.sine(this.theta_m90);
    this.diff_3.x = this.c_x + this.x_space * global.cosine(this.theta) - this.x_space * global.cosine(this.theta_m90);
    this.diff_3.y = this.c_y + this.y_space * global.sine(this.theta) - this.y_space * global.sine(this.theta_m90);
    this.diff_4.x = this.c_x + this.x_space * global.cosine(this.theta) + this.x_space * global.cosine(this.theta_m90);
    this.diff_4.y = this.c_y + this.y_space * global.sine(this.theta) + this.y_space * global.sine(this.theta_m90);
    this.diff_5.x = this.c_x + this.x_space * global.cosine(this.theta);
    this.diff_5.y = this.c_y + this.y_space * global.sine(this.theta);
