...
class SinglePoleSingleThrowSymbol {
  ...
  build_element() {
    ...
    this.spst_1.y =
      this.connect1_y +
      this.x_space * 0 * global.sine(this.theta) +
      this.x_space * global.sine(this.theta_m90);
    this.spst_3.x =
      this.connect1_x +
    ...
    this.spst_3.y =
      this.connect1_y +
      this.x_space * 2 * global.sine(this.theta) +
      this.x_space * global.sine(this.theta_m90);
    this.spst_5.x =
      this.connect1_x +
      this.x_space * 0 * global.cosine(this.theta) -
    ...
    this.spst_9.y =
      this.c_y + this.x_space * 1.75 * global.sine(this.theta_m90);
    this.spst_11.x =
      this.c_x + this.x_space * 2.5 * global.cosine(this.theta_m90);
    this.spst_11.y =
      this.c_y + this.x_space * 2.5 * global.sine(this.theta_m90);
    ...
    this.spst_19.y =
      this.c_y + (this.x_space >> 1) * global.sine(this.theta_m90);
