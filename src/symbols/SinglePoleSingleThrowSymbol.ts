 ...
 * File		        : SinglePoleSingleThrowSymbol.js
 * Author            : nboatengc
 * Date created      : 20190928
 *
 * Purpose           : A class to draw the spst element without worrying about the
...
class SinglePoleSingleThrowSymbol {
  ...
  public spst_0 = new PointF(0, 0);
  public spst_1 = new PointF(0, 0);
  public spst_2 = new PointF(0, 0);
  public spst_3 = new PointF(0, 0);
  public spst_4 = new PointF(0, 0);
  public spst_5 = new PointF(0, 0);
  public spst_6 = new PointF(0, 0);
  public spst_7 = new PointF(0, 0);
  public spst_8 = new PointF(0, 0);
  public spst_9 = new PointF(0, 0);
  public spst_10 = new PointF(0, 0);
  public spst_11 = new PointF(0, 0);
  public spst_12 = new PointF(0, 0);
  public spst_13 = new PointF(0, 0);
  public spst_14 = new PointF(0, 0);
  public spst_15 = new PointF(0, 0);
  public spst_16 = new PointF(0, 0);
  public spst_17 = new PointF(0, 0);
  public spst_18 = new PointF(0, 0);
  public spst_19 = new PointF(0, 0);
  public spst_20 = new PointF(0, 0);
  public spst_21 = new PointF(0, 0);
  ...
  public TAG = language_manager.TAG_SPST;
  ...
  build_element() {
    ...
    this.spst_0.y = this.connect1_y + this.x_space * global.sine(this.theta) + this.x_space * global.sine(this.theta_m90);
    this.spst_1.x = this.connect1_x + this.x_space * 0 * global.cosine(this.theta) + this.x_space * global.cosine(this.theta_m90);
    this.spst_1.y = this.connect1_y + this.x_space * 0 * global.sine(this.theta) + this.x_space * global.sine(this.theta_m90);
    this.spst_3.x = this.connect1_x + this.x_space * 2 * global.cosine(this.theta) + this.x_space * global.cosine(this.theta_m90);
    this.spst_3.y = this.connect1_y + this.x_space * 2 * global.sine(this.theta) + this.x_space * global.sine(this.theta_m90);
    this.spst_5.x = this.connect1_x + this.x_space * 0 * global.cosine(this.theta) - this.x_space * global.cosine(this.theta_m90);
    this.spst_5.y = this.connect1_y + this.x_space * 0 * global.sine(this.theta) - this.x_space * global.sine(this.theta_m90);
    this.spst_7.x = this.connect1_x + this.x_space * 2 * global.cosine(this.theta) - this.x_space * global.cosine(this.theta_m90);
    this.spst_7.y = this.connect1_y + this.x_space * 2 * global.sine(this.theta) - this.x_space * global.sine(this.theta_m90);
    this.spst_9.x = this.c_x + this.x_space * 1.75 * global.cosine(this.theta_m90);
    this.spst_9.y = this.c_y + this.x_space * 1.75 * global.sine(this.theta_m90);
    this.spst_11.x = this.c_x + this.x_space * 2.5 * global.cosine(this.theta_m90);
    this.spst_11.y = this.c_y + this.x_space * 2.5 * global.sine(this.theta_m90);
    this.spst_13.x = this.c_x + this.x_space * global.cosine(this.theta_m90);
    this.spst_13.y = this.c_y + this.x_space * global.sine(this.theta_m90);
    this.spst_15.x = this.connect1_x + this.x_space * 0 * global.cosine(this.theta) - this.x_space * global.cosine(this.theta_m90);
    this.spst_15.y = this.connect1_y + this.x_space * 0 * global.sine(this.theta) - this.x_space * global.sine(this.theta_m90);
    this.spst_17.x = this.connect1_x + this.x_space * 2 * global.cosine(this.theta) - this.x_space * global.cosine(this.theta_m90);
    this.spst_17.y = this.connect1_y + this.x_space * 2 * global.sine(this.theta) - this.x_space * global.sine(this.theta_m90);
    this.spst_19.x = this.c_x + (this.x_space >> 1) * global.cosine(this.theta_m90);
    this.spst_19.y = this.c_y + (this.x_space >> 1) * global.sine(this.theta_m90);
    this.spst_21.x = this.c_x - this.x_space * global.cosine(this.theta_m90);
    this.spst_21.y = this.c_y - this.x_space * global.sine(this.theta_m90);
  }
  resize(rect: RectF) {
    /* Create a new rectangle for the bounds of this component */
    this.bounds.set_bounds(rect.left, rect.top, rect.right, rect.bottom);
