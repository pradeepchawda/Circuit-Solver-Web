...
class SquareWaveSymbol {
  ...
  public TAG = language_manager.TAG_SQUAREWAVE;
  ...
  build_element() {
    ...
    this.sq_3.x = this.sq_0.x - (this.x_space >> 1) * global.cosine(this.theta_m90);
    this.sq_3.y = this.sq_0.y - (this.x_space >> 1) * global.sine(this.theta_m90);
    this.sq_4.x = this.sq_1.x + (this.x_space >> 1) * global.cosine(this.theta_m90);
    this.sq_4.y = this.sq_1.y + (this.x_space >> 1) * global.sine(this.theta_m90);
    this.sq_5.x = this.sq_1.x - (this.x_space >> 1) * global.cosine(this.theta_m90);
    this.sq_5.y = this.sq_1.y - (this.x_space >> 1) * global.sine(this.theta_m90);
