...
class ANDGateSymbol {
  ...
  public and_0 = new PointF(0, 0);
  public and_1 = new PointF(0, 0);
  public and_2 = new PointF(0, 0);
  public and_3 = new PointF(0, 0);
  public and_4 = new PointF(0, 0);
  public and_5 = new PointF(0, 0);
  public and_6 = new PointF(0, 0);
  ...
  public TAG = language_manager.TAG_AND;
  ...
  build_element() {
    ...
    this.and_1.x = this.and_0.x + 0.75 * this.x_space * global.cosine(this.theta_m90);
    this.and_1.y = this.and_0.y + 0.75 * this.y_space * global.sine(this.theta_m90);
    this.and_2.x = this.and_1.x + 0.75 * this.x_space * global.cosine(this.theta - Math.PI);
    this.and_2.y = this.and_1.y + 0.75 * this.y_space * global.sine(this.theta - Math.PI);
    /* Bottom segment */
    ...
    this.and_4.x = this.and_3.x + 0.75 * this.x_space * global.cosine(this.theta_m90);
    this.and_4.y = this.and_3.y + 0.75 * this.y_space * global.sine(this.theta_m90);
    this.and_5.x = this.and_4.x + 0.75 * this.x_space * global.cosine(this.theta);
    this.and_5.y = this.and_4.y + 0.75 * this.y_space * global.sine(this.theta);
    /* End Segment */
    this.and_6.x = this.p3.x - 0.75 * this.x_space * global.cosine(this.theta_m90);
    this.and_6.y = this.p3.y - 0.75 * this.y_space * global.sine(this.theta_m90);
  }
  resize(rect: RectF) {
    /* Create a new rectangle for the bounds of this component */
    this.bounds.set_bounds(rect.left, rect.top, rect.right, rect.bottom);
