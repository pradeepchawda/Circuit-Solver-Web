...
class AdderSymbol {
  ...
  public TAG = language_manager.TAG_ADD;
  ...
  build_element() {
    /* Top segment */
    this.adder_0.x = this.p1.x + 2.0 * this.x_space * global.cosine(this.theta_m90);
    this.adder_0.y = this.p1.y + 2.0 * this.y_space * global.sine(this.theta_m90);
    this.adder_1.x = this.adder_0.x + this.x_space * global.cosine(this.theta);
    this.adder_1.y = this.adder_0.y + this.y_space * global.sine(this.theta);
    this.adder_2.x = this.adder_1.x + 0.75 * this.x_space * global.cosine(this.theta - Math.PI);
    this.adder_2.y = this.adder_1.y + 0.75 * this.y_space * global.sine(this.theta - Math.PI);
    /* Bottom segment */
    this.adder_3.x = this.p2.x + 2.0 * this.x_space * global.cosine(this.theta_m90);
    this.adder_3.y = this.p2.y + 2.0 * this.y_space * global.sine(this.theta_m90);
    this.adder_4.x = this.adder_3.x - this.x_space * global.cosine(this.theta);
    this.adder_4.y = this.adder_3.y - this.y_space * global.sine(this.theta);
    this.adder_5.x = this.adder_4.x + 0.75 * this.x_space * global.cosine(this.theta);
    this.adder_5.y = this.adder_4.y + 0.75 * this.y_space * global.sine(this.theta);
    /* End Segment */
    this.adder_6.x = this.p3.x - 0.75 * this.x_space * global.cosine(this.theta_m90);
    this.adder_6.y = this.p3.y - 0.75 * this.y_space * global.sine(this.theta_m90);
  }
  resize(rect: RectF) {
    /* Create a new rectangle for the bounds of this component */
    this.bounds.set_bounds(rect.left, rect.top, rect.right, rect.bottom);
