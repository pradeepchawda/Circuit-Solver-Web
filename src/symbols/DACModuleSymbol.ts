...
class DACModuleSymbol {
  ...
  public dac_0 = new PointF(0, 0);
  public dac_1 = new PointF(0, 0);
  public dac_2 = new PointF(0, 0);
  public dac_3 = new PointF(0, 0);
  public dac_4 = new PointF(0, 0);
  public dac_5 = new PointF(0, 0);
  ...
  public TAG = language_manager.TAG_DAC;
  ...
  build_element() {
    this.dac_0.x = this.c_x - this.x_space * global.cosine(this.theta) + this.x_space * global.cosine(this.theta_m90);
    this.dac_0.y = this.c_y - this.y_space * global.sine(this.theta) + this.y_space * global.sine(this.theta_m90);
    this.dac_2.x = this.c_x - this.x_space * global.cosine(this.theta) - this.x_space * global.cosine(this.theta_m90);
    this.dac_2.y = this.c_y - this.y_space * global.sine(this.theta) - this.y_space * global.sine(this.theta_m90);
    this.dac_3.x = this.c_x + this.x_space * global.cosine(this.theta) - this.x_space * global.cosine(this.theta_m90);
    this.dac_3.y = this.c_y + this.y_space * global.sine(this.theta) - this.y_space * global.sine(this.theta_m90);
    this.dac_4.x = this.c_x + this.x_space * global.cosine(this.theta) + this.x_space * global.cosine(this.theta_m90);
    this.dac_4.y = this.c_y + this.y_space * global.sine(this.theta) + this.y_space * global.sine(this.theta_m90);
    this.dac_5.x = this.c_x + this.x_space * global.cosine(this.theta);
    this.dac_5.y = this.c_y + this.y_space * global.sine(this.theta);
