...
class DiodeSymbol {
	...
	build_element() {
		this.dio_0.x = this.c_x + (this.x_space >> 1) * global.cosine(this.theta) + (this.x_space >> 1) * global.cosine(this.theta_m90);
		this.dio_0.y = this.c_y + (this.y_space >> 1) * global.sine(this.theta) + (this.y_space >> 1) * global.sine(this.theta_m90);
		this.dio_1.x = this.c_x - (this.x_space >> 1) * global.cosine(this.theta) + (this.x_space >> 1) * global.cosine(this.theta_m90);
		this.dio_1.y = this.c_y - (this.y_space >> 1) * global.sine(this.theta) + (this.y_space >> 1) * global.sine(this.theta_m90);
		this.dio_3.x = this.c_x + (this.x_space >> 1) * global.cosine(this.theta) + (this.x_space >> 1) * global.cosine(Math.PI + this.theta_m90);
		this.dio_3.y = this.c_y + (this.y_space >> 1) * global.sine(this.theta) + (this.y_space >> 1) * global.sine(Math.PI + this.theta_m90);
		this.dio_2.x = this.c_x - (this.x_space >> 1) * global.cosine(this.theta) + (this.x_space >> 1) * global.cosine(Math.PI + this.theta_m90);
		this.dio_2.y = this.c_y - (this.y_space >> 1) * global.sine(this.theta) + (this.y_space >> 1) * global.sine(Math.PI + this.theta_m90);
