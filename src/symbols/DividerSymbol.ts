...
class DividerSymbol {
  ...
  public TAG = language_manager.TAG_DIV;
  ...
  build_element() {
    /* Top segment */
    this.divider_0.x = this.p1.x + 2.0 * this.x_space * global.cosine(this.theta_m90);
    this.divider_0.y = this.p1.y + 2.0 * this.y_space * global.sine(this.theta_m90);
    this.divider_1.x = this.divider_0.x + this.x_space * global.cosine(this.theta);
    this.divider_1.y = this.divider_0.y + this.y_space * global.sine(this.theta);
    this.divider_2.x = this.divider_1.x + 0.75 * this.x_space * global.cosine(this.theta - Math.PI);
    this.divider_2.y = this.divider_1.y + 0.75 * this.y_space * global.sine(this.theta - Math.PI);
    /* Bottom segment */
    this.divider_3.x = this.p2.x + 2.0 * this.x_space * global.cosine(this.theta_m90);
    this.divider_3.y = this.p2.y + 2.0 * this.y_space * global.sine(this.theta_m90);
    this.divider_4.x = this.divider_3.x - this.x_space * global.cosine(this.theta);
    this.divider_4.y = this.divider_3.y - this.y_space * global.sine(this.theta);
    this.divider_5.x = this.divider_4.x + 0.75 * this.x_space * global.cosine(this.theta);
    this.divider_5.y = this.divider_4.y + 0.75 * this.y_space * global.sine(this.theta);
    /* End Segment */
    this.divider_6.x = this.p3.x - 0.75 * this.x_space * global.cosine(this.theta_m90);
    this.divider_6.y = this.p3.y - 0.75 * this.y_space * global.sine(this.theta_m90);
  }
  resize(rect: RectF) {
    /* Create a new rectangle for the bounds of this component */
    this.bounds.set_bounds(rect.left, rect.top, rect.right, rect.bottom);
  ...
  draw_symbol(canvas: GraphicsEngine, page: number) {
    ...
    if (this.page === page) {
      ...
      this.circle_buffer[indexer++] = Array(this.c_x, this.c_y + this.bounds.get_width() * 0.1, 1.125 * global.CANVAS_STROKE_WIDTH_2);
      this.circle_buffer[indexer++] = Array(this.c_x, this.c_y - this.bounds.get_width() * 0.1, 1.125 * global.CANVAS_STROKE_WIDTH_2);
