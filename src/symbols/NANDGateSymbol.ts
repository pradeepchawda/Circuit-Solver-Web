...
class NANDGateSymbol {
  ...
  public TAG = language_manager.TAG_NAND;
  ...
  build_element() {
    /* Top segment */
    this.nand_0.x = this.p1.x + 1.5 * this.x_space * global.cosine(this.theta);
    this.nand_0.y = this.p1.y + 1.5 * this.y_space * global.sine(this.theta);
    this.nand_1.x = this.nand_0.x + 0.75 * this.x_space * global.cosine(this.theta_m90);
    this.nand_1.y = this.nand_0.y + 0.75 * this.y_space * global.sine(this.theta_m90);
    this.nand_2.x = this.nand_1.x + 0.75 * this.x_space * global.cosine(this.theta - Math.PI);
    this.nand_2.y = this.nand_1.y + 0.75 * this.y_space * global.sine(this.theta - Math.PI);
    /* Bottom segment */
    this.nand_3.x = this.p1.x + 2.5 * this.x_space * global.cosine(this.theta);
    this.nand_3.y = this.p1.y + 2.5 * this.y_space * global.sine(this.theta);
    this.nand_4.x = this.nand_3.x + 0.75 * this.x_space * global.cosine(this.theta_m90);
    this.nand_4.y = this.nand_3.y + 0.75 * this.y_space * global.sine(this.theta_m90);
    this.nand_5.x = this.nand_4.x + 0.75 * this.x_space * global.cosine(this.theta);
    this.nand_5.y = this.nand_4.y + 0.75 * this.y_space * global.sine(this.theta);
    /* End Segment */
    this.nand_6.x = this.p3.x - 0.9 * this.x_space * global.cosine(this.theta_m90);
    this.nand_6.y = this.p3.y - 0.9 * this.y_space * global.sine(this.theta_m90);
    this.nand_7.x = this.p3.x - 0.6 * this.x_space * global.cosine(this.theta_m90);
    this.nand_7.y = this.p3.y - 0.6 * this.y_space * global.sine(this.theta_m90);
    this.nand_8.x = this.p3.x - 0.3 * this.x_space * global.cosine(this.theta_m90);
    this.nand_8.y = this.p3.y - 0.3 * this.y_space * global.sine(this.theta_m90);
  }
  resize(rect: RectF) {
    /* Create a new rectangle for the bounds of this component */
    this.bounds.set_bounds(rect.left, rect.top, rect.right, rect.bottom);
