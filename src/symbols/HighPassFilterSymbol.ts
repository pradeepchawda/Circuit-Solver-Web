 ...
 * File		        : HighPassFilterSymbol.js
 * Author            : nboatengc
 * Date created      : 20190928
 *
 * Purpose           : A class to draw the notgate element without worrying about the
...
class HighPassFilterSymbol {
  ...
  public hpf_0 = new PointF(0, 0);
  public hpf_1 = new PointF(0, 0);
  public hpf_2 = new PointF(0, 0);
  public hpf_3 = new PointF(0, 0);
  public hpf_4 = new PointF(0, 0);
  public hpf_5 = new PointF(0, 0);
  public hpf_6 = new PointF(0, 0);
  public hpf_7 = new PointF(0, 0);
  public hpf_8 = new PointF(0, 0);
  ...
  public TAG = language_manager.TAG_HPF;
  ...
  build_element() {
    this.hpf_0.x = this.c_x - this.x_space * global.cosine(this.theta) + this.x_space * global.cosine(this.theta_m90);
    this.hpf_0.y = this.c_y - this.y_space * global.sine(this.theta) + this.y_space * global.sine(this.theta_m90);
    this.hpf_2.x = this.c_x - this.x_space * global.cosine(this.theta) - this.x_space * global.cosine(this.theta_m90);
    this.hpf_2.y = this.c_y - this.y_space * global.sine(this.theta) - this.y_space * global.sine(this.theta_m90);
    this.hpf_3.x = this.c_x + this.x_space * global.cosine(this.theta) - this.x_space * global.cosine(this.theta_m90);
    this.hpf_3.y = this.c_y + this.y_space * global.sine(this.theta) - this.y_space * global.sine(this.theta_m90);
    this.hpf_4.x = this.c_x + this.x_space * global.cosine(this.theta) + this.x_space * global.cosine(this.theta_m90);
    this.hpf_4.y = this.c_y + this.y_space * global.sine(this.theta) + this.y_space * global.sine(this.theta_m90);
    this.hpf_5.x = this.c_x + this.x_space * global.cosine(this.theta);
    this.hpf_5.y = this.c_y + this.y_space * global.sine(this.theta);
    this.hpf_6.x = this.c_x - 0.5 * this.x_space * global.cosine(this.theta) - 0.25 * this.x_space * global.cosine(this.theta_m90);
    this.hpf_6.y = this.c_y - 0.5 * this.y_space * global.sine(this.theta) - 0.25 * this.y_space * global.sine(this.theta_m90);
    this.hpf_7.x = this.c_x + 0.25 * this.x_space * global.cosine(this.theta) - 0.25 * this.x_space * global.cosine(this.theta_m90);
    this.hpf_7.y = this.c_y + 0.25 * this.y_space * global.sine(this.theta) - 0.25 * this.y_space * global.sine(this.theta_m90);
    this.hpf_8.x = this.c_x + 0.5 * this.x_space * global.cosine(this.theta) + 0.25 * this.x_space * global.cosine(this.theta_m90);
    this.hpf_8.y = this.c_y + 0.5 * this.y_space * global.sine(this.theta) + 0.25 * this.y_space * global.sine(this.theta_m90);
