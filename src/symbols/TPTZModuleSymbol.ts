 ...
 * File		        : TPTZModuleSymbol.js
 * Author            : nboatengc
 * Date created      : 20190928
 *
 * Purpose           : A class to draw the tptz element without worrying about the
...
class TPTZModuleSymbol {
	...
	/* Angle from p1 to p2 */
	public theta: number;
	public tptz_0: PointF;
	public tptz_1: PointF;
	public tptz_2: PointF;
	public tptz_3: PointF;
	public tptz_4: PointF;
	public tptz_5: PointF;
	...
	build_element() {
		this.tptz_0.x = this.c_x - this.x_space * global.cosine(this.theta) + this.x_space * global.cosine(this.theta_m90);
		this.tptz_0.y = this.c_y - this.y_space * global.sine(this.theta) + this.y_space * global.sine(this.theta_m90);
		this.tptz_2.x = this.c_x - this.x_space * global.cosine(this.theta) - this.x_space * global.cosine(this.theta_m90);
		this.tptz_2.y = this.c_y - this.y_space * global.sine(this.theta) - this.y_space * global.sine(this.theta_m90);
		this.tptz_3.x = this.c_x + this.x_space * global.cosine(this.theta) - this.x_space * global.cosine(this.theta_m90);
		this.tptz_3.y = this.c_y + this.y_space * global.sine(this.theta) - this.y_space * global.sine(this.theta_m90);
		this.tptz_4.x = this.c_x + this.x_space * global.cosine(this.theta) + this.x_space * global.cosine(this.theta_m90);
		this.tptz_4.y = this.c_y + this.y_space * global.sine(this.theta) + this.y_space * global.sine(this.theta_m90);
		this.tptz_5.x = this.c_x + this.x_space * global.cosine(this.theta);
		this.tptz_5.y = this.c_y + this.y_space * global.sine(this.theta);
