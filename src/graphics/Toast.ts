...
class Toast {
  ...
  private HEIGHT_RATIO: number = 0.85;
  private HEIGHT_FACTOR: number = 0.7;
  ...
  private readonly MAX_SECONDS: number = 2;
  /* The maximum amount of time to show the text. */
  private readonly MAX_TIME: number = FPS;
  /* A flag that dictates when this component can draw to the screen. */
  public draw_text: boolean = false;
  /* This is to draw a surrounding box around the text. */
  private bounds: RectF = new RectF(0, 0, 0, 0);
  private TOAST_REQUEST_DRAW: boolean = false;
  private last_text: string = '-';
  private text_measure_div2: number = -1;
