...
class OnScreenKeyboard {
	...
	public LETTER_ROW_1: string;
	public LETTER_ROW_2: string;
	public LETTER_ROW_3: string;
	...
	public ENGINEERING_KEYBOARD_FILTER: RegExp;
	public FILE_NAME_KEYBOARD_FILTER: RegExp;
