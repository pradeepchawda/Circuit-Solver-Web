...
class OnScreenKeyboard {
	private readonly KEYBOARD_MAX_KEYS: number;
	private readonly LETTER_ROW_1: string;
	private readonly LETTER_ROW_2: string;
	private readonly LETTER_ROW_3: string;
	private readonly KEYBOARD_LETTER_REF: Array<number>;
	private readonly KEYBOARD_SPECIAL_REF: Array<number>;
	private readonly KEYBOARD_MAPPING: Array<string>;
	private readonly KEYBOARD_INCREMENT_AT: Array<number>;
	private readonly KEYBOARD_BLOCK_EXPAND: Array<number>;
	private readonly KEYBOARD_EXPAND_FORMAT: KEYBOARD_EXPAND_T;
	private readonly KEYBOARD_KEYS: Array<RectF>;
	private readonly ENGINEERING_KEYBOARD_FILTER: RegExp;
	private readonly FILE_NAME_KEYBOARD_FILTER: RegExp;
	private readonly ENGINEERING_KEYBOARD_FILTER_INDEX: Array<boolean>;
	private readonly FILE_NAME_KEYBOARD_FILTER_INDEX: Array<boolean>;
	private readonly KEYBOARD_KEY_EVENT: ON_SCREEN_KEYBOARD_KEY_EVENT_T;
	public bounds: RectF;
	...
	private flag_caps_lock: boolean;
	private flag_shift: boolean;
	private flag_enter: boolean;
	private cap_ref: number;
	private alt_1_ref: number;
	private alt_2_ref: number;
	private exit_ref: number;
	private tab_ref: number;
	private backspace_ref: number;
	private shift_1_ref: number;
	private enter_ref: number;
	private ctrl_1_ref: number;
	private ctrl_2_ref: number;
	private shift_2_ref: number;
	private flag_key_down: boolean;
	private flag_key_up: boolean;
	private engineering_keyboard_mode: boolean;
	private hover_index: number;
