				...
				if (this.window_anchored) {
					if (
						...
						if (
							...
							this.attributes[global.CONSTANTS.SYSTEM_OPTION_LANGUAGE].contains_xy(global.mouse_x - this.offset_x, global.mouse_y - this.offset_y) &&
							...
							this.attributes[global.CONSTANTS.SYSTEM_OPTION_AUTOMATIC_TIMESTEP].contains_xy(global.mouse_x - this.offset_x, global.mouse_y - this.offset_y) &&
							...
							this.attributes[global.CONSTANTS.SYSTEM_OPTION_SHORTCUT_HINTS].contains_xy(global.mouse_x - this.offset_x, global.mouse_y - this.offset_y) &&
							...
							this.attributes[global.CONSTANTS.SYSTEM_OPTION_STRETCH_WINDOW].contains_xy(global.mouse_x - this.offset_x, global.mouse_y - this.offset_y) &&
			...
			if (index === global.CONSTANTS.SYSTEM_OPTION_LANGUAGE) {
				...
				if (global.CONSTANTS.SYSTEM_OPTION_AUTOMATIC_TIMESTEP < this.ATTRIBUTE_SHOW_SIZE) {
					if (global.variables.system_options['values'][global.CONSTANTS.SYSTEM_OPTION_AUTOMATIC_TIMESTEP] === global.CONSTANTS.OFF) {
						global.variables.system_options['values'][global.CONSTANTS.SYSTEM_OPTION_AUTOMATIC_TIMESTEP] = global.ON;
					} else {
				...
				if (global.CONSTANTS.SYSTEM_OPTION_SHORTCUT_HINTS < this.ATTRIBUTE_SHOW_SIZE) {
					if (global.variables.system_options['values'][global.CONSTANTS.SYSTEM_OPTION_SHORTCUT_HINTS] === global.CONSTANTS.OFF) {
						global.variables.system_options['values'][global.CONSTANTS.SYSTEM_OPTION_SHORTCUT_HINTS] = global.ON;
					} else {
				...
				if (global.CONSTANTS.SYSTEM_OPTION_STRETCH_WINDOW < this.ATTRIBUTE_SHOW_SIZE) {
					if (global.variables.system_options['values'][global.CONSTANTS.SYSTEM_OPTION_STRETCH_WINDOW] === global.CONSTANTS.OFF) {
						global.variables.system_options['values'][global.CONSTANTS.SYSTEM_OPTION_STRETCH_WINDOW] = global.ON;
	...
	draw_window(canvas: GraphicsEngine): void {
		if (global.flag_select_settings) {
			...
			for (var i: number = 0; i < this.ATTRIBUTE_SHOW_SIZE; i++) {
				if (global.not_null(global.variables.system_options)) {
					if (i < global.variables.system_options['options'].length && global.not_null(this.attributes[i])) {
						if (this.attributes[i].contains_xy(global.mouse_x - this.offset_x, global.mouse_y - this.offset_y) && this.window_anchored && !global.CONSTANTS.MOBILE_MODE) {
							canvas.draw_rect(
						...
						if (global.variables.system_options['values'][i] === global.ON || global.variables.system_options['values'][i] === global.CONSTANTS.OFF) {
							...
							if (global.variables.system_options['values'][i] === global.ON) {
