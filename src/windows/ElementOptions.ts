...
class ElementOptions {
  ...
  public mb_x = menu_bar.menu_icons[menu_bar.UP_DOWN_INDEX].get_center_x();
  ...
  public show_2 = false;
  public show_3 = false;
  public edit_path0 = new Path();
  public edit_path1 = new Path();
  public trash_path0 = new Path();
  public trash_path1 = new Path();
  public flip_path0 = new Path();
  public flip_path1 = new Path();
  ...
  public meter_line_paint = new Paint();
  /* This paint is used for drawing the "lines" that the component is comprised of. */
